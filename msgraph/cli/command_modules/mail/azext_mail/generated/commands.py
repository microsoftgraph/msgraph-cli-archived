...
from azext_mail.generated._client_factory import (
    cf_user,
...
mail_user = CliCommandType(
    operations_tmpl='azext_mail.vendored_sdks.mail.operations._users_operations#UsersOperations.{}',
    client_factory=cf_user,
)


mail_user_inference_classification = CliCommandType(
    operations_tmpl='azext_mail.vendored_sdks.mail.operations._users_inference_classification_operations#UsersInferenceClassificationOperations.{}',
...
mail_user_mail_folder = CliCommandType(
    operations_tmpl=(
        'azext_mail.vendored_sdks.mail.operations._users_mail_folders_operations#UsersMailFoldersOperations.{}'
    ),
...
mail_user_mail_folder_message = CliCommandType(
    operations_tmpl='azext_mail.vendored_sdks.mail.operations._users_mail_folders_messages_operations#UsersMailFoldersMessagesOperations.{}',
    client_factory=cf_user_mail_folder_message,
)


mail_user_message = CliCommandType(
    operations_tmpl='azext_mail.vendored_sdks.mail.operations._users_messages_operations#UsersMessagesOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group('mail user', mail_user, client_factory=cf_user) as g:
    ...
    with self.command_group(
        ...
        mail_user_inference_classification,
        client_factory=cf_user_inference_classification,
    ) as g:
    ...
    with self.command_group('mail user-mail-folder', mail_user_mail_folder, client_factory=cf_user_mail_folder) as g:
    ...
    with self.command_group(
        'mail user-mail-folder-message', mail_user_mail_folder_message, client_factory=cf_user_mail_folder_message
    ) as g:
    ...
    with self.command_group('mail user-message', mail_user_message, client_factory=cf_user_message) as g:
    ...
    with self.command_group('mail', is_experimental=True):
        pass
