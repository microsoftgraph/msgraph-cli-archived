...
class sitesonenotesectionsparentsectiongroupparentnotebookOperations:
    ...
    async def copy_notebook(
        ...
        body: "models.paths2ukqiqsitessiteidonenotesectionsonenotesectionidparentsectiongroupparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema",
        **kwargs
