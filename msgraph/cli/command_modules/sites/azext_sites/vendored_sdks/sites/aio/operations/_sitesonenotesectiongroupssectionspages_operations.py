...
class sitesonenotesectiongroupssectionspagesOperations:
    ...
    async def copy_to_section(
        ...
        onenote_page_id: str,
        body: "models.paths169srg3sitessiteidonenotesectiongroupssectiongroupidsectionsonenotesectionidpagesonenotepageidmicrosoftgraphcopytosectionpostrequestbodycontentapplicationjsonschema",
        **kwargs
    ...
    async def onenote_patch_content(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        body: "models.paths7m7nkositessiteidonenotesectiongroupssectiongroupidsectionsonenotesectionidpagesonenotepageidmicrosoftgraphonenotepatchcontentpostrequestbodycontentapplicationjsonschema",
        **kwargs
    ) -> None:
