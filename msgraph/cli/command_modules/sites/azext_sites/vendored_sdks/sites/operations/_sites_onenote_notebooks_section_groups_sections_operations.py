...
class SitesOnenoteNotebooksSectionGroupsSectionsOperations(object):
    ...
    def copy_to_notebook(
        ...
        body,  # type: "models.PathsD1OdemSitesSiteIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
    ...
    def copy_to_section_group(
        ...
        section_group_id,  # type: str
        onenote_section_id,  # type: str
        body,  # type: "models.Paths1Rvjs90SitesSiteIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdMicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteOperation"
