...
class GroupsPlannerOperations:
    """GroupsPlannerOperations async operations.
    ...
    def list_plans(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerPlan]
    ...
    list_plans.metadata = {'url': '/groups/{group-id}/planner/plans'}  # type: ignore
    ...
    async def create_plans(
        ...
        **kwargs
        ...
        return deserialized
    create_plans.metadata = {'url': '/groups/{group-id}/planner/plans'}  # type: ignore
    ...
    async def get_plans(
        ...
        **kwargs
        ...
        return deserialized
    get_plans.metadata = {'url': '/groups/{group-id}/planner/plans/{plannerPlan-id}'}  # type: ignore
    ...
    update_plans.metadata = {'url': '/groups/{group-id}/planner/plans/{plannerPlan-id}'}  # type: ignore
    ...
    delete_plans.metadata = {'url': '/groups/{group-id}/planner/plans/{plannerPlan-id}'}  # type: ignore
