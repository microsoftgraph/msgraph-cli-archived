...
class PlannerBucketsTasksOperations(object):
    """PlannerBucketsTasksOperations operations.
    ...
    def get_details(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_details.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    update_details.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_details.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
