...
class UsersPlannerPlansBucketsTasksOperations(object):
    """UsersPlannerPlansBucketsTasksOperations operations.
    ...
    def get_details(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_details.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    update_details.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_details.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
