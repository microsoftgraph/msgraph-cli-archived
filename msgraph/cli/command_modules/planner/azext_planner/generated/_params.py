...
def load_arguments(self, _):
    ...
    with self.argument_context('planner delete-bucket') as c:
        c.argument('planner_bucket_id', type=str, help='key: id of plannerBucket')
        c.argument('if_match', type=str, help='ETag')

    with self.argument_context('planner delete-plan') as c:
        c.argument('planner_plan_id', type=str, help='key: id of plannerPlan')
        c.argument('if_match', type=str, help='ETag')

    with self.argument_context('planner delete-task') as c:
        c.argument('planner_task_id', type=str, help='key: id of plannerTask')
        c.argument('if_match', type=str, help='ETag')
    ...
    with self.argument_context('planner show-bucket') as c:
        c.argument('planner_bucket_id', type=str, help='key: id of plannerBucket')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('planner show-plan') as c:
        c.argument('planner_plan_id', type=str, help='key: id of plannerPlan')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('planner show-task') as c:
        c.argument('planner_task_id', type=str, help='key: id of plannerTask')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')
