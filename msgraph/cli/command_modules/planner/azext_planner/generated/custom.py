...
def planner_delete_bucket(client,
                          planner_bucket_id,
                          if_match=None):
...
def planner_delete_plan(client,
                        planner_plan_id,
                        if_match=None):
...
def planner_delete_task(client,
                        planner_task_id,
                        if_match=None):
...
def planner_show_bucket(client,
                        planner_bucket_id,
                        select=None,
                        expand=None):
