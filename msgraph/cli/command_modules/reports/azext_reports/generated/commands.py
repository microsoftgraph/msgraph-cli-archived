...
from azext_reports.generated._client_factory import (
...
reports_audit_log_audit_log_root = CliCommandType(
    operations_tmpl='azext_reports.vendored_sdks.reports.operations._audit_logs_audit_log_root_operations#AuditLogsAuditLogRootOperations.{}',
    client_factory=cf_audit_log_audit_log_root,
)


reports_audit_log = CliCommandType(
    operations_tmpl='azext_reports.vendored_sdks.reports.operations._audit_logs_operations#AuditLogsOperations.{}',
...
reports_report_report_root = CliCommandType(
    operations_tmpl=(
        'azext_reports.vendored_sdks.reports.operations._reports_report_root_operations#ReportsReportRootOperations.{}'
    ),
...
reports_report = CliCommandType(
    operations_tmpl='azext_reports.vendored_sdks.reports.operations._reports_operations#ReportsOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group(
        'reports audit-log-audit-log-root', reports_audit_log_audit_log_root, client_factory=cf_audit_log_audit_log_root
    ) as g:
    ...
    with self.command_group('reports audit-log', reports_audit_log, client_factory=cf_audit_log) as g:
    ...
    with self.command_group(
        'reports report-root', reports_report_report_root, client_factory=cf_report_report_root
    ) as g:
    ...
    with self.command_group('reports report', reports_report, client_factory=cf_report) as g:
    ...
    with self.command_group('reports', is_experimental=True):
        pass
