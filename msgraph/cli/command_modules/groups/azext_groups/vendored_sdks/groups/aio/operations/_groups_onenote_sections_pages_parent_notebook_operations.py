...
class GroupsOnenoteSectionsPagesParentNotebookOperations:
    ...
    async def copy_notebook(
        ...
        onenote_page_id: str,
        body: "models.Paths1Wb2V8OGroupsGroupIdOnenoteSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
