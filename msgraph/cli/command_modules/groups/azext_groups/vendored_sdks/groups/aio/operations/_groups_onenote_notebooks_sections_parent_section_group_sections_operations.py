...
class GroupsOnenoteNotebooksSectionsParentSectionGroupSectionsOperations:
    """GroupsOnenoteNotebooksSectionsParentSectionGroupSectionsOperations async operations.
    ...
    async def copy_to_notebook(
        ...
        body: "models.PathsM5T1F1GroupsGroupIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdParentsectiongroupSectionsOnenotesectionId1MicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ...
    async def copy_to_section_group(
        ...
        onenote_section_id: str,
        onenote_section_id1: str,
        body: "models.Paths78P6D4GroupsGroupIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdParentsectiongroupSectionsOnenotesectionId1MicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> "models.MicrosoftGraphOnenoteOperation":
