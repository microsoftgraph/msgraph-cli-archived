...
class GroupsOnenoteNotebooksSectionGroupsSectionsPagesParentNotebookOperations:
    """GroupsOnenoteNotebooksSectionGroupsSectionsPagesParentNotebookOperations async operations.
    ...
    async def copy_notebook(
        ...
        onenote_page_id: str,
        body: "models.Paths5Gqi20GroupsGroupIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
