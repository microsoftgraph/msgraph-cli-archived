...
class GroupsCalendarEventsCalendarOperations:
    """GroupsCalendarEventsCalendarOperations async operations.
    ...
    async def get_schedule(
        ...
        group_id: str,
        event_id: str,
        body: "models.Paths1D3Sml5GroupsGroupIdCalendarEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema",
        **kwargs
