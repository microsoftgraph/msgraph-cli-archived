...
class GroupsOnenoteSectionGroupsSectionsPagesParentNotebookOperations:
    ...
    async def copy_notebook(
        ...
        onenote_page_id: str,
        body: "models.Paths1Uobp0GroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
