...
class GroupsCalendarCalendarViewCalendarOperations:
    """GroupsCalendarCalendarViewCalendarOperations async operations.
    ...
    async def get_schedule(
        ...
        group_id: str,
        event_id: str,
        body: "models.Paths1Jq5C3VGroupsGroupIdCalendarCalendarviewEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema",
        **kwargs
