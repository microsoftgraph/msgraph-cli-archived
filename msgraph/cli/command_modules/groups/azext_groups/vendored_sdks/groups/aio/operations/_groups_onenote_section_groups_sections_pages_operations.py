...
class GroupsOnenoteSectionGroupsSectionsPagesOperations:
    ...
    async def copy_to_section(
        ...
        onenote_page_id: str,
        body: "models.Paths1Ghsy1BGroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ...
    async def onenote_patch_content(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        body: "models.Paths13IutgfGroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
