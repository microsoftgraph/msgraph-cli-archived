...
class GroupsOnenotePagesParentNotebookSectionsParentNotebookOperations:
    """GroupsOnenotePagesParentNotebookSectionsParentNotebookOperations async operations.
    ...
    async def copy_notebook(
        ...
        body: "models.Paths5Y0EhdGroupsGroupIdOnenotePagesOnenotepageIdParentnotebookSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
