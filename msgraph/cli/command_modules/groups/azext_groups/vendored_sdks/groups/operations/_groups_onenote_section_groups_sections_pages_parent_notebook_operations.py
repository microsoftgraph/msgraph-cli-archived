...
class GroupsOnenoteSectionGroupsSectionsPagesParentNotebookOperations(object):
    ...
    def copy_notebook(
        ...
        body,  # type: "models.Paths1Uobp0GroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~groups.models.Paths1Uobp0GroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema
        ...
        body_content = self._serialize.body(body, 'Paths1Uobp0GroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    copy_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/microsoft.graph.copyNotebook'}  # type: ignore
