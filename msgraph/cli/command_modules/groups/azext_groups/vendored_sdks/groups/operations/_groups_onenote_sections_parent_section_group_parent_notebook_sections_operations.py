...
class GroupsOnenoteSectionsParentSectionGroupParentNotebookSectionsOperations(object):
    """GroupsOnenoteSectionsParentSectionGroupParentNotebookSectionsOperations operations.
    ...
    def copy_to_notebook(
        ...
        body,  # type: "models.Paths1Dyy9InGroupsGroupIdOnenoteSectionsOnenotesectionIdParentsectiongroupParentnotebookSectionsOnenotesectionId1MicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
    ...
    def copy_to_section_group(
        ...
        onenote_section_id,  # type: str
        onenote_section_id1,  # type: str
        body,  # type: "models.PathsRzkt3FGroupsGroupIdOnenoteSectionsOnenotesectionIdParentsectiongroupParentnotebookSectionsOnenotesectionId1MicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteOperation"
