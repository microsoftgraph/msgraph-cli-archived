...
class GroupsCalendarOperations(object):
    ...
    def allowed_calendar_sharing_roles(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    allowed_calendar_sharing_roles.metadata = {'url': '/groups/{group-id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User=\'{User}\')'}  # type: ignore

    def get_schedule(
        self,
        group_id,  # type: str
        body,  # type: "models.PathsB1HbbpGroupsGroupIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~groups.models.PathsB1HbbpGroupsGroupIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content = self._serialize.body(body, 'PathsB1HbbpGroupsGroupIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    get_schedule.metadata = {'url': '/groups/{group-id}/calendar/microsoft.graph.getSchedule'}  # type: ignore
