...
class GroupsOnenotePagesParentNotebookOperations(object):
    ...
    def copy_notebook(
        ...
        body,  # type: "models.Paths1Cv7Bb9GroupsGroupIdOnenotePagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
