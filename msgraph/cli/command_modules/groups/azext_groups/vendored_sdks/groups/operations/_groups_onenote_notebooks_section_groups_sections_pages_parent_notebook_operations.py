...
class GroupsOnenoteNotebooksSectionGroupsSectionsPagesParentNotebookOperations(object):
    """GroupsOnenoteNotebooksSectionGroupsSectionsPagesParentNotebookOperations operations.
    ...
    def copy_notebook(
        ...
        body,  # type: "models.Paths5Gqi20GroupsGroupIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~groups.models.Paths5Gqi20GroupsGroupIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema
        ...
        body_content = self._serialize.body(body, 'Paths5Gqi20GroupsGroupIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    copy_notebook.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/microsoft.graph.copyNotebook'}  # type: ignore
