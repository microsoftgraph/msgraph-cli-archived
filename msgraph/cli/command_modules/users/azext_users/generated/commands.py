...
from azext_users.generated._client_factory import cf_user_user, cf_user, cf_user_outlook, cf_user_setting


users_user_user = CliCommandType(
    operations_tmpl='azext_users.vendored_sdks.users.operations._users_user_operations#UsersUserOperations.{}',
    client_factory=cf_user_user,
)


users_user = CliCommandType(
    operations_tmpl='azext_users.vendored_sdks.users.operations._users_operations#UsersOperations.{}',
    client_factory=cf_user,
)


users_user_outlook = CliCommandType(
    operations_tmpl='azext_users.vendored_sdks.users.operations._users_outlook_operations#UsersOutlookOperations.{}',
    client_factory=cf_user_outlook,
)


users_user_setting = CliCommandType(
    operations_tmpl='azext_users.vendored_sdks.users.operations._users_settings_operations#UsersSettingsOperations.{}',
