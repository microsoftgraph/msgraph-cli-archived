...
changenotifications_subscription_subscription = CliCommandType(
    operations_tmpl='azext_changenotifications.vendored_sdks.changenotifications.operations._subscriptions_subscription_operations#SubscriptionsSubscriptionOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group(
        ...
        changenotifications_subscription_subscription,
        client_factory=cf_subscription_subscription,
    ) as g:
