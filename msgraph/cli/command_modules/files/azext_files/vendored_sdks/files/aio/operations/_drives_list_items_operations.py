...
class DrivesListItemsOperations:
    ...
    async def get_activities_by_interval96_b0(
        ...
        **kwargs
        ...
        return deserialized
    get_activities_by_interval96_b0.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/microsoft.graph.getActivitiesByInterval()'}  # type: ignore
    ...
    async def get_activities_by_interval53_ee(
        ...
        **kwargs
        ...
        return deserialized
    get_activities_by_interval53_ee.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
