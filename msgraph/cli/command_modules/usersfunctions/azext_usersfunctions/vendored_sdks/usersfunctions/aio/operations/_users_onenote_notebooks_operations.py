...
class UsersOnenoteNotebooksOperations:
    ...
    async def get_recent_notebooks(
        ...
        **kwargs
        ...
        return deserialized
    get_recent_notebooks.metadata = {'url': '/users/{user-id}/onenote/notebooks/microsoft.graph.getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks})'}  # type: ignore
