...
class DeviceAppManagementMobileAppsOperations(object):
    """DeviceAppManagementMobileAppsOperations operations.
    ...
    def list_assignments(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfMobileAppAssignment"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devices_corporate_management.models.CollectionOfMobileAppAssignment]
    ...
    list_assignments.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments'}  # type: ignore

    def create_assignments(
        self,
        mobile_app_id,  # type: str
        body,  # type: "models.MicrosoftGraphMobileAppAssignment"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphMobileAppAssignment"
        ...
        :type body: ~devices_corporate_management.models.MicrosoftGraphMobileAppAssignment
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphMobileAppAssignment')
        ...
        return deserialized
    create_assignments.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments'}  # type: ignore

    def get_assignments(
        self,
        mobile_app_id,  # type: str
        mobile_app_assignment_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_assignments.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments/{mobileAppAssignment-id}'}  # type: ignore
    ...
    update_assignments.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments/{mobileAppAssignment-id}'}  # type: ignore
    ...
    delete_assignments.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments/{mobileAppAssignment-id}'}  # type: ignore
    ...
    def list_categories(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfMobileAppCategory0"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devices_corporate_management.models.CollectionOfMobileAppCategory0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_categories.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/categories'}  # type: ignore

    def list_ref_categories(
        self,
        mobile_app_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum119"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfLinksOfMobileAppCategory"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devices_corporate_management.models.CollectionOfLinksOfMobileAppCategory]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_categories.metadata['url']  # type: ignore
                path_format_arguments = {
                    'mobileApp-id': self._serialize.url("mobile_app_id", mobile_app_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_categories.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/categories/$ref'}  # type: ignore

    def create_ref_categories(
        self,
        mobile_app_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_ref_categories.metadata['url']  # type: ignore
        path_format_arguments = {
            'mobileApp-id': self._serialize.url("mobile_app_id", mobile_app_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_categories.metadata = {'url': '/deviceAppManagement/mobileApps/{mobileApp-id}/categories/$ref'}  # type: ignore

    def assign(
        self,
        mobile_app_id,  # type: str
        body,  # type: "models.Paths12NzrcrDeviceappmanagementMobileappsMobileappIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type body: ~devices_corporate_management.models.Paths12NzrcrDeviceappmanagementMobileappsMobileappIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths12NzrcrDeviceappmanagementMobileappsMobileappIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
