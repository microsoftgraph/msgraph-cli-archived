...
class informationprotectionthreatassessmentrequestsOperations:
    """informationprotectionthreatassessmentrequestsOperations async operations.
    ...
    def list_results(
        ...
        **kwargs
    ) -> AsyncIterable["models.collectionofthreatassessmentresult"]:
        ...
        :type orderby: list[str or ~identity_sign_ins.models.Enum36]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_sign_ins.models.Enum37]
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.collectionofthreatassessmentresult]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_results.metadata['url']  # type: ignore
    ...
    list_results.metadata = {'url': '/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}/results'}  # type: ignore

    async def create_results(
        self,
        threat_assessment_request_id: str,
        body: "models.microsoftgraphthreatassessmentresult",
        **kwargs
    ) -> "models.microsoftgraphthreatassessmentresult":
        ...
        :type body: ~identity_sign_ins.models.microsoftgraphthreatassessmentresult
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.create_results.metadata['url']  # type: ignore
        path_format_arguments = {
            'threatAssessmentRequest-id': self._serialize.url("threat_assessment_request_id", threat_assessment_request_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_results.metadata = {'url': '/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}/results'}  # type: ignore

    async def get_results(
        self,
        threat_assessment_request_id: str,
        threat_assessment_result_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_results.metadata['url']  # type: ignore
        path_format_arguments = {
            'threatAssessmentRequest-id': self._serialize.url("threat_assessment_request_id", threat_assessment_request_id, 'str'),
        ...
        return deserialized
    get_results.metadata = {'url': '/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}/results/{threatAssessmentResult-id}'}  # type: ignore
    ...
    async def update_results(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_results.metadata['url']  # type: ignore
        path_format_arguments = {
            'threatAssessmentRequest-id': self._serialize.url("threat_assessment_request_id", threat_assessment_request_id, 'str'),
            'threatAssessmentResult-id': self._serialize.url("threat_assessment_result_id", threat_assessment_result_id, 'str'),
        }
    ...
    update_results.metadata = {'url': '/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}/results/{threatAssessmentResult-id}'}  # type: ignore
    ...
    async def delete_results(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_results.metadata['url']  # type: ignore
        path_format_arguments = {
            'threatAssessmentRequest-id': self._serialize.url("threat_assessment_request_id", threat_assessment_request_id, 'str'),
            'threatAssessmentResult-id': self._serialize.url("threat_assessment_result_id", threat_assessment_result_id, 'str'),
        }
    ...
    delete_results.metadata = {'url': '/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}/results/{threatAssessmentResult-id}'}  # type: ignore
