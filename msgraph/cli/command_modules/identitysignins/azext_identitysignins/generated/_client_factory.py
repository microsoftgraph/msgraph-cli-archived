...
def cf_data_policy_operation_data_policy_operation(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).data_policy_operations_data_policy_operation
...
def cf_identity_provider_identity_provider(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).identity_providers_identity_provider
...
def cf_information_protection_threat_assessment_request(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).information_protection_threat_assessment_requests


def cf_invitation_invitation(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).invitations_invitation
...
def cf_oauth2permission_grant_oauth2permission_grant(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).oauth2_permission_grants_oauth2_permission_grant


def cf_oauth2permission_grant(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).oauth2_permission_grants
...
def cf_policy_policy_root(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).policies_policy_root
...
def cf_policy_permission_grant_policy(cli_ctx, *_):
    return cf_identitysignins_cl(cli_ctx).policies_permission_grant_policies
