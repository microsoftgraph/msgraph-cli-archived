...
from azext_identitysignins.generated._help import helps  # pylint: disable=unused-import
try:
    from azext_identitysignins.manual._help import helps  # pylint: disable=reimported
