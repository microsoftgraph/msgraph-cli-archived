...
class UsersOnenoteSectionGroupsSectionsParentNotebookSectionsOperations:
    """UsersOnenoteSectionGroupsSectionsParentNotebookSectionsOperations async operations.
    ...
    async def copy_to_notebook(
        ...
        body: "models.PathsI6Vxt9UsersUserIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdParentnotebookSectionsOnenotesectionId1MicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
