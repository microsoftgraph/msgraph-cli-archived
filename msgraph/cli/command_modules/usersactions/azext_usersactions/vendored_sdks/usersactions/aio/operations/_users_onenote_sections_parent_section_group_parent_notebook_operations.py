...
class UsersOnenoteSectionsParentSectionGroupParentNotebookOperations:
    ...
    async def copy_notebook(
        ...
        body: "models.Paths1EnvxcpUsersUserIdOnenoteSectionsOnenotesectionIdParentsectiongroupParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
        ...
        :type body: ~users_actions.models.Paths1EnvxcpUsersUserIdOnenoteSectionsOnenotesectionIdParentsectiongroupParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema
        ...
        body_content = self._serialize.body(body, 'Paths1EnvxcpUsersUserIdOnenoteSectionsOnenotesectionIdParentsectiongroupParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema')
