...
class usersonenotesectionsparentsectiongroupparentnotebookOperations(object):
    ...
    def copy_notebook(
        ...
        body,  # type: "models.paths1envxcpusersuseridonenotesectionsonenotesectionidparentsectiongroupparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
