...
class UsersOnenoteNotebooksOperations(object):
    ...
    def copy_notebook(
        ...
        body,  # type: "models.Paths47PyxmUsersUserIdOnenoteNotebooksNotebookIdMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
    ...
    def get_notebook_from_web_url(
        self,
        user_id,  # type: str
        body,  # type: "models.Paths1Fukv4UsersUserIdOnenoteNotebooksMicrosoftGraphGetnotebookfromweburlPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
