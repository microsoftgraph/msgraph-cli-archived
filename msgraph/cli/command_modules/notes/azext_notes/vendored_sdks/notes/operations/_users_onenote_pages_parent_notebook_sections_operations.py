...
class UsersOnenotePagesParentNotebookSectionsOperations(object):
    """UsersOnenotePagesParentNotebookSectionsOperations operations.
    ...
    list_pages.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    def create_pages(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_pages.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    def get_pages(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_pages.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    update_pages.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    delete_pages.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
