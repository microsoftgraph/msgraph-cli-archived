...
class ContactsOrgContactOperations(object):
    """ContactsOrgContactOperations operations.
    ...
    def create_org_contact(
        self,
        body,  # type: "models.MicrosoftGraphOrgContact"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~identity_directory_management.models.MicrosoftGraphOrgContact
        :keyword callable cls: A custom type or function that will be passed the direct response
