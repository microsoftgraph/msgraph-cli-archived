...
class DevicesOperations:
    ...
    list_extensions.metadata = {'url': '/devices/{device-id}/extensions'}  # type: ignore
    ...
    async def create_extensions(
        ...
        **kwargs
        ...
        return deserialized
    create_extensions.metadata = {'url': '/devices/{device-id}/extensions'}  # type: ignore
    ...
    async def get_extensions(
        ...
        **kwargs
        ...
        return deserialized
    get_extensions.metadata = {'url': '/devices/{device-id}/extensions/{extension-id}'}  # type: ignore
    ...
    update_extensions.metadata = {'url': '/devices/{device-id}/extensions/{extension-id}'}  # type: ignore
    ...
    delete_extensions.metadata = {'url': '/devices/{device-id}/extensions/{extension-id}'}  # type: ignore
    ...
    def list_member_of(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_member_of(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def check_member_groups(
        self,
        device_id: str,
        body: "models.PathsNtst38DevicesDeviceIdMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> List[str]:
        ...
        :type body: ~identity_directory_management.models.PathsNtst38DevicesDeviceIdMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    check_member_groups.metadata = {'url': '/devices/{device-id}/microsoft.graph.checkMemberGroups'}  # type: ignore

    async def check_member_objects(
        self,
        device_id: str,
        body: "models.Paths17JleimDevicesDeviceIdMicrosoftGraphCheckmemberobjectsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> List[str]:
        ...
        :type device_id: str
        :param body: Action parameters.
        :type body: ~identity_directory_management.models.Paths17JleimDevicesDeviceIdMicrosoftGraphCheckmemberobjectsPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: list of str, or the result of cls(response)
        :rtype: list[str]
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    check_member_objects.metadata = {'url': '/devices/{device-id}/microsoft.graph.checkMemberObjects'}  # type: ignore

    async def get_member_groups(
        self,
        device_id: str,
        body: "models.PathsOikz69DevicesDeviceIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> List[str]:
        ...
        :type device_id: str
        :param body: Action parameters.
        :type body: ~identity_directory_management.models.PathsOikz69DevicesDeviceIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: list of str, or the result of cls(response)
        :rtype: list[str]
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_member_groups.metadata = {'url': '/devices/{device-id}/microsoft.graph.getMemberGroups'}  # type: ignore

    async def get_member_objects(
        self,
        device_id: str,
        body: "models.Paths1QbmtipDevicesDeviceIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> List[str]:
        ...
        :type device_id: str
        :param body: Action parameters.
        :type body: ~identity_directory_management.models.Paths1QbmtipDevicesDeviceIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: list of str, or the result of cls(response)
        :rtype: list[str]
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_member_objects.metadata = {'url': '/devices/{device-id}/microsoft.graph.getMemberObjects'}  # type: ignore
    ...
    def list_registered_owners(
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_registered_owners.metadata['url']  # type: ignore
                path_format_arguments = {
                    'device-id': self._serialize.url("device_id", device_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_registered_owners.metadata = {'url': '/devices/{device-id}/registeredOwners'}  # type: ignore

    def list_ref_registered_owners(
        self,
        device_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_registered_owners.metadata['url']  # type: ignore
                path_format_arguments = {
                    'device-id': self._serialize.url("device_id", device_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_registered_owners.metadata = {'url': '/devices/{device-id}/registeredOwners/$ref'}  # type: ignore

    async def create_ref_registered_owners(
        self,
        device_id: str,
        body: Dict[str, object],
        **kwargs
        ...
        # Construct URL
        url = self.create_ref_registered_owners.metadata['url']  # type: ignore
        path_format_arguments = {
            'device-id': self._serialize.url("device_id", device_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_registered_owners.metadata = {'url': '/devices/{device-id}/registeredOwners/$ref'}  # type: ignore
    ...
    def list_registered_users(
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_registered_users.metadata['url']  # type: ignore
                path_format_arguments = {
                    'device-id': self._serialize.url("device_id", device_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_registered_users.metadata = {'url': '/devices/{device-id}/registeredUsers'}  # type: ignore

    def list_ref_registered_users(
        self,
        device_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_registered_users.metadata['url']  # type: ignore
                path_format_arguments = {
                    'device-id': self._serialize.url("device_id", device_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_registered_users.metadata = {'url': '/devices/{device-id}/registeredUsers/$ref'}  # type: ignore

    async def create_ref_registered_users(
        self,
        device_id: str,
        body: Dict[str, object],
        **kwargs
        ...
        # Construct URL
        url = self.create_ref_registered_users.metadata['url']  # type: ignore
        path_format_arguments = {
            'device-id': self._serialize.url("device_id", device_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_registered_users.metadata = {'url': '/devices/{device-id}/registeredUsers/$ref'}  # type: ignore
    ...
    async def get_available_extension_properties(
        self,
        body: "models.Paths1540TevDevicesMicrosoftGraphGetavailableextensionpropertiesPostRequestbodyContentApplicationJsonSchema",
        **kwargs
        ...
        :param body: Action parameters.
        :type body: ~identity_directory_management.models.Paths1540TevDevicesMicrosoftGraphGetavailableextensionpropertiesPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_available_extension_properties.metadata = {'url': '/devices/microsoft.graph.getAvailableExtensionProperties'}  # type: ignore

    async def get_by_ids(
        self,
        body: "models.Paths1545W8NDevicesMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
        ...
        :param body: Action parameters.
        :type body: ~identity_directory_management.models.Paths1545W8NDevicesMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_by_ids.metadata = {'url': '/devices/microsoft.graph.getByIds'}  # type: ignore

    async def validate_properties(
        self,
        body: "models.Paths7X6XkrDevicesMicrosoftGraphValidatepropertiesPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
        ...
        :param body: Action parameters.
        :type body: ~identity_directory_management.models.Paths7X6XkrDevicesMicrosoftGraphValidatepropertiesPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    validate_properties.metadata = {'url': '/devices/microsoft.graph.validateProperties'}  # type: ignore
