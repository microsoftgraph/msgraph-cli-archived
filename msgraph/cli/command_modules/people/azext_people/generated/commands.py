...
from azext_people.generated._client_factory import (
    cf_user,
    cf_user_insight,
...
people_user = CliCommandType(
    operations_tmpl='azext_people.vendored_sdks.people.operations._users_operations#UsersOperations.{}',
...
people_user_insight = CliCommandType(
    operations_tmpl=(
        'azext_people.vendored_sdks.people.operations._users_insights_operations#UsersInsightsOperations.{}'
    ),
...
people_user_insight_shared = CliCommandType(
    operations_tmpl='azext_people.vendored_sdks.people.operations._users_insights_shared_operations#UsersInsightsSharedOperations.{}',
    client_factory=cf_user_insight_shared,
)


people_user_insight_trending = CliCommandType(
    operations_tmpl='azext_people.vendored_sdks.people.operations._users_insights_trending_operations#UsersInsightsTrendingOperations.{}',
...
people_user_insight_used = CliCommandType(
    operations_tmpl=(
        'azext_people.vendored_sdks.people.operations._users_insights_used_operations#UsersInsightsUsedOperations.{}'
    ),
...
def load_command_table(self, _):
    ...
    with self.command_group('people user', people_user, client_factory=cf_user) as g:
    ...
    with self.command_group('people user-insight', people_user_insight, client_factory=cf_user_insight) as g:
    ...
    with self.command_group(
        'people user-insight-shared', people_user_insight_shared, client_factory=cf_user_insight_shared
    ) as g:
    ...
    with self.command_group(
        'people user-insight-trending', people_user_insight_trending, client_factory=cf_user_insight_trending
    ) as g:
    ...
    with self.command_group(
        'people user-insight-used', people_user_insight_used, client_factory=cf_user_insight_used
    ) as g:
    ...
    with self.command_group('people', is_experimental=True):
        pass
