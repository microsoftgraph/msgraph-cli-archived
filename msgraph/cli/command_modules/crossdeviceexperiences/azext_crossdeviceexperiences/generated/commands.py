...
crossdeviceexperiences_user_activity = CliCommandType(
    operations_tmpl='azext_crossdeviceexperiences.vendored_sdks.crossdeviceexperiences.operations._users_activities_operations#UsersActivitiesOperations.{}',
    client_factory=cf_user_activity,
)


crossdeviceexperiences_user_activity_history_item = CliCommandType(
    operations_tmpl='azext_crossdeviceexperiences.vendored_sdks.crossdeviceexperiences.operations._users_activities_history_items_operations#UsersActivitiesHistoryItemsOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group(
        'crossdeviceexperiences user-activity', crossdeviceexperiences_user_activity, client_factory=cf_user_activity
    ) as g:
    ...
    with self.command_group(
        ...
        crossdeviceexperiences_user_activity_history_item,
        client_factory=cf_user_activity_history_item,
    ) as g:
