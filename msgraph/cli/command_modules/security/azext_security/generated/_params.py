...
from azext_security.action import (
    AddCloudAppStates,
    AddHistoryStates,
    AddHostStates,
    AddMalwareStates,
...
def load_arguments(self, _):
    ...
    with self.argument_context('security delete-alert') as c:
        c.argument('alert_id', type=str, help='key: id of alert')
        c.argument('if_match', type=str, help='ETag')

    with self.argument_context('security delete-secure-score') as c:
        c.argument('secure_score_id', type=str, help='key: id of secureScore')
        c.argument('if_match', type=str, help='ETag')

    with self.argument_context('security delete-secure-score-control-profile') as c:
    ...
    with self.argument_context('security show-alert') as c:
        c.argument('alert_id', type=str, help='key: id of alert')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('security show-secure-score') as c:
        c.argument('secure_score_id', type=str, help='key: id of secureScore')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('security show-secure-score-control-profile') as c:
        c.argument('secure_score_control_profile_id', type=str, help='key: id of secureScoreControlProfile')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')
