...
from azext_directoryobjects.generated._client_factory import cf_directory_object_directory_object, cf_directory_object


directoryobjects_directory_object_directory_object = CliCommandType(
    operations_tmpl='azext_directoryobjects.vendored_sdks.directoryobjects.operations._directory_objects_directory_object_operations#DirectoryObjectsDirectoryObjectOperations.{}',
    client_factory=cf_directory_object_directory_object,
)


directoryobjects_directory_object = CliCommandType(
    operations_tmpl='azext_directoryobjects.vendored_sdks.directoryobjects.operations._directory_objects_operations#DirectoryObjectsOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group(
        ...
        directoryobjects_directory_object_directory_object,
        client_factory=cf_directory_object_directory_object,
    ) as g:
        g.custom_command(
    ...
    with self.command_group(
        'directoryobjects directory-object', directoryobjects_directory_object, client_factory=cf_directory_object
    ) as g:
    ...
    with self.command_group('directoryobjects', is_experimental=True):
        pass
