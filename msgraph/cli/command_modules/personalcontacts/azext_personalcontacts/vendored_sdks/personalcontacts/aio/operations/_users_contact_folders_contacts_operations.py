...
class UsersContactFoldersContactsOperations:
    ...
    def list_multi_value_extended_properties(
        ...
        **kwargs
        ...
        :type contact_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~personal_contacts.models.Enum16]
        :param select: Select properties to be returned.
        :type select: list[str or ~personal_contacts.models.Enum17]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_photo(
        ...
        **kwargs
        ...
        :type contact_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~personal_contacts.models.Enum19]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_single_value_extended_properties(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~personal_contacts.models.Enum21]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
