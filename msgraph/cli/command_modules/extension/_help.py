...
examples:
  - name: Add extension by name
    text: mg extension add --name anextension
  - name: Add extension from URL
    text: mg extension add --source https://contoso.com/anextension-0.0.1-py2.py3-none-any.whl
  - name: Add extension from local disk
    text: mg extension add --source ~/anextension-0.0.1-py2.py3-none-any.whl
  - name: Add extension from local disk and use pip proxy for dependencies
    text: mg extension add --source ~/anextension-0.0.1-py2.py3-none-any.whl --pip-proxy https://user:pass@proxy.server:8080
  - name: Add extension to system directory
    text: mg extension add --name anextension --system
  - name: Add a specific version of extension
    text: mg extension add --name anextension --version 1.0.0
  - name: Upgrade the extension if already installed
    text: mg extension add --upgrade --name anextension
"""
...
examples:
  - name: List all publicly available extensions
    text: mg extension list-available
  - name: List details on a particular extension
    text: mg extension list-available --show-details --query anextension
"""
...
examples:
  - name: Remove an extension. (autogenerated)
    text: mg extension remove --name MyExtension
    crafted: true
"""
...
examples:
  - name: Show an extension. (autogenerated)
    text: mg extension show --name MyExtension
    crafted: true
"""
...
examples:
  - name: Update an extension by name
    text: mg extension update --name anextension
  - name: Update an extension by name and use pip proxy for dependencies
    text: mg extension update --name anextension --pip-proxy https://user:pass@proxy.server:8080
"""
...
examples:
  - name: List available versions for an extension
    text: mg extension list-versions --name anextension
"""
