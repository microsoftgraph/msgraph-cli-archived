...
from msgraph.cli.command_modules.cloud._completers import (
    get_cloud_name_completion_list, get_custom_cloud_name_completion_list)
import msgraph.cli.command_modules.cloud._help  # pylint: disable=unused-import
...
class CloudCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        cloud_custom = CliCommandType(
            operations_tmpl='msgraph.cli.command_modules.cloud.custom#{}')
    ...
    def load_arguments(self, command):
        ...
        with self.argument_context('cloud') as c:
            ...
            c.argument('endpoint_management',
                       help='The management service endpoint')
            c.argument('endpoint_resource_manager',
                       help='The resource management endpoint')
            c.argument('endpoint_sql_management',
                       help='The sql server management endpoint')
            c.argument('endpoint_gallery',
                       help='The template gallery endpoint')
            c.argument('endpoint_active_directory',
                       help='The Active Directory login endpoint')
            c.argument('endpoint_active_directory_resource_id',
            ...
            c.argument('suffix_sql_server_hostname',
                       help='The dns suffix for sql servers')
            c.argument('suffix_storage_endpoint',
                       help='The endpoint suffix for storage accounts')
            c.argument('suffix_keyvault_dns',
            ...
            c.argument('suffix_acr_login_server_endpoint',
