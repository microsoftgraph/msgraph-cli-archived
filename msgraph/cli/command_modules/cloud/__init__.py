...
from msgraph.cli.command_modules.cloud._completers import (get_cloud_name_completion_list,
                                                           get_custom_cloud_name_completion_list)
...
class CloudCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        cloud_custom = CliCommandType(operations_tmpl='msgraph.cli.command_modules.cloud.custom#{}')
