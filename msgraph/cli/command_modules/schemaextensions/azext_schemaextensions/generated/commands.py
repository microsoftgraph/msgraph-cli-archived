...
schemaextensions_schema_extension_schema_extension = CliCommandType(
    operations_tmpl='azext_schemaextensions.vendored_sdks.schemaextensions.operations._schema_extensions_schema_extension_operations#SchemaExtensionsSchemaExtensionOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group(
        ...
        schemaextensions_schema_extension_schema_extension,
        client_factory=cf_schema_extension_schema_extension,
    ) as g:
        g.custom_command(
    ...
    with self.command_group('schemaextensions', is_experimental=True):
        pass
