...
def _get_mgmt_service_client(cli_ctx,
    ...
    if subscription_bound:
        ...
        credential = InteractiveBrowserCredential(client_id='326ac0be-4361-4f56-9d69-66b6fe407442')
        session = GraphSession(credential, ['orgcontact.read.all'])
        client = client_type(cred, **client_kwargs, session=session)
        print(client)
