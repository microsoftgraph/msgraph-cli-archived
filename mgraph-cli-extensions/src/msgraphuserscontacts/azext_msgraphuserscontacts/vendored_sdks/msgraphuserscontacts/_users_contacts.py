...
from ._configuration import UsersContactsConfiguration
...
class UsersContacts(object):
    ...
    :vartype user: Microsoft.Graph.PowerShell.operations.UserOperations
    :ivar user_contact_folder: UserContactFolderOperations operations
    :vartype user_contact_folder: Microsoft.Graph.PowerShell.operations.UserContactFolderOperations
    :ivar user_contact_folder_contact: UserContactFolderContactOperations operations
    :vartype user_contact_folder_contact: Microsoft.Graph.PowerShell.operations.UserContactFolderContactOperations
    :ivar user_contact: UserContactOperations operations
    :vartype user_contact: Microsoft.Graph.PowerShell.operations.UserContactOperations
