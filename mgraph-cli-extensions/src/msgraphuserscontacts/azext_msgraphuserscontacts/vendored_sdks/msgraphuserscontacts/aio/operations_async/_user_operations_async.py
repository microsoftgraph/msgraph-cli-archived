...
class UserOperations:
    ...
    def list_contact_folder(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~Microsoft.Graph.PowerShell.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Get7ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Get8ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfContactFolder or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~Microsoft.Graph.PowerShell.models.CollectionOfContactFolder]
    ...
    async def get_contact_folder(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Get2ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Get3ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContactFolder, or the result of cls(response)
        :rtype: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContactFolder
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_contact(
        ...
        **kwargs
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~Microsoft.Graph.PowerShell.models.Enum34]
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum35]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Enum36]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfContact0 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~Microsoft.Graph.PowerShell.models.CollectionOfContact0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_contact(
        ...
        **kwargs
        ...
        :type contact_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum37]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Enum38]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContact, or the result of cls(response)
        :rtype: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContact
        :raises: ~azure.core.exceptions.HttpResponseError
