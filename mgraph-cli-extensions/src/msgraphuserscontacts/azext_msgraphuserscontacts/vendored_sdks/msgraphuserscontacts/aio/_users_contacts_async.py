...
from ._configuration_async import UsersContactsConfiguration
...
class UsersContacts(object):
    ...
    :vartype user: Microsoft.Graph.PowerShell.aio.operations_async.UserOperations
    :ivar user_contact_folder: UserContactFolderOperations operations
    :vartype user_contact_folder: Microsoft.Graph.PowerShell.aio.operations_async.UserContactFolderOperations
    :ivar user_contact_folder_contact: UserContactFolderContactOperations operations
    :vartype user_contact_folder_contact: Microsoft.Graph.PowerShell.aio.operations_async.UserContactFolderContactOperations
    :ivar user_contact: UserContactOperations operations
    :vartype user_contact: Microsoft.Graph.PowerShell.aio.operations_async.UserContactOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = UsersContactsConfiguration(credential, top, skip, search, filter, count, **kwargs)
    ...
    async def __aenter__(self) -> "UsersContacts":
