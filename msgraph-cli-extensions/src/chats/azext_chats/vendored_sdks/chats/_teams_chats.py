...
from ._configuration import TeamsChatsConfiguration
...
class TeamsChats(object):
    ...
    :vartype chat_chat: teams_chats.operations.ChatChatOperations
    :ivar chat: ChatOperations operations
    :vartype chat: teams_chats.operations.ChatOperations
    :ivar chat_installed_app: ChatInstalledAppOperations operations
    :vartype chat_installed_app: teams_chats.operations.ChatInstalledAppOperations
    :ivar chat_message: ChatMessageOperations operations
    :vartype chat_message: teams_chats.operations.ChatMessageOperations
    :ivar chat_message_reply: ChatMessageReplyOperations operations
    :vartype chat_message_reply: teams_chats.operations.ChatMessageReplyOperations
    :ivar user: UserOperations operations
    :vartype user: teams_chats.operations.UserOperations
