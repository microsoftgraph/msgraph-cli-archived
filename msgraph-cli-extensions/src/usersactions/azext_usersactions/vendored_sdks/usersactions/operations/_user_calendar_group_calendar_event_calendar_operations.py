...
class UserCalendarGroupCalendarEventCalendarOperations(object):
    """UserCalendarGroupCalendarEventCalendarOperations operations.
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1IagkehUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(_body, 'Paths1IagkehUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    get_schedule.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/calendar/microsoft.graph.getSchedule'}  # type: ignore
