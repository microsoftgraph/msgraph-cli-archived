...
class UserOnlineMeetingOperations(object):
    """UserOnlineMeetingOperations operations.
    ...
    def create_or_get(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1H47062UsersUserIdOnlinemeetingsMicrosoftGraphCreateorgetPostRequestbodyContentApplicationJsonSchema(chat_info=chat_info, end_date_time=end_date_time, external_id=external_id, start_date_time=start_date_time, subject=subject, attendees=attendees, organizer=organizer)
