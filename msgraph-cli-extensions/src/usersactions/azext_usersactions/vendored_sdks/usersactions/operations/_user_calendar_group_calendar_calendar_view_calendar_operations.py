...
class UserCalendarGroupCalendarCalendarViewCalendarOperations(object):
    """UserCalendarGroupCalendarCalendarViewCalendarOperations operations.
    ...
    def get_schedule(
        ...
        event_id,  # type: str
        schedules=None,  # type: Optional[List[str]]
        end_time=None,  # type: Optional["models.MicrosoftGraphDateTimeZone"]
        start_time=None,  # type: Optional["models.MicrosoftGraphDateTimeZone"]
        availability_view_interval=None,  # type: Optional[int]
        **kwargs  # type: Any
    ):
        ...
        _body = models.Paths6Qlv56UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(_body, 'Paths6Qlv56UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    get_schedule.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/calendarView/{event-id}/calendar/microsoft.graph.getSchedule'}  # type: ignore
