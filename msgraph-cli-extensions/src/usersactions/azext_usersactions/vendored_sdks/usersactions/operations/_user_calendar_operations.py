...
class UserCalendarOperations(object):
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsQue4OrUsersUserIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(_body, 'PathsQue4OrUsersUserIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    get_schedule.metadata = {'url': '/users/{user-id}/calendars/{calendar-id}/microsoft.graph.getSchedule'}  # type: ignore
