...
class ShareOperations(object):
    ...
    def get_drive_item(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~files_shares.models.Enum109]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum110]
    ...
    def list_item(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~files_shares.models.Enum111]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum112]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Get8ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDriveItem or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~files_shares.models.CollectionOfDriveItem]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_item(
        ...
        **kwargs  # type: Any
        ...
        :param shared_drive_item_id: key: sharedDriveItem-id of sharedDriveItem.
        :type shared_drive_item_id: str
        :param drive_item_id: key: driveItem-id of driveItem.
        :type drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum114]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Get3ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDriveItem, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphDriveItem
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_list(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum116]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum117]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphList, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_list_item(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum180]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum181]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_permission(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum200]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPermission, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphPermission
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update_permission(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param body: New navigation property values.
        :type body: ~files_shares.models.MicrosoftGraphPermission
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_root(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum201]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum202]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDriveItem, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphDriveItem
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_site(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum203]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum204]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSite, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphSite
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update_site(
        ...
        microsoft_graph_identity_user=None,  # type: Optional["models.MicrosoftGraphIdentity"]
        display_name=None,  # type: Optional[str]
        root=None,  # type: Optional[object]
        microsoft_graph_sharepoint_ids=None,  # type: Optional["models.MicrosoftGraphSharepointIds"]
        analytics=None,  # type: Optional["models.MicrosoftGraphItemAnalytics"]
        columns=None,  # type: Optional[List["models.MicrosoftGraphColumnDefinition"]]
        content_types=None,  # type: Optional[List["models.MicrosoftGraphContentType"]]
        ...
        any_root=None,  # type: Optional[object]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type microsoft_graph_onenote_pages: list[~files_shares.models.MicrosoftGraphOnenotePage]
        ...
        :type hostname: str
        :param any_root: Any object.
        :type any_root: object
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
