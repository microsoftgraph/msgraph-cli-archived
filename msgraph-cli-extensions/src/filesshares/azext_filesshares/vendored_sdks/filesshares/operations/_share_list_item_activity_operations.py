...
class ShareListItemActivityOperations(object):
    """ShareListItemActivityOperations operations.
    ...
    def get_drive_item(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~files_shares.models.Enum187]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum188]
    ...
    def get_list_item(
        ...
        **kwargs  # type: Any
        ...
        :type item_activity_old_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum189]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum190]
        :keyword callable cls: A custom type or function that will be passed the direct response
...
ny]
    ...
    update_list_item.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem'}  # type: ignore
