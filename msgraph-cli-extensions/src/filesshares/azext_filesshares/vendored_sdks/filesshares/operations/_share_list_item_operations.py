...
class ShareListItemOperations(object):
    ...
    def list_activity(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~files_shares.models.Enum182]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum183]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum184]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfItemActivityOld2 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~files_shares.models.CollectionOfItemActivityOld2]
    ...
    def get_activity(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum185]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum186]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphItemActivityOld, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphItemActivityOld
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_analytic(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum191]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum192]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_drive_item(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum193]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum194]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_version(
        ...
        **kwargs  # type: Any
        ...
        :type shared_drive_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~files_shares.models.Enum195]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum196]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum197]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfListItemVersion1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~files_shares.models.CollectionOfListItemVersion1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_version(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum198]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum199]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphListItemVersion, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphListItemVersion
        :raises: ~azure.core.exceptions.HttpResponseError
