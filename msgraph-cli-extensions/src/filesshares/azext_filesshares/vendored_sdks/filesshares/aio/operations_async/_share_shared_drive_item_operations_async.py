...
class ShareSharedDriveItemOperations:
    ...
    def list_shared_drive_item(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~files_shares.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Get6ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Get7ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSharedDriveItem or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files_shares.models.CollectionOfSharedDriveItem]
    ...
    async def create_shared_drive_item(
        ...
        **kwargs
        ...
        :type body: ~files_shares.models.MicrosoftGraphSharedDriveItem
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSharedDriveItem, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphSharedDriveItem
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_shared_drive_item(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSharedDriveItem, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphSharedDriveItem
        :raises: ~azure.core.exceptions.HttpResponseError
