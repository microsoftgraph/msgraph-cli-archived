...
class ShareListOperations:
    """ShareListOperations async operations.
    ...
    def list_activity(
        ...
        expand: Optional[List[Union[str, "models.Enum120"]]] = None,
        **kwargs
        ...
        :type orderby: list[str or ~files_shares.models.Enum118]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum119]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum120]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfItemActivityOld or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files_shares.models.CollectionOfItemActivityOld]
    ...
    list_activity.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities'}  # type: ignore
    ...
    async def create_activity(
        ...
        **kwargs
        ...
        return deserialized
    create_activity.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities'}  # type: ignore
    ...
    async def get_activity(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum121]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum122]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphItemActivityOld, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphItemActivityOld
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_activity.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    update_activity.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    def list_column(
        ...
        **kwargs
        ...
        :type shared_drive_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~files_shares.models.Enum141]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum142]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfColumnDefinition or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files_shares.models.CollectionOfColumnDefinition]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_column.metadata = {'url': '/shares/{sharedDriveItem-id}/list/columns'}  # type: ignore
    ...
    async def create_column(
        ...
        **kwargs
        ...
        :rtype: ~files_shares.models.MicrosoftGraphColumnDefinition
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        return deserialized
    create_column.metadata = {'url': '/shares/{sharedDriveItem-id}/list/columns'}  # type: ignore
    ...
    async def get_column(
        ...
        **kwargs
        ...
        :param shared_drive_item_id: key: sharedDriveItem-id of sharedDriveItem.
        :type shared_drive_item_id: str
        :param column_definition_id: key: columnDefinition-id of columnDefinition.
        :type column_definition_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum143]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphColumnDefinition, or the result of cls(response)
        ...
        return deserialized
    get_column.metadata = {'url': '/shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}'}  # type: ignore
    ...
    update_column.metadata = {'url': '/shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}'}  # type: ignore
    ...
    def list_content_type(
        ...
        **kwargs
        ...
        :type shared_drive_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~files_shares.models.Enum144]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum145]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum146]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfContentType or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files_shares.models.CollectionOfContentType]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_content_type.metadata = {'url': '/shares/{sharedDriveItem-id}/list/contentTypes'}  # type: ignore
    ...
    async def create_content_type(
        ...
        **kwargs
        ...
        :rtype: ~files_shares.models.MicrosoftGraphContentType
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        return deserialized
    create_content_type.metadata = {'url': '/shares/{sharedDriveItem-id}/list/contentTypes'}  # type: ignore
    ...
    async def get_content_type(
        ...
        **kwargs
        ...
        :param shared_drive_item_id: key: sharedDriveItem-id of sharedDriveItem.
        :type shared_drive_item_id: str
        :param content_type_id: key: contentType-id of contentType.
        :type content_type_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum147]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum148]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContentType, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphContentType
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_content_type.metadata = {'url': '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}'}  # type: ignore
    ...
    update_content_type.metadata = {'url': '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}'}  # type: ignore
    ...
    async def get_drive(
        ...
        **kwargs
        ...
        :type shared_drive_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum152]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum153]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDrive, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphDrive
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def update_drive(
        ...
        bundles: Optional[List["models.MicrosoftGraphDriveItem"]] = None,
        ...
        **kwargs
        ...
        :type microsoft_graph_identity_application: ~files_shares.models.MicrosoftGraphIdentity
        :param microsoft_graph_identity_device: identity.
        :type microsoft_graph_identity_device: ~files_shares.models.MicrosoftGraphIdentity
        :param microsoft_graph_identity_user: identity.
        :type microsoft_graph_identity_user: ~files_shares.models.MicrosoftGraphIdentity
        ...
        :type application1: ~files_shares.models.MicrosoftGraphIdentity
        :param device1: identity.
        :type device1: ~files_shares.models.MicrosoftGraphIdentity
        :param user1: identity.
        :type user1: ~files_shares.models.MicrosoftGraphIdentity
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_item(
        ...
        **kwargs
        ...
        :type shared_drive_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~files_shares.models.Enum154]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum155]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum156]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfListItem or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files_shares.models.CollectionOfListItem]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_item.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items'}  # type: ignore
    ...
    async def create_item(
        ...
        **kwargs
        ...
        :type content_type_parameter: ~files_shares.models.MicrosoftGraphContentTypeInfo
        :param microsoft_graph_sharepoint_ids: sharepointIds.
        :type microsoft_graph_sharepoint_ids: ~files_shares.models.MicrosoftGraphSharepointIds
        ...
        :rtype: ~files_shares.models.MicrosoftGraphListItem
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        return deserialized
    create_item.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items'}  # type: ignore
    ...
    async def get_item(
        ...
        **kwargs
        ...
        :param shared_drive_item_id: key: sharedDriveItem-id of sharedDriveItem.
        :type shared_drive_item_id: str
        :param list_item_id: key: listItem-id of listItem.
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum157]
        :param expand: Expand related entities.
        :type expand: list[str or ~files_shares.models.Enum158]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphListItem, or the result of cls(response)
        :rtype: ~files_shares.models.MicrosoftGraphListItem
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_item.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}'}  # type: ignore
    ...
    update_item.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}'}  # type: ignore

    def list_subscription(
        self,
        shared_drive_item_id: str,
        orderby: Optional[List[Union[str, "models.Enum177"]]] = None,
        ...
        **kwargs
        ...
        :type shared_drive_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~files_shares.models.Enum177]
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum178]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSubscription or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files_shares.models.CollectionOfSubscription]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_subscription.metadata = {'url': '/shares/{sharedDriveItem-id}/list/subscriptions'}  # type: ignore
    ...
    async def create_subscription(
        ...
        **kwargs
        ...
        :rtype: ~files_shares.models.MicrosoftGraphSubscription
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphSubscription(id=id, resource=resource, change_type=change_type, client_state=client_state, notification_url=notification_url, expiration_date_time=expiration_date_time, application_id=application_id, creator_id=creator_id, include_properties=include_properties, include_resource_data=include_resource_data, lifecycle_notification_url=lifecycle_notification_url, encryption_certificate=encryption_certificate, encryption_certificate_id=encryption_certificate_id, latest_supported_tls_version=latest_supported_tls_version)
        content_type = kwargs.pop("content_type", "application/json")
        ...
        return deserialized
    create_subscription.metadata = {'url': '/shares/{sharedDriveItem-id}/list/subscriptions'}  # type: ignore

    async def get_subscription(
        self,
        shared_drive_item_id: str,
        subscription_id: str,
        select: Optional[List[Union[str, "models.Enum179"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSubscription":
        """Get subscriptions from shares.
        ...
        :param shared_drive_item_id: key: sharedDriveItem-id of sharedDriveItem.
        :type shared_drive_item_id: str
        :param subscription_id: key: subscription-id of subscription.
        :type subscription_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files_shares.models.Enum179]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSubscription, or the result of cls(response)
        ...
        return deserialized
    get_subscription.metadata = {'url': '/shares/{sharedDriveItem-id}/list/subscriptions/{subscription-id}'}  # type: ignore
    ...
    update_subscription.metadata = {'url': '/shares/{sharedDriveItem-id}/list/subscriptions/{subscription-id}'}  # type: ignore
