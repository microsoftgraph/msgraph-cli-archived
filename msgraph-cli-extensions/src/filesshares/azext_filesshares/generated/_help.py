...
helps['filesshares update-shared-drive-item'] = """
    type: command
...
SharePoint site.
      ...
      - name: --subscriptions
        ...
        long-summary: |
            Usage: --subscriptions resource=XX change-type=XX client-state=XX notification-url=XX \
expiration-date-time=XX application-id=XX creator-id=XX include-properties=XX include-resource-data=XX \
lifecycle-notification-url=XX encryption-certificate=XX encryption-certificate-id=XX latest-supported-tls-version=XX \
id=XX
...
(https://graph.microsoft.com/v1.0/). See the possible resource path values for each supported resource.
            change-type: Required. Indicates the type of change in the subscribed resource that will raise a \
notification. The supported values are: created, updated, deleted. Multiple values can be combined using a \
comma-separated list.Note: Drive root item and list notifications support only the updated changeType. User and group \
notifications support updated and deleted changeType.
            client-state: Optional. Specifies the value of the clientState property sent by the service in each \
notification. The maximum length is 128 characters. The client can check that the notification came from the service \
...
property received with each notification.
            notification-url: Required. The URL of the endpoint that will receive the notifications. This URL must \
...
helps['filesshares update-list-item'] = """
    type: command
...
helps['filesshares update-content-type'] = """
    type: command
...
helps['filesshares update-drive'] = """
    type: command
...
SharePoint site.
      ...
      - name: --owner-application
        short-summary: "identity"
        long-summary: |
            Usage: --owner-application id=XX display-name=XX
...
associated with the user won't show up as having changed when using delta.
      - name: --owner-device
        short-summary: "identity"
        long-summary: |
            Usage: --owner-device id=XX display-name=XX
...
associated with the user won't show up as having changed when using delta.
      - name: --owner-user
        short-summary: "identity"
        long-summary: |
            Usage: --owner-user id=XX display-name=XX
...
helps['filesshares update-subscription'] = """
    type: command
...
helps['filesshares update-field'] = """
    type: command
    short-summary: "Update the navigation property fields in shares"
"""

helps['filesshares update-version'] = """
    type: command
...
helps['filesshares update-column-link'] = """
    type: command
