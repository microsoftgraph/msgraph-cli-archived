...
class InvitationOperations(object):
    ...
    def get_invited_user(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~identity_invitations.models.Enum109]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_invitations.models.Enum110]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphUser, or the result of cls(response)
        :rtype: ~identity_invitations.models.MicrosoftGraphUser
