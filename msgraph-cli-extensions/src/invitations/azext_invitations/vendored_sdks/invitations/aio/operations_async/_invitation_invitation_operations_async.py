...
class InvitationInvitationOperations:
    """InvitationInvitationOperations async operations.

    You should not instantiate this class directly. Instead, you should create a Client instance that
    instantiates it for you and attaches it as an attribute.

    :ivar models: Alias to model classes used in this operation group.
    :type models: ~identity_invitations.models
    ...
    def list_invitation(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~identity_invitations.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_invitations.models.Get6ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_invitations.models.Get7ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfInvitation or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_invitations.models.CollectionOfInvitation]
    ...
    async def create_invitation(
        ...
        invited_user: Optional["models.MicrosoftGraphUser"] = None,
        ...
        **kwargs
        ...
        :rtype: ~identity_invitations.models.MicrosoftGraphInvitation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphInvitation(id=id, invited_user_display_name=invited_user_display_name, invited_user_type=invited_user_type, invited_user_email_address=invited_user_email_address, send_invitation_message=send_invitation_message, invite_redirect_url=invite_redirect_url, invite_redeem_url=invite_redeem_url, status=status, reset_redemption=reset_redemption, invited_user=invited_user, cc_recipients=cc_recipients, message_language=message_language, customized_message_body=customized_message_body)
    ...
    async def get_invitation(
        ...
        **kwargs
        ...
        :param invitation_id: key: invitation-id of invitation.
        :type invitation_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_invitations.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_invitations.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphInvitation, or the result of cls(response)
        :rtype: ~identity_invitations.models.MicrosoftGraphInvitation
        :raises: ~azure.core.exceptions.HttpResponseError
