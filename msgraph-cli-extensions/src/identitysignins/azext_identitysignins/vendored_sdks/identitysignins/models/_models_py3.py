...
class CollectionOfActivityBasedTimeoutPolicy(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        value: Optional[List["MicrosoftGraphActivityBasedTimeoutPolicy"]] = None,
...
class CollectionOfDataPolicyOperation(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphDataPolicyOperation"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class CollectionOfIdentityProvider(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphIdentityProvider"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class CollectionOfNamedLocation(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphNamedLocation"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class CollectionOfPermissionGrantConditionSet(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphPermissionGrantConditionSet"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class CollectionOfPermissionGrantPolicy(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphPermissionGrantPolicy"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class CollectionOfThreatAssessmentRequest(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphThreatAssessmentRequest"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class CollectionOfThreatAssessmentResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        additional_properties: Optional[Dict[str, object]] = None,
        value: Optional[List["MicrosoftGraphThreatAssessmentResult"]] = None,
        odata_next_link: Optional[str] = None,
        **kwargs
    ):
...
class MicrosoftGraphActivityBasedTimeoutPolicy(MicrosoftGraphStsPolicy):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MicrosoftGraphActivityBasedTimeoutPolicy, self).__init__(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, definition=definition, is_organization_default=is_organization_default, applies_to=applies_to, **kwargs)
        self.additional_properties = additional_properties
        self.additional_properties = additional_properties
        self.additional_properties = additional_properties
...
class MicrosoftGraphConditionalAccessApplications(msrest.serialization.Model):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :param exclude_applications: The list of application IDs explicitly excluded from the policy.
    :type exclude_applications: list[str]
    :param include_applications: The list of application IDs the policy applies to, unless
     explicitly excluded (in excludeApplications). Can also be set to All.
    :type include_applications: list[str]
    :param include_user_actions: User actions to include. For example,
...
class MicrosoftGraphConditionalAccessGrantControls(msrest.serialization.Model):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :param built_in_controls: List of values of built-in controls required by the policy. Possible
    ...
    :param operator: Defines the relationship of the grant controls. Possible values: AND, OR.
    :type operator: str
    :param terms_of_use: List of terms of use IDs required by the policy.
...
class MicrosoftGraphConditionalAccessLocations(msrest.serialization.Model):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :param exclude_locations: Location IDs excluded from scope of policy.
    :type exclude_locations: list[str]
    :param include_locations: Location IDs in scope of policy unless explicitly excluded, All, or
     AllTrusted.
...
class MicrosoftGraphConditionalAccessRoot(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        *,
        id: Optional[str] = None,
        additional_properties: Optional[Dict[str, object]] = None,
        named_locations: Optional[List["MicrosoftGraphNamedLocation"]] = None,
        policies: Optional[List["MicrosoftGraphConditionalAccessPolicy"]] = None,
        **kwargs
    ):
        super(MicrosoftGraphConditionalAccessRoot, self).__init__(id=id, **kwargs)
        self.additional_properties = additional_properties
...
class MicrosoftGraphConditionalAccessUsers(msrest.serialization.Model):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :param exclude_groups: Group IDs excluded from scope of policy.
    :type exclude_groups: list[str]
    :param exclude_roles: Role IDs excluded from scope of policy.
    :type exclude_roles: list[str]
    :param exclude_users: User IDs excluded from scope of policy and/or GuestsOrExternalUsers.
    :type exclude_users: list[str]
    :param include_groups: Group IDs in scope of policy unless explicitly excluded, or All.
    :type include_groups: list[str]
    :param include_roles: Role IDs in scope of policy unless explicitly excluded, or All.
    :type include_roles: list[str]
    :param include_users: User IDs in scope of policy unless explicitly excluded, or None or All or
...
class MicrosoftGraphDataPolicyOperation(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        *,
        ...
        status: Optional[Union[str, "MicrosoftGraphDataPolicyOperationStatus"]] = None,
        storage_location: Optional[str] = None,
        submitted_date_time: Optional[datetime.datetime] = None,
        user_id: Optional[str] = None,
        **kwargs
    ):
        super(MicrosoftGraphDataPolicyOperation, self).__init__(id=id, **kwargs)
        self.additional_properties = additional_properties
...
class MicrosoftGraphIdentityProvider(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MicrosoftGraphIdentityProvider, self).__init__(id=id, **kwargs)
        self.additional_properties = additional_properties
...
class MicrosoftGraphNamedLocation(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MicrosoftGraphNamedLocation, self).__init__(id=id, **kwargs)
        self.additional_properties = additional_properties
        self.created_date_time = created_date_time
        self.display_name = display_name
        self.modified_date_time = modified_date_time
...
class MicrosoftGraphPermissionGrantConditionSet(MicrosoftGraphEntity):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :param client_application_ids:
    :type client_application_ids: list[str]
    :param client_application_publisher_ids:
    :type client_application_publisher_ids: list[str]
    :param client_applications_from_verified_publisher_only:
    :type client_applications_from_verified_publisher_only: bool
    :param client_application_tenant_ids:
    :type client_application_tenant_ids: list[str]
    :param permission_classification:
    :type permission_classification: str
    :param permissions:
    ...
    _attribute_map = {
        'id': {'key': 'id', 'type': 'str'},
        'additional_properties': {'key': '', 'type': '{object}'},
        'client_application_ids': {'key': 'clientApplicationIds', 'type': '[str]'},
        'client_application_publisher_ids': {'key': 'clientApplicationPublisherIds', 'type': '[str]'},
        'client_applications_from_verified_publisher_only': {'key': 'clientApplicationsFromVerifiedPublisherOnly', 'type': 'bool'},
        'client_application_tenant_ids': {'key': 'clientApplicationTenantIds', 'type': '[str]'},
        'permission_classification': {'key': 'permissionClassification', 'type': 'str'},
        'permissions': {'key': 'permissions', 'type': '[str]'},
        'permission_type': {'key': 'permissionType', 'type': 'str'},
        'resource_application': {'key': 'resourceApplication', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        permission_type: Optional[Union[str, "MicrosoftGraphPermissionType"]] = None,
        resource_application: Optional[str] = None,
        **kwargs
    ):
        super(MicrosoftGraphPermissionGrantConditionSet, self).__init__(id=id, **kwargs)
        self.additional_properties = additional_properties
        self.client_application_ids = client_application_ids
        self.client_application_publisher_ids = client_application_publisher_ids
        self.client_applications_from_verified_publisher_only = client_applications_from_verified_publisher_only
        self.client_application_tenant_ids = client_application_tenant_ids
        self.permission_classification = permission_classification
        self.permissions = permissions
        self.permission_type = permission_type
        self.resource_application = resource_application
...
class MicrosoftGraphPermissionGrantPolicy(MicrosoftGraphPolicyBase):
    ...
    def __init__(
        ...
        *,
        ...
        display_name: Optional[str] = None,
        additional_properties: Optional[Dict[str, object]] = None,
        excludes: Optional[List["MicrosoftGraphPermissionGrantConditionSet"]] = None,
        includes: Optional[List["MicrosoftGraphPermissionGrantConditionSet"]] = None,
        **kwargs
    ):
        super(MicrosoftGraphPermissionGrantPolicy, self).__init__(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, **kwargs)
        self.additional_properties = additional_properties
        self.additional_properties = additional_properties
...
class MicrosoftGraphPolicyRoot(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        *,
        ...
        permission_grant_policies: Optional[List["MicrosoftGraphPermissionGrantPolicy"]] = None,
        ...
        **kwargs
        ...
        self.permission_grant_policies = permission_grant_policies
...
class MicrosoftGraphTodo(MicrosoftGraphEntity):
    ...
    :type additional_properties: dict[str, object]
    :param lists:
    :type lists: list[~identity_sign_ins.models.MicrosoftGraphTodoTaskList]
    """
...
class MicrosoftGraphTodoTask(MicrosoftGraphEntity):
    ...
    :type reminder_date_time: ~identity_sign_ins.models.MicrosoftGraphDateTimeZone
    :param status:  Possible values include: "notStarted", "inProgress", "completed",
     "waitingOnOthers", "deferred".
    :type status: str or ~identity_sign_ins.models.MicrosoftGraphTaskStatus
    :param title:
    :type title: str
    :param extensions:
    :type extensions: list[~identity_sign_ins.models.MicrosoftGraphExtension]
    :param linked_resources:
    :type linked_resources: list[~identity_sign_ins.models.MicrosoftGraphLinkedResource]
    """
...
class MicrosoftGraphTodoTaskList(MicrosoftGraphEntity):
    ...
    :param wellknown_list_name:  Possible values include: "none", "defaultList", "flaggedEmails",
     "unknownFutureValue".
    :type wellknown_list_name: str or ~identity_sign_ins.models.MicrosoftGraphWellknownListName
    :param extensions:
    :type extensions: list[~identity_sign_ins.models.MicrosoftGraphExtension]
    :param tasks:
    :type tasks: list[~identity_sign_ins.models.MicrosoftGraphTodoTask]
    """
...
class MicrosoftGraphUser(MicrosoftGraphDirectoryObject):
    ...
    :type teamwork: ~identity_sign_ins.models.MicrosoftGraphUserTeamwork
    :param todo: todo.
    :type todo: ~identity_sign_ins.models.MicrosoftGraphTodo
    """
...
class MicrosoftGraphUserScopeTeamsAppInstallation(MicrosoftGraphTeamsAppInstallation):
    ...
    :type additional_properties: dict[str, object]
    :param chat: chat.
    :type chat: ~identity_sign_ins.models.MicrosoftGraphChat
    """
...
class MicrosoftGraphUserTeamwork(MicrosoftGraphEntity):
    ...
    :type installed_apps:
     list[~identity_sign_ins.models.MicrosoftGraphUserScopeTeamsAppInstallation]
    """
