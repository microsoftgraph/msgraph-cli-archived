...
class MicrosoftGraphPermissionGrantConditionSet(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.client_applications_from_verified_publisher_only = kwargs.get('client_applications_from_verified_publisher_only', None)
        self.client_application_tenant_ids = kwargs.get('client_application_tenant_ids', None)
        self.permission_classification = kwargs.get('permission_classification', None)
        self.permissions = kwargs.get('permissions', None)
...
class MicrosoftGraphPolicyRoot(MicrosoftGraphEntity):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.permission_grant_policies = kwargs.get('permission_grant_policies', None)
