...
def load_command_table(self, _):
    ...
    from azext_identitysignins.generated._client_factory import cf_data_policy_operation_data_policy_operation
    identitysignins_data_policy_operation_data_policy_operation = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._data_policy_operation_data_pol'
        'icy_operation_operations#DataPolicyOperationDataPolicyOperationOperations.{}',
        client_factory=cf_data_policy_operation_data_policy_operation)
    with self.command_group('identitysignins', identitysignins_data_policy_operation_data_policy_operation,
    ...
    from azext_identitysignins.generated._client_factory import cf_identity
    identitysignins_identity = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._identity_operations#IdentityOp'
        'erations.{}',
        client_factory=cf_identity)
    with self.command_group('identitysignins', identitysignins_identity, client_factory=cf_identity) as g:
        g.custom_command('delete', 'identitysignins_delete', confirmation=True)
    ...
    from azext_identitysignins.generated._client_factory import cf_identity_conditional_access
    identitysignins_identity_conditional_access = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._identity_conditional_access_op'
        'erations#IdentityConditionalAccessOperations.{}',
        client_factory=cf_identity_conditional_access)
    with self.command_group('identitysignins', identitysignins_identity_conditional_access,
    ...
    from azext_identitysignins.generated._client_factory import cf_identity_provider_identity_provider
    identitysignins_identity_provider_identity_provider = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._identity_provider_identity_pro'
        'vider_operations#IdentityProviderIdentityProviderOperations.{}',
        client_factory=cf_identity_provider_identity_provider)
    with self.command_group('identitysignins', identitysignins_identity_provider_identity_provider,
    ...
    from azext_identitysignins.generated._client_factory import cf_information_protection_information_protection
    identitysignins_information_protection_information_protection = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._information_protection_informa'
        'tion_protection_operations#InformationProtectionInformationProtectionOperations.{}',
        client_factory=cf_information_protection_information_protection)
    with self.command_group('identitysignins', identitysignins_information_protection_information_protection,
    ...
    from azext_identitysignins.generated._client_factory import cf_information_protection
    identitysignins_information_protection = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._information_protection_operati'
        'ons#InformationProtectionOperations.{}',
        client_factory=cf_information_protection)
    with self.command_group('identitysignins', identitysignins_information_protection,
    ...
    from azext_identitysignins.generated._client_factory import cf_information_protection_threat_assessment_request
    identitysignins_information_protection_threat_assessment_request = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._information_protection_threat_'
        'assessment_request_operations#InformationProtectionThreatAssessmentRequestOperations.{}',
        client_factory=cf_information_protection_threat_assessment_request)
    with self.command_group('identitysignins', identitysignins_information_protection_threat_assessment_request,
    ...
    from azext_identitysignins.generated._client_factory import cf_invitation_invitation
    identitysignins_invitation_invitation = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._invitation_invitation_operatio'
        'ns#InvitationInvitationOperations.{}',
        client_factory=cf_invitation_invitation)
    with self.command_group('identitysignins', identitysignins_invitation_invitation,
    ...
    from azext_identitysignins.generated._client_factory import cf_invitation
    identitysignins_invitation = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._invitation_operations#Invitati'
        'onOperations.{}',
        client_factory=cf_invitation)
    with self.command_group('identitysignins', identitysignins_invitation, client_factory=cf_invitation) as g:
        g.custom_command('delete', 'identitysignins_delete', confirmation=True)
    ...
    from azext_identitysignins.generated._client_factory import cf_oauth2permission_grant_oauth2permission_grant
    identitysignins_oauth2permission_grant_oauth2permission_grant = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._oauth2_permission_grant_oauth2'
        '_permission_grant_operations#Oauth2PermissionGrantOAuth2PermissionGrantOperations.{}',
        client_factory=cf_oauth2permission_grant_oauth2permission_grant)
    with self.command_group('identitysignins', identitysignins_oauth2permission_grant_oauth2permission_grant,
    ...
    from azext_identitysignins.generated._client_factory import cf_oauth2permission_grant
    identitysignins_oauth2permission_grant = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._oauth2_permission_grant_operat'
        'ions#Oauth2PermissionGrantOperations.{}',
        client_factory=cf_oauth2permission_grant)
    with self.command_group('identitysignins', identitysignins_oauth2permission_grant,
                            client_factory=cf_oauth2permission_grant) as g:
        g.custom_command('delta', 'identitysignins_delta')

    from azext_identitysignins.generated._client_factory import cf_organization
    identitysignins_organization = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._organization_operations#Organi'
        'zationOperations.{}',
        client_factory=cf_organization)
    with self.command_group('identitysignins', identitysignins_organization, client_factory=cf_organization) as g:
    ...
    from azext_identitysignins.generated._client_factory import cf_policy_policy_root
    identitysignins_policy_policy_root = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._policy_policy_root_operations#'
        'PolicyPolicyRootOperations.{}',
        client_factory=cf_policy_policy_root)
    with self.command_group('identitysignins', identitysignins_policy_policy_root,
    ...
    from azext_identitysignins.generated._client_factory import cf_policy
    identitysignins_policy = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._policy_operations#PolicyOperat'
        'ions.{}',
        client_factory=cf_policy)
    with self.command_group('identitysignins', identitysignins_policy, client_factory=cf_policy) as g:
        g.custom_command('delete', 'identitysignins_delete', confirmation=True)
    ...
    from azext_identitysignins.generated._client_factory import cf_policy_permission_grant_policy
    identitysignins_policy_permission_grant_policy = CliCommandType(
        operations_tmpl='azext_identitysignins.vendored_sdks.identitysignins.operations._policy_permission_grant_policy'
        '_operations#PolicyPermissionGrantPolicyOperations.{}',
        client_factory=cf_policy_permission_grant_policy)
    with self.command_group('identitysignins', identitysignins_policy_permission_grant_policy,
