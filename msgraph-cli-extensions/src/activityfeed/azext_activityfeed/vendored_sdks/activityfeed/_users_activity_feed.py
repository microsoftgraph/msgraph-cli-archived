...
from ._configuration import UsersActivityFeedConfiguration
...
class UsersActivityFeed(object):
    ...
    :vartype user: users_activity_feed.operations.UserOperations
    :ivar user_activity: UserActivityOperations operations
    :vartype user_activity: users_activity_feed.operations.UserActivityOperations
    :ivar user_activity_history_item: UserActivityHistoryItemOperations operations
    :vartype user_activity_history_item: users_activity_feed.operations.UserActivityHistoryItemOperations
