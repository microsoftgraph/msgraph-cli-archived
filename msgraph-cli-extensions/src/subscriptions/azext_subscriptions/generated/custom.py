...
def subscriptions_delete(client,
                         subscription_id,
                         if_match=None):
...
def subscriptions_create_subscription(client,
                                      id_=None,
                                      resource=None,
                                      change_type=None,
                                      client_state=None,
...
def subscriptions_get_subscription(client,
                                   subscription_id,
                                   select=None,
                                   expand=None):
...
def subscriptions_list_subscription(client,
                                    orderby=None,
                                    select=None,
                                    expand=None):
...
def subscriptions_update_subscription(client,
                                      subscription_id,
                                      id_=None,
                                      resource=None,
                                      change_type=None,
