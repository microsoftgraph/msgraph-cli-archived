...
def load_arguments(self, _):
    ...
    with self.argument_context('subscriptions subscription-subscription update') as c:
    ...
    with self.argument_context('subscriptions subscription-subscription delete') as c:
        c.argument('subscription_id', help='key: subscription-id of subscription', id_part='subscription')
        c.argument('if_match', help='ETag')

    with self.argument_context('subscriptions subscription-subscription create-subscription') as c:
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('resource', help='Required. Specifies the resource that will be monitored for changes. Do not '
                   'include the base URL (https://graph.microsoft.com/v1.0/). See the possible resource path values '
                   'for each supported resource.')
    ...
    with self.argument_context('subscriptions subscription-subscription get-subscription') as c:
        c.argument('subscription_id', help='key: subscription-id of subscription', id_part='subscription')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('subscriptions subscription-subscription list-subscription') as c:
