...
class CollectionOfSubscription(msrest.serialization.Model):
    ...
    :param value:
    :type value: list[~subscriptions.models.MicrosoftGraphSubscription]
...
class OdataError(msrest.serialization.Model):
    ...
    :type error: ~subscriptions.models.OdataErrorMain
    """
...
class OdataErrorMain(msrest.serialization.Model):
    ...
    :type target: str
    :param details:
    :type details: list[~subscriptions.models.OdataErrorDetail]
