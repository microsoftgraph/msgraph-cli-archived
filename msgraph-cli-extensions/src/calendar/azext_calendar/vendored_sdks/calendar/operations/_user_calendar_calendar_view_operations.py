...
class UserCalendarCalendarViewOperations(object):
    ...
    def list_instance(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum295"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum296"]]]
        **kwargs  # type: Any
    ):
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum294]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum295]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum296]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_instance(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum297"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum298"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphEvent"
        """Get instances from users.
        ...
        :type event_id1: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum297]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum298]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_multi_value_extended_property(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum301"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphMultiValueLegacyExtendedProperty"
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum301]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    def list_single_value_extended_property(
        ...
        calendar_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum302"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum303"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum302]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum303]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_single_value_extended_property(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum304"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSingleValueLegacyExtendedProperty"
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum304]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
