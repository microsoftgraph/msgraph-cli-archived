...
class UserCalendarGroupCalendarOperations(object):
    ...
    def list_calendar_view(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEvent15"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent15]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_multi_value_extended_property(
        ...
        calendar_group_id,  # type: str
        calendar_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum269"]]]
