...
class UserCalendarViewOperations(object):
    ...
    def list_attachment(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum338"]]]
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~calendar.models.Enum338]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum339]
    ...
    def get_attachment(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum340]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
    ...
    def list_extension(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum362"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum362]
        :param select: Select properties to be returned.
    ...
    def list_instance(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum363"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum363]
        :param select: Select properties to be returned.
    ...
    def get_instance(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum366"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum367"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphEvent"
        """Get instances from users.
        ...
        :type event_id1: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum366]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum367]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum368]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum369]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_single_value_extended_property(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum371"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum372"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum371]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum372]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
