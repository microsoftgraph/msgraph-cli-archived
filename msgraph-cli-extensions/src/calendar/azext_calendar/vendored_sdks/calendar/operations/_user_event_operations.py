...
class UserEventOperations(object):
    ...
    def list_attachment(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum379"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum380"]]]
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~calendar.models.Enum379]
    ...
    def get_attachment(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum381"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphAttachment"
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum381]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
    ...
    def get_calendar(
        ...
        user_id,  # type: str
        event_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum382"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum383"]]]
        **kwargs  # type: Any
    ):
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum383]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_extension(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum403"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum403]
        :param select: Select properties to be returned.
    ...
    def list_instance(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum404]
        :param select: Select properties to be returned.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent30]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_instance(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum407"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum408"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphEvent"
        """Get instances from users.
        ...
        :type event_id1: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum407]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum408]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_multi_value_extended_property(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum409"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum409]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum410]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_single_value_extended_property(
        ...
        user_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum412"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum413"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum412]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum413]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
