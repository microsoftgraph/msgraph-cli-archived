...
class UserCalendarViewCalendarOperations:
    ...
    def list_single_value_extended_property(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum359"]]] = None,
        select: Optional[List[Union[str, "models.Enum360"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ...
    async def get_single_value_extended_property(
        ...
        select: Optional[List[Union[str, "models.Enum361"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSingleValueLegacyExtendedProperty":
        """Get singleValueExtendedProperties from users.
