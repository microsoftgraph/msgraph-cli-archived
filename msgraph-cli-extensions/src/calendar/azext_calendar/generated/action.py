...
class AddCalendarCreateCalendarViewMultiValueExtendedProperties(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddCalendarCreateCalendarViewMultiValueExtendedProperties, self).__call__(parser, namespace, action, option_string)
...
class AddCalendarCreateCalendarViewSingleValueExtendedProperties(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddCalendarCreateCalendarViewSingleValueExtendedProperties, self).__call__(parser, namespace, action, option_string)
...
class AddCalendarUpdateCalendarMultiValueExtendedProperties(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddCalendarUpdateCalendarMultiValueExtendedProperties, self).__call__(parser, namespace, action, option_string)
...
class AddCalendarUpdateCalendarSingleValueExtendedProperties(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddCalendarUpdateCalendarSingleValueExtendedProperties, self).__call__(parser, namespace, action, option_string)
