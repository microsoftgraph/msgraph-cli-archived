...
class ProgramControlProgramControlOperations(object):
    """ProgramControlProgramControlOperations operations.
    ...
    def list_program_control(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfProgramControl"]
        """Get entities from programControls.

        Get entities from programControls.

        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_access_review.models.Enum25]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_access_review.models.Enum26]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_access_review.models.Enum27]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfProgramControl or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~identity_access_review.models.CollectionOfProgramControl]
    ...
    def create_program_control(
        self,
        id=None,  # type: Optional[str]
        control_id=None,  # type: Optional[str]
        program_id=None,  # type: Optional[str]
        ...
        **kwargs  # type: Any
        ...
        _body = models.MicrosoftGraphProgramControl(id=id, control_id=control_id, program_id=program_id, control_type_id=control_type_id, display_name=display_name, status=status, owner=owner, resource=resource, created_date_time=created_date_time, program=program)
    ...
    def get_program_control(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_access_review.models.Enum28]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_access_review.models.Enum29]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphProgramControl, or the result of cls(response)
        :rtype: ~identity_access_review.models.MicrosoftGraphProgramControl
        :raises: ~azure.core.exceptions.HttpResponseError
