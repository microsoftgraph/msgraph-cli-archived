...
class AddFilesUpdateListSubscriptions(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddFilesUpdateListSubscriptions, self).__call__(parser, namespace, action, option_string)
...
class AddFilesCreateFollowingSubscriptions(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddFilesCreateFollowingSubscriptions, self).__call__(parser, namespace, action, option_string)
