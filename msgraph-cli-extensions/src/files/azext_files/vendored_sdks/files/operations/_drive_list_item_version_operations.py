...
class DriveListItemVersionOperations(object):
    """DriveListItemVersionOperations operations.
    ...
    def get_field(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_field.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/fields'}  # type: ignore
    ...
    update_field.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/fields'}  # type: ignore
    ...
    delete_field.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/fields'}  # type: ignore
