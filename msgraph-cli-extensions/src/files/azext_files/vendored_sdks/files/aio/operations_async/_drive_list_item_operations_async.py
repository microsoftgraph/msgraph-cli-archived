...
class DriveListItemOperations:
    ...
    async def get_drive_item(
        ...
        **kwargs
        ...
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum98]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum99]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_version(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~files.models.Enum100]
        :param select: Select properties to be returned.
    ...
    async def get_version(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum103]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum104]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphListItemVersion, or the result of cls(response)
        :rtype: ~files.models.MicrosoftGraphListItemVersion
        :raises: ~azure.core.exceptions.HttpResponseError
