...
class TeamPrimaryChannelMessageOperations:
    ...
    def list_hosted_content(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~teams.models.Enum134]
    ...
    def list_reply(
        ...
        **kwargs
        ...
        :type chat_message_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~teams.models.Enum135]
        :param select: Select properties to be returned.
        :type select: list[str or ~teams.models.Enum136]
        :param expand: Expand related entities.
        :type expand: list[str or ~teams.models.Enum137]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_reply(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~teams.models.Enum138]
        :param expand: Expand related entities.
        :type expand: list[str or ~teams.models.Enum139]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphChatMessage, or the result of cls(response)
        :rtype: ~teams.models.MicrosoftGraphChatMessage
        :raises: ~azure.core.exceptions.HttpResponseError
