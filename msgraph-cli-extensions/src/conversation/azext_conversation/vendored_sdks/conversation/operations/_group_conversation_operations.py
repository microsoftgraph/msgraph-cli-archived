...
class GroupConversationOperations(object):
    """GroupConversationOperations operations.
    ...
    def list_thread(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfConversationThread"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~groups_conversation.models.CollectionOfConversationThread]
    ...
    def create_thread(
        ...
        last_delivered_date_time=None,  # type: Optional[datetime.datetime]
        unique_senders=None,  # type: Optional[List[str]]
        cc_recipients=None,  # type: Optional[List["models.MicrosoftGraphRecipient"]]
        preview=None,  # type: Optional[str]
        is_locked=None,  # type: Optional[bool]
        posts=None,  # type: Optional[List["models.MicrosoftGraphPost"]]
        **kwargs  # type: Any
    ):
