...
class RiskyUserOperations(object):
    ...
    def list_history(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~identity_protection.models.Enum147]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_protection.models.Enum148]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_protection.models.Get8ItemsItem]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_protection.models.CollectionOfRiskyUserHistoryItem]
    ...
    def create_history(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~identity_protection.models.MicrosoftGraphRiskyUserHistoryItem
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphRiskyUserHistoryItem(id=id, is_deleted=is_deleted, is_guest=is_guest, is_processing=is_processing, risk_last_updated_date_time=risk_last_updated_date_time, risk_level=risk_level, risk_state=risk_state, risk_detail=risk_detail, user_display_name=user_display_name, user_principal_name=user_principal_name, history=history, user_id=user_id, initiated_by=initiated_by, activity=activity)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphRiskyUserHistoryItem')
    ...
    def get_history(
        ...
        **kwargs  # type: Any
        ...
        :param risky_user_id: key: riskyUser-id of riskyUser.
        :type risky_user_id: str
        :param risky_user_history_item_id: key: riskyUserHistoryItem-id of riskyUserHistoryItem.
        :type risky_user_history_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_protection.models.Enum150]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_protection.models.Get3ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphRiskyUserHistoryItem, or the result of cls(response)
        :rtype: ~identity_protection.models.MicrosoftGraphRiskyUserHistoryItem
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def confirm_compromised(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsL8Oa4IRiskyusersMicrosoftGraphConfirmcompromisedPostRequestbodyContentApplicationJsonSchema(user_ids=user_ids)
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PathsL8Oa4IRiskyusersMicrosoftGraphConfirmcompromisedPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def dismiss(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsTai6NqRiskyusersMicrosoftGraphDismissPostRequestbodyContentApplicationJsonSchema(user_ids=user_ids)
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PathsTai6NqRiskyusersMicrosoftGraphDismissPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
