...
class RiskDetectionRiskDetectionOperations(object):
    """RiskDetectionRiskDetectionOperations operations.
    ...
    def list_risk_detection(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfRiskDetection"]
        """Get entities from riskDetections.

        Get entities from riskDetections.

        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_protection.models.Enum133]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_protection.models.Enum134]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_protection.models.CollectionOfRiskDetection]
    ...
    def create_risk_detection(
        self,
        id=None,  # type: Optional[str]
        request_id_parameter=None,  # type: Optional[str]
        correlation_id=None,  # type: Optional[str]
        risk_event_type=None,  # type: Optional[str]
        risk_type=None,  # type: Optional[Union[str, "models.MicrosoftGraphRiskEventType"]]
        ...
        detection_timing_type=None,  # type: Optional[Union[str, "models.MicrosoftGraphRiskDetectionTimingType"]]
        activity=None,  # type: Optional[Union[str, "models.MicrosoftGraphActivityType"]]
        ...
        detected_date_time=None,  # type: Optional[datetime.datetime]
        ...
        additional_info=None,  # type: Optional[str]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MicrosoftGraphRiskDetection"
        ...
        :param source:
        :type source: str
        :param detection_timing_type: riskDetectionTimingType.
        :type detection_timing_type: str or ~identity_protection.models.MicrosoftGraphRiskDetectionTimingType
        ...
        :rtype: ~identity_protection.models.MicrosoftGraphRiskDetection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphRiskDetection(id=id, request_id=request_id_parameter, correlation_id=correlation_id, risk_event_type=risk_event_type, risk_type=risk_type, risk_state=risk_state, risk_level=risk_level, risk_detail=risk_detail, source=source, detection_timing_type=detection_timing_type, activity=activity, token_issuer_type=token_issuer_type, ip_address=ip_address, activity_date_time=activity_date_time, detected_date_time=detected_date_time, last_updated_date_time=last_updated_date_time, user_id=user_id, user_display_name=user_display_name, user_principal_name=user_principal_name, additional_info=additional_info, city=city, state=state, country_or_region=country_or_region, geo_coordinates=geo_coordinates)
    ...
    def get_risk_detection(
        ...
        **kwargs  # type: Any
        ...
        :param risk_detection_id: key: riskDetection-id of riskDetection.
        :type risk_detection_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_protection.models.Enum141]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphRiskDetection, or the result of cls(response)
