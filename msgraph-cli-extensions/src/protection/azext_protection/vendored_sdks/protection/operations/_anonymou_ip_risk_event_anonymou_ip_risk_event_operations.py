...
class AnonymouIpRiskEventAnonymouIpRiskEventOperations(object):
    """AnonymouIpRiskEventAnonymouIpRiskEventOperations operations.
    ...
    def list_anonymou_ip_risk_event(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfAnonymousIpRiskEvent"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_protection.models.CollectionOfAnonymousIpRiskEvent]
    ...
    def create_anonymou_ip_risk_event(
        self,
    ...
    def get_anonymou_ip_risk_event(
        self,
        anonymous_ip_risk_event_id,  # type: str
    ...
    def update_anonymou_ip_risk_event(
        self,
        anonymous_ip_risk_event_id,  # type: str
        id=None,  # type: Optional[str]
        user_display_name=None,  # type: Optional[str]
    ...
    def delete_anonymou_ip_risk_event(
        self,
        anonymous_ip_risk_event_id,  # type: str
