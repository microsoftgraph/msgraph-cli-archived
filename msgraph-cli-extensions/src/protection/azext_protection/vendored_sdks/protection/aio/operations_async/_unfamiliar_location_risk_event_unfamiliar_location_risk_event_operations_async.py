...
class UnfamiliarLocationRiskEventUnfamiliarLocationRiskEventOperations:
    """UnfamiliarLocationRiskEventUnfamiliarLocationRiskEventOperations async operations.
    ...
    def list_unfamiliar_location_risk_event(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfUnfamiliarLocationRiskEvent"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_protection.models.CollectionOfUnfamiliarLocationRiskEvent]
    ...
    async def create_unfamiliar_location_risk_event(
        self,
    ...
    async def get_unfamiliar_location_risk_event(
        self,
        unfamiliar_location_risk_event_id: str,
    ...
    async def update_unfamiliar_location_risk_event(
        self,
        unfamiliar_location_risk_event_id: str,
        id: Optional[str] = None,
        user_display_name: Optional[str] = None,
    ...
    async def delete_unfamiliar_location_risk_event(
        self,
        unfamiliar_location_risk_event_id: str,
