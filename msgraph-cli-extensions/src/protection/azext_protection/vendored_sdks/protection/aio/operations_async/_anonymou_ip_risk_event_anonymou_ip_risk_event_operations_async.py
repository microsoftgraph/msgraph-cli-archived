...
class AnonymouIpRiskEventAnonymouIpRiskEventOperations:
    """AnonymouIpRiskEventAnonymouIpRiskEventOperations async operations.
    ...
    def list_anonymou_ip_risk_event(
        self,
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfAnonymousIpRiskEvent"]:
        """Get entities from anonymousIpRiskEvents.

        Get entities from anonymousIpRiskEvents.

        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_protection.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_protection.models.Get6ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_protection.models.Get7ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfAnonymousIpRiskEvent or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_protection.models.CollectionOfAnonymousIpRiskEvent]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfAnonymousIpRiskEvent"]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_anonymou_ip_risk_event.metadata['url']  # type: ignore
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfAnonymousIpRiskEvent', pipeline_response)
    ...
    list_anonymou_ip_risk_event.metadata = {'url': '/anonymousIpRiskEvents'}  # type: ignore

    async def create_anonymou_ip_risk_event(
        self,
        ...
        **kwargs
    ) -> "models.MicrosoftGraphLocatedRiskEvent":
        ...
        # Construct URL
        url = self.create_anonymou_ip_risk_event.metadata['url']  # type: ignore
        ...
        return deserialized
    create_anonymou_ip_risk_event.metadata = {'url': '/anonymousIpRiskEvents'}  # type: ignore

    async def get_anonymou_ip_risk_event(
        self,
        anonymous_ip_risk_event_id: str,
        ...
        **kwargs
        ...
        :param anonymous_ip_risk_event_id: key: anonymousIpRiskEvent-id of anonymousIpRiskEvent.
        :type anonymous_ip_risk_event_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_protection.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_protection.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphLocatedRiskEvent, or the result of cls(response)
        :rtype: ~identity_protection.models.MicrosoftGraphLocatedRiskEvent
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        # Construct URL
        url = self.get_anonymou_ip_risk_event.metadata['url']  # type: ignore
        path_format_arguments = {
            'anonymousIpRiskEvent-id': self._serialize.url("anonymous_ip_risk_event_id", anonymous_ip_risk_event_id, 'str'),
        }
        ...
        return deserialized
    get_anonymou_ip_risk_event.metadata = {'url': '/anonymousIpRiskEvents/{anonymousIpRiskEvent-id}'}  # type: ignore

    async def update_anonymou_ip_risk_event(
        self,
        anonymous_ip_risk_event_id: str,
        id: Optional[str] = None,
        user_display_name: Optional[str] = None,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_anonymou_ip_risk_event.metadata['url']  # type: ignore
        path_format_arguments = {
            'anonymousIpRiskEvent-id': self._serialize.url("anonymous_ip_risk_event_id", anonymous_ip_risk_event_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    update_anonymou_ip_risk_event.metadata = {'url': '/anonymousIpRiskEvents/{anonymousIpRiskEvent-id}'}  # type: ignore

    async def delete_anonymou_ip_risk_event(
        self,
        anonymous_ip_risk_event_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_anonymou_ip_risk_event.metadata['url']  # type: ignore
        path_format_arguments = {
            'anonymousIpRiskEvent-id': self._serialize.url("anonymous_ip_risk_event_id", anonymous_ip_risk_event_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    delete_anonymou_ip_risk_event.metadata = {'url': '/anonymousIpRiskEvents/{anonymousIpRiskEvent-id}'}  # type: ignore
