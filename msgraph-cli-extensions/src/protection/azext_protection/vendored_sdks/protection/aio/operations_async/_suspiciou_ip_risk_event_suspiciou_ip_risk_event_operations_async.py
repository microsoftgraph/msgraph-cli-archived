...
class SuspiciouIpRiskEventSuspiciouIpRiskEventOperations:
    """SuspiciouIpRiskEventSuspiciouIpRiskEventOperations async operations.
    ...
    def list_suspiciou_ip_risk_event(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSuspiciousIpRiskEvent"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_protection.models.CollectionOfSuspiciousIpRiskEvent]
    ...
    async def create_suspiciou_ip_risk_event(
        self,
    ...
    async def get_suspiciou_ip_risk_event(
        self,
        suspicious_ip_risk_event_id: str,
    ...
    async def update_suspiciou_ip_risk_event(
        self,
        suspicious_ip_risk_event_id: str,
        id: Optional[str] = None,
        user_display_name: Optional[str] = None,
    ...
    async def delete_suspiciou_ip_risk_event(
        self,
        suspicious_ip_risk_event_id: str,
