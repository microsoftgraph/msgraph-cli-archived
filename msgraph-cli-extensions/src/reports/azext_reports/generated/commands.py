...
def load_command_table(self, _):
    ...
    with self.command_group('reports report-report-root', reports_report_report_root,
                            client_factory=cf_report_report_root, is_experimental=True) as g:
        g.custom_command('update', 'reports_report_report_root_update')
    ...
    with self.command_group('reports report', reports_report, client_factory=cf_report, is_experimental=True) as g:
        g.custom_command('update', 'reports_report_update')
