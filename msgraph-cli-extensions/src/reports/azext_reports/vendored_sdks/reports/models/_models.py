...
class MicrosoftGraphAzureAdUserFeatureUsage(MicrosoftGraphEntity):
    ...
    :param license_recommended: azureADLicenseType. Possible values include: "none", "free",
     "basic", "premiumP1", "premiumP2", "unknownFutureValue".
    :type license_recommended: str or ~reports.models.MicrosoftGraphAzureAdLicenseType
    :param license_assigned: azureADLicenseType. Possible values include: "none", "free", "basic",
     "premiumP1", "premiumP2", "unknownFutureValue".
...
class MicrosoftGraphCredentialUsageSummary(MicrosoftGraphEntity):
    ...
    :param id: Read-only.
    :type id: str
    :param feature: featureType. Possible values include: "registration", "reset",
     "unknownFutureValue".
    ...
    :param auth_method: usageAuthMethod. Possible values include: "email", "mobileSMS",
     "mobileCall", "officePhone", "securityQuestion", "appNotification", "appCode",
...
class MicrosoftGraphFeatureUsageDetail(msrest.serialization.Model):
    ...
    :param feature_name:
    :type feature_name: str
    :param license_required: azureADLicenseType. Possible values include: "none", "free", "basic",
     "premiumP1", "premiumP2", "unknownFutureValue".
...
class MicrosoftGraphLicenseInfoDetail(msrest.serialization.Model):
    ...
    :param license_type: azureADLicenseType. Possible values include: "none", "free", "basic",
     "premiumP1", "premiumP2", "unknownFutureValue".
...
class MicrosoftGraphRelyingPartyDetailedSummary(MicrosoftGraphEntity):
    ...
    :param migration_status: migrationStatus. Possible values include: "ready", "needsReview",
...
class MicrosoftGraphUserRegistrationCount(msrest.serialization.Model):
    ...
    :param registration_status: registrationStatusType. Possible values include: "registered",
     "enabled", "capable", "mfaRegistered", "unknownFutureValue".
