...
|------|----|-----------|----------|------------|
|**--id**|string|Read-only.|id|id|
|**--feature**|choice|featureType|feature|feature|
|**--user-principal-name**|string||user_principal_name|userPrincipalName|
|**--user-display-name**|string||user_display_name|userDisplayName|
|**--is-success**|boolean||is_success|isSuccess|
|**--auth-method**|choice|usageAuthMethod|auth_method|authMethod|
...
### reports report-report-root update

update a reports report-report-root.
