...
class IdentityOperations:
    ...
    :type models: ~identity_user_flows.models
    ...
    def list_user_flow(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~identity_user_flows.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_user_flows.models.Get6ItemsItem]
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_user_flows.models.CollectionOfIdentityUserFlow]
    ...
    async def create_user_flow(
        ...
        **kwargs
        ...
        :param id: Read-only.
        :type id: str
        :param user_flow_type: userFlowType.
        ...
        :rtype: ~identity_user_flows.models.MicrosoftGraphIdentityUserFlow
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_user_flow(
        ...
        **kwargs
        ...
        :param identity_user_flow_id: key: identityUserFlow-id of identityUserFlow.
        :type identity_user_flow_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_user_flows.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphIdentityUserFlow, or the result of cls(response)
