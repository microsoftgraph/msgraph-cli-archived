...
class GroupPlannerOperations:
    """GroupPlannerOperations async operations.
    ...
    def list_plan(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerPlan"]:
        ...
        :type orderby: list[str or ~groups_planner.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Get7ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_planner.models.Get8ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPlannerPlan or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_planner.models.CollectionOfPlannerPlan]
    ...
    async def create_plan(
        ...
        **kwargs
        ...
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerPlan
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_plan(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum6]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_planner.models.Get3ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerPlan, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerPlan
        :raises: ~azure.core.exceptions.HttpResponseError
