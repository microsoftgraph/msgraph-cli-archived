...
class GroupOperations:
    ...
    async def get_planner(
        ...
        **kwargs
        ...
        :type select: list[str or ~groups_planner.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_planner.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerGroup, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerGroup
    ...
    async def update_planner(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphPlannerGroup(id=id, plans=plans)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphPlannerGroup')
