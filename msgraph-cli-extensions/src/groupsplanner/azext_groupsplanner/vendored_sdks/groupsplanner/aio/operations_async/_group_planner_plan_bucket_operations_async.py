...
class GroupPlannerPlanBucketOperations:
    """GroupPlannerPlanBucketOperations async operations.
    ...
    def list_task(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~groups_planner.models.Enum13]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum14]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_planner.models.Get10ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPlannerTask or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_planner.models.CollectionOfPlannerTask]
    ...
    async def get_task(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum16]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_planner.models.Get5ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerTask, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerTask
        :raises: ~azure.core.exceptions.HttpResponseError
