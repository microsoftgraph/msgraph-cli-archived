...
def cf_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group


def cf_group_onenote(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote


def cf_group_onenote_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook


def cf_group_onenote_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook_section_group


def cf_group_onenote_notebook_section_group_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook_section_group_section


def cf_group_onenote_notebook_section_group_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook_section_group_section_page


def cf_group_onenote_notebook_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook_section


def cf_group_onenote_notebook_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook_section_page


def cf_group_onenote_notebook_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_notebook_section_parent_section_group


def cf_group_onenote_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page


def cf_group_onenote_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_notebook


def cf_group_onenote_page_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_notebook_section_group
...
def cf_group_onenote_page_parent_notebook_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_notebook_section_parent_section_group
...
def cf_group_onenote_page_parent_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_section_parent_notebook


def cf_group_onenote_page_parent_section_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_section_parent_notebook_section_group


def cf_group_onenote_page_parent_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_section_parent_section_group


def cf_group_onenote_page_parent_section_parent_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_page_parent_section_parent_section_group_parent_notebook


def cf_group_onenote_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group


def cf_group_onenote_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_parent_notebook


def cf_group_onenote_section_group_parent_notebook_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_parent_notebook_section


def cf_group_onenote_section_group_parent_notebook_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_parent_notebook_section_page


def cf_group_onenote_section_group_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_section


def cf_group_onenote_section_group_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_section_page


def cf_group_onenote_section_group_section_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_section_page_parent_notebook


def cf_group_onenote_section_group_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_group_section_parent_notebook


def cf_group_onenote_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section


def cf_group_onenote_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_page


def cf_group_onenote_section_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_page_parent_notebook


def cf_group_onenote_section_page_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_page_parent_notebook_section_group


def cf_group_onenote_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_parent_notebook


def cf_group_onenote_section_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_parent_notebook_section_group


def cf_group_onenote_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_parent_section_group


def cf_group_onenote_section_parent_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).group_onenote_section_parent_section_group_parent_notebook


def cf_site(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site


def cf_site_onenote(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote


def cf_site_onenote_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook


def cf_site_onenote_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook_section_group


def cf_site_onenote_notebook_section_group_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook_section_group_section


def cf_site_onenote_notebook_section_group_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook_section_group_section_page


def cf_site_onenote_notebook_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook_section


def cf_site_onenote_notebook_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook_section_page


def cf_site_onenote_notebook_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_notebook_section_parent_section_group


def cf_site_onenote_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page


def cf_site_onenote_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_notebook


def cf_site_onenote_page_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_notebook_section_group
...
def cf_site_onenote_page_parent_notebook_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_notebook_section_parent_section_group
...
def cf_site_onenote_page_parent_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_section_parent_notebook


def cf_site_onenote_page_parent_section_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_section_parent_notebook_section_group


def cf_site_onenote_page_parent_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_section_parent_section_group


def cf_site_onenote_page_parent_section_parent_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_page_parent_section_parent_section_group_parent_notebook


def cf_site_onenote_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group


def cf_site_onenote_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_parent_notebook


def cf_site_onenote_section_group_parent_notebook_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_parent_notebook_section


def cf_site_onenote_section_group_parent_notebook_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_parent_notebook_section_page


def cf_site_onenote_section_group_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_section


def cf_site_onenote_section_group_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_section_page


def cf_site_onenote_section_group_section_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_section_page_parent_notebook


def cf_site_onenote_section_group_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_group_section_parent_notebook


def cf_site_onenote_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section


def cf_site_onenote_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_page


def cf_site_onenote_section_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_page_parent_notebook


def cf_site_onenote_section_page_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_page_parent_notebook_section_group


def cf_site_onenote_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_parent_notebook


def cf_site_onenote_section_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_parent_notebook_section_group


def cf_site_onenote_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_parent_section_group


def cf_site_onenote_section_parent_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).site_onenote_section_parent_section_group_parent_notebook


def cf_user(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user


def cf_user_onenote(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote


def cf_user_onenote_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook


def cf_user_onenote_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook_section_group


def cf_user_onenote_notebook_section_group_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook_section_group_section


def cf_user_onenote_notebook_section_group_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook_section_group_section_page


def cf_user_onenote_notebook_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook_section


def cf_user_onenote_notebook_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook_section_page


def cf_user_onenote_notebook_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_notebook_section_parent_section_group


def cf_user_onenote_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page


def cf_user_onenote_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_notebook


def cf_user_onenote_page_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_notebook_section_group
...
def cf_user_onenote_page_parent_notebook_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_notebook_section_parent_section_group
...
def cf_user_onenote_page_parent_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_section_parent_notebook


def cf_user_onenote_page_parent_section_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_section_parent_notebook_section_group


def cf_user_onenote_page_parent_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_section_parent_section_group


def cf_user_onenote_page_parent_section_parent_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_page_parent_section_parent_section_group_parent_notebook


def cf_user_onenote_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group


def cf_user_onenote_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_parent_notebook


def cf_user_onenote_section_group_parent_notebook_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_parent_notebook_section


def cf_user_onenote_section_group_parent_notebook_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_parent_notebook_section_page


def cf_user_onenote_section_group_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_section


def cf_user_onenote_section_group_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_section_page


def cf_user_onenote_section_group_section_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_section_page_parent_notebook


def cf_user_onenote_section_group_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_group_section_parent_notebook


def cf_user_onenote_section(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section


def cf_user_onenote_section_page(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_page


def cf_user_onenote_section_page_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_page_parent_notebook


def cf_user_onenote_section_page_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_page_parent_notebook_section_group


def cf_user_onenote_section_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_parent_notebook


def cf_user_onenote_section_parent_notebook_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_parent_notebook_section_group


def cf_user_onenote_section_parent_section_group(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_parent_section_group


def cf_user_onenote_section_parent_section_group_parent_notebook(cli_ctx, *_):
    return cf_notes_cl(cli_ctx).user_onenote_section_parent_section_group_parent_notebook
