...
class UserOnenoteSectionParentSectionGroupParentNotebookOperations:
    ...
    def list_section_group(
        ...
        orderby: Optional[List[Union[str, "models.Enum1072"]]] = None,
        select: Optional[List[Union[str, "models.Enum1073"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1074"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup60"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup60]
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore

    def list_section(
        self,
        user_id: str,
        onenote_section_id: str,
        orderby: Optional[List[Union[str, "models.Enum1077"]]] = None,
        select: Optional[List[Union[str, "models.Enum1078"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1079"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection60"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection60]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section(
        ...
        select: Optional[List[Union[str, "models.Enum1080"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1081"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenoteSection":
        """Get sections from users.
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
