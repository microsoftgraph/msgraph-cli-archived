...
class UserOnenoteSectionGroupSectionOperations:
    """UserOnenoteSectionGroupSectionOperations async operations.
    ...
    def list_page(
        ...
        orderby: Optional[List[Union[str, "models.Enum971"]]] = None,
        select: Optional[List[Union[str, "models.Enum972"]]] = None,
        expand: Optional[List[Union[str, "models.Enum973"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage24"]:
        ...
        :type orderby: list[str or ~notes.models.Enum971]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum972]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum973]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage24 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage24]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage24"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage24', pipeline_response)
    ...
    list_page.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum974"]]] = None,
        expand: Optional[List[Union[str, "models.Enum975"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum974]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum975]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    async def get_page_content(
        ...
        **kwargs
        ...
        return deserialized
    get_page_content.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_page_content.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    async def get_parent_notebook(
        ...
        section_group_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum990"]]] = None,
        expand: Optional[List[Union[str, "models.Enum991"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum990]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum991]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        section_group_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum1002"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1003"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1002]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1003]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
