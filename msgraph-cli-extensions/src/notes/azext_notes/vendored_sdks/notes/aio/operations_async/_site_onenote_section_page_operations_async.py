...
class SiteOnenoteSectionPageOperations:
    """SiteOnenoteSectionPageOperations async operations.
    ...
    async def get_parent_notebook(
        ...
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum650"]]] = None,
        expand: Optional[List[Union[str, "models.Enum651"]]] = None,
        **kwargs
    ...
    async def get_parent_section(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum676"]]] = None,
        expand: Optional[List[Union[str, "models.Enum677"]]] = None,
        **kwargs
