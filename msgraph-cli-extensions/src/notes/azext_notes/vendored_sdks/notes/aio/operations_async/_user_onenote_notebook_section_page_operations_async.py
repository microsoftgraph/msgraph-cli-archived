...
class UserOnenoteNotebookSectionPageOperations:
    """UserOnenoteNotebookSectionPageOperations async operations.
    ...
    async def get_parent_notebook(
        ...
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum779"]]] = None,
        expand: Optional[List[Union[str, "models.Enum780"]]] = None,
        **kwargs
    ...
    async def get_parent_section(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum781"]]] = None,
        expand: Optional[List[Union[str, "models.Enum782"]]] = None,
        **kwargs
