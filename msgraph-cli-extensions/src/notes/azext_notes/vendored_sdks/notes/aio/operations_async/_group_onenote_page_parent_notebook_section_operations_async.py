...
class GroupOnenotePageParentNotebookSectionOperations:
    """GroupOnenotePageParentNotebookSectionOperations async operations.
    ...
    def list_page(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~notes.models.Enum116]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum117]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum118]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage3 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage3]
    ...
    async def get_page(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum119]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum120]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_page.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    async def get_parent_notebook(
        ...
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum121]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum122]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum123]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum124]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
