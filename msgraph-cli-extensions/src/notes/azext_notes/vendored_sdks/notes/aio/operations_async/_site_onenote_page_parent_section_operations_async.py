...
class SiteOnenotePageParentSectionOperations:
    """SiteOnenotePageParentSectionOperations async operations.
    ...
    def list_page(
        ...
        site_id: str,
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum505"]]] = None,
        select: Optional[List[Union[str, "models.Enum506"]]] = None,
        expand: Optional[List[Union[str, "models.Enum507"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage13"]:
        ...
        :type orderby: list[str or ~notes.models.Enum505]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum506]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum507]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage13 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage13]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage13"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage13', pipeline_response)
    ...
    async def get_page(
        ...
        select: Optional[List[Union[str, "models.Enum508"]]] = None,
        expand: Optional[List[Union[str, "models.Enum509"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum508]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum509]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_page.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore

    async def get_parent_notebook(
        self,
        site_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum510"]]] = None,
        expand: Optional[List[Union[str, "models.Enum511"]]] = None,
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum510]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum511]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore

    async def get_parent_section_group(
        self,
        site_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum536"]]] = None,
        expand: Optional[List[Union[str, "models.Enum537"]]] = None,
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum536]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum537]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
