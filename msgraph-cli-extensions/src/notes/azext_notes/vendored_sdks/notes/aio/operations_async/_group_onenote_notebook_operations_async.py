...
class GroupOnenoteNotebookOperations:
    """GroupOnenoteNotebookOperations async operations.
    ...
    def list_section_group(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup"]:
        ...
        :type orderby: list[str or ~notes.models.Enum9]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum10]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Get9ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups'}  # type: ignore
    ...
    async def create_section_group(
        ...
        **kwargs
        ...
        return deserialized
    create_section_group.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups'}  # type: ignore
    ...
    async def get_section_group(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum12]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Get4ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    def list_section(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection0"]:
        ...
        :type notebook_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum41]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum42]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum43]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection0 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection0"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection0', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, AsyncList(list_of_elem)
    ...
    list_section.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections'}  # type: ignore
    ...
    async def create_section(
        ...
        **kwargs
        ...
        return deserialized
    create_section.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections'}  # type: ignore
    ...
    async def get_section(
        ...
        expand: Optional[List[Union[str, "models.Enum45"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenoteSection":
        """Get sections from groups.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum44]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum45]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}'}  # type: ignore
