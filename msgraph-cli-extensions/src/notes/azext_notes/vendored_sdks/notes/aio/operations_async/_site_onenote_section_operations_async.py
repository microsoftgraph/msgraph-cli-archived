...
class SiteOnenoteSectionOperations:
    """SiteOnenoteSectionOperations async operations.
    ...
    def list_page(
        ...
        orderby: Optional[List[Union[str, "models.Enum645"]]] = None,
        select: Optional[List[Union[str, "models.Enum646"]]] = None,
        expand: Optional[List[Union[str, "models.Enum647"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage16"]:
        ...
        :type orderby: list[str or ~notes.models.Enum645]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum646]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum647]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage16 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage16]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage16"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage16', pipeline_response)
    ...
    list_page.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum648"]]] = None,
        expand: Optional[List[Union[str, "models.Enum649"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum648]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum649]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    async def get_page_content(
        ...
        **kwargs
        ...
        return deserialized
    get_page_content.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_page_content.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore

    async def get_parent_notebook(
        self,
        site_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum678"]]] = None,
        expand: Optional[List[Union[str, "models.Enum679"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum678]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum679]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum704]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum705]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
