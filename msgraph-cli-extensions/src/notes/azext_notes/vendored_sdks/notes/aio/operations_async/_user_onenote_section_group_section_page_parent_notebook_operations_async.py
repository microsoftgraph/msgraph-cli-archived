...
class UserOnenoteSectionGroupSectionPageParentNotebookOperations:
    """UserOnenoteSectionGroupSectionPageParentNotebookOperations async operations.
    ...
    def list_section_group(
        ...
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum978"]]] = None,
        select: Optional[List[Union[str, "models.Enum979"]]] = None,
        expand: Optional[List[Union[str, "models.Enum980"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup54"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup54]
    ...
    async def get_section_group(
        ...
        select: Optional[List[Union[str, "models.Enum981"]]] = None,
        expand: Optional[List[Union[str, "models.Enum982"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSectionGroup":
        """Get sectionGroups from users.
    ...
    def list_section(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum983"]]] = None,
        select: Optional[List[Union[str, "models.Enum984"]]] = None,
        expand: Optional[List[Union[str, "models.Enum985"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection53"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection53]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
