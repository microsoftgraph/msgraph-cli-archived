...
class UserOnenoteSectionGroupSectionPageOperations:
    """UserOnenoteSectionGroupSectionPageOperations async operations.
    ...
    async def get_parent_section(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum988"]]] = None,
        expand: Optional[List[Union[str, "models.Enum989"]]] = None,
        **kwargs
