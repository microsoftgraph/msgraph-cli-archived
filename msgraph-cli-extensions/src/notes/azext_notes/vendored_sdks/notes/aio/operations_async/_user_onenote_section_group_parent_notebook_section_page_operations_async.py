...
class UserOnenoteSectionGroupParentNotebookSectionPageOperations:
    ...
    async def get_parent_notebook(
        ...
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum951"]]] = None,
        expand: Optional[List[Union[str, "models.Enum952"]]] = None,
        **kwargs
        ...
        :type select: list[str or ~notes.models.Enum951]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum952]
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section(
        ...
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum953]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum954]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
