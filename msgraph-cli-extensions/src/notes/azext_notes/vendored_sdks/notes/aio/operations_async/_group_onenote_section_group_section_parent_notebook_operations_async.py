...
class GroupOnenoteSectionGroupSectionParentNotebookOperations:
    """GroupOnenoteSectionGroupSectionParentNotebookOperations async operations.
    ...
    def list_section_group(
        ...
        expand: Optional[List[Union[str, "models.Enum266"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup13"]:
        ...
        :type orderby: list[str or ~notes.models.Enum264]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum265]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum266]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup13 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup13]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup13"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup13', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    async def create_section_group(
        ...
        **kwargs
        ...
        return deserialized
    create_section_group.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    async def get_section_group(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum267]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum268]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    def list_section(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection12"]:
        ...
        :type onenote_section_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum269]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum270]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum271]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection12 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection12]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection12"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection12', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, AsyncList(list_of_elem)
    ...
    list_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sections'}  # type: ignore
    ...
    async def create_section(
        ...
        **kwargs
        ...
        return deserialized
    create_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sections'}  # type: ignore
    ...
    async def get_section(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum272]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum273]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
