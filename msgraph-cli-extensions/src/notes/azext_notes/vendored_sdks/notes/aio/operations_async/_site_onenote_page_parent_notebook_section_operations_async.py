...
class SiteOnenotePageParentNotebookSectionOperations:
    """SiteOnenotePageParentNotebookSectionOperations async operations.
    ...
    def list_page(
        ...
        orderby: Optional[List[Union[str, "models.Enum480"]]] = None,
        select: Optional[List[Union[str, "models.Enum481"]]] = None,
        expand: Optional[List[Union[str, "models.Enum482"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage12"]:
        ...
        :type orderby: list[str or ~notes.models.Enum480]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum481]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum482]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage12 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage12]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage12"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage12', pipeline_response)
    ...
    list_page.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        expand: Optional[List[Union[str, "models.Enum484"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum483]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum484]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    async def get_parent_notebook(
        ...
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum485]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum486]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        onenote_page_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum487"]]] = None,
        expand: Optional[List[Union[str, "models.Enum488"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum487]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum488]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
