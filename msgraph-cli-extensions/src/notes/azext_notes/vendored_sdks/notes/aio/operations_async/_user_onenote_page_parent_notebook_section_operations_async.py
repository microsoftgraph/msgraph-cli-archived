...
class UserOnenotePageParentNotebookSectionOperations:
    """UserOnenotePageParentNotebookSectionOperations async operations.
    ...
    def list_page(
        ...
        orderby: Optional[List[Union[str, "models.Enum844"]]] = None,
        select: Optional[List[Union[str, "models.Enum845"]]] = None,
        expand: Optional[List[Union[str, "models.Enum846"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage21"]:
        ...
        :type orderby: list[str or ~notes.models.Enum844]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum845]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum846]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage21 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage21]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage21"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage21', pipeline_response)
    ...
    list_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        select: Optional[List[Union[str, "models.Enum847"]]] = None,
        expand: Optional[List[Union[str, "models.Enum848"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum847]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum848]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    async def get_parent_notebook(
        ...
        onenote_page_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum849"]]] = None,
        expand: Optional[List[Union[str, "models.Enum850"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum849]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum850]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        onenote_page_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum851"]]] = None,
        expand: Optional[List[Union[str, "models.Enum852"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum851]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum852]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
