...
class UserOnenotePageParentSectionOperations:
    """UserOnenotePageParentSectionOperations async operations.
    ...
    def list_page(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage22"]:
        ...
        :type orderby: list[str or ~notes.models.Enum869]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum870]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum871]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage22 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage22]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage22"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage22', pipeline_response)
    ...
    list_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum872]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum873]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore

    async def get_parent_notebook(
        self,
        user_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum874"]]] = None,
        expand: Optional[List[Union[str, "models.Enum875"]]] = None,
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum874]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum875]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore

    async def get_parent_section_group(
        self,
        user_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum900"]]] = None,
        expand: Optional[List[Union[str, "models.Enum901"]]] = None,
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum900]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum901]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
