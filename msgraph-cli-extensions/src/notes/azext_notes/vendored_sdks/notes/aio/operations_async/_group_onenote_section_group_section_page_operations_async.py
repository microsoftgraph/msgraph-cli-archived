...
class GroupOnenoteSectionGroupSectionPageOperations:
    """GroupOnenoteSectionGroupSectionPageOperations async operations.
    ...
    async def get_parent_section(
        ...
        expand: Optional[List[Union[str, "models.Enum261"]]] = None,
        **kwargs
