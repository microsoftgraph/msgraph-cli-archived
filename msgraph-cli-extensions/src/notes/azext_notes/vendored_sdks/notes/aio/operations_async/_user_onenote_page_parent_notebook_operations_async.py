...
class UserOnenotePageParentNotebookOperations:
    """UserOnenotePageParentNotebookOperations async operations.
    ...
    def list_section_group(
        ...
        user_id: str,
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum811"]]] = None,
        select: Optional[List[Union[str, "models.Enum812"]]] = None,
        expand: Optional[List[Union[str, "models.Enum813"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup44"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup44]
    ...
    list_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    async def create_section_group(
        ...
        **kwargs
        ...
        return deserialized
    create_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    async def get_section_group(
        ...
        select: Optional[List[Union[str, "models.Enum814"]]] = None,
        expand: Optional[List[Union[str, "models.Enum815"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSectionGroup":
        """Get sectionGroups from users.
        ...
        return deserialized
    get_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore

    def list_section(
        self,
        user_id: str,
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum839"]]] = None,
        select: Optional[List[Union[str, "models.Enum840"]]] = None,
        expand: Optional[List[Union[str, "models.Enum841"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection45"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection45]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_section.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections'}  # type: ignore
    ...
    async def create_section(
        ...
        **kwargs
        ...
        return deserialized
    create_section.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections'}  # type: ignore
    ...
    async def get_section(
        ...
        select: Optional[List[Union[str, "models.Enum842"]]] = None,
        expand: Optional[List[Union[str, "models.Enum843"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenoteSection":
        """Get sections from users.
        ...
        return deserialized
    get_section.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
