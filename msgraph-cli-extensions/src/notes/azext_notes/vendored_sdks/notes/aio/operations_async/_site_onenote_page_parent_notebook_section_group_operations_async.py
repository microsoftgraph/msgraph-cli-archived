...
class SiteOnenotePageParentNotebookSectionGroupOperations:
    """SiteOnenotePageParentNotebookSectionGroupOperations async operations.
    ...
    async def get_parent_notebook(
        ...
        select: Optional[List[Union[str, "models.Enum452"]]] = None,
        expand: Optional[List[Union[str, "models.Enum453"]]] = None,
        **kwargs
    ...
    async def get_parent_section_group(
        ...
        expand: Optional[List[Union[str, "models.Enum455"]]] = None,
        **kwargs
    ...
    def list_section_group(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup24"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup24]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section_group(
        ...
        select: Optional[List[Union[str, "models.Enum459"]]] = None,
        expand: Optional[List[Union[str, "models.Enum460"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSectionGroup":
        """Get sectionGroups from sites.
    ...
    def list_section(
        ...
        onenote_page_id: str,
        section_group_id: str,
        orderby: Optional[List[Union[str, "models.Enum461"]]] = None,
        select: Optional[List[Union[str, "models.Enum462"]]] = None,
        expand: Optional[List[Union[str, "models.Enum463"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection23"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection23]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
