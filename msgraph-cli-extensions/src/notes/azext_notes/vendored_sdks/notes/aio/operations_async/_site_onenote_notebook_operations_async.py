...
class SiteOnenoteNotebookOperations:
    """SiteOnenoteNotebookOperations async operations.
    ...
    def list_section_group(
        ...
        site_id: str,
        notebook_id: str,
        orderby: Optional[List[Union[str, "models.Enum373"]]] = None,
        select: Optional[List[Union[str, "models.Enum374"]]] = None,
        expand: Optional[List[Union[str, "models.Enum375"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup20"]:
        ...
        :type orderby: list[str or ~notes.models.Enum373]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum374]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum375]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup20 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup20]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup20"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup20', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups'}  # type: ignore
    ...
    async def create_section_group(
        ...
        **kwargs
        ...
        return deserialized
    create_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups'}  # type: ignore
    ...
    async def get_section_group(
        ...
        expand: Optional[List[Union[str, "models.Enum377"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSectionGroup":
        """Get sectionGroups from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum376]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum377]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}'}  # type: ignore

    def list_section(
        self,
        site_id: str,
        notebook_id: str,
        orderby: Optional[List[Union[str, "models.Enum405"]]] = None,
        select: Optional[List[Union[str, "models.Enum406"]]] = None,
        expand: Optional[List[Union[str, "models.Enum407"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection21"]:
        ...
        :type notebook_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum405]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum406]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum407]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection21 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection21]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection21"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection21', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, AsyncList(list_of_elem)
    ...
    list_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections'}  # type: ignore
    ...
    async def create_section(
        ...
        **kwargs
        ...
        return deserialized
    create_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections'}  # type: ignore
    ...
    async def get_section(
        ...
        expand: Optional[List[Union[str, "models.Enum409"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenoteSection":
        """Get sections from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum408]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum409]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}'}  # type: ignore
