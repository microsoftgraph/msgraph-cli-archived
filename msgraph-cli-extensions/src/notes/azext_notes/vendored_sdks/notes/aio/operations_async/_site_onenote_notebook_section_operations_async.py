...
class SiteOnenoteNotebookSectionOperations:
    """SiteOnenoteNotebookSectionOperations async operations.
    ...
    def list_page(
        ...
        expand: Optional[List[Union[str, "models.Enum412"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage9"]:
        ...
        :type orderby: list[str or ~notes.models.Enum410]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum411]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum412]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage9 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage9]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenotePage9"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenotePage9', pipeline_response)
    ...
    list_page.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        expand: Optional[List[Union[str, "models.Enum414"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum413]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum414]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    async def get_page_content(
        ...
        **kwargs
        ...
        return deserialized
    get_page_content.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_page_content.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    async def get_parent_notebook(
        ...
        notebook_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum419"]]] = None,
        expand: Optional[List[Union[str, "models.Enum420"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum419]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum420]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        notebook_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum421"]]] = None,
        expand: Optional[List[Union[str, "models.Enum422"]]] = None,
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum421]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum422]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
