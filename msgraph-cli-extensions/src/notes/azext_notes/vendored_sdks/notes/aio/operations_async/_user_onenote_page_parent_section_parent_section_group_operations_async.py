...
class UserOnenotePageParentSectionParentSectionGroupOperations:
    """UserOnenotePageParentSectionParentSectionGroupOperations async operations.
    ...
    async def get_parent_notebook(
        ...
        user_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum902"]]] = None,
        expand: Optional[List[Union[str, "models.Enum903"]]] = None,
        **kwargs
    ...
    async def get_parent_section_group(
        ...
        user_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum914"]]] = None,
        expand: Optional[List[Union[str, "models.Enum915"]]] = None,
        **kwargs
    ...
    def list_section_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup50]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section_group(
        ...
        select: Optional[List[Union[str, "models.Enum919"]]] = None,
        expand: Optional[List[Union[str, "models.Enum920"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSectionGroup":
        """Get sectionGroups from users.
    ...
    def list_section(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection50"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection50]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
