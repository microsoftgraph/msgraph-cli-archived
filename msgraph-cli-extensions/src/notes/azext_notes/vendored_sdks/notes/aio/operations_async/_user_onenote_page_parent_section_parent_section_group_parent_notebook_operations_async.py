...
class UserOnenotePageParentSectionParentSectionGroupParentNotebookOperations:
    ...
    def list_section_group(
        ...
        user_id: str,
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum904"]]] = None,
        select: Optional[List[Union[str, "models.Enum905"]]] = None,
        expand: Optional[List[Union[str, "models.Enum906"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup49"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfSectionGroup49]
    ...
    async def get_section_group(
        ...
        select: Optional[List[Union[str, "models.Enum907"]]] = None,
        expand: Optional[List[Union[str, "models.Enum908"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSectionGroup":
        """Get sectionGroups from users.
    ...
    def list_section(
        ...
        user_id: str,
        onenote_page_id: str,
        orderby: Optional[List[Union[str, "models.Enum909"]]] = None,
        select: Optional[List[Union[str, "models.Enum910"]]] = None,
        expand: Optional[List[Union[str, "models.Enum911"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection49"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenoteSection49]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section(
        ...
        select: Optional[List[Union[str, "models.Enum912"]]] = None,
        expand: Optional[List[Union[str, "models.Enum913"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenoteSection":
        """Get sections from users.
