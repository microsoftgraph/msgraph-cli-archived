...
class GroupOnenotePageParentSectionOperations:
    """GroupOnenotePageParentSectionOperations async operations.
    ...
    def list_page(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage4"]:
        ...
        :type orderby: list[str or ~notes.models.Enum141]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum142]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum143]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage4 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage4]
    ...
    list_page.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        **kwargs
        ...
        return deserialized
    create_page.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum144]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum145]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_page.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}'}  # type: ignore
    ...
    async def get_parent_notebook(
        ...
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum146]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum147]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook'}  # type: ignore
    ...
    async def get_parent_section_group(
        ...
        **kwargs
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum172]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum173]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup'}  # type: ignore
