...
class SiteOnenoteSectionGroupSectionPageOperations(object):
    """SiteOnenoteSectionGroupSectionPageOperations operations.
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum612"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum613"]]]
        **kwargs  # type: Any
    ):
    ...
    def get_parent_section(
        ...
        onenote_section_id,  # type: str
        onenote_page_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum624"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum625"]]]
        **kwargs  # type: Any
    ):
