...
class UserOnenoteSectionParentNotebookSectionGroupOperations(object):
    """UserOnenoteSectionParentNotebookSectionGroupOperations operations.
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1049"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1050"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~notes.models.Enum1049]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1050]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        **kwargs  # type: Any
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1051]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1052]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    def list_section_group(
        ...
        onenote_section_id,  # type: str
        section_group_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1053"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1054"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1055"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup59"]
        ...
        :type orderby: list[str or ~notes.models.Enum1053]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1054]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1055]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup59 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup59]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup59"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup59', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1056]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1057]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    def list_section(
        ...
        onenote_section_id,  # type: str
        section_group_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1058"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1059"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1060"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection58"]
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum1058]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1059]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1060]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection58 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection58]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection58"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection58', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def get_section(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1061"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1062"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteSection"
        """Get sections from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1061]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1062]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
