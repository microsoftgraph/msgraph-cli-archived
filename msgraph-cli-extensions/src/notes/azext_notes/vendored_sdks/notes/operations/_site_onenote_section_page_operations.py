...
class SiteOnenoteSectionPageOperations(object):
    """SiteOnenoteSectionPageOperations operations.
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum650"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum651"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~notes.models.Enum650]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum651]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section(
        ...
        onenote_section_id,  # type: str
        onenote_page_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum676"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum677"]]]
        **kwargs  # type: Any
    ):
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum676]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum677]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    update_parent_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    delete_parent_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
