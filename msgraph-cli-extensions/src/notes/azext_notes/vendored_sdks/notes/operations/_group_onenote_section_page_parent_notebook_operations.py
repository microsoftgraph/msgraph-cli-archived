...
class GroupOnenoteSectionPageParentNotebookOperations(object):
    ...
    def list_section_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup14]
    ...
    delete_section_group.metadata = {'url': '/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    def list_section(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection15]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    delete_section.metadata = {'url': '/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
