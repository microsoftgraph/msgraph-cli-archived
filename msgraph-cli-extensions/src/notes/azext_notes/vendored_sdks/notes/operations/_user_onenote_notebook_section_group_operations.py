...
class UserOnenoteNotebookSectionGroupOperations(object):
    """UserOnenoteNotebookSectionGroupOperations operations.
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Enum742]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum743]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        notebook_id,  # type: str
        section_group_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum744"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum745"]]]
        **kwargs  # type: Any
    ):
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum744]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum745]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    def list_section_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfSectionGroup42"]
        ...
        :type orderby: list[str or ~notes.models.Enum746]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum747]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum748]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup42 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup42]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup42"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup42', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum749]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum750]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    def list_section(
        ...
        notebook_id,  # type: str
        section_group_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum751"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum752"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum753"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection41"]
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum751]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum752]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum753]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection41 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection41]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection41"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection41', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def get_section(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum754]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum755]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}'}  # type: ignore
