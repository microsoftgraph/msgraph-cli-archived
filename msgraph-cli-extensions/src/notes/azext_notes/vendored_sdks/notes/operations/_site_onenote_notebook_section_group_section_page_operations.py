...
class SiteOnenoteNotebookSectionGroupSectionPageOperations(object):
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum397"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum398"]]]
        **kwargs  # type: Any
    ):
    ...
    def get_parent_section(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum400"]]]
        **kwargs  # type: Any
    ):
