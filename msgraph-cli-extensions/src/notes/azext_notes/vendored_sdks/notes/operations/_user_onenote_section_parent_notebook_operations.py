...
class UserOnenoteSectionParentNotebookOperations(object):
    """UserOnenoteSectionParentNotebookOperations operations.
    ...
    def list_section_group(
        ...
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1044"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1045"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1046"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup58"]
        ...
        :type orderby: list[str or ~notes.models.Enum1044]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1045]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1046]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup58 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup58]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup58"]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup58', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1047"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1048"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1047]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1048]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore

    def list_section(
        self,
        user_id,  # type: str
        onenote_section_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1063"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1064"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1065"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection59"]
        ...
        :type onenote_section_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum1063]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1064]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1065]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection59 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection59]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection59"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection59', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections'}  # type: ignore
    ...
    def get_section(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1066"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1067"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteSection"
        """Get sections from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1066]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1067]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
