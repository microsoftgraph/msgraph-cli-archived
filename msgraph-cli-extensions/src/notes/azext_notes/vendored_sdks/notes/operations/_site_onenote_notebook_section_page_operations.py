...
class SiteOnenoteNotebookSectionPageOperations(object):
    """SiteOnenoteNotebookSectionPageOperations operations.
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Enum415]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum416]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section(
        ...
        **kwargs  # type: Any
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum417]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum418]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    update_parent_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    delete_parent_section.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
