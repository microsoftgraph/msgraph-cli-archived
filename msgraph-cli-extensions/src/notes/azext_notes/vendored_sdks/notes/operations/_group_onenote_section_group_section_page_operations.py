...
class GroupOnenoteSectionGroupSectionPageOperations(object):
    """GroupOnenoteSectionGroupSectionPageOperations operations.
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Enum248]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum249]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum261"]]]
        **kwargs  # type: Any
    ):
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum260]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum261]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    update_parent_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    delete_parent_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
