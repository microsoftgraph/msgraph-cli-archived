...
class SiteOnenotePageParentSectionParentNotebookSectionGroupOperations(object):
    """SiteOnenotePageParentSectionParentNotebookSectionGroupOperations operations.
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum517"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum518"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~notes.models.Enum517]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum518]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        onenote_page_id,  # type: str
        section_group_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum519"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum520"]]]
        **kwargs  # type: Any
    ):
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum519]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum520]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    def list_section_group(
        ...
        onenote_page_id,  # type: str
        section_group_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum521"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum522"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum523"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup27"]
        ...
        :type orderby: list[str or ~notes.models.Enum521]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum522]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum523]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup27 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup27]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup27"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup27', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum524"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum525"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum524]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum525]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    def list_section(
        ...
        onenote_page_id,  # type: str
        section_group_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum526"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum527"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum528"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection26"]
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum526]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum527]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum528]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection26 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection26]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection26"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection26', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def get_section(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum529"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum530"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteSection"
        """Get sections from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum529]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum530]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}'}  # type: ignore
