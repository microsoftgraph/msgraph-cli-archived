...
class SiteOnenotePageParentNotebookOperations(object):
    """SiteOnenotePageParentNotebookOperations operations.
    ...
    def list_section_group(
        ...
        orderby=None,  # type: Optional[List[Union[str, "models.Enum447"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum448"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum449"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup23"]
        ...
        :type orderby: list[str or ~notes.models.Enum447]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum448]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum449]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup23 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup23]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup23"]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup23', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum450"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum451"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum450]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum451]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    def list_section(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection24"]
        ...
        :type onenote_page_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum475]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum476]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum477]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection24 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection24]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection24"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection24', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections'}  # type: ignore
    ...
    def get_section(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum478]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum479]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
