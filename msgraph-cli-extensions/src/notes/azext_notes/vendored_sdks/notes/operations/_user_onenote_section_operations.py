...
class UserOnenoteSectionOperations(object):
    """UserOnenoteSectionOperations operations.
    ...
    def list_page(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenotePage25]
    ...
    list_page.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    def create_page(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_page.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    def get_page(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1012"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1013"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenotePage"
        """Get pages from users.
        ...
        return deserialized
    get_page.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    def get_page_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_page_content.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_page_content.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore

    def get_parent_notebook(
        self,
        user_id,  # type: str
        onenote_section_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum1042"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1043"]]]
        **kwargs  # type: Any
    ):
