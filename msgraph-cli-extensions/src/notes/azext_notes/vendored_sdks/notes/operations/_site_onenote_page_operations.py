...
class SiteOnenotePageOperations(object):
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum445"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum446"]]]
        **kwargs  # type: Any
    ):
    ...
    def get_parent_section(
        ...
        site_id,  # type: str
        onenote_page_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum503"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum504"]]]
        **kwargs  # type: Any
    ):
