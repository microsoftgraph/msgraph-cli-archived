...
class SiteOnenoteNotebookOperations(object):
    ...
    def list_section_group(
        ...
        orderby=None,  # type: Optional[List[Union[str, "models.Enum373"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum374"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum375"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup20"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup20]
    ...
    def get_section_group(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum377"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from sites.
    ...
    def list_section(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection21"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection21]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
