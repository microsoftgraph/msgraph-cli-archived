...
class SiteOnenoteSectionParentNotebookSectionGroupOperations(object):
    """SiteOnenoteSectionParentNotebookSectionGroupOperations operations.
    ...
    delete_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
