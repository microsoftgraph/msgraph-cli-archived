...
class GroupOnenoteSectionPageParentNotebookSectionGroupOperations(object):
    """GroupOnenoteSectionPageParentNotebookSectionGroupOperations operations.
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Enum293]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum294]
    ...
    delete_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        **kwargs  # type: Any
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum295]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum296]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section_group.metadata = {'url': '/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    def list_section_group(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~notes.models.Enum297]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum298]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum299]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup15 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup15]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_section_group(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum300]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum301]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_section_group.metadata = {'url': '/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    def list_section(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum304"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection14"]
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum302]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum303]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum304]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection14 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection14]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_section(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum306"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteSection"
        """Get sections from groups.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum305]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum306]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_section.metadata = {'url': '/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
