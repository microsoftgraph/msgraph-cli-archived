...
class SiteOnenoteSectionParentNotebookOperations(object):
    """SiteOnenoteSectionParentNotebookOperations operations.
    ...
    def list_section_group(
        ...
        orderby=None,  # type: Optional[List[Union[str, "models.Enum680"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum681"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum682"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup37"]
        ...
        :type orderby: list[str or ~notes.models.Enum680]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum681]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum682]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup37 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup37]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup37"]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup37', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum683"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum684"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum683]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum684]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore

    def list_section(
        self,
        site_id,  # type: str
        onenote_section_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum699"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum700"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum701"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection38"]
        ...
        :type onenote_section_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum699]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum700]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum701]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection38 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection38]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection38"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection38', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections'}  # type: ignore
    ...
    def get_section(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum702]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum703]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sections/{onenoteSection-id1}'}  # type: ignore
