...
class GroupOnenoteSectionGroupParentNotebookSectionPageOperations(object):
    """GroupOnenoteSectionGroupParentNotebookSectionPageOperations operations.
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Enum223]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum224]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section(
        ...
        **kwargs  # type: Any
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum225]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum226]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    update_parent_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
    ...
    delete_parent_section.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection'}  # type: ignore
