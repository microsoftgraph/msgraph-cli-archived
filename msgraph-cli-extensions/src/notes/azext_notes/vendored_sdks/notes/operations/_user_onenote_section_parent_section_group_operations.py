...
class UserOnenoteSectionParentSectionGroupOperations(object):
    """UserOnenoteSectionParentSectionGroupOperations operations.
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Enum1070]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1071]
        ...
        return deserialized
    get_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentNotebook'}  # type: ignore
    ...
    update_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentNotebook'}  # type: ignore
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        **kwargs  # type: Any
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1082]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1083]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentSectionGroup'}  # type: ignore
    ...
    update_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentSectionGroup'}  # type: ignore
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/parentSectionGroup'}  # type: ignore

    def list_section_group(
        self,
        user_id,  # type: str
        onenote_section_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1084"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1085"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1086"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup61"]
        ...
        :type orderby: list[str or ~notes.models.Enum1084]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1085]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1086]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup61 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup61]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup61"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup61', pipeline_response)
    ...
    list_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sectionGroups'}  # type: ignore
    ...
    def create_section_group(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sectionGroups'}  # type: ignore
    ...
    def get_section_group(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1087"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1088"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1087]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1088]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sectionGroups/{sectionGroup-id}'}  # type: ignore

    def list_section(
        self,
        user_id,  # type: str
        onenote_section_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1089"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1090"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1091"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection61"]
        ...
        :type onenote_section_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum1089]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1090]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1091]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection61 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection61]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection61"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection61', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sections'}  # type: ignore
    ...
    def create_section(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sections'}  # type: ignore
    ...
    def get_section(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1092"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1093"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphOnenoteSection"
        """Get sections from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum1092]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum1093]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup/sections/{onenoteSection-id1}'}  # type: ignore
