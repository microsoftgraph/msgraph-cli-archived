...
class UserOnenotePageParentSectionParentSectionGroupOperations(object):
    """UserOnenotePageParentSectionParentSectionGroupOperations operations.
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum902"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum903"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~notes.models.Enum902]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum903]
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup/parentNotebook'}  # type: ignore

    def get_parent_section_group(
        self,
        user_id,  # type: str
        onenote_page_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum914"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum915"]]]
        **kwargs  # type: Any
    ):
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum914]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum915]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup/parentSectionGroup'}  # type: ignore

    def list_section_group(
        self,
        user_id,  # type: str
        onenote_page_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum916"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum917"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum918"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfSectionGroup50"]
        ...
        :type orderby: list[str or ~notes.models.Enum916]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum917]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum918]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup50 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfSectionGroup50]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSectionGroup50"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSectionGroup50', pipeline_response)
    ...
    def get_section_group(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum919"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum920"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSectionGroup"
        """Get sectionGroups from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum919]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum920]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_section_group.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    def list_section(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection50"]
        ...
        :type onenote_page_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum921]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum922]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum923]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection50 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.CollectionOfOnenoteSection50]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOnenoteSection50"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOnenoteSection50', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    def get_section(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum924]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum925]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~notes.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_section.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentSection/parentSectionGroup/sections/{onenoteSection-id}'}  # type: ignore
