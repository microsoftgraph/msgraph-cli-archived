...
from ._configuration import IdentityProvidersConfiguration
...
class IdentityProviders(object):
    ...
    :vartype identity_provider_identity_provider: identity_providers.operations.IdentityProviderIdentityProviderOperations
