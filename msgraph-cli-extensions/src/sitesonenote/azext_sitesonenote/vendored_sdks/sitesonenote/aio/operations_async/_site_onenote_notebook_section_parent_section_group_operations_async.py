...
class SiteOnenoteNotebookSectionParentSectionGroupOperations:
    ...
    async def get_parent_notebook(
        ...
        **kwargs
        ...
        :type select: list[str or ~sites_one_note.models.Enum59]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites_one_note.models.Enum60]
    ...
    async def get_parent_section_group(
        ...
        **kwargs
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~sites_one_note.models.Enum61]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites_one_note.models.Enum62]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_section_group(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~sites_one_note.models.Enum63]
        :param select: Select properties to be returned.
        :type select: list[str or ~sites_one_note.models.Enum64]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites_one_note.models.Enum65]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup1 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~sites_one_note.models.CollectionOfSectionGroup1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section_group(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~sites_one_note.models.Enum66]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites_one_note.models.Enum67]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~sites_one_note.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_section(
        ...
        **kwargs
        ...
        :type onenote_section_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~sites_one_note.models.Enum68]
        :param select: Select properties to be returned.
        :type select: list[str or ~sites_one_note.models.Enum69]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites_one_note.models.Enum70]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection1 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~sites_one_note.models.CollectionOfOnenoteSection1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~sites_one_note.models.Enum71]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites_one_note.models.Enum72]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~sites_one_note.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
