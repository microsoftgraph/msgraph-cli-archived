...
def analytics_get_activity_statistics(client,
                                      activity_statistics_id,
                                      select=None,
                                      expand=None):
...
def analytics_list_activity_statistics(client,
                                       orderby=None,
                                       select=None,
                                       expand=None):
...
def analytics_get_insight(client,
                          user_id,
                          select=None,
                          expand=None):
...
def analytics_create_trending(client,
                              user_id,
                              id_=None,
                              weight=None,
                              resource_visualization=None,
...
def analytics_create_used(client,
                          user_id,
                          id_=None,
                          last_used=None,
                          resource_visualization=None,
...
def analytics_get_shared(client,
                         user_id,
                         shared_insight_id,
                         select=None,
                         expand=None):
...
def analytics_get_trending(client,
                           user_id,
                           trending_id,
                           select=None,
                           expand=None):
...
def analytics_list_shared(client,
                          user_id,
                          orderby=None,
                          select=None,
                          expand=None):
...
def analytics_list_trending(client,
                            user_id,
                            orderby=None,
                            select=None,
                            expand=None):
...
def analytics_list_used(client,
                        user_id,
                        orderby=None,
                        select=None,
                        expand=None):
...
def analytics_get_resource(client,
                           user_id,
                           shared_insight_id,
                           select=None,
                           expand=None):
