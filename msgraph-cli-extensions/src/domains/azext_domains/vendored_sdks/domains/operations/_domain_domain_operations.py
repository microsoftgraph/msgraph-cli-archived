...
class DomainDomainOperations(object):
    """DomainDomainOperations operations.
    ...
    def list_domain(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfDomain"]
        """Get entities from domains.

        Get entities from domains.

        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_domains.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_domains.models.Get6ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_domains.models.Get7ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDomain or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~identity_domains.models.CollectionOfDomain]
    ...
    def create_domain(
        ...
        authentication_type=None,  # type: Optional[str]
        availability_status=None,  # type: Optional[str]
        is_admin_managed=None,  # type: Optional[bool]
        is_default=None,  # type: Optional[bool]
        is_initial=None,  # type: Optional[bool]
        is_root=None,  # type: Optional[bool]
        is_verified=None,  # type: Optional[bool]
        password_notification_window_in_days=None,  # type: Optional[int]
        password_validity_period_in_days=None,  # type: Optional[int]
        supported_services=None,  # type: Optional[List[str]]
        state=None,  # type: Optional["models.MicrosoftGraphDomainState"]
        service_configuration_records=None,  # type: Optional[List["models.MicrosoftGraphDomainDnsRecord"]]
        verification_dns_records=None,  # type: Optional[List["models.MicrosoftGraphDomainDnsRecord"]]
        domain_name_references=None,  # type: Optional[List["models.MicrosoftGraphDirectoryObject"]]
        **kwargs  # type: Any
    ):
        ...
        :type service_configuration_records: list[~identity_domains.models.MicrosoftGraphDomainDnsRecord]
    ...
    def get_domain(
        ...
        **kwargs  # type: Any
        ...
        :type domain_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_domains.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_domains.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDomain, or the result of cls(response)
        :rtype: ~identity_domains.models.MicrosoftGraphDomain
        :raises: ~azure.core.exceptions.HttpResponseError
