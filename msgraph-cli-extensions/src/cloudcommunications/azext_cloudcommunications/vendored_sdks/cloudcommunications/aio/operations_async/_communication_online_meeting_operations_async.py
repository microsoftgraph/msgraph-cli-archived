...
class CommunicationOnlineMeetingOperations:
    """CommunicationOnlineMeetingOperations async operations.
    ...
    async def create_or_get(
        ...
        **kwargs
        ...
        _body = models.Paths1Pc6SxrCommunicationsOnlinemeetingsMicrosoftGraphCreateorgetPostRequestbodyContentApplicationJsonSchema(chat_info=chat_info, end_date_time=end_date_time, external_id=external_id, start_date_time=start_date_time, subject=subject, attendees=attendees, organizer=organizer)
        ...
        body_content = self._serialize.body(_body, 'Paths1Pc6SxrCommunicationsOnlinemeetingsMicrosoftGraphCreateorgetPostRequestbodyContentApplicationJsonSchema')
