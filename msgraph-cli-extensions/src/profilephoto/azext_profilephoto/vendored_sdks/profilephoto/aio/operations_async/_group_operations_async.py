...
class GroupOperations:
    ...
    :type models: ~groups_profile_photo.models
    ...
    async def get_photo(
        ...
        **kwargs
        ...
        :type select: list[str or ~groups_profile_photo.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphProfilePhoto, or the result of cls(response)
        :rtype: ~groups_profile_photo.models.MicrosoftGraphProfilePhoto
    ...
    def list_photo(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~groups_profile_photo.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_profile_photo.models.Get7ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfProfilePhoto or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_profile_photo.models.CollectionOfProfilePhoto]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_photo.metadata = {'url': '/groups/{group-id}/photos'}  # type: ignore
    ...
    async def create_photo(
        ...
        **kwargs
        ...
        return deserialized
    create_photo.metadata = {'url': '/groups/{group-id}/photos'}  # type: ignore

    async def get_photo(
        self,
        group_id: str,
        profile_photo_id: str,
        select: Optional[List[Union[str, "models.Enum3"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphProfilePhoto":
        """Get photos from groups.
        ...
        :param group_id: key: group-id of group.
        :type group_id: str
        :param profile_photo_id: key: profilePhoto-id of profilePhoto.
        :type profile_photo_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_profile_photo.models.Enum3]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphProfilePhoto, or the result of cls(response)
        ...
        return deserialized
    get_photo.metadata = {'url': '/groups/{group-id}/photos/{profilePhoto-id}'}  # type: ignore
    ...
    update_photo.metadata = {'url': '/groups/{group-id}/photos/{profilePhoto-id}'}  # type: ignore
