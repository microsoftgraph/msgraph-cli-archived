...
class UserOperations:
    ...
    :type models: ~users_profile_photo.models
    ...
    async def get_photo(
        ...
        **kwargs
        ...
        :type select: list[str or ~users_profile_photo.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphProfilePhoto, or the result of cls(response)
        :rtype: ~users_profile_photo.models.MicrosoftGraphProfilePhoto
    ...
    def list_photo(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~users_profile_photo.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_profile_photo.models.Get7ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfProfilePhoto or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users_profile_photo.models.CollectionOfProfilePhoto]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_photo(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_profile_photo.models.Enum3]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphProfilePhoto, or the result of cls(response)
