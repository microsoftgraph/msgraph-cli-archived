...
from azext_personalcontacts.action import (
    ...
    AddEmailAddresses,
    AddExtensions,
    AddPersonalcontactsCreateContactMultiValueExtendedProperties,
    AddPhoto,
    AddPersonalcontactsCreateContactSingleValueExtendedProperties,
    AddPersonalcontactsCreateContactFolderMultiValueExtendedProperties,
    AddPersonalcontactsCreateContactFolderSingleValueExtendedProperties
)
...
def load_arguments(self, _):
    ...
    with self.argument_context('personalcontacts create-contact') as c:
        ...
        c.argument('multi_value_extended_properties',
                   action=AddPersonalcontactsCreateContactMultiValueExtendedProperties, nargs='*', help='The '
        ...
        c.argument('single_value_extended_properties',
                   action=AddPersonalcontactsCreateContactSingleValueExtendedProperties, nargs='*', help='The '
    ...
    with self.argument_context('personalcontacts create-contact-folder') as c:
        ...
        c.argument('multi_value_extended_properties',
                   action=AddPersonalcontactsCreateContactFolderMultiValueExtendedProperties, nargs='*', help='The '
                   'collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.')
        c.argument('single_value_extended_properties',
                   action=AddPersonalcontactsCreateContactFolderSingleValueExtendedProperties, nargs='*', help='The '
