...
def user_user_user_update(client,
                          user_id,
                          body):
...
def user_user_user_delete(client,
                          user_id,
                          if_match=None):
...
def user_user_user_create_user(client,
                               body):
    return client.create_user(body=body)


def user_user_user_get_user(client,
                            user_id,
                            select=None,
                            expand=None):
...
def user_user_user_list_user(client,
                             orderby=None,
                             select=None,
                             expand=None):
...
def user_user_get_presence(client,
                           user_id,
                           select=None,
                           expand=None):
