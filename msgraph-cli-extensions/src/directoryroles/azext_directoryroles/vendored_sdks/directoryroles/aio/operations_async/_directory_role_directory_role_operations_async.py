...
class DirectoryRoleDirectoryRoleOperations:
    """DirectoryRoleDirectoryRoleOperations async operations.
    ...
    def list_directory_role(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfDirectoryRole"]:
        """Get entities from directoryRoles.

        Get entities from directoryRoles.

        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_roles.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_roles.models.Get6ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_directory_roles.models.Get7ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDirectoryRole or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_roles.models.CollectionOfDirectoryRole]
    ...
    async def create_directory_role(
        self,
        ...
        scoped_members: Optional[List["models.MicrosoftGraphScopedRoleMembership"]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphDirectoryRole":
        ...
        :rtype: ~identity_directory_roles.models.MicrosoftGraphDirectoryRole
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphDirectoryRole(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, role_template_id=role_template_id, members=members, scoped_members=scoped_members)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphDirectoryRole')
    ...
    async def get_directory_role(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_roles.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_directory_roles.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDirectoryRole, or the result of cls(response)
        :rtype: ~identity_directory_roles.models.MicrosoftGraphDirectoryRole
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def update_directory_role(
        self,
        directory_role_id: str,
        id: Optional[str] = None,
        deleted_date_time: Optional[datetime.datetime] = None,
    ...
    async def delete_directory_role(
        self,
        directory_role_id: str,
