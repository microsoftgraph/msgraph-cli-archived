...
class DirectoryRoleDirectoryRoleOperations(object):
    """DirectoryRoleDirectoryRoleOperations operations.
    ...
    def list_directory_role(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_roles.models.CollectionOfDirectoryRole]
    ...
    def create_directory_role(
        ...
        role_template_id=None,  # type: Optional[str]
        members=None,  # type: Optional[List["models.MicrosoftGraphDirectoryObject"]]
        scoped_members=None,  # type: Optional[List["models.MicrosoftGraphScopedRoleMembership"]]
        **kwargs  # type: Any
    ):
