...
class UserContactOperations:
    ...
    def list_extension(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~users_contacts.models.Enum39]
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users_contacts.models.CollectionOfExtension0]
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs
        ...
        :type contact_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_contacts.models.Enum40]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_contacts.models.Enum41]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfMultiValueLegacyExtendedProperty1 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users_contacts.models.CollectionOfMultiValueLegacyExtendedProperty1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_multi_value_extended_property(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_contacts.models.Enum42]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    async def get_photo(
        ...
        **kwargs
        ...
        :type contact_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~users_contacts.models.Enum43]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_single_value_extended_property(
        ...
        **kwargs
        ...
        :type contact_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_contacts.models.Enum44]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_contacts.models.Enum45]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty1 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users_contacts.models.CollectionOfSingleValueLegacyExtendedProperty1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_single_value_extended_property(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_contacts.models.Enum46]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
