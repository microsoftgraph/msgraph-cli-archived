...
class UsersContacts(object):
    ...
    :vartype user: users_contacts.operations.UserOperations
    :ivar user_contact_folder: UserContactFolderOperations operations
    :vartype user_contact_folder: users_contacts.operations.UserContactFolderOperations
    :ivar user_contact_folder_contact: UserContactFolderContactOperations operations
    :vartype user_contact_folder_contact: users_contacts.operations.UserContactFolderContactOperations
    :ivar user_contact: UserContactOperations operations
    :vartype user_contact: users_contacts.operations.UserContactOperations
