...
class UserCalendarGroupCalendarCalendarViewCalendarOperations(object):
    ...
    def allowed_calendar_sharing_role(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    allowed_calendar_sharing_role.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/calendarView/{event-id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User=\'{User}\')'}  # type: ignore
