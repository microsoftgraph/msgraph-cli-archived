...
from azext_usersonenote.action import (
    AddResources,
...
def load_arguments(self, _):
    ...
    with self.argument_context('usersonenote update') as c:
    ...
    with self.argument_context('usersonenote get-onenote') as c:
        c.argument('user_id', help='key: user-id of user')
    ...
    with self.argument_context('usersonenote create-notebook') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('self', help='The endpoint where you can get details about the page. Read-only.')
        c.argument('created_date_time', help='The date and time when the page was created. The timestamp represents '
    ...
    with self.argument_context('usersonenote create-operation') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('status', arg_type=get_enum_type(['NotStarted', 'Running', 'Completed', 'Failed']), help='')
    ...
    with self.argument_context('usersonenote create-page') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('body', type=validate_file_or_dict, help='New navigation property Expected value: '
                   'json-string/@json-file.')

    with self.argument_context('usersonenote create-resource') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('self', help='The endpoint where you can get details about the page. Read-only.')
        c.argument('content', help='The content stream')
    ...
    with self.argument_context('usersonenote create-section') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('self', help='The endpoint where you can get details about the page. Read-only.')
        c.argument('created_date_time', help='The date and time when the page was created. The timestamp represents '
    ...
    with self.argument_context('usersonenote create-section-group') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('self', help='The endpoint where you can get details about the page. Read-only.')
        c.argument('created_date_time', help='The date and time when the page was created. The timestamp represents '
    ...
    with self.argument_context('usersonenote get-notebook') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('notebook_id', help='key: notebook-id of notebook')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote get-operation') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('onenote_operation_id', help='key: onenoteOperation-id of onenoteOperation')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote get-page') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('onenote_page_id', help='key: onenotePage-id of onenotePage')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote get-resource') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('onenote_resource_id', help='key: onenoteResource-id of onenoteResource')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote get-section') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('onenote_section_id', help='key: onenoteSection-id of onenoteSection')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote get-section-group') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('section_group_id', help='key: sectionGroup-id of sectionGroup')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote list-notebook') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote list-operation') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote list-page') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote list-resource') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote list-section') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('usersonenote list-section-group') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('usersonenote get-parent-notebook') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('notebook_id', help='key: notebook-id of notebook')
        c.argument('section_group_id', help='key: sectionGroup-id of sectionGroup')
        c.argument('select', nargs='*', help='Select properties to be returned')
    ...
    with self.argument_context('usersonenote get-parent-section-group') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('notebook_id', help='key: notebook-id of notebook')
        c.argument('section_group_id', help='key: sectionGroup-id of sectionGroup')
        c.argument('select', nargs='*', help='Select properties to be returned')
    ...
    with self.argument_context('usersonenote get-parent-section') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('notebook_id', help='key: notebook-id of notebook')
        c.argument('section_group_id', help='key: sectionGroup-id of sectionGroup')
        c.argument('onenote_section_id', help='key: onenoteSection-id of onenoteSection')
