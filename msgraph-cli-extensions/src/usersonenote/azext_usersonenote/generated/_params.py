...
def load_arguments(self, _):
    ...
    with self.argument_context('usersonenote update-onenote') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
    ...
    with self.argument_context('usersonenote update-notebook') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('notebook_id', type=str, help='key: notebook-id of notebook')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('self', type=str, help='The endpoint where you can get details about the page. Read-only.')
    ...
    with self.argument_context('usersonenote update-operation') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('onenote_operation_id', type=str, help='key: onenoteOperation-id of onenoteOperation')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('status', arg_type=get_enum_type(['NotStarted', 'Running', 'Completed', 'Failed']), help='')
    ...
    with self.argument_context('usersonenote update-page') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('onenote_page_id', type=str, help='key: onenotePage-id of onenotePage')
        c.argument('body', type=validate_file_or_dict, help='New navigation property values Expected value: '
                   'json-string/@json-file.')

    with self.argument_context('usersonenote update-resource') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('onenote_resource_id', type=str, help='key: onenoteResource-id of onenoteResource')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('self', type=str, help='The endpoint where you can get details about the page. Read-only.')
    ...
    with self.argument_context('usersonenote update-section') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('onenote_section_id', type=str, help='key: onenoteSection-id of onenoteSection')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('self', type=str, help='The endpoint where you can get details about the page. Read-only.')
    ...
    with self.argument_context('usersonenote update-section-group') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('section_group_id', type=str, help='key: sectionGroup-id of sectionGroup')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('self', type=str, help='The endpoint where you can get details about the page. Read-only.')
    ...
    with self.argument_context('usersonenote update-parent-notebook') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('notebook_id', type=str, help='key: notebook-id of notebook')
        c.argument('section_group_id', type=str, help='key: sectionGroup-id of sectionGroup')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
    ...
    with self.argument_context('usersonenote update-parent-section-group') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('notebook_id', type=str, help='key: notebook-id of notebook')
        c.argument('section_group_id', type=str, help='key: sectionGroup-id of sectionGroup')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
    ...
    with self.argument_context('usersonenote update-parent-section') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('notebook_id', type=str, help='key: notebook-id of notebook')
        c.argument('section_group_id', type=str, help='key: sectionGroup-id of sectionGroup')
        c.argument('onenote_section_id', type=str, help='key: onenoteSection-id of onenoteSection')
