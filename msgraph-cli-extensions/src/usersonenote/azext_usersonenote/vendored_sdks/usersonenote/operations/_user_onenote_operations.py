...
class UserOnenoteOperations(object):
    ...
    def list_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~users_one_note.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Get7ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Get8ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfNotebook or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfNotebook]
    ...
    def get_notebook(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum7]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Get3ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphNotebook, or the result of cls(response)
        :rtype: ~users_one_note.models.MicrosoftGraphNotebook
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_operation(
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_one_note.models.Enum73]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum74]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteOperation or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfOnenoteOperation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_operation(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~users_one_note.models.MicrosoftGraphOnenoteOperation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_operation(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum75]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteOperation, or the result of cls(response)
    ...
    def list_page(
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_one_note.models.Enum76]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum77]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum78]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenotePage1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfOnenotePage1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_page(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum79]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum80]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenotePage, or the result of cls(response)
        :rtype: ~users_one_note.models.MicrosoftGraphOnenotePage
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_resource(
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_one_note.models.Enum198]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum199]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteResource or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfOnenoteResource]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_resource(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~users_one_note.models.MicrosoftGraphOnenoteResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_resource(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum200]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteResource, or the result of cls(response)
    ...
    def list_section_group(
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_one_note.models.Enum201]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum202]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum203]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup9 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfSectionGroup9]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_section_group(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum204]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum205]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~users_one_note.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_section(
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_one_note.models.Enum276]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum277]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum278]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection13 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfOnenoteSection13]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_section(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum279]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum280]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~users_one_note.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
