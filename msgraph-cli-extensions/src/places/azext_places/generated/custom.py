...
def places_place_place_update(client,
                              place_id,
                              id_=None,
                              display_name=None,
...
def places_place_place_delete(client,
                              place_id,
                              if_match=None):
...
def places_place_place_create_place(client,
                                    id_=None,
                                    display_name=None,
                                    geo_coordinates=None,
                                    phone=None,
...
def places_place_place_get_place(client,
                                 place_id,
                                 select=None,
                                 expand=None):
...
def places_place_place_list_place(client,
                                  orderby=None,
                                  select=None,
                                  expand=None):
