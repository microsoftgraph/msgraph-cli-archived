...
class UserOperations:
    ...
    :type models: ~notification.models
    ...
    def list_notification(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~notification.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~notification.models.Get7ItemsItem]
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notification.models.CollectionOfNotification]
    ...
    async def create_notification(
        ...
        **kwargs
        ...
        :rtype: ~notification.models.MicrosoftGraphNotification
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphNotification(id=id, target_host_name=target_host_name, expiration_date_time=expiration_date_time, display_time_to_live=display_time_to_live, priority=priority, group_name=group_name, target_policy=target_policy, raw_content=raw_content, visual_content=visual_content)
    ...
    async def get_notification(
        ...
        **kwargs
        ...
        :param user_id: key: user-id of user.
        :type user_id: str
        :param notification_id: key: notification-id of notification.
        :type notification_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notification.models.Get2ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphNotification, or the result of cls(response)
