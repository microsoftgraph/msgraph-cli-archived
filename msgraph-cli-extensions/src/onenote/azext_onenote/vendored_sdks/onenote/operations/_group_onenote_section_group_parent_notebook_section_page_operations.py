...
class GroupOnenoteSectionGroupParentNotebookSectionPageOperations(object):
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~groups_one_note.models.Enum223]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum224]
    ...
    def get_parent_section(
        ...
        **kwargs  # type: Any
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum225]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum226]
        :keyword callable cls: A custom type or function that will be passed the direct response
