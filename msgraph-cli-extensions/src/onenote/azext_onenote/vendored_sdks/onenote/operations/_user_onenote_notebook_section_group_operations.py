...
class UserOnenoteNotebookSectionGroupOperations(object):
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~users_one_note.models.Enum14]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum15]
    ...
    def get_parent_section_group(
        ...
        **kwargs  # type: Any
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum16]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum17]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_section_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfSectionGroup0"]
        ...
        :type orderby: list[str or ~users_one_note.models.Enum18]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum19]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Get10ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfSectionGroup0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_section_group(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum21]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Get5ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~users_one_note.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_section(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfOnenoteSection"]
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_one_note.models.Enum23]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum24]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum25]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_one_note.models.CollectionOfOnenoteSection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_section(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_one_note.models.Enum26]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_one_note.models.Enum27]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~users_one_note.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
