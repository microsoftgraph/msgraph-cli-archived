...
class GroupOnenoteSectionPageOperations(object):
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~groups_one_note.models.Enum286]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum287]
    ...
    def get_parent_section(
        ...
        **kwargs  # type: Any
        ...
        :type onenote_page_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum312]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum313]
        :keyword callable cls: A custom type or function that will be passed the direct response
