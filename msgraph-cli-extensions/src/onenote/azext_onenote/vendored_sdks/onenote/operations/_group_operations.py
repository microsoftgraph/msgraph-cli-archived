...
class GroupOperations(object):
    ...
    def get_onenote(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~groups_one_note.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenote, or the result of cls(response)
        :rtype: ~groups_one_note.models.MicrosoftGraphOnenote
        ...
        return deserialized
    get_onenote.metadata = {'url': '/groups/{group-id}/onenote'}  # type: ignore
    ...
    update_onenote.metadata = {'url': '/groups/{group-id}/onenote'}  # type: ignore
