...
def load_command_table(self, _):
    ...
    from azext_users.generated._client_factory import cf_user_user
    users_user_user = CliCommandType(
        operations_tmpl='azext_users.vendored_sdks.users.operations._user_user_operations#UserUserOperations.{}',
        client_factory=cf_user_user)
    with self.command_group('users', users_user_user, client_factory=cf_user_user) as g:
    ...
    from azext_users.generated._client_factory import cf_user
    users_user = CliCommandType(
        operations_tmpl='azext_users.vendored_sdks.users.operations._user_operations#UserOperations.{}',
        client_factory=cf_user)
    with self.command_group('users', users_user, client_factory=cf_user) as g:
        g.custom_command('delete', 'users_delete', confirmation=True)
    ...
    users_user_outlook = CliCommandType(
        operations_tmpl='azext_users.vendored_sdks.users.operations._user_outlook_operations#UserOutlookOperations.{}',
        client_factory=cf_user_outlook)
    with self.command_group('users', users_user_outlook, client_factory=cf_user_outlook) as g:
        g.custom_command('delete', 'users_delete', confirmation=True)
    ...
    from azext_users.generated._client_factory import cf_user_setting
    users_user_setting = CliCommandType(
        operations_tmpl='azext_users.vendored_sdks.users.operations._user_setting_operations#UserSettingOperations.{}',
        client_factory=cf_user_setting)
    with self.command_group('users', users_user_setting, client_factory=cf_user_setting) as g:
        g.custom_command('delete', 'users_delete', confirmation=True)
