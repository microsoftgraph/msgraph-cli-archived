...
class UserTodoListOperations:
    """UserTodoListOperations async operations.
    ...
    def list_extension(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users.models.CollectionOfExtension0]
    ...
    def list_task(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfTodoTask"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users.models.CollectionOfTodoTask]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
