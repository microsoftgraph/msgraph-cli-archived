...
class SiteListItemOperations:
    ...
    async def get_drive_item(
        ...
        **kwargs
        ...
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum116]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum117]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_activity_by_interval96_b0(
        ...
        **kwargs
        ...
        return deserialized
    get_activity_by_interval96_b0.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/microsoft.graph.getActivitiesByInterval()'}  # type: ignore
    ...
    async def get_activity_by_interval53_ee(
        ...
        **kwargs
        ...
        return deserialized
    get_activity_by_interval53_ee.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    def list_version(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~sites.models.Enum118]
        :param select: Select properties to be returned.
    ...
    async def get_version(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum121]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum122]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphListItemVersion, or the result of cls(response)
        :rtype: ~sites.models.MicrosoftGraphListItemVersion
        :raises: ~azure.core.exceptions.HttpResponseError
