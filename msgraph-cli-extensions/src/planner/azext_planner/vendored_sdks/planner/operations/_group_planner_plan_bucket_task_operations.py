...
class GroupPlannerPlanBucketTaskOperations(object):
    ...
    def get_assigned_to_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~groups_planner.models.Enum18]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerAssignedToTaskBoardTaskFormat, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerAssignedToTaskBoardTaskFormat
    ...
    def get_bucket_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum19]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerBucketTaskBoardTaskFormat, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerBucketTaskBoardTaskFormat
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_detail(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum20]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerTaskDetails, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerTaskDetails
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update_detail(
        ...
        **kwargs  # type: Any
        ...
        :param preview_type: plannerPreviewType.
    ...
    def get_progress_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum21]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerProgressTaskBoardTaskFormat, or the result of cls(response)
        :rtype: ~groups_planner.models.MicrosoftGraphPlannerProgressTaskBoardTaskFormat
        :raises: ~azure.core.exceptions.HttpResponseError
        """
