...
class GroupPlannerPlanTaskOperations(object):
    ...
    def get_assigned_to_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~groups_planner.models.Enum28]
    ...
    def get_bucket_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum29]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_detail(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum30]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_progress_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_planner.models.Enum31]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
