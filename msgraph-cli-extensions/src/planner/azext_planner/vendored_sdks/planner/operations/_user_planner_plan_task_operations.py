...
class UserPlannerPlanTaskOperations(object):
    ...
    def get_assigned_to_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~users_planner.models.Enum34]
    ...
    def get_bucket_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~users_planner.models.Enum35]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_detail(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~users_planner.models.Enum36]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_progress_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~users_planner.models.Enum37]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
