...
def planner_user_planner_update(client,
                                user_id,
...
def planner_user_planner_get_favorite_plan(client,
                                           user_id,
                                           planner_plan_id,
                                           select=None,
                                           expand=None):
...
def planner_user_planner_get_recent_plan(client,
                                         user_id,
                                         planner_plan_id,
                                         select=None,
                                         expand=None):
...
def planner_user_planner_plan_update(client,
                                     user_id,
                                     planner_plan_id,
    ...
    if user_id is not None and planner_plan_id is not None and planner_bucket_id is not None:
        return client.update_bucket(user_id=user_id,
                                    ...
                                    tasks=tasks)
    elif user_id is not None and planner_plan_id is not None and planner_task_id is not None and body is not None:
        return client.update_task(user_id=user_id,
                                  planner_plan_id=planner_plan_id,
                                  planner_task_id=planner_task_id,
                                  body=body)
...
def planner_user_planner_plan_bucket_update(client,
                                            user_id,
                                            planner_plan_id,
                                            planner_bucket_id,
                                            planner_task_id,
...
def planner_user_planner_plan_bucket_task_update(client,
                                                 user_id,
                                                 planner_plan_id,
                                                 planner_bucket_id,
                                                 planner_task_id,
...
def planner_user_planner_plan_task_update(client,
                                          user_id,
                                          planner_plan_id,
                                          planner_task_id,
                                          id_=None,
...
def planner_user_planner_task_update(client,
                                     user_id,
                                     planner_task_id,
                                     id_=None,
                                     unassigned_order_hint=None,
