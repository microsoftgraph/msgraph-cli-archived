...
class UserOperations:
    ...
    :type models: ~users_devices.models
    ...
    def list_device(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~users_devices.models.Get6ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_devices.models.Get7ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_devices.models.Get8ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDevice or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users_devices.models.CollectionOfDevice]
    ...
    async def create_device(
        ...
        **kwargs
        ...
        :rtype: ~users_devices.models.MicrosoftGraphDevice
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_device(
        ...
        **kwargs
        ...
        :type device_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~users_devices.models.Get2ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_devices.models.Get3ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDevice, or the result of cls(response)
        :rtype: ~users_devices.models.MicrosoftGraphDevice
        :raises: ~azure.core.exceptions.HttpResponseError
