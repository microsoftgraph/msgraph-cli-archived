...
class DeviceDeviceOperations:
    ...
    def list_device(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~identity_devices.models.Get5ItemsItem]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_devices.models.Get6ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_devices.models.Get7ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDevice or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_devices.models.CollectionOfDevice]
    ...
    async def create_device(
        ...
        **kwargs
        ...
        :type alternative_security_ids: list[~identity_devices.models.MicrosoftGraphAlternativeSecurityId]
        ...
        :type member_of: list[~identity_devices.models.MicrosoftGraphDirectoryObject]
        ...
        :type registered_owners: list[~identity_devices.models.MicrosoftGraphDirectoryObject]
        ...
        :type registered_users: list[~identity_devices.models.MicrosoftGraphDirectoryObject]
        :param transitive_member_of:
        :type transitive_member_of: list[~identity_devices.models.MicrosoftGraphDirectoryObject]
        :param extensions: The collection of open extensions defined for the device. Read-only.
         Nullable.
        :type extensions: list[~identity_devices.models.MicrosoftGraphEntity]
        :param commands:
        :type commands: list[~identity_devices.models.MicrosoftGraphCommand]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDevice, or the result of cls(response)
        :rtype: ~identity_devices.models.MicrosoftGraphDevice
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphDevice(id=id, deleted_date_time=deleted_date_time, account_enabled=account_enabled, alternative_security_ids=alternative_security_ids, approximate_last_sign_in_date_time=approximate_last_sign_in_date_time, compliance_expiration_date_time=compliance_expiration_date_time, device_id=device_id, device_metadata=device_metadata, device_version=device_version, display_name=display_name, is_compliant=is_compliant, is_managed=is_managed, on_premises_last_sync_date_time=on_premises_last_sync_date_time, on_premises_sync_enabled=on_premises_sync_enabled, operating_system=operating_system, operating_system_version=operating_system_version, physical_ids=physical_ids, profile_type=profile_type, system_labels=system_labels, trust_type=trust_type, name=name, manufacturer=manufacturer, model=model, kind=kind, status=status, platform=platform, member_of=member_of, registered_owners=registered_owners, registered_users=registered_users, transitive_member_of=transitive_member_of, extensions=extensions, commands=commands)
    ...
    async def get_device(
        ...
        **kwargs
        ...
        :type device_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_devices.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_devices.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDevice, or the result of cls(response)
        :rtype: ~identity_devices.models.MicrosoftGraphDevice
        :raises: ~azure.core.exceptions.HttpResponseError
