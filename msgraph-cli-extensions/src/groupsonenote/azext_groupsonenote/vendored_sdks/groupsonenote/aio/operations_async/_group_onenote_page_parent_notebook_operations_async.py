...
class GroupOnenotePageParentNotebookOperations:
    """GroupOnenotePageParentNotebookOperations async operations.
    ...
    def list_section_group(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSectionGroup2"]:
        ...
        :type orderby: list[str or ~groups_one_note.models.Enum83]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum84]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum85]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup2 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_one_note.models.CollectionOfSectionGroup2]
    ...
    list_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    async def create_section_group(
        ...
        **kwargs
        ...
        return deserialized
    create_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups'}  # type: ignore
    ...
    async def get_section_group(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum86]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum87]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~groups_one_note.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    update_section_group.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}'}  # type: ignore
    ...
    def list_section(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenoteSection3"]:
        ...
        :type onenote_page_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~groups_one_note.models.Enum111]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum112]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum113]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection3 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_one_note.models.CollectionOfOnenoteSection3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_section.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections'}  # type: ignore
    ...
    async def create_section(
        ...
        **kwargs
        ...
        return deserialized
    create_section.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections'}  # type: ignore
    ...
    async def get_section(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum114]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum115]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~groups_one_note.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
    ...
    update_section.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}'}  # type: ignore
