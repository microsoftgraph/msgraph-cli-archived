...
class GroupOnenotePageParentSectionParentNotebookSectionGroupOperations:
    ...
    async def get_parent_notebook(
        ...
        **kwargs
        ...
        :type select: list[str or ~groups_one_note.models.Enum153]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum154]
    ...
    async def get_parent_section_group(
        ...
        **kwargs
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum155]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum156]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_section_group(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~groups_one_note.models.Enum157]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum158]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum159]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSectionGroup6 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_one_note.models.CollectionOfSectionGroup6]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section_group(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum160]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum161]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSectionGroup, or the result of cls(response)
        :rtype: ~groups_one_note.models.MicrosoftGraphSectionGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_section(
        ...
        **kwargs
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~groups_one_note.models.Enum162]
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum163]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum164]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOnenoteSection5 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~groups_one_note.models.CollectionOfOnenoteSection5]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_section(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~groups_one_note.models.Enum165]
        :param expand: Expand related entities.
        :type expand: list[str or ~groups_one_note.models.Enum166]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOnenoteSection, or the result of cls(response)
        :rtype: ~groups_one_note.models.MicrosoftGraphOnenoteSection
        :raises: ~azure.core.exceptions.HttpResponseError
