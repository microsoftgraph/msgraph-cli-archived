...
def load_command_table(self, _):
    ...
    with self.command_group('mail', mail_user, client_factory=cf_user) as g:
    ...
    with self.command_group('mail', mail_user_inference_classification,
    ...
    with self.command_group('mail', mail_user_mail_folder, client_factory=cf_user_mail_folder) as g:
        g.custom_command('delete', 'mail_delete', confirmation=True)
    ...
    with self.command_group('mail', mail_user_mail_folder_message, client_factory=cf_user_mail_folder_message) as g:
        g.custom_command('delete', 'mail_delete', confirmation=True)
    ...
    with self.command_group('mail', mail_user_message, client_factory=cf_user_message) as g:
        g.custom_command('delete', 'mail_delete', confirmation=True)
        g.custom_command('create-attachment', 'mail_create_attachment')
        g.custom_command('create-extension', 'mail_create_extension')
        g.custom_command('create-multi-value-extended-property', 'mail_create_multi_value_extended_property')
