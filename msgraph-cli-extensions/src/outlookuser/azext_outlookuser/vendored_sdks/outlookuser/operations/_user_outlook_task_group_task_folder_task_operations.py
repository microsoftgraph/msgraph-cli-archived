...
class UserOutlookTaskGroupTaskFolderTaskOperations(object):
    ...
    def list_attachment(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~users_outlook_user.models.Enum60]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum61]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~users_outlook_user.models.CollectionOfAttachment0]
    ...
    def get_attachment(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum62]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_outlook_user.models.Enum63]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum64]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfMultiValueLegacyExtendedProperty2 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_outlook_user.models.CollectionOfMultiValueLegacyExtendedProperty2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum65]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_outlook_user.models.Enum66]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum67]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty2 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_outlook_user.models.CollectionOfSingleValueLegacyExtendedProperty2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum68]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
