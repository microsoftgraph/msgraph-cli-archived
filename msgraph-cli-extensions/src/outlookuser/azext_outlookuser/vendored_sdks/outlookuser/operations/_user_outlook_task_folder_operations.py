...
class UserOutlookTaskFolderOperations(object):
    """UserOutlookTaskFolderOperations operations.
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~users_outlook_user.models.Enum19]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum20]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~users_outlook_user.models.CollectionOfMultiValueLegacyExtendedProperty]
    ...
    list_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties'}  # type: ignore
    ...
    def create_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties'}  # type: ignore
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum21]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
        ...
        return deserialized
    get_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    update_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_outlook_user.models.Enum22]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum23]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_outlook_user.models.CollectionOfSingleValueLegacyExtendedProperty]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/singleValueExtendedProperties'}  # type: ignore
    ...
    def create_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/singleValueExtendedProperties'}  # type: ignore
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum24]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
        ...
        return deserialized
    get_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    update_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_task(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum27"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfOutlookTask"]
        ...
        :type outlook_task_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users_outlook_user.models.Enum25]
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum26]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_outlook_user.models.Enum27]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOutlookTask or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users_outlook_user.models.CollectionOfOutlookTask]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfOutlookTask"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfOutlookTask', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_task.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks'}  # type: ignore
    ...
    def create_task(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_task.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks'}  # type: ignore
    ...
    def get_task(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users_outlook_user.models.Enum28]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_outlook_user.models.Enum29]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOutlookTask, or the result of cls(response)
        :rtype: ~users_outlook_user.models.MicrosoftGraphOutlookTask
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_task.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}'}  # type: ignore
    ...
    update_task.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}'}  # type: ignore
