...
class UserOperations:
    ...
    async def get_outlook(
        ...
        **kwargs
        ...
        :type select: list[str or ~users_outlook_user.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~users_outlook_user.models.Get2ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOutlookUser, or the result of cls(response)
        :rtype: ~users_outlook_user.models.MicrosoftGraphOutlookUser
    ...
    async def update_outlook(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphOutlookUser(id=id, master_categories=master_categories, task_groups=task_groups, task_folders=task_folders, tasks=tasks)
