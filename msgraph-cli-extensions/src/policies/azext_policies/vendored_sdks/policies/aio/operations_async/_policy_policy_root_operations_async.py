...
class PolicyPolicyRootOperations:
    ...
    async def update_policy_root(
        ...
        activity_based_timeout_policies: Optional[List["models.MicrosoftGraphStsPolicy"]] = None,
        claims_mapping_policies: Optional[List["models.MicrosoftGraphStsPolicy"]] = None,
        home_realm_discovery_policies: Optional[List["models.MicrosoftGraphStsPolicy"]] = None,
        token_issuance_policies: Optional[List["models.MicrosoftGraphStsPolicy"]] = None,
        token_lifetime_policies: Optional[List["models.MicrosoftGraphStsPolicy"]] = None,
