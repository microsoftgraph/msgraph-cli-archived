...
def load_command_table(self, _):
    ...
    from azext_changenotifications.generated._client_factory import cf_subscription_subscription
    changenotifications_subscription_subscription = CliCommandType(
        operations_tmpl='azext_changenotifications.vendored_sdks.changenotifications.operations._subscription_subscript'
        'ion_operations#SubscriptionSubscriptionOperations.{}',
        client_factory=cf_subscription_subscription)
    with self.command_group('changenotifications', changenotifications_subscription_subscription,
