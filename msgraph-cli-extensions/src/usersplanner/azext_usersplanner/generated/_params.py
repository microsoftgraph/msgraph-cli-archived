...
def load_arguments(self, _):
    ...
    with self.argument_context('usersplanner update-planner') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
    ...
    with self.argument_context('usersplanner get-all') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_delta_id', type=str, help='key: plannerDelta-id of plannerDelta')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('usersplanner update-all') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_delta_id', type=str, help='key: plannerDelta-id of plannerDelta')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')

    with self.argument_context('usersplanner update-plan') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_plan_id', type=str, help='key: plannerPlan-id of plannerPlan')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('created_date_time', help='Read-only. Date and time at which the plan is created. The Timestamp '
    ...
    with self.argument_context('usersplanner update-task') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_task_id', type=str, help='key: plannerTask-id of plannerTask')
    ...
    with self.argument_context('usersplanner update-bucket') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_plan_id', type=str, help='key: plannerPlan-id of plannerPlan')
        c.argument('planner_bucket_id', type=str, help='key: plannerBucket-id of plannerBucket')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
    ...
    with self.argument_context('usersplanner update-detail') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_plan_id', type=str, help='key: plannerPlan-id of plannerPlan')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
    ...
    with self.argument_context('usersplanner update-assigned-to-task-board-format') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_plan_id', type=str, help='key: plannerPlan-id of plannerPlan')
        c.argument('planner_bucket_id', type=str, help='key: plannerBucket-id of plannerBucket')
        c.argument('planner_task_id', type=str, help='key: plannerTask-id of plannerTask')
    ...
    with self.argument_context('usersplanner update-bucket-task-board-format') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_plan_id', type=str, help='key: plannerPlan-id of plannerPlan')
        c.argument('planner_bucket_id', type=str, help='key: plannerBucket-id of plannerBucket')
        c.argument('planner_task_id', type=str, help='key: plannerTask-id of plannerTask')
    ...
    with self.argument_context('usersplanner update-progress-task-board-format') as c:
        c.argument('user_id', type=str, help='key: user-id of user')
        c.argument('planner_plan_id', type=str, help='key: plannerPlan-id of plannerPlan')
        c.argument('planner_bucket_id', type=str, help='key: plannerBucket-id of plannerBucket')
        c.argument('planner_task_id', type=str, help='key: plannerTask-id of plannerTask')
