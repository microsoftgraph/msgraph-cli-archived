...
def contacts_user_update(client,
                         user_id,
...
def contacts_user_create_contact(client,
                                 user_id,
                                 body):
...
def contacts_user_create_contact_folder(client,
                                        user_id,
                                        id_=None,
                                        parent_folder_id=None,
                                        display_name=None,
...
def contacts_user_get_contact(client,
                              user_id,
                              contact_id,
                              select=None,
                              expand=None):
...
def contacts_user_get_contact_folder(client,
                                     user_id,
                                     contact_folder_id,
                                     select=None,
                                     expand=None):
...
def contacts_user_list_contact(client,
                               user_id,
                               orderby=None,
                               select=None,
                               expand=None):
...
def contacts_user_list_contact_folder(client,
                                      user_id,
                                      orderby=None,
                                      select=None,
                                      expand=None):
...
def contacts_user_contact_folder_update(client,
                                        user_id,
                                        contact_folder_id,
...
def contacts_user_contact_folder_create_child_folder(client,
                                                     user_id,
                                                     contact_folder_id,
                                                     id_=None,
                                                     parent_folder_id=None,
...
def contacts_user_contact_folder_create_contact(client,
                                                user_id,
                                                contact_folder_id,
                                                body):
    return client.create_contact(user_id=user_id,
...
def contacts_user_contact_folder_create_multi_value_extended_property(client,
                                                                      user_id,
                                                                      contact_folder_id,
                                                                      id_=None,
                                                                      value=None):
...
def contacts_user_contact_folder_create_single_value_extended_property(client,
                                                                       user_id,
                                                                       contact_folder_id,
                                                                       id_=None,
                                                                       value=None):
...
def contacts_user_contact_folder_get_child_folder(client,
                                                  user_id,
                                                  contact_folder_id,
                                                  contact_folder_id1,
                                                  select=None,
...
def contacts_user_contact_folder_get_contact(client,
                                             user_id,
                                             contact_folder_id,
                                             contact_id,
                                             select=None,
...
def contacts_user_contact_folder_get_multi_value_extended_property(client,
                                                                   user_id,
                                                                   contact_folder_id,
...
def contacts_user_contact_folder_get_single_value_extended_property(client,
                                                                    user_id,
                                                                    contact_folder_id,
...
def contacts_user_contact_folder_list_child_folder(client,
                                                   user_id,
                                                   contact_folder_id,
                                                   orderby=None,
                                                   select=None,
...
def contacts_user_contact_folder_list_contact(client,
                                              user_id,
                                              contact_folder_id,
                                              orderby=None,
                                              select=None,
...
def contacts_user_contact_folder_list_multi_value_extended_property(client,
                                                                    user_id,
                                                                    contact_folder_id,
                                                                    orderby=None,
                                                                    select=None,
...
def contacts_user_contact_folder_list_single_value_extended_property(client,
                                                                     user_id,
                                                                     contact_folder_id,
                                                                     orderby=None,
                                                                     select=None,
...
def contacts_user_contact_folder_contact_update(client,
                                                user_id,
                                                contact_folder_id,
                                                contact_id,
                                                extension_id=None,
...
def contacts_user_contact_folder_contact_create_extension(client,
                                                          user_id,
                                                          contact_folder_id,
                                                          contact_id,
                                                          id_=None):
...
def contacts_user_contact_folder_contact_create_multi_value_extended_property(client,
                                                                              user_id,
                                                                              contact_folder_id,
                                                                              contact_id,
                                                                              id_=None,
...
def contacts_user_contact_folder_contact_create_single_value_extended_property(client,
                                                                               user_id,
                                                                               contact_folder_id,
                                                                               contact_id,
                                                                               id_=None,
...
def contacts_user_contact_folder_contact_get_extension(client,
                                                       user_id,
                                                       contact_folder_id,
                                                       contact_id,
                                                       extension_id,
...
def contacts_user_contact_folder_contact_get_multi_value_extended_property(client,
                                                                           user_id,
                                                                           contact_folder_id,
                                                                           contact_id,
                                                                           multi_value_legacy_extended_property_id,
...
def contacts_user_contact_folder_contact_get_photo(client,
                                                   user_id,
                                                   contact_folder_id,
                                                   contact_id,
                                                   select=None,
...
def contacts_user_contact_folder_contact_get_single_value_extended_property(client,
                                                                            user_id,
                                                                            contact_folder_id,
                                                                            contact_id,
                                                                            single_value_legacy_extended_property_id,
...
def contacts_user_contact_folder_contact_list_extension(client,
                                                        user_id,
                                                        contact_folder_id,
                                                        contact_id,
                                                        orderby=None,
...
def contacts_user_contact_folder_contact_list_multi_value_extended_property(client,
                                                                            user_id,
                                                                            contact_folder_id,
                                                                            contact_id,
                                                                            orderby=None,
...
def contacts_user_contact_folder_contact_list_single_value_extended_property(client,
                                                                             user_id,
                                                                             contact_folder_id,
                                                                             contact_id,
                                                                             orderby=None,
...
def contacts_user_contact_update(client,
                                 user_id,
                                 contact_id,
                                 extension_id=None,
                                 id_=None,
...
def contacts_user_contact_create_extension(client,
                                           user_id,
                                           contact_id,
                                           id_=None):
    return client.create_extension(user_id=user_id,
...
def contacts_user_contact_create_multi_value_extended_property(client,
                                                               user_id,
                                                               contact_id,
                                                               id_=None,
                                                               value=None):
...
def contacts_user_contact_create_single_value_extended_property(client,
                                                                user_id,
                                                                contact_id,
                                                                id_=None,
                                                                value=None):
...
def contacts_user_contact_get_extension(client,
                                        user_id,
                                        contact_id,
                                        extension_id,
                                        select=None,
...
def contacts_user_contact_get_multi_value_extended_property(client,
                                                            user_id,
                                                            contact_id,
                                                            multi_value_legacy_extended_property_id,
                                                            select=None,
...
def contacts_user_contact_get_photo(client,
                                    user_id,
                                    contact_id,
                                    select=None,
                                    expand=None):
...
def contacts_user_contact_get_single_value_extended_property(client,
                                                             user_id,
                                                             contact_id,
                                                             single_value_legacy_extended_property_id,
                                                             select=None,
...
def contacts_user_contact_list_extension(client,
                                         user_id,
                                         contact_id,
                                         orderby=None,
                                         select=None,
...
def contacts_user_contact_list_multi_value_extended_property(client,
                                                             user_id,
                                                             contact_id,
                                                             orderby=None,
                                                             select=None,
...
def contacts_user_contact_list_single_value_extended_property(client,
                                                              user_id,
                                                              contact_id,
                                                              orderby=None,
                                                              select=None,
