...
class UsersContacts(object):
    ...
    :vartype user: users_contacts.aio.operations_async.UserOperations
    :ivar user_contact_folder: UserContactFolderOperations operations
    :vartype user_contact_folder: users_contacts.aio.operations_async.UserContactFolderOperations
    :ivar user_contact_folder_contact: UserContactFolderContactOperations operations
    :vartype user_contact_folder_contact: users_contacts.aio.operations_async.UserContactFolderContactOperations
    :ivar user_contact: UserContactOperations operations
    :vartype user_contact: users_contacts.aio.operations_async.UserContactOperations
