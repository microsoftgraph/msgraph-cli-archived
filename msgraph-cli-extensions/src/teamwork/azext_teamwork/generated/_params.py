...
from azext_teamwork.action import (
...
def load_arguments(self, _):
    ...
    with self.argument_context('teamwork user update') as c:
    ...
    with self.argument_context('teamwork user get-teamwork') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('teamwork user-teamwork update') as c:
        c.argument('user_id', help='key: user-id of user')
    ...
    with self.argument_context('teamwork user-teamwork create-installed-app') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('id_', options_list=['--id'], help='Read-only.')
        c.argument('teams_app_definition', action=AddTeamsAppDefinition, nargs='*', help='teamsAppDefinition')
        c.argument('teams_app_id', help='Read-only.')
    ...
    with self.argument_context('teamwork user-teamwork get-installed-app') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('teams_app_installation_id', help='key: teamsAppInstallation-id of teamsAppInstallation')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('teamwork user-teamwork list-installed-app') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('teamwork user-teamwork-installed-app get-team-app') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('teams_app_installation_id', help='key: teamsAppInstallation-id of teamsAppInstallation')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('teamwork user-teamwork-installed-app get-team-app-definition') as c:
        c.argument('user_id', help='key: user-id of user')
        c.argument('teams_app_installation_id', help='key: teamsAppInstallation-id of teamsAppInstallation')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
