...
class CollectionOfLinksOfEducationClass(msrest.serialization.Model):
    """Collection of links of educationClass.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationClass, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationClass0(msrest.serialization.Model):
    """Collection of links of educationClass.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationClass0, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationClass1(msrest.serialization.Model):
    """Collection of links of educationClass.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationClass1, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationSchool(msrest.serialization.Model):
    """Collection of links of educationSchool.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationSchool, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationSchool0(msrest.serialization.Model):
    """Collection of links of educationSchool.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationSchool0, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationSchool1(msrest.serialization.Model):
    """Collection of links of educationSchool.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationSchool1, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationUser(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationUser, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationUser0(msrest.serialization.Model):
    """Collection of links of educationUser.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationUser0, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)


class CollectionOfLinksOfEducationUser1(msrest.serialization.Model):
    """Collection of links of educationUser.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CollectionOfLinksOfEducationUser1, self).__init__(**kwargs)
        self.additional_properties = kwargs.get('additional_properties', None)
        self.value = kwargs.get('value', None)
        self.odata_next_link = kwargs.get('odata_next_link', None)
...
class MicrosoftGraphChatMessage(MicrosoftGraphEntity):
    ...
    :type hosted_contents: list[~education.models.MicrosoftGraphChatMessageHostedContent]
    :param replies:
...
class MicrosoftGraphContact(MicrosoftGraphOutlookItem):
    ...
    :type business_address: ~education.models.MicrosoftGraphPhysicalAddress
    ...
    :type email_addresses: list[~education.models.MicrosoftGraphEmailAddress]
    ...
    :type home_address: ~education.models.MicrosoftGraphPhysicalAddress
    ...
    :type other_address: ~education.models.MicrosoftGraphPhysicalAddress
...
class MicrosoftGraphGroup(MicrosoftGraphDirectoryObject):
    ...
    :type settings: list[~education.models.MicrosoftGraphGroupSetting]
...
class MicrosoftGraphListItem(MicrosoftGraphBaseItem):
    ...
    :type fields: ~education.models.MicrosoftGraphFieldValueSet
...
class MicrosoftGraphPerson(MicrosoftGraphEntity):
    ...
    :type person_type: ~education.models.MicrosoftGraphPersonType
    ...
    :type scored_email_addresses: list[~education.models.MicrosoftGraphScoredEmailAddress]
...
class MicrosoftGraphPublicError(msrest.serialization.Model):
    ...
    :type code: str
    :param details:
    :type details: list[~education.models.MicrosoftGraphPublicErrorDetail]
    :param inner_error: publicInnerError.
    :type inner_error: ~education.models.MicrosoftGraphPublicInnerError
    :param message:
    :type message: str
    :param target:
    :type target: str
...
class MicrosoftGraphScopedRoleMembership(MicrosoftGraphEntity):
    ...
    :type role_member_info: ~education.models.MicrosoftGraphIdentity
    """
...
class MicrosoftGraphScoredEmailAddress(msrest.serialization.Model):
    ...
    :type selection_likelihood: str or ~education.models.MicrosoftGraphSelectionLikelihoodInfo
    """
...
class MicrosoftGraphSite(MicrosoftGraphBaseItem):
    ...
    :type error: ~education.models.MicrosoftGraphPublicError
    :param root: root.
    :type root: dict[str, object]
    :param sharepoint_ids: sharepointIds.
    :type sharepoint_ids: ~education.models.MicrosoftGraphSharepointIds
...
class MicrosoftGraphTeam(MicrosoftGraphEntity):
    ...
    :type template: ~education.models.MicrosoftGraphTeamsTemplate
    """
...
class MicrosoftGraphTodo(MicrosoftGraphEntity):
    ...
    :type additional_properties: dict[str, object]
    :param lists:
    :type lists: list[~education.models.MicrosoftGraphTodoTaskList]
    """
...
class MicrosoftGraphTodoTask(MicrosoftGraphEntity):
    ...
    :type linked_resources: list[~education.models.MicrosoftGraphLinkedResource]
    """
...
class MicrosoftGraphTodoTaskList(MicrosoftGraphEntity):
    ...
    :param wellknown_list_name:  Possible values include: "none", "defaultList", "flaggedEmails",
     "unknownFutureValue".
    :type wellknown_list_name: str or ~education.models.MicrosoftGraphWellknownListName
    :param extensions:
    :type extensions: list[~education.models.MicrosoftGraphExtension]
    :param tasks:
    :type tasks: list[~education.models.MicrosoftGraphTodoTask]
    """
...
class MicrosoftGraphUser(MicrosoftGraphDirectoryObject):
    ...
    :type oauth2_permission_grants: list[~education.models.MicrosoftGraphOAuth2PermissionGrant]
    ...
    :param todo: todo.
    :type todo: ~education.models.MicrosoftGraphTodo
    """
...
class MicrosoftGraphUserScopeTeamsAppInstallation(MicrosoftGraphTeamsAppInstallation):
    ...
    :type additional_properties: dict[str, object]
    :param chat: chat.
    :type chat: ~education.models.MicrosoftGraphChat
    """
...
class MicrosoftGraphUserTeamwork(MicrosoftGraphEntity):
    ...
    :type installed_apps: list[~education.models.MicrosoftGraphUserScopeTeamsAppInstallation]
    """
...
class MicrosoftGraphWorkbook(MicrosoftGraphEntity):
    ...
    :type functions: ~education.models.MicrosoftGraphWorkbookFunctions
    ...
    :type operations: list[~education.models.MicrosoftGraphWorkbookOperation]
...
class MicrosoftGraphWorkbookChartAreaFormat(MicrosoftGraphEntity):
    ...
    :type fill: ~education.models.MicrosoftGraphWorkbookChartFill
...
class MicrosoftGraphWorkbookOperation(MicrosoftGraphEntity):
    ...
    :type error: ~education.models.MicrosoftGraphWorkbookOperationError
    ...
    :type status: str or ~education.models.MicrosoftGraphWorkbookOperationStatus
    """
...
class MicrosoftGraphWorkbookOperationError(msrest.serialization.Model):
    ...
    :type inner_error: ~education.models.MicrosoftGraphWorkbookOperationError
    :param message: The error message.
    :type message: str
    """
