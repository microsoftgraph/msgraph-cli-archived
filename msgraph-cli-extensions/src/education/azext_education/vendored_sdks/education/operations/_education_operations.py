...
class EducationOperations(object):
    ...
    def create_class(
        ...
        **kwargs  # type: Any
        ...
        :param external_source: educationExternalSource.
    ...
    def create_synchronization_profile(
        ...
        id=None,  # type: Optional[str]
        display_name=None,  # type: Optional[str]
        data_provider=None,  # type: Optional[object]
        identity_synchronization_configuration=None,  # type: Optional[object]
        ...
        **kwargs  # type: Any
        ...
        :param state: educationSynchronizationProfileState.
