...
class EducationRootOperations:
    """EducationRootOperations async operations.
    ...
    async def update_education_root(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphEducationRoot(id=id, synchronization_profiles=synchronization_profiles, classes=classes, schools=schools, users=users, me=me)
