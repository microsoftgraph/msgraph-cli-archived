...
### devicescorporatemanagement create-assignment
...
### devicescorporatemanagement create-intended-policy
...
### devicescorporatemanagement create-mdm-window-information-protection-policy

create-mdm-window-information-protection-policy a devicescorporatemanagement.
...
### devicescorporatemanagement create-ref-managed-app-registration
...
### devicescorporatemanagement create-window-information-protection-policy

create-window-information-protection-policy a devicescorporatemanagement.
...
### devicescorporatemanagement get-android-managed-app-protection
...
get-applied-policy a devicescorporatemanagement.
...
get-default-managed-app-protection a devicescorporatemanagement.
...
### devicescorporatemanagement get-managed-app-policy
...
### devicescorporatemanagement get-operation
...
get-user-id-with-flagged-app-registration a devicescorporatemanagement.
...
### devicescorporatemanagement list-app
...
### devicescorporatemanagement list-assignment
...
### devicescorporatemanagement list-default-managed-app-protection
...
### devicescorporatemanagement list-device-configuration-state
...
### devicescorporatemanagement list-device-state
...
### devicescorporatemanagement list-intended-policy
...
list-managed-app-policy a devicescorporatemanagement.
...
### devicescorporatemanagement list-managed-app-statuses

list-managed-app-statuses a devicescorporatemanagement.
...
### devicescorporatemanagement list-managed-device

list-managed-device a devicescorporatemanagement.
...
### devicescorporatemanagement list-managed-e-book

list-managed-e-book a devicescorporatemanagement.
...
### devicescorporatemanagement list-mdm-window-information-protection-policy

list-mdm-window-information-protection-policy a devicescorporatemanagement.
...
### devicescorporatemanagement list-mobile-app

list-mobile-app a devicescorporatemanagement.
...
### devicescorporatemanagement list-mobile-app-category

list-mobile-app-category a devicescorporatemanagement.
...
### devicescorporatemanagement list-mobile-app-configuration

list-mobile-app-configuration a devicescorporatemanagement.
...
### devicescorporatemanagement list-operation

list-operation a devicescorporatemanagement.
...
### devicescorporatemanagement list-ref-category

list-ref-category a devicescorporatemanagement.
...
### devicescorporatemanagement list-ref-managed-app-registration

list-ref-managed-app-registration a devicescorporatemanagement.
...
### devicescorporatemanagement list-targeted-managed-app-configuration

list-targeted-managed-app-configuration a devicescorporatemanagement.
...
### devicescorporatemanagement list-user-state-summary

list-user-state-summary a devicescorporatemanagement.
...
### devicescorporatemanagement list-user-statuses

list-user-statuses a devicescorporatemanagement.
...
### devicescorporatemanagement list-vpp-token

list-vpp-token a devicescorporatemanagement.
...
### devicescorporatemanagement list-window-information-protection-policy

list-window-information-protection-policy a devicescorporatemanagement.
...
### devicescorporatemanagement sync-license

sync-license a devicescorporatemanagement.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|devicescorporatemanagement|deviceAppManagement.vppTokens|
...
### devicescorporatemanagement sync-microsoft-store-for-business-app

sync-microsoft-store-for-business-app a devicescorporatemanagement.
...
### devicescorporatemanagement target-app

target-app a devicescorporatemanagement.
...
### devicescorporatemanagement update-android-managed-app-protection

update-android-managed-app-protection a devicescorporatemanagement.
...
### devicescorporatemanagement update-app

update-app a devicescorporatemanagement.
...
### devicescorporatemanagement update-applied-policy

update-applied-policy a devicescorporatemanagement.
...
### devicescorporatemanagement update-assignment

update-assignment a devicescorporatemanagement.
...
### devicescorporatemanagement update-default-managed-app-protection

update-default-managed-app-protection a devicescorporatemanagement.
...
### devicescorporatemanagement update-deployment-summary

update-deployment-summary a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-app-management

update-device-app-management a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-category

update-device-category a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-compliance-policy-state

update-device-compliance-policy-state a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-configuration-state

update-device-configuration-state a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-management-troubleshooting-event

update-device-management-troubleshooting-event a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-state

update-device-state a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-status-summary

update-device-status-summary a devicescorporatemanagement.
...
### devicescorporatemanagement update-device-statuses

update-device-statuses a devicescorporatemanagement.
...
### devicescorporatemanagement update-install-summary

update-install-summary a devicescorporatemanagement.
...
### devicescorporatemanagement update-intended-policy

update-intended-policy a devicescorporatemanagement.
...
### devicescorporatemanagement update-io-managed-app-protection

update-io-managed-app-protection a devicescorporatemanagement.
...
### devicescorporatemanagement update-managed-app-policy

update-managed-app-policy a devicescorporatemanagement.
...
### devicescorporatemanagement update-managed-app-registration

update-managed-app-registration a devicescorporatemanagement.
...
### devicescorporatemanagement update-managed-app-statuses

update-managed-app-statuses a devicescorporatemanagement.
...
### devicescorporatemanagement update-managed-device

update-managed-device a devicescorporatemanagement.
...
### devicescorporatemanagement update-managed-e-book

update-managed-e-book a devicescorporatemanagement.
...
### devicescorporatemanagement update-mdm-window-information-protection-policy

update-mdm-window-information-protection-policy a devicescorporatemanagement.
...
### devicescorporatemanagement update-mobile-app

update-mobile-app a devicescorporatemanagement.
...
### devicescorporatemanagement update-mobile-app-category

update-mobile-app-category a devicescorporatemanagement.
...
### devicescorporatemanagement update-mobile-app-configuration

update-mobile-app-configuration a devicescorporatemanagement.
...
### devicescorporatemanagement update-operation

update-operation a devicescorporatemanagement.
...
### devicescorporatemanagement update-targeted-managed-app-configuration

update-targeted-managed-app-configuration a devicescorporatemanagement.
...
### devicescorporatemanagement update-user-state-summary

update-user-state-summary a devicescorporatemanagement.
...
### devicescorporatemanagement update-user-status-summary

update-user-status-summary a devicescorporatemanagement.
...
### devicescorporatemanagement update-user-statuses

update-user-statuses a devicescorporatemanagement.
...
### devicescorporatemanagement update-vpp-token

update-vpp-token a devicescorporatemanagement.
...
### devicescorporatemanagement update-window-information-protection-policy

update-window-information-protection-policy a devicescorporatemanagement.
