...
class UserOperations(object):
    ...
    list_app_role_assignment.metadata = {'url': '/users/{user-id}/appRoleAssignments'}  # type: ignore
    ...
    def create_app_role_assignment(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_app_role_assignment.metadata = {'url': '/users/{user-id}/appRoleAssignments'}  # type: ignore
    ...
    def get_app_role_assignment(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_app_role_assignment.metadata = {'url': '/users/{user-id}/appRoleAssignments/{appRoleAssignment-id}'}  # type: ignore
    ...
    update_app_role_assignment.metadata = {'url': '/users/{user-id}/appRoleAssignments/{appRoleAssignment-id}'}  # type: ignore
    ...
    delete_app_role_assignment.metadata = {'url': '/users/{user-id}/appRoleAssignments/{appRoleAssignment-id}'}  # type: ignore
