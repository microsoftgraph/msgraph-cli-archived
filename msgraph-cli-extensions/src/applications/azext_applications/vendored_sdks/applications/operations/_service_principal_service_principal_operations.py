...
class ServicePrincipalServicePrincipalOperations(object):
    ...
    def create_service_principal(
        ...
        delegated_permission_classifications=None,  # type: Optional[List["models.MicrosoftGraphDelegatedPermissionClassification"]]
        ...
        **kwargs  # type: Any
        ...
        :type delegated_permission_classifications: list[~applications.models.MicrosoftGraphDelegatedPermissionClassification]
    ...
    def get_service_principal(
        ...
        **kwargs  # type: Any
        ...
        :type consistency_level: str
        :param select: Select properties to be returned.
        :type select: list[str or ~applications.models.Enum31]
        :param expand: Expand related entities.
        :type expand: list[str or ~applications.models.Enum32]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphServicePrincipal, or the result of cls(response)
        :rtype: ~applications.models.MicrosoftGraphServicePrincipal
        :raises: ~azure.core.exceptions.HttpResponseError
