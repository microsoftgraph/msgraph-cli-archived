...
def applications_list_application(client,
                                  ...
                                  select=None,
                                  expand=None):
    return client.list_application(consistency_level=consistency_level,
                                   orderby=orderby,
                                   select=select,
                                   expand=expand)
...
def applications_create_service_principal(client,
                                          ...
                                          delegated_permission_classifications=None,
                                          endpoints=None,
                                          home_realm_discovery_policies=None,
                                          member_of=None,
...
def applications_list_service_principal(client,
                                        ...
                                        select=None,
                                        expand=None):
    return client.list_service_principal(consistency_level=consistency_level,
                                         orderby=orderby,
                                         select=select,
                                         expand=expand)
...
def applications_delete(client,
                        ...
                        if_match=None,
                        delegated_permission_classification_id=None,
                        endpoint_id=None):
    if service_principal_id is not None and app_role_assignment_id is not None:
        ...
        return client.delete_app_role_assignment(service_principal_id=service_principal_id,
                                                 app_role_assignment_id=app_role_assignment_id,
                                                 if_match=if_match)
    elif service_principal_id is not None and delegated_permission_classification_id is not None:
        return client.delete_delegated_permission_classification(service_principal_id=service_principal_id,
                                                                 delegated_permission_classification_id=delegated_permission_classification_id,
                                                                 if_match=if_match)
...
def applications_create_delegated_permission_classification(client,
                                                            service_principal_id,
                                                            id_=None,
                                                            classification=None,
                                                            permission_id=None,
                                                            permission_name=None):
    return client.create_delegated_permission_classification(service_principal_id=service_principal_id,
                                                             id=id_,
...
def applications_get_delegated_permission_classification(client,
                                                         service_principal_id,
                                                         delegated_permission_classification_id,
                                                         select=None,
                                                         expand=None):
    return client.get_delegated_permission_classification(service_principal_id=service_principal_id,
                                                          delegated_permission_classification_id=delegated_permission_classification_id,
                                                          select=select,
                                                          expand=expand)
...
def applications_list_delegated_permission_classification(client,
                                                          service_principal_id,
                                                          orderby=None,
                                                          select=None,
                                                          expand=None):
    return client.list_delegated_permission_classification(service_principal_id=service_principal_id,
                                                           orderby=orderby,
                                                           select=select,
                                                           expand=expand)
...
def applications_update_delegated_permission_classification(client,
                                                            service_principal_id,
                                                            delegated_permission_classification_id,
                                                            id_=None,
                                                            classification=None,
                                                            permission_id=None,
                                                            permission_name=None):
    return client.update_delegated_permission_classification(service_principal_id=service_principal_id,
                                                             delegated_permission_classification_id=delegated_permission_classification_id,
                                                             id=id_,
                                                             classification=classification,
                                                             permission_id=permission_id,
