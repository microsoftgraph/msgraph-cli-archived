...
roles supporting assignment to other applications' service principals are also known as application permissions. The \
...
policy type, but only one can be activated as the organization default. Optional, default value is false.
      ...
      - name: --delegated-permission-classifications
        long-summary: |
            Usage: --delegated-permission-classifications classification=XX permission-id=XX permission-name=XX id=XX

            id: Read-only.

            Multiple actions can be specified by using more than one --delegated-permission-classifications argument.
      - name: --endpoints
...
helps['applications create-delegated-permission-classification'] = """
    type: command
    short-summary: "Create new navigation property to delegatedPermissionClassifications for servicePrincipals"
"""
...
helps['applications get-delegated-permission-classification'] = """
    type: command
    short-summary: "Get delegatedPermissionClassifications from servicePrincipals"
"""
...
helps['applications list-delegated-permission-classification'] = """
    type: command
    short-summary: "Get delegatedPermissionClassifications from servicePrincipals"
"""
...
helps['applications update-delegated-permission-classification'] = """
    type: command
    short-summary: "Update the navigation property delegatedPermissionClassifications in servicePrincipals"
"""
