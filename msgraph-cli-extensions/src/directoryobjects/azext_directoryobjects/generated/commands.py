...
def load_command_table(self, _):
    ...
    from azext_directoryobjects.generated._client_factory import cf_directory_object_directory_object
    directoryobjects_directory_object_directory_object = CliCommandType(
        operations_tmpl='azext_directoryobjects.vendored_sdks.directoryobjects.operations._directory_object_directory_o'
        'bject_operations#DirectoryObjectDirectoryObjectOperations.{}',
        client_factory=cf_directory_object_directory_object)
    with self.command_group('directoryobjects', directoryobjects_directory_object_directory_object,
    ...
    from azext_directoryobjects.generated._client_factory import cf_directory_object
    directoryobjects_directory_object = CliCommandType(
        operations_tmpl='azext_directoryobjects.vendored_sdks.directoryobjects.operations._directory_object_operations#'
        'DirectoryObjectOperations.{}',
        client_factory=cf_directory_object)
    with self.command_group('directoryobjects', directoryobjects_directory_object,
