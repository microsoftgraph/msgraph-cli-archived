...
from ._configuration import UsersMailConfiguration
...
class UsersMail(object):
    ...
    :vartype user: users_mail.operations.UserOperations
    :ivar user_inference_classification: UserInferenceClassificationOperations operations
    :vartype user_inference_classification: users_mail.operations.UserInferenceClassificationOperations
    :ivar user_mail_folder: UserMailFolderOperations operations
    :vartype user_mail_folder: users_mail.operations.UserMailFolderOperations
    :ivar user_mail_folder_message: UserMailFolderMessageOperations operations
    :vartype user_mail_folder_message: users_mail.operations.UserMailFolderMessageOperations
    :ivar user_message: UserMessageOperations operations
    :vartype user_message: users_mail.operations.UserMessageOperations
