...
from ._configuration_async import UsersMailConfiguration
...
class UsersMail(object):
    """UsersMail.

    :ivar user: UserOperations operations
    :vartype user: users_mail.aio.operations_async.UserOperations
    :ivar user_inference_classification: UserInferenceClassificationOperations operations
    :vartype user_inference_classification: users_mail.aio.operations_async.UserInferenceClassificationOperations
    :ivar user_mail_folder: UserMailFolderOperations operations
    :vartype user_mail_folder: users_mail.aio.operations_async.UserMailFolderOperations
    :ivar user_mail_folder_message: UserMailFolderMessageOperations operations
    :vartype user_mail_folder_message: users_mail.aio.operations_async.UserMailFolderMessageOperations
    :ivar user_message: UserMessageOperations operations
    :vartype user_message: users_mail.aio.operations_async.UserMessageOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = UsersMailConfiguration(credential, top, skip, search, filter, count, **kwargs)
    ...
    async def __aenter__(self) -> "UsersMail":
