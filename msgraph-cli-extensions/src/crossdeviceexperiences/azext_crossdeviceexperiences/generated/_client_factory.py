...
def cf_user(cli_ctx, *_):
    return cf_crossdeviceexperiences_cl(cli_ctx).user


def cf_user_activity(cli_ctx, *_):
    return cf_crossdeviceexperiences_cl(cli_ctx).user_activity


def cf_user_activity_history_item(cli_ctx, *_):
    return cf_crossdeviceexperiences_cl(cli_ctx).user_activity_history_item
