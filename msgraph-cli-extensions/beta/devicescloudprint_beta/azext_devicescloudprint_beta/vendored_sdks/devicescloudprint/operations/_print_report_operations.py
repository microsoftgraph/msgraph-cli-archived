...
class PrintReportOperations(object):
    """PrintReportOperations operations.
    ...
    def get_group_archived_print_job(
        self,
        group_id,  # type: str
    ...
    def get_printer_archived_print_job(
        self,
        printer_id,  # type: str
        period_start,  # type: datetime.datetime
        period_end,  # type: datetime.datetime
    ...
    def get_print_usage_summary_by_group(
        self,
        period_start,  # type: datetime.datetime
        period_end,  # type: datetime.datetime
        **kwargs  # type: Any
    ...
    def get_print_usage_summary_by_printer(
        self,
        period_start,  # type: datetime.datetime
        period_end,  # type: datetime.datetime
        **kwargs  # type: Any
    ...
    def get_print_usage_summary_by_time_span(
        self,
        period_start,  # type: datetime.datetime
        period_end,  # type: datetime.datetime
    ...
    def get_print_usage_summary_by_user(
        self,
        period_start,  # type: datetime.datetime
        period_end,  # type: datetime.datetime
        **kwargs  # type: Any
    ...
    def get_user_archived_print_job(
        self,
        user_id,  # type: str
        period_start,  # type: datetime.datetime
        period_end,  # type: datetime.datetime
