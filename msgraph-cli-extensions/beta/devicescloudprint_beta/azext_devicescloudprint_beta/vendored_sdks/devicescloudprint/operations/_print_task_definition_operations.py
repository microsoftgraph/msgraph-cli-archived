...
class PrintTaskDefinitionOperations(object):
    """PrintTaskDefinitionOperations operations.
    ...
    def create_task(
        ...
        parent_url=None,  # type: Optional[str]
        status=None,  # type: Optional["models.MicrosoftGraphPrintTaskStatus"]
        ...
        microsoft_graph_print_task_definition=None,  # type: Optional["models.MicrosoftGraphPrintTaskDefinition"]
        **kwargs  # type: Any
    ):
        ...
        _body = models.MicrosoftGraphPrintTask(id=id, parent_url=parent_url, status=status, definition=definition, id_trigger_id=microsoft_graph_entity_id, event=event, definition_trigger_definition=microsoft_graph_print_task_definition)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphPrintTask')
