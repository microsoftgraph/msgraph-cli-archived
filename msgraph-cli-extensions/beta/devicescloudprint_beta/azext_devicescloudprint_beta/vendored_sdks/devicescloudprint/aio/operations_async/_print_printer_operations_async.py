...
class PrintPrinterOperations:
    """PrintPrinterOperations async operations.
    ...
    async def create_allowed_group(
        self,
        printer_id: str,
    ...
    async def update_allowed_group(
        self,
        printer_id: str,
        print_identity_id: str,
        id: Optional[str] = None,
    ...
    async def delete_allowed_group(
        self,
        printer_id: str,
        print_identity_id: str,
    ...
    async def create_ref_connector(
        self,
        printer_id: str,
    ...
    async def restore_factory_default(
        self,
        printer_id: str,
        **kwargs
    ) -> None:
    ...
    async def create(
        ...
        certificate_signing_request: Optional["models.MicrosoftGraphPrintCertificateSigningRequest"] = None,
