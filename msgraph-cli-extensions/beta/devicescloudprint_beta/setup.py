...
VERSION = '0.1.0'
try:
    from azext_devicescloudprint_beta.manual.version import VERSION
except ImportError:
    pass
...
setup(
    ...
    package_data={'azext_devicescloudprint_beta': ['azext_metadata.json']},
)
