...
class UsersPlannerOperations(object):
    """UsersPlannerOperations operations.
    ...
    def create_all(
        self,
        user_id,  # type: str
        body,  # type: "models.MicrosoftGraphPlannerDelta"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~planner.models.MicrosoftGraphPlannerDelta
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_favorite_plans(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_favorite_plans.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_favorite_plans.metadata = {'url': '/users/{user-id}/planner/favoritePlans'}  # type: ignore

    def list_ref_favorite_plans(
        self,
        user_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_favorite_plans.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_favorite_plans.metadata = {'url': '/users/{user-id}/planner/favoritePlans/$ref'}  # type: ignore

    def create_ref_favorite_plans(
        self,
        user_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_ref_favorite_plans.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_favorite_plans.metadata = {'url': '/users/{user-id}/planner/favoritePlans/$ref'}  # type: ignore
    ...
    def list_recent_plans(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_recent_plans.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_recent_plans.metadata = {'url': '/users/{user-id}/planner/recentPlans'}  # type: ignore

    def list_ref_recent_plans(
        self,
        user_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_recent_plans.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_recent_plans.metadata = {'url': '/users/{user-id}/planner/recentPlans/$ref'}  # type: ignore

    def create_ref_recent_plans(
        self,
        user_id,  # type: str
        body,  # type: Dict[str, object]
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_ref_recent_plans.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_recent_plans.metadata = {'url': '/users/{user-id}/planner/recentPlans/$ref'}  # type: ignore
