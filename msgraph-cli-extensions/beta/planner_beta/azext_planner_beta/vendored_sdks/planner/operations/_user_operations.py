...
class UserOperations(object):
    ...
    def update_planner(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphPlannerUser(id=id, favorite_plan_references=favorite_plan_references, recent_plan_references=recent_plan_references, all=all, favorite_plans=favorite_plans, plans=plans, recent_plans=recent_plans, tasks=tasks)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphPlannerUser')
