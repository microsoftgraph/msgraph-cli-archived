...
class UserPlannerTaskOperations(object):
    """UserPlannerTaskOperations operations.
    ...
    def get_assigned_to_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~planner.models.Enum131]
        ...
        return deserialized
    get_assigned_to_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat'}  # type: ignore
    ...
    update_assigned_to_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat'}  # type: ignore
    ...
    delete_assigned_to_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat'}  # type: ignore
    ...
    def get_bucket_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum132]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_bucket_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat'}  # type: ignore
    ...
    update_bucket_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat'}  # type: ignore
    ...
    delete_bucket_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat'}  # type: ignore
    ...
    def get_detail(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum133]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_detail.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    update_detail.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_detail.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    def get_progress_task_board_format(
        ...
        **kwargs  # type: Any
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum134]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_progress_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat'}  # type: ignore
    ...
    update_progress_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat'}  # type: ignore
    ...
    delete_progress_task_board_format.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat'}  # type: ignore
