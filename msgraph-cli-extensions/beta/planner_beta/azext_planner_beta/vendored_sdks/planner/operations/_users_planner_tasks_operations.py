...
class UsersPlannerTasksOperations(object):
    """UsersPlannerTasksOperations operations.
    ...
    def get_details(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_details.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    update_details.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_details.metadata = {'url': '/users/{user-id}/planner/tasks/{plannerTask-id}/details'}  # type: ignore
