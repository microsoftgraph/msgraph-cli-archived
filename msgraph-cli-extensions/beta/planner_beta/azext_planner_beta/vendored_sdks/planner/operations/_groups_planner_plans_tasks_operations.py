...
class GroupsPlannerPlansTasksOperations(object):
    """GroupsPlannerPlansTasksOperations operations.
    ...
    def get_details(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_details.metadata = {'url': '/groups/{group-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    update_details.metadata = {'url': '/groups/{group-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_details.metadata = {'url': '/groups/{group-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details'}  # type: ignore
