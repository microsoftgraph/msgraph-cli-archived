...
class usersplannerplansbucketsOperations:
    """usersplannerplansbucketsOperations async operations.
    ...
    def list_tasks(
        ...
        **kwargs
    ) -> AsyncIterable["models.collectionofplannertask5"]:
        ...
        :type orderby: list[str or ~planner.models.Enum103]
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum104]
        :param expand: Expand related entities.
        :type expand: list[str or ~planner.models.Enum105]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofplannertask5 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.collectionofplannertask5]
    ...
    list_tasks.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks'}  # type: ignore
    ...
    async def create_tasks(
        ...
        **kwargs
        ...
        return deserialized
    create_tasks.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks'}  # type: ignore
    ...
    async def get_tasks(
        ...
        **kwargs
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~planner.models.Enum107]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphplannertask, or the result of cls(response)
        :rtype: ~planner.models.microsoftgraphplannertask
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_tasks.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
    ...
    update_tasks.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
    ...
    delete_tasks.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
