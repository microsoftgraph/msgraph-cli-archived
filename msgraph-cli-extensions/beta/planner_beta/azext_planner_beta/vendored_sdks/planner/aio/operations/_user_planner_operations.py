...
class UserPlannerOperations:
    """UserPlannerOperations async operations.
    ...
    def list_all(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerDelta"]:
        """Get all from users.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerDelta]
    ...
    async def create_all(
        ...
        **kwargs
    ) -> "models.MicrosoftGraphPlannerDelta":
        ...
        body = models.MicrosoftGraphPlannerDelta(id=id)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphPlannerDelta')
    ...
    def list_ref_favorite_plan(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfLinksOfPlannerPlan"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfLinksOfPlannerPlan]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_ref_favorite_plan(
        self,
        user_id: str,
    ...
    def list_plan(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerPlan2"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerPlan2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_recent_plan(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerPlan3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_recent_plan(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfLinksOfPlannerPlan0"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfLinksOfPlannerPlan0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_ref_recent_plan(
        self,
        user_id: str,
        body: Dict[str, object],
        **kwargs
    ...
    async def create_task(
        ...
        title: Optional[str] = None,
        bucket_task_board_format: Optional["models.MicrosoftGraphPlannerBucketTaskBoardTaskFormat"] = None,
        progress_task_board_format: Optional["models.MicrosoftGraphPlannerProgressTaskBoardTaskFormat"] = None,
        microsoft_graph_entity_id: Optional[str] = None,
        checklist: Optional[Dict[str, object]] = None,
        description: Optional[str] = None,
        microsoft_graph_planner_preview_type: Optional[Union[str, "models.MicrosoftGraphPlannerPreviewType"]] = None,
