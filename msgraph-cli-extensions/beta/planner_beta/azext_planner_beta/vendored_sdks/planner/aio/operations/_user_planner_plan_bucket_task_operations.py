...
class UserPlannerPlanBucketTaskOperations:
    """UserPlannerPlanBucketTaskOperations async operations.
    ...
    async def get_assigned_to_task_board_format(
        ...
        **kwargs
        ...
        :type select: list[str or ~planner.models.Enum108]
    ...
    delete_assigned_to_task_board_format.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat'}  # type: ignore
    ...
    delete_bucket_task_board_format.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat'}  # type: ignore
    ...
    async def get_detail(
        ...
        **kwargs
        ...
        :type planner_task_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum110]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_detail.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_progress_task_board_format.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/progressTaskBoardFormat'}  # type: ignore
