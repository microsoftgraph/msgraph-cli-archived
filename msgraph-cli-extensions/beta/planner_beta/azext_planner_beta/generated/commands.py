...
def load_command_table(self, _):
    ...
    with self.command_group('planner group', planner_beta_group) as g:
    ...
    with self.command_group('planner group-planner', planner_beta_group_planner) as g:
    ...
    with self.command_group('planner group-planner-plan', planner_beta_group_planner_plan) as g:
    ...
    with self.command_group('planner group-planner-plan-bucket', planner_beta_group_planner_plan_bucket) as g:
    ...
    with self.command_group('planner group-planner-plan-bucket-task', planner_beta_group_planner_plan_bucket_task) as g:
    ...
    with self.command_group('planner group-planner-plan-task', planner_beta_group_planner_plan_task) as g:
    ...
    with self.command_group('planner planner', planner_beta_planner_planner) as g:
    ...
    with self.command_group('planner planner', planner_beta_planner) as g:
    ...
    planner_beta_planner_bucket = CliCommandType(
        operations_tmpl='azext_planner_beta.vendored_sdks.planner.operations._planner_buckets_operations#PlannerBucketsOperations.{}',
        client_factory=cf_planner_bucket,
    )
    with self.command_group('planner planner-bucket', planner_beta_planner_bucket) as g:
    ...
    with self.command_group('planner planner-bucket-task', planner_beta_planner_bucket_task) as g:
    ...
    with self.command_group('planner planner-plan', planner_beta_planner_plan) as g:
    ...
    with self.command_group('planner planner-plan-bucket', planner_beta_planner_plan_bucket) as g:
    ...
    with self.command_group('planner planner-plan-bucket-task', planner_beta_planner_plan_bucket_task) as g:
    ...
    with self.command_group('planner planner-plan-task', planner_beta_planner_plan_task) as g:
    ...
    with self.command_group('planner planner-task', planner_beta_planner_task) as g:
    ...
    with self.command_group('planner user', planner_beta_user) as g:
    ...
    with self.command_group('planner user-planner', planner_beta_user_planner) as g:
    ...
    with self.command_group('planner user-planner-plan', planner_beta_user_planner_plan) as g:
    ...
    with self.command_group('planner user-planner-plan-bucket', planner_beta_user_planner_plan_bucket) as g:
    ...
    with self.command_group('planner user-planner-plan-bucket-task', planner_beta_user_planner_plan_bucket_task) as g:
    ...
    with self.command_group('planner user-planner-plan-task', planner_beta_user_planner_plan_task) as g:
    ...
    with self.command_group('planner user-planner-task', planner_beta_user_planner_task) as g:
