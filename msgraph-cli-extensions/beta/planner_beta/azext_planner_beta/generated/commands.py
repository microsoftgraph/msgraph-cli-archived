...
def load_command_table(self, _):
    ...
    with self.command_group('planner', planner_beta_group, client_factory=cf_group) as g:
    ...
    with self.command_group('planner', planner_beta_group_planner, client_factory=cf_group_planner) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
    ...
    with self.command_group('planner', planner_beta_group_planner_plan, client_factory=cf_group_planner_plan) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
    ...
    with self.command_group('planner', planner_beta_group_planner_plan_bucket,
    ...
    with self.command_group('planner', planner_beta_group_planner_plan_bucket_task,
    ...
    with self.command_group('planner', planner_beta_group_planner_plan_task,
    ...
    with self.command_group('planner', planner_beta_planner_planner, client_factory=cf_planner_planner) as g:
        g.custom_command('get-planner', 'planner_get_planner')
        g.custom_command('update-planner', 'planner_update_planner')
    ...
    with self.command_group('planner', planner_beta_planner, client_factory=cf_planner) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('create-bucket', 'planner_create_bucket')
        g.custom_command('create-plan', 'planner_create_plan')
        g.custom_command('create-task', 'planner_create_task')
    ...
    with self.command_group('planner', planner_beta_planner_bucket, client_factory=cf_planner_bucket) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('create-task', 'planner_create_task')
        g.custom_command('get-task', 'planner_get_task')
        g.custom_command('list-task', 'planner_list_task')
    ...
    with self.command_group('planner', planner_beta_planner_bucket_task, client_factory=cf_planner_bucket_task) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('get-assigned-to-task-board-format', 'planner_get_assigned_to_task_board_format')
        g.custom_command('get-bucket-task-board-format', 'planner_get_bucket_task_board_format')
        g.custom_command('get-detail', 'planner_get_detail')
    ...
    with self.command_group('planner', planner_beta_planner_plan, client_factory=cf_planner_plan) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('create-bucket', 'planner_create_bucket')
        g.custom_command('create-task', 'planner_create_task')
        g.custom_command('get-bucket', 'planner_get_bucket')
    ...
    with self.command_group('planner', planner_beta_planner_plan_bucket, client_factory=cf_planner_plan_bucket) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('create-task', 'planner_create_task')
        g.custom_command('get-task', 'planner_get_task')
        g.custom_command('list-task', 'planner_list_task')
    ...
    with self.command_group('planner', planner_beta_planner_plan_bucket_task,
    ...
    with self.command_group('planner', planner_beta_planner_plan_task, client_factory=cf_planner_plan_task) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('get-assigned-to-task-board-format', 'planner_get_assigned_to_task_board_format')
        g.custom_command('get-bucket-task-board-format', 'planner_get_bucket_task_board_format')
        g.custom_command('get-detail', 'planner_get_detail')
    ...
    with self.command_group('planner', planner_beta_planner_task, client_factory=cf_planner_task) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('get-assigned-to-task-board-format', 'planner_get_assigned_to_task_board_format')
        g.custom_command('get-bucket-task-board-format', 'planner_get_bucket_task_board_format')
        g.custom_command('get-detail', 'planner_get_detail')
    ...
    with self.command_group('planner', planner_beta_user, client_factory=cf_user) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('get-planner', 'planner_get_planner')
        g.custom_command('update-planner', 'planner_update_planner')
    ...
    with self.command_group('planner', planner_beta_user_planner, client_factory=cf_user_planner) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('create-all', 'planner_create_all')
        g.custom_command('create-plan', 'planner_create_plan')
        g.custom_command('create-ref-favorite-plan', 'planner_create_ref_favorite_plan')
        g.custom_command('create-ref-recent-plan', 'planner_create_ref_recent_plan')
        g.custom_command('create-task', 'planner_create_task')
        g.custom_command('get-all', 'planner_get_all')
        g.custom_command('get-plan', 'planner_get_plan')
        g.custom_command('get-task', 'planner_get_task')
        g.custom_command('list-all', 'planner_list_all')
        g.custom_command('list-favorite-plan', 'planner_list_favorite_plan')
        g.custom_command('list-plan', 'planner_list_plan')
        g.custom_command('list-recent-plan', 'planner_list_recent_plan')
        g.custom_command('list-ref-favorite-plan', 'planner_list_ref_favorite_plan')
        g.custom_command('list-ref-recent-plan', 'planner_list_ref_recent_plan')
        g.custom_command('list-task', 'planner_list_task')
        g.custom_command('update-all', 'planner_update_all')
        g.custom_command('update-plan', 'planner_update_plan')
        g.custom_command('update-task', 'planner_update_task')
    ...
    with self.command_group('planner', planner_beta_user_planner_plan, client_factory=cf_user_planner_plan) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('create-bucket', 'planner_create_bucket')
        g.custom_command('create-task', 'planner_create_task')
        g.custom_command('get-bucket', 'planner_get_bucket')
    ...
    with self.command_group('planner', planner_beta_user_planner_plan_bucket,
    ...
    with self.command_group('planner', planner_beta_user_planner_plan_bucket_task,
    ...
    with self.command_group('planner', planner_beta_user_planner_plan_task,
    ...
    with self.command_group('planner', planner_beta_user_planner_task, client_factory=cf_user_planner_task) as g:
        g.custom_command('delete', 'planner_delete', confirmation=True)
        g.custom_command('get-assigned-to-task-board-format', 'planner_get_assigned_to_task_board_format')
        g.custom_command('get-bucket-task-board-format', 'planner_get_bucket_task_board_format')
        g.custom_command('get-detail', 'planner_get_detail')
