...
|---------|------------|--------|-----------|
|[az planner group update](#groupsUpdatePlanner)|UpdatePlanner|[Parameters](#ParametersgroupsUpdatePlanner)|Not Found|
...
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az planner user update](#usersUpdatePlanner)|UpdatePlanner|[Parameters](#ParametersusersUpdatePlanner)|Not Found|
...
#### <a name="groupsUpdatePlanner">Command `az planner group update`</a>
...
#### <a name="usersUpdatePlanner">Command `az planner user update`</a>
