...
|**--details-context-details**|dictionary|plannerPlanContextDetailsCollection|context_details|contextDetails|
...
### planner user-planner create-ref-favorite-plan

create-ref-favorite-plan a planner user-planner.
...
|Name (az)|Swagger name|
|---------|------------|
|create-ref-favorite-plan|CreateRefFavoritePlans|
...
### planner user-planner create-ref-recent-plan

create-ref-recent-plan a planner user-planner.
...
|Name (az)|Swagger name|
|---------|------------|
|create-ref-recent-plan|CreateRefRecentPlans|
...
### planner user-planner list-ref-favorite-plan

list-ref-favorite-plan a planner user-planner.
...
|Name (az)|Swagger name|
|---------|------------|
|list-ref-favorite-plan|ListRefFavoritePlans|
...
### planner user-planner list-ref-recent-plan

list-ref-recent-plan a planner user-planner.
...
|Name (az)|Swagger name|
|---------|------------|
|list-ref-recent-plan|ListRefRecentPlans|
...
### planner user-planner update-all

update-all a planner user-planner.
