...
### identitydirmgt create-apply-to

create-apply-to a identitydirmgt.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt|directory.featureRolloutPolicies|
...
### identitydirmgt create-command

create-command a identitydirmgt.
...
### identitydirmgt create-directory-setting

create-directory-setting a identitydirmgt.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt|settings.directorySetting|
...
### identitydirmgt create-directory-setting-template

create-directory-setting-template a identitydirmgt.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt|directorySettingTemplates.directorySettingTemplate|
...
### identitydirmgt create-feature-rollout-policy

create-feature-rollout-policy a identitydirmgt.
...
### identitydirmgt create-profile-card-property

create-profile-card-property a identitydirmgt.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt|organization.settings|
...
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt|administrativeUnits|
...
### identitydirmgt get-apply-to

get-apply-to a identitydirmgt.
...
### identitydirmgt get-branding

get-branding a identitydirmgt.
...
### identitydirmgt get-command

get-command a identitydirmgt.
...
### identitydirmgt get-directory-setting

get-directory-setting a identitydirmgt.
...
### identitydirmgt get-directory-setting-template

get-directory-setting-template a identitydirmgt.
...
### identitydirmgt get-feature-rollout-policy

get-feature-rollout-policy a identitydirmgt.
...
### identitydirmgt get-item-insight

get-item-insight a identitydirmgt.
...
### identitydirmgt get-profile-card-property

get-profile-card-property a identitydirmgt.
...
### identitydirmgt get-setting

get-setting a identitydirmgt.
...
### identitydirmgt get-user-owned-object

get-user-owned-object a identitydirmgt.
...
### identitydirmgt list-apply-to

list-apply-to a identitydirmgt.
...
### identitydirmgt list-command

list-command a identitydirmgt.
...
### identitydirmgt list-directory-setting

list-directory-setting a identitydirmgt.
...
### identitydirmgt list-directory-setting-template

list-directory-setting-template a identitydirmgt.
...
### identitydirmgt list-feature-rollout-policy

list-feature-rollout-policy a identitydirmgt.
...
### identitydirmgt list-profile-card-property

list-profile-card-property a identitydirmgt.
...
### identitydirmgt update-apply-to

update-apply-to a identitydirmgt.
...
### identitydirmgt update-branding

update-branding a identitydirmgt.
...
### identitydirmgt update-command

update-command a identitydirmgt.
...
### identitydirmgt update-directory-setting

update-directory-setting a identitydirmgt.
...
### identitydirmgt update-directory-setting-template

update-directory-setting-template a identitydirmgt.
...
### identitydirmgt update-feature-rollout-policy

update-feature-rollout-policy a identitydirmgt.
...
### identitydirmgt update-item-insight

update-item-insight a identitydirmgt.
...
### identitydirmgt update-profile-card-property

update-profile-card-property a identitydirmgt.
...
### identitydirmgt update-setting

update-setting a identitydirmgt.
