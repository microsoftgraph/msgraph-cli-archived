...
### identitydirmgt administrative-unit delete

delete a identitydirmgt administrative-unit.
...
### identitydirmgt administrative-unit delta

delta a identitydirmgt administrative-unit.
...
### identitydirmgt administrative-unit get-scoped-role-member
...
list-extension a identitydirmgt administrative-unit.
...
list-ref-member a identitydirmgt administrative-unit.
...
update-administrative-unit a identitydirmgt administrative-unit-administrative-unit.
...
### identitydirmgt contract get-user-owned-object
...
### identitydirmgt device get-command
...
create-apply-to a identitydirmgt directory-feature-rollout-policy.
...
### identitydirmgt directory-role-template get-user-owned-object

get-user-owned-object a identitydirmgt directory-role-template.
...
### identitydirmgt directory-setting-template check-member-group

check-member-group a identitydirmgt directory-setting-template.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt directory-setting-template|directorySettingTemplates|
...
### identitydirmgt directory-setting-template check-member-object

check-member-object a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template get-by-id

get-by-id a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template get-member-group

get-member-group a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template get-member-object

get-member-object a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template get-user-owned-object

get-user-owned-object a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template restore

restore a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template validate-property

validate-property a identitydirmgt directory-setting-template.
...
### identitydirmgt directory-setting-template-directory-setting-template create-directory-setting-template

create-directory-setting-template a identitydirmgt directory-setting-template-directory-setting-template.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt directory-setting-template-directory-setting-template|directorySettingTemplates.directorySettingTemplate|
...
### identitydirmgt directory-setting-template-directory-setting-template delete

delete a identitydirmgt directory-setting-template-directory-setting-template.
...
|Name (az)|Swagger name|
|---------|------------|
|delete|DeleteDirectorySettingTemplate|
...
### identitydirmgt directory-setting-template-directory-setting-template get-directory-setting-template

get-directory-setting-template a identitydirmgt directory-setting-template-directory-setting-template.
...
### identitydirmgt directory-setting-template-directory-setting-template list-directory-setting-template

list-directory-setting-template a identitydirmgt directory-setting-template-directory-setting-template.
...
### identitydirmgt directory-setting-template-directory-setting-template update-directory-setting-template

update-directory-setting-template a identitydirmgt directory-setting-template-directory-setting-template.
...
### identitydirmgt organization get-branding

get-branding a identitydirmgt organization.
...
### identitydirmgt organization get-setting

get-setting a identitydirmgt organization.
...
### identitydirmgt organization get-user-owned-object

get-user-owned-object a identitydirmgt organization.
...
### identitydirmgt organization update-branding

update-branding a identitydirmgt organization.
...
### identitydirmgt organization update-setting

update-setting a identitydirmgt organization.
...
### identitydirmgt organization-setting create-profile-card-property

create-profile-card-property a identitydirmgt organization-setting.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt organization-setting|organization.settings|
...
### identitydirmgt organization-setting delete

delete a identitydirmgt organization-setting.
...
|Name (az)|Swagger name|
|---------|------------|
|delete|DeleteProfileCardProperties|
|delete|DeleteItemInsights|
...
### identitydirmgt organization-setting get-item-insight

get-item-insight a identitydirmgt organization-setting.
...
### identitydirmgt organization-setting get-profile-card-property

get-profile-card-property a identitydirmgt organization-setting.
...
### identitydirmgt organization-setting list-profile-card-property

list-profile-card-property a identitydirmgt organization-setting.
...
### identitydirmgt organization-setting update-item-insight

update-item-insight a identitydirmgt organization-setting.
...
### identitydirmgt organization-setting update-profile-card-property

update-profile-card-property a identitydirmgt organization-setting.
...
### identitydirmgt setting-directory-setting create-directory-setting

create-directory-setting a identitydirmgt setting-directory-setting.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|identitydirmgt setting-directory-setting|settings.directorySetting|
...
### identitydirmgt setting-directory-setting delete

delete a identitydirmgt setting-directory-setting.
...
### identitydirmgt setting-directory-setting get-directory-setting

get-directory-setting a identitydirmgt setting-directory-setting.
...
### identitydirmgt setting-directory-setting list-directory-setting

list-directory-setting a identitydirmgt setting-directory-setting.
...
### identitydirmgt setting-directory-setting update-directory-setting

update-directory-setting a identitydirmgt setting-directory-setting.
