...
class DeviceOperations:
    ...
    def list_command(
        ...
        **kwargs
        ...
        :type select: list[str or ~identity_directory_management.models.Enum37]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_directory_management.models.Enum38]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfCommand or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfCommand]
    ...
    async def create_command(
        ...
        **kwargs
        ...
        :rtype: ~identity_directory_management.models.MicrosoftGraphCommand
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _body = models.MicrosoftGraphCommand(id=id, app_service_name=app_service_name, error=error, package_family_name=package_family_name, payload=payload, permission_ticket=permission_ticket, post_back_uri=post_back_uri, status=status, type=type, id_responsepayload_id=microsoft_graph_entity_id)
    ...
    async def get_command(
        ...
        **kwargs
        ...
        :param device_id: key: id of device.
        :type device_id: str
        :param command_id: key: id of command.
        :type command_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum39]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_directory_management.models.Enum40]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphCommand, or the result of cls(response)
        :rtype: ~identity_directory_management.models.MicrosoftGraphCommand
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def delete_command(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_command.metadata['url']  # type: ignore
        path_format_arguments = {
            'device-id': self._serialize.url("device_id", device_id, 'str'),
            'command-id': self._serialize.url("command_id", command_id, 'str'),
        }
    ...
    delete_command.metadata = {'url': '/devices/{device-id}/commands/{command-id}'}  # type: ignore
    ...
    def list_extension(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum41]
        :param select: Select properties to be returned.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfExtension0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_member_of(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum42]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum43]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDirectoryObject3 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_member_of(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum44]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfLinksOfDirectoryObject3 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_registered_owner(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum45]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum46]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDirectoryObject4 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject4]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_registered_owner(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum47]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfLinksOfDirectoryObject4 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject4]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_ref_registered_owner(
        self,
        device_id: str,
        body: Dict[str, object],
        **kwargs
    ...
    def list_registered_user(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum48]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum49]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDirectoryObject5 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject5]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_registered_user(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum50]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfLinksOfDirectoryObject5 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject5]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_ref_registered_user(
        self,
        device_id: str,
        body: Dict[str, object],
        **kwargs
    ...
    def list_transitive_member_of(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum51]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum52]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDirectoryObject6 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject6]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_transitive_member_of(
        ...
        **kwargs
        ...
        :type device_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum53]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfLinksOfDirectoryObject6 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject6]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
