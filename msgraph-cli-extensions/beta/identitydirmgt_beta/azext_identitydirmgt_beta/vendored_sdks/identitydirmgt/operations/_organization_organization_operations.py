...
class OrganizationOrganizationOperations(object):
    """OrganizationOrganizationOperations operations.
    ...
    def list_organization(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfOrganization"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfOrganization]
    ...
    def create_organization(
        ...
        country_letter_code=None,  # type: Optional[str]
        created_date_time=None,  # type: Optional[datetime.datetime]
        directory_size_quota=None,  # type: Optional["models.MicrosoftGraphDirectorySizeQuota"]
        display_name=None,  # type: Optional[str]
        is_multiple_data_locations_for_services_enabled=None,  # type: Optional[bool]
        marketing_notification_emails=None,  # type: Optional[List[str]]
        ...
        privacy_profile=None,  # type: Optional["models.MicrosoftGraphPrivacyProfile"]
        provisioned_plans=None,  # type: Optional[List["models.MicrosoftGraphProvisionedPlan"]]
        security_compliance_notification_mails=None,  # type: Optional[List[str]]
        security_compliance_notification_phones=None,  # type: Optional[List[str]]
        state=None,  # type: Optional[str]
        street=None,  # type: Optional[str]
        technical_notification_mails=None,  # type: Optional[List[str]]
        verified_domains=None,  # type: Optional[List["models.MicrosoftGraphVerifiedDomain"]]
        certificate_connector_setting=None,  # type: Optional["models.MicrosoftGraphCertificateConnectorSetting"]
        mobile_device_management_authority=None,  # type: Optional[Union[str, "models.MicrosoftGraphMdmAuthority"]]
        certificate_based_auth_configuration=None,  # type: Optional[List["models.MicrosoftGraphCertificateBasedAuthConfiguration"]]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MicrosoftGraphOrganization"
