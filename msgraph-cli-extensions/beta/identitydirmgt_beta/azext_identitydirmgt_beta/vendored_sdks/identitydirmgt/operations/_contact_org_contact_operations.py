...
class ContactOrgContactOperations(object):
    """ContactOrgContactOperations operations.
    ...
    def create_org_contact(
        ...
        addresses=None,  # type: Optional[List["models.MicrosoftGraphPhysicalOfficeAddress"]]
