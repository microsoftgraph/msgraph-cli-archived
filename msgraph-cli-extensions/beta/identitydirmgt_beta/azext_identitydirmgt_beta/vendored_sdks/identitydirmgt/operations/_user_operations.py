...
class UserOperations(object):
    ...
    def list_scoped_role_member_of(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfScopedRoleMembership1"]
        ...
        :type orderby: list[str or ~identity_directory_management.models.Enum125]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum126]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfScopedRoleMembership1]
    ...
    def create_scoped_role_member_of(
        self,
        user_id,  # type: str
    ...
    def get_scoped_role_member_of(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum127]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphScopedRoleMembership, or the result of cls(response)
    ...
    def update_scoped_role_member_of(
        self,
        user_id,  # type: str
        scoped_role_membership_id,  # type: str
        id=None,  # type: Optional[str]
    ...
    def delete_scoped_role_member_of(
        self,
        user_id,  # type: str
        scoped_role_membership_id,  # type: str
