...
class userscalendargroupscalendarsOperations(object):
    ...
    def allowed_calendar_sharing_roles(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    allowed_calendar_sharing_roles.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/microsoft.graph.allowedCalendarSharingRoles(User=\'{User}\')'}  # type: ignore
