...
class UsersCalendarsCalendarViewCalendarOperations:
    """UsersCalendarsCalendarViewCalendarOperations async operations.
    ...
    async def allowed_calendar_sharing_roles(
        ...
        **kwargs
        ...
        return deserialized
    allowed_calendar_sharing_roles.metadata = {'url': '/users/{user-id}/calendars/{calendar-id}/calendarView/{event-id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User=\'{User}\')'}  # type: ignore
