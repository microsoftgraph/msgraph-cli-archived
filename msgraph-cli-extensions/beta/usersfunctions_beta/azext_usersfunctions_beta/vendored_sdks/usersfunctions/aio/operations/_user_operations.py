...
class UserOperations:
    ...
    async def get_effective_device_enrollment_configuration(
        self,
        user_id: str,
        **kwargs
    ...
    async def get_logged_on_managed_device(
        self,
        user_id: str,
        **kwargs
    ...
    async def get_managed_device_with_app_failure(
        self,
        user_id: str,
        **kwargs
    ) -> List[str]:
    ...
    async def get_managed_device_with_failed_or_pending_app(
        self,
        user_id: str,
        **kwargs
    ...
    async def get_managed_app_blocked_user(
        self,
        **kwargs
    ) -> List[str]:
