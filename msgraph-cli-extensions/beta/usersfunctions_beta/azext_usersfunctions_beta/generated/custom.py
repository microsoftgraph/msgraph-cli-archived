...
def usersfunctions_get_file_vault_key(client,
                                      user_id,
                                      managed_device_id):
...
def usersfunctions_get_non_compliant_setting(client,
                                             user_id,
                                             managed_device_id):
...
def usersfunctions_export_device_and_app_management_data_d390(client,
                                                              user_id):
    return client.export_device_and_app_management_data_d390(user_id=user_id)


def usersfunctions_export_device_and_app_management_data623_c(client,
                                                              user_id,
                                                              skip,
                                                              top):
...
def usersfunctions_find_room_ac49(client,
                                  user_id,
                                  room_list):
...
def usersfunctions_find_room_d266(client,
                                  user_id):
    return client.find_room_d266(user_id=user_id)


def usersfunctions_find_room_list(client,
                                  user_id):
    return client.find_room_list(user_id=user_id)


def usersfunctions_get_effective_device_enrollment_configuration(client,
                                                                 user_id):
    return client.get_effective_device_enrollment_configuration(user_id=user_id)


def usersfunctions_get_logged_on_managed_device(client,
                                                user_id):
    return client.get_logged_on_managed_device(user_id=user_id)


def usersfunctions_get_managed_app_blocked_user(client):
...
def usersfunctions_get_managed_device_with_app_failure(client,
                                                       user_id):
    return client.get_managed_device_with_app_failure(user_id=user_id)


def usersfunctions_get_managed_device_with_failed_or_pending_app(client,
                                                                 user_id):
    return client.get_managed_device_with_failed_or_pending_app(user_id=user_id)


def usersfunctions_is_managed_app_user_blocked(client,
                                               user_id):
