...
def load_arguments(self, _):
    ...
    with self.argument_context('usersfunctions get-non-compliant-setting') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('managed_device_id', type=str, help='key: id of managedDevice')
    ...
    with self.argument_context('usersfunctions export-device-and-app-management-data-d390') as c:
        c.argument('user_id', type=str, help='key: id of user')

    with self.argument_context('usersfunctions export-device-and-app-management-data623-c') as c:
        c.argument('user_id', type=str, help='key: id of user')
    ...
    with self.argument_context('usersfunctions get-effective-device-enrollment-configuration') as c:
        c.argument('user_id', type=str, help='key: id of user')

    with self.argument_context('usersfunctions get-logged-on-managed-device') as c:
        c.argument('user_id', type=str, help='key: id of user')
    ...
    with self.argument_context('usersfunctions get-managed-device-with-app-failure') as c:
        c.argument('user_id', type=str, help='key: id of user')

    with self.argument_context('usersfunctions get-managed-device-with-failed-or-pending-app') as c:
        c.argument('user_id', type=str, help='key: id of user')

    with self.argument_context('usersfunctions is-managed-app-user-blocked') as c:
        c.argument('user_id', type=str, help='key: id of user')
