...
def calendar_delete(client,
    ...
    if group_id is not None and event_id is not None and attachment_id is not None:
        ...
        return client.delete_exception_occurrence(group_id=group_id,
                                                  event_id=event_id,
                                                  event_id1=event_id1,
                                                  if_match=if_match)
...
def calendar_create_exception_occurrence(client,
                                         group_id,
                                         event_id,
                                         body):
    return client.create_exception_occurrence(group_id=group_id,
                                              event_id=event_id,
                                              body=body)
...
def calendar_get_exception_occurrence(client,
                                      group_id,
                                      event_id,
                                      event_id1,
                                      select=None,
                                      expand=None):
    return client.get_exception_occurrence(group_id=group_id,
                                           event_id=event_id,
                                           event_id1=event_id1,
                                           select=select,
                                           expand=expand)
...
def calendar_list_exception_occurrence(client,
                                       group_id,
                                       event_id,
                                       orderby=None,
                                       select=None,
                                       expand=None):
    return client.list_exception_occurrence(group_id=group_id,
                                            event_id=event_id,
                                            orderby=orderby,
                                            select=select,
                                            expand=expand)
...
def calendar_update_exception_occurrence(client,
                                         group_id,
                                         event_id,
                                         event_id1,
                                         body):
    return client.update_exception_occurrence(group_id=group_id,
                                              event_id=event_id,
                                              event_id1=event_id1,
                                              body=body)
...
def calendar_delete(client,
    ...
    if user_id is not None and event_id is not None and attachment_id is not None:
        ...
        return client.delete_exception_occurrence(user_id=user_id,
                                                  event_id=event_id,
                                                  event_id1=event_id1,
                                                  if_match=if_match)
...
def calendar_create_exception_occurrence(client,
                                         ...
                                         event_id,
                                         body):
    return client.create_exception_occurrence(user_id=user_id,
                                              event_id=event_id,
                                              body=body)
...
def calendar_get_exception_occurrence(client,
                                      ...
                                      select=None,
                                      expand=None):
    return client.get_exception_occurrence(user_id=user_id,
                                           event_id=event_id,
                                           event_id1=event_id1,
                                           select=select,
                                           expand=expand)
...
def calendar_list_exception_occurrence(client,
                                       ...
                                       select=None,
                                       expand=None):
    return client.list_exception_occurrence(user_id=user_id,
                                            event_id=event_id,
                                            orderby=orderby,
                                            select=select,
                                            expand=expand)
...
def calendar_update_exception_occurrence(client,
                                         ...
                                         event_id1,
                                         body):
    return client.update_exception_occurrence(user_id=user_id,
                                              event_id=event_id,
                                              event_id1=event_id1,
                                              body=body)
...
def calendar_create_calendar(client,
    ...
    return client.create_calendar(user_id=user_id,
                                  ...
                                  id=id_,
                                  allowed_online_meeting_providers=allowed_online_meeting_providers,
                                  microsoft_graph_calendar_group_id_calendar_group_id=microsoft_graph_calendar_group_id_calendar_group_id,
                                  can_edit=can_edit,
                                  can_share=can_share,
                                  can_view_private_items=can_view_private_items,
                                  change_key=change_key,
