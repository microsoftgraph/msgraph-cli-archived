...
class GroupCalendarViewOperations(object):
    ...
    def list_attachment(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~calendar.models.Enum88]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum89]
    ...
    def get_attachment(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum90]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
    ...
    def list_exception_occurrence(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEvent8"]
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum112]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum113]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum114]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEvent8 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent8]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEvent8"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEvent8', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendarView/{event-id}/exceptionOccurrences'}  # type: ignore
    ...
    def create_exception_occurrence(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendarView/{event-id}/exceptionOccurrences'}  # type: ignore
    ...
    def get_exception_occurrence(
        ...
        **kwargs  # type: Any
        ...
        :type event_id1: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum115]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum116]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendarView/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    update_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendarView/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    delete_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendarView/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    def list_extension(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum117]
        :param select: Select properties to be returned.
    ...
    def list_instance(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEvent9"]
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum120]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEvent9 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent9]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEvent9"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEvent9', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    def list_multi_value_extended_property(
        ...
        group_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum123"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum123]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum124]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum125]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum126]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum127]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum128]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
