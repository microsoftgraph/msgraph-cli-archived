...
class GroupsEventsCalendarOperations(object):
    ...
    def list_calendar_view(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum144"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfEvent11"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent11]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
