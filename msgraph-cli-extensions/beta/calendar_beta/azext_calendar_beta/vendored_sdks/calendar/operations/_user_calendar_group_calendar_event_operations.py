...
class UserCalendarGroupCalendarEventOperations(object):
    """UserCalendarGroupCalendarEventOperations operations.
    ...
    def list_attachment(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~calendar.models.Enum288]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum289]
    ...
    list_attachment.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments'}  # type: ignore
    ...
    def create_attachment(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_attachment.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments'}  # type: ignore
    ...
    def get_attachment(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum290]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
        ...
        return deserialized
    get_attachment.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments/{attachment-id}'}  # type: ignore
    ...
    update_attachment.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments/{attachment-id}'}  # type: ignore
    ...
    delete_attachment.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments/{attachment-id}'}  # type: ignore
    ...
    def get_calendar(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum291]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum292]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_exception_occurrence(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEvent25"]
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum293]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum294]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum295]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEvent25 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent25]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEvent25"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_exception_occurrence.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                    'calendarGroup-id': self._serialize.url("calendar_group_id", calendar_group_id, 'str'),
                    'calendar-id': self._serialize.url("calendar_id", calendar_id, 'str'),
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEvent25', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_exception_occurrence.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/exceptionOccurrences'}  # type: ignore

    def create_exception_occurrence(
        self,
        user_id,  # type: str
        calendar_group_id,  # type: str
        calendar_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_exception_occurrence.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'calendarGroup-id': self._serialize.url("calendar_group_id", calendar_group_id, 'str'),
            'calendar-id': self._serialize.url("calendar_id", calendar_id, 'str'),
        ...
        return deserialized
    create_exception_occurrence.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/exceptionOccurrences'}  # type: ignore

    def get_exception_occurrence(
        self,
        user_id,  # type: str
        calendar_group_id,  # type: str
        calendar_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        :type event_id1: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum296]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum297]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        # Construct URL
        url = self.get_exception_occurrence.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'calendarGroup-id': self._serialize.url("calendar_group_id", calendar_group_id, 'str'),
            'calendar-id': self._serialize.url("calendar_id", calendar_id, 'str'),
        ...
        return deserialized
    get_exception_occurrence.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore

    def update_exception_occurrence(
        self,
        user_id,  # type: str
        calendar_group_id,  # type: str
        calendar_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.update_exception_occurrence.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'calendarGroup-id': self._serialize.url("calendar_group_id", calendar_group_id, 'str'),
            'calendar-id': self._serialize.url("calendar_id", calendar_id, 'str'),
    ...
    update_exception_occurrence.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore

    def delete_exception_occurrence(
        self,
        user_id,  # type: str
        calendar_group_id,  # type: str
        calendar_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_exception_occurrence.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'calendarGroup-id': self._serialize.url("calendar_group_id", calendar_group_id, 'str'),
            'calendar-id': self._serialize.url("calendar_id", calendar_id, 'str'),
    ...
    delete_exception_occurrence.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    def list_extension(
        ...
        calendar_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum298"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum298]
        :param select: Select properties to be returned.
    ...
    list_extension.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions'}  # type: ignore
    ...
    def create_extension(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_extension.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions'}  # type: ignore
    ...
    def get_extension(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_extension.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}'}  # type: ignore
    ...
    update_extension.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}'}  # type: ignore
    ...
    delete_extension.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}'}  # type: ignore
    ...
    def list_instance(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum299]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum300]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum301]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEvent26 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent26]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEvent26"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEvent26', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_instance.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances'}  # type: ignore
    ...
    def create_instance(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_instance.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances'}  # type: ignore
    ...
    def get_instance(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum302"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum303"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphEvent"
        """Get instances from users.
        ...
        :type event_id1: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum302]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum303]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_instance.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances/{event-id1}'}  # type: ignore
    ...
    update_instance.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances/{event-id1}'}  # type: ignore
    ...
    delete_instance.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances/{event-id1}'}  # type: ignore
    ...
    def list_multi_value_extended_property(
        ...
        calendar_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum304"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum305"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum304]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum305]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_multi_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/multiValueExtendedProperties'}  # type: ignore
    ...
    def create_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_multi_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/multiValueExtendedProperties'}  # type: ignore
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum306]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
        ...
        return deserialized
    get_multi_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    update_multi_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    delete_multi_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_single_value_extended_property(
        ...
        calendar_id,  # type: str
        event_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum307"]]]
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum307]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum308]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_single_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/singleValueExtendedProperties'}  # type: ignore
    ...
    def create_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_single_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/singleValueExtendedProperties'}  # type: ignore
    ...
    def get_single_value_extended_property(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum309"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphSingleValueLegacyExtendedProperty"
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum309]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
        ...
        return deserialized
    get_single_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    update_single_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    delete_single_value_extended_property.metadata = {'url': '/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
