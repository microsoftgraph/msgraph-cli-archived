...
class GroupCalendarCalendarViewOperations(object):
    ...
    def list_attachment(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~calendar.models.Enum28]
    ...
    def get_calendar(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum31]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum32]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendar/calendarView/{event-id}/exceptionOccurrences'}  # type: ignore
    ...
    def create_exception_occurrence(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendar/calendarView/{event-id}/exceptionOccurrences'}  # type: ignore
    ...
    def get_exception_occurrence(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendar/calendarView/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    update_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendar/calendarView/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    delete_exception_occurrence.metadata = {'url': '/groups/{group-id}/calendar/calendarView/{event-id}/exceptionOccurrences/{event-id1}'}  # type: ignore
    ...
    def list_instance(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEvent1"]
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum39]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum40]
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum41]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEvent1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~calendar.models.CollectionOfEvent1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_instance(
        ...
        **kwargs  # type: Any
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~calendar.models.Enum43]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEvent, or the result of cls(response)
        :rtype: ~calendar.models.MicrosoftGraphEvent
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum46]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type event_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~calendar.models.Enum47]
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum48]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~calendar.models.Enum49]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
