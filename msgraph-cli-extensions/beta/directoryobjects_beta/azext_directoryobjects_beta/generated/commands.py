...
def load_command_table(self, _):
    ...
    with self.command_group('directoryobjects', directoryobjects_beta_directory_object_directory_object,
    ...
    with self.command_group('directoryobjects', directoryobjects_beta_directory_object,
        ...
        g.custom_command('get-user-owned-object', 'directoryobjects_get_user_owned_object')
