...
def load_command_table(self, _):
    ...
    directoryobjects_beta_directory_object_directory_object = CliCommandType(
        operations_tmpl='azext_directoryobjects_beta.vendored_sdks.directoryobjects.operations._directory_objects_direc'
    ...
    directoryobjects_beta_directory_object = CliCommandType(
        operations_tmpl='azext_directoryobjects_beta.vendored_sdks.directoryobjects.operations._directory_objects_opera'
