...
def load_command_table(self, _):
    ...
    with self.command_group(
        'directoryobjects directory-object-directory-object', directoryobjects_beta_directory_object_directory_object
    ) as g:
    ...
    with self.command_group('directoryobjects directory-object', directoryobjects_beta_directory_object) as g:
