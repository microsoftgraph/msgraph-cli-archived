...
from azext_directoryobjects_beta.generated._client_factory import cf_directoryobjectsdirectoryobject, cf_directoryobject


directoryobjects_beta_directoryobjectsdirectoryobject = CliCommandType(
    operations_tmpl='azext_directoryobjects_beta.vendored_sdks.directoryobjects.operations._directoryobjectsdirectoryobject_operations#directoryobjectsdirectoryobjectOperations.{}',
    client_factory=cf_directoryobjectsdirectoryobject,
)


directoryobjects_beta_directoryobject = CliCommandType(
    operations_tmpl='azext_directoryobjects_beta.vendored_sdks.directoryobjects.operations._directoryobjects_operations#directoryobjectsOperations.{}',
...
def load_command_table(self, _):
    ...
    with self.command_group(
        ...
        directoryobjects_beta_directoryobjectsdirectoryobject,
        client_factory=cf_directoryobjectsdirectoryobject,
    ) as g:
        g.custom_command(
    ...
    with self.command_group(
        'directoryobjects directoryobject', directoryobjects_beta_directoryobject, client_factory=cf_directoryobject
    ) as g:
        ...
        g.custom_command('get-user-owned-object', 'directoryobjects_directoryobject_get_user_owned_object')
