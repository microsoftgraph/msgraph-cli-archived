...
try:
    ...
    from ._models_py3 import paths50tm3xdirectoryobjectsmicrosoftgraphgetuserownedobjectspostrequestbodycontentapplicationjsonschema
    ...
    from ._models import paths50tm3xdirectoryobjectsmicrosoftgraphgetuserownedobjectspostrequestbodycontentapplicationjsonschema  # type: ignore
