...
from ._configuration_async import ChangeNotificationsConfiguration
...
class ChangeNotifications(object):
    ...
    :vartype subscription_subscription: change_notifications.aio.operations_async.SubscriptionSubscriptionOperations
