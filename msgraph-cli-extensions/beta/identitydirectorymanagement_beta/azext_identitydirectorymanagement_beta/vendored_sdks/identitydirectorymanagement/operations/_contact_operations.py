...
class ContactOperations(object):
    """ContactOperations operations.
    ...
    def list_direct_report(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~identity_directory_management.models.Enum18]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum19]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject0]
    ...
    def list_ref_direct_report(
        ...
        **kwargs  # type: Any
        ...
        :type org_contact_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum20]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfLinksOfDirectoryObject0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_member_of(
        ...
        **kwargs  # type: Any
        ...
        :type org_contact_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_directory_management.models.Enum22]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum23]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfDirectoryObject1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfDirectoryObject1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_member_of(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfLinksOfDirectoryObject1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> List["models.MicrosoftGraphOrgContact"]
    ...
    def get_user_owned_object(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Bsgnp0ContactsMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema(user_id=user_id, type=type)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths1Bsgnp0ContactsMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    get_user_owned_object.metadata = {'url': '/contacts/microsoft.graph.getUserOwnedObjects'}  # type: ignore
