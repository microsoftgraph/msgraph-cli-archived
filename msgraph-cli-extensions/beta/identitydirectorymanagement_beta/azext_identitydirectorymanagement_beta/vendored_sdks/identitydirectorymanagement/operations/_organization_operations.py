...
class OrganizationOperations(object):
    ...
    def get_branding(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MicrosoftGraphOrganizationalBranding"
        ...
        :type select: list[str or ~identity_directory_management.models.Enum110]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_directory_management.models.Enum111]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOrganizationalBranding, or the result of cls(response)
        :rtype: ~identity_directory_management.models.MicrosoftGraphOrganizationalBranding
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MicrosoftGraphOrganizationalBranding"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"

        # Construct URL
        url = self.get_branding.metadata['url']  # type: ignore
        ...
        deserialized = self._deserialize('MicrosoftGraphOrganizationalBranding', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    get_branding.metadata = {'url': '/organization/{organization-id}/branding'}  # type: ignore
    ...
    def update_branding(
        ...
        background_image=None,  # type: Optional[bytes]
        banner_logo=None,  # type: Optional[bytes]
        sign_in_page_text=None,  # type: Optional[str]
        square_logo=None,  # type: Optional[bytes]
        username_hint_text=None,  # type: Optional[str]
        localizations=None,  # type: Optional[List["models.MicrosoftGraphOrganizationalBrandingLocalization"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        _body = models.MicrosoftGraphOrganizationalBranding(id=id, background_color=background_color, background_image=background_image, banner_logo=banner_logo, sign_in_page_text=sign_in_page_text, square_logo=square_logo, username_hint_text=username_hint_text, localizations=localizations)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.update_branding.metadata['url']  # type: ignore
        path_format_arguments = {
            'organization-id': self._serialize.url("organization_id", organization_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphOrganizationalBranding')
    ...
    update_branding.metadata = {'url': '/organization/{organization-id}/branding'}  # type: ignore
    ...
    def delete_branding(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_branding.metadata['url']  # type: ignore
        path_format_arguments = {
            'organization-id': self._serialize.url("organization_id", organization_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    delete_branding.metadata = {'url': '/organization/{organization-id}/branding'}  # type: ignore
    ...
    def list_extension(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~identity_directory_management.models.Enum112]
        :param select: Select properties to be returned.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_directory_management.models.CollectionOfExtension1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def check_member_group(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsMf08MlOrganizationIdMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema(group_ids=group_ids)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PathsMf08MlOrganizationIdMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def check_member_object(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Yxqrp7OrganizationIdMicrosoftGraphCheckmemberobjectsPostRequestbodyContentApplicationJsonSchema(ids=ids)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths1Yxqrp7OrganizationIdMicrosoftGraphCheckmemberobjectsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def get_member_group(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsPlvqruOrganizationIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema(security_enabled_only=security_enabled_only)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PathsPlvqruOrganizationIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def get_member_object(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Hzls82OrganizationIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema(security_enabled_only=security_enabled_only)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths1Hzls82OrganizationIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def restore(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    restore.metadata = {'url': '/organization/{organization-id}/microsoft.graph.restore'}  # type: ignore
    ...
    def set_mobile_device_management_authority(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.set_mobile_device_management_authority.metadata['url']  # type: ignore
        path_format_arguments = {
            'organization-id': self._serialize.url("organization_id", organization_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def get_setting(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MicrosoftGraphOrganizationSettings"
        ...
        :type organization_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum113]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_directory_management.models.Enum114]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOrganizationSettings, or the result of cls(response)
        :rtype: ~identity_directory_management.models.MicrosoftGraphOrganizationSettings
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MicrosoftGraphOrganizationSettings"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        deserialized = self._deserialize('MicrosoftGraphOrganizationSettings', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    get_setting.metadata = {'url': '/organization/{organization-id}/settings'}  # type: ignore

    def update_setting(
        self,
        organization_id,  # type: str
        id=None,  # type: Optional[str]
        item_insights=None,  # type: Optional["models.MicrosoftGraphItemInsightsSettings"]
        profile_card_properties=None,  # type: Optional[List["models.MicrosoftGraphProfileCardProperty"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        _body = models.MicrosoftGraphOrganizationSettings(id=id, item_insights=item_insights, profile_card_properties=profile_card_properties)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphOrganizationSettings')
        body_content_kwargs['content'] = body_content
        request = self._client.patch(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    update_setting.metadata = {'url': '/organization/{organization-id}/settings'}  # type: ignore
    ...
    delete_setting.metadata = {'url': '/organization/{organization-id}/settings'}  # type: ignore
    ...
    def get_by_id(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths11G1VgqOrganizationMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema(ids=ids, types=types)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths11G1VgqOrganizationMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def get_user_owned_object(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsMsgcxjOrganizationMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema(user_id=user_id, type=type)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PathsMsgcxjOrganizationMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    get_user_owned_object.metadata = {'url': '/organization/microsoft.graph.getUserOwnedObjects'}  # type: ignore
    ...
    def validate_property(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1G440InOrganizationMicrosoftGraphValidatepropertiesPostRequestbodyContentApplicationJsonSchema(entity_type=entity_type, display_name=display_name, mail_nickname=mail_nickname, on_behalf_of_user_id=on_behalf_of_user_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths1G440InOrganizationMicrosoftGraphValidatepropertiesPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
