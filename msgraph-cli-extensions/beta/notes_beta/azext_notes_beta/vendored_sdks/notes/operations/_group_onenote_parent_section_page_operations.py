...
class GroupOnenoteParentSectionPageOperations(object):
    """GroupOnenoteParentSectionPageOperations operations.
    ...
    def get_page_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_page_content.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}/content'}  # type: ignore
    ...
    set_page_content.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}/content'}  # type: ignore
