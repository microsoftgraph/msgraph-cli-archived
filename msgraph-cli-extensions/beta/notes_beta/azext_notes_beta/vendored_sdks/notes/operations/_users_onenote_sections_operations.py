...
class UsersOnenoteSectionsOperations(object):
    ...
    def get_pages_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
