...
class sitesonenoteparentsectionpagesOperations(object):
    """sitesonenoteparentsectionpagesOperations operations.
    ...
    def get_pages_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}/content'}  # type: ignore
