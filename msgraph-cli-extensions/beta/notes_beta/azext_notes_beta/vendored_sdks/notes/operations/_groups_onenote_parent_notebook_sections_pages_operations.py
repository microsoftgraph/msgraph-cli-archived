...
class GroupsOnenoteParentNotebookSectionsPagesOperations(object):
    """GroupsOnenoteParentNotebookSectionsPagesOperations operations.
    ...
    def get_pages_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}/content'}  # type: ignore
