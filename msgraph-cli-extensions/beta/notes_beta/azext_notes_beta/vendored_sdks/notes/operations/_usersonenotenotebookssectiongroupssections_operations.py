...
class usersonenotenotebookssectiongroupssectionsOperations(object):
    """usersonenotenotebookssectiongroupssectionsOperations operations.
    ...
    def list_pages(
        ...
        orderby=None,  # type: Optional[List[Union[str, "models.Enum756"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum757"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum758"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.collectionofonenotepage17"]
        ...
        :type orderby: list[str or ~notes.models.Enum756]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum757]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum758]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofonenotepage17 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.collectionofonenotepage17]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.collectionofonenotepage17"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionofonenotepage17', pipeline_response)
    ...
    list_pages.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    def create_pages(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_pages.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    def get_pages(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum759"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum760"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.microsoftgraphonenotepage"
        """Get pages from users.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum759]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum760]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphonenotepage, or the result of cls(response)
        :rtype: ~notes.models.microsoftgraphonenotepage
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_pages.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    update_pages.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    delete_pages.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}'}  # type: ignore
    ...
    def get_pages_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    def get_parent_notebook(
        ...
        **kwargs  # type: Any
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum765]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum766]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_notebook.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        section_group_id,  # type: str
        onenote_section_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum767"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum768"]]]
        **kwargs  # type: Any
    ):
        ...
        :type onenote_section_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum767]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum768]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section_group.metadata = {'url': '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentSectionGroup'}  # type: ignore
