...
class UsersOnenoteParentNotebookSectionGroupsSectionsPagesOperations(object):
    """UsersOnenoteParentNotebookSectionGroupsSectionsPagesOperations operations.
    ...
    def get_pages_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id1}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id1}/content'}  # type: ignore
