...
class UserOnenoteParentNotebookSectionGroupSectionPageOperations(object):
    """UserOnenoteParentNotebookSectionGroupSectionPageOperations operations.
    ...
    def get_page_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_page_content.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id1}/content'}  # type: ignore
    ...
    set_page_content.metadata = {'url': '/users/{user-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id1}/content'}  # type: ignore
