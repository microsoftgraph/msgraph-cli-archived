...
class groupsonenotesectiongroupsparentnotebooksectionsOperations:
    """groupsonenotesectiongroupsparentnotebooksectionsOperations async operations.
    ...
    async def get_pages_content(
        ...
        **kwargs
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
