...
class GroupsOnenoteNotebooksSectionsOperations:
    ...
    async def get_pages_content(
        ...
        **kwargs
        ...
        return deserialized
    get_pages_content.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
    ...
    set_pages_content.metadata = {'url': '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content'}  # type: ignore
