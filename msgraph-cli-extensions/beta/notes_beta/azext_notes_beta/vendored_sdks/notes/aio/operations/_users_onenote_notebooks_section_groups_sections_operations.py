...
class UsersOnenoteNotebooksSectionGroupsSectionsOperations:
    """UsersOnenoteNotebooksSectionGroupsSectionsOperations async operations.
    ...
    def list_pages(
        ...
        orderby: Optional[List[Union[str, "models.Enum756"]]] = None,
        select: Optional[List[Union[str, "models.Enum757"]]] = None,
        expand: Optional[List[Union[str, "models.Enum758"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOnenotePage17"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~notes.models.CollectionOfOnenotePage17]
    ...
    async def get_pages(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        select: Optional[List[Union[str, "models.Enum759"]]] = None,
        expand: Optional[List[Union[str, "models.Enum760"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphOnenotePage":
        """Get pages from users.
    ...
    async def get_parent_section_group(
        ...
        section_group_id: str,
        onenote_section_id: str,
        select: Optional[List[Union[str, "models.Enum767"]]] = None,
        expand: Optional[List[Union[str, "models.Enum768"]]] = None,
        **kwargs
