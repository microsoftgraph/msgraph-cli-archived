...
class CommunicationsOperations:
    ...
    async def create_calls(
        self,
        body: "models.MicrosoftGraphCall",
        **kwargs
    ...
    async def get_presences_by_user_id(
        self,
        body: "models.Paths10WpgkzCommunicationsMicrosoftGraphGetpresencesbyuseridPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ...
    async def update_online_meetings(
        self,
        online_meeting_id: str,
        body: "models.MicrosoftGraphOnlineMeeting",
        **kwargs
    ...
    async def delete_online_meetings(
        self,
        online_meeting_id: str,
        if_match: Optional[str] = None,
        **kwargs
