...
class CommunicationOperations:
    ...
    async def list_call(
        ...
        expand: Optional[List[Union[str, "models.Enum39"]]] = None,
        **kwargs
    ) -> "models.CollectionOfCall":
