...
class CommunicationCallRecordOperations(object):
    """CommunicationCallRecordOperations operations.
    ...
    def create_session(
        ...
        segments=None,  # type: Optional[List["models.MicrosoftGraphCallRecordsSegment"]]
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphCallRecordsSession(id=id, end_date_time=end_date_time, failure_info=failure_info, modalities=modalities, start_date_time=start_date_time, segments=segments, user_agent_caller_user_agent=user_agent_parameter, user_agent_callee_user_agent=microsoft_graph_call_records_user_agent)
