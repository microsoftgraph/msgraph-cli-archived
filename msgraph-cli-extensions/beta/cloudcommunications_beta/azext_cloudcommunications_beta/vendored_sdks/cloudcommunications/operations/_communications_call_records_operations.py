...
class CommunicationsCallRecordsOperations(object):
    """CommunicationsCallRecordsOperations operations.
    ...
    def list_sessions(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfSession"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~cloud_communications.models.CollectionOfSession]
    ...
    list_sessions.metadata = {'url': '/communications/callRecords/{callRecord-id}/sessions'}  # type: ignore

    def create_sessions(
        self,
        call_record_id,  # type: str
        body,  # type: "models.MicrosoftGraphCallRecordsSession"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphCallRecordsSession"
        ...
        :type body: ~cloud_communications.models.MicrosoftGraphCallRecordsSession
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.create_sessions.metadata['url']  # type: ignore
        path_format_arguments = {
            'callRecord-id': self._serialize.url("call_record_id", call_record_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphCallRecordsSession')
        ...
        return deserialized
    create_sessions.metadata = {'url': '/communications/callRecords/{callRecord-id}/sessions'}  # type: ignore
    ...
    def get_sessions(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_sessions.metadata['url']  # type: ignore
        path_format_arguments = {
            'callRecord-id': self._serialize.url("call_record_id", call_record_id, 'str'),
        ...
        return deserialized
    get_sessions.metadata = {'url': '/communications/callRecords/{callRecord-id}/sessions/{session-id}'}  # type: ignore
    ...
    def update_sessions(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.update_sessions.metadata['url']  # type: ignore
        path_format_arguments = {
            'callRecord-id': self._serialize.url("call_record_id", call_record_id, 'str'),
            'session-id': self._serialize.url("session_id", session_id, 'str'),
        }
    ...
    update_sessions.metadata = {'url': '/communications/callRecords/{callRecord-id}/sessions/{session-id}'}  # type: ignore
    ...
    def delete_sessions(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_sessions.metadata['url']  # type: ignore
        path_format_arguments = {
            'callRecord-id': self._serialize.url("call_record_id", call_record_id, 'str'),
            'session-id': self._serialize.url("session_id", session_id, 'str'),
        }
    ...
    delete_sessions.metadata = {'url': '/communications/callRecords/{callRecord-id}/sessions/{session-id}'}  # type: ignore
