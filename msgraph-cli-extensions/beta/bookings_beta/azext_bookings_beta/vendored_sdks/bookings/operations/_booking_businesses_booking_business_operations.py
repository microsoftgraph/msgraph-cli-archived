...
class BookingBusinessesBookingBusinessOperations(object):
    """BookingBusinessesBookingBusinessOperations operations.
    ...
    def create_booking_business(
        self,
        body,  # type: "models.MicrosoftGraphBookingBusiness"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~bookings.models.MicrosoftGraphBookingBusiness
        :keyword callable cls: A custom type or function that will be passed the direct response
