...
class BookingBusinessesAppointmentsOperations:
    """BookingBusinessesAppointmentsOperations async operations.
    ...
    async def cancel(
        ...
        body: "models.Paths1K88Cl0BookingbusinessesBookingbusinessIdAppointmentsBookingappointmentIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
