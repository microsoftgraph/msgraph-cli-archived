...
class BookingBusinessCalendarViewOperations:
    """BookingBusinessCalendarViewOperations async operations.
    ...
    async def cancel(
        ...
        **kwargs
        ...
        body = models.Paths1Bomg32BookingbusinessesBookingbusinessIdCalendarviewBookingappointmentIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema(cancellation_message=cancellation_message)
