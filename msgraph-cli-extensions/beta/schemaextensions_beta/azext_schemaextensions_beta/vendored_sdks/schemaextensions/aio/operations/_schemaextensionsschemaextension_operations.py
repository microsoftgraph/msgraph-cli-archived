...
class schemaextensionsschemaextensionOperations:
    """schemaextensionsschemaextensionOperations async operations.
    ...
    async def create_schema_extension(
        self,
        body: "models.microsoftgraphschemaextension",
        **kwargs
        ...
        :type body: ~schema_extensions.models.microsoftgraphschemaextension
        :keyword callable cls: A custom type or function that will be passed the direct response
