...
class schemaextensionsschemaextensionOperations(object):
    """schemaextensionsschemaextensionOperations operations.
    ...
    def create_schema_extension(
        self,
        body,  # type: "models.microsoftgraphschemaextension"
        **kwargs  # type: Any
    ):
