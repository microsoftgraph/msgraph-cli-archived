...
|[az mail user create-folder](#usersCreateMailFolders)|CreateMailFolders|[Parameters](#ParametersusersCreateMailFolders)|Not Found|
|[az mail user create-message](#usersCreateMessages)|CreateMessages|[Parameters](#ParametersusersCreateMessages)|Not Found|
|[az mail user list-folder](#usersListMailFolders)|ListMailFolders|[Parameters](#ParametersusersListMailFolders)|Not Found|
...
|[az mail user update-folder](#usersUpdateMailFolders)|UpdateMailFolders|[Parameters](#ParametersusersUpdateMailFolders)|Not Found|
...
|[az mail user-mail-folder delete](#users.mailFoldersDeleteUserConfigurations)|DeleteUserConfigurations|[Parameters](#Parametersusers.mailFoldersDeleteUserConfigurations)|Not Found|
...
|[az mail user-mail-folder-message delete](#users.mailFolders.messagesDeleteMentions)|DeleteMentions|[Parameters](#Parametersusers.mailFolders.messagesDeleteMentions)|Not Found|
...
|[az mail user-message delete](#users.messagesDeleteMentions)|DeleteMentions|[Parameters](#Parametersusers.messagesDeleteMentions)|Not Found|
...
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
#### <a name="usersCreateMailFolders">Command `az mail user create-folder`</a>
...
#### <a name="usersListMailFolders">Command `az mail user list-folder`</a>
...
#### <a name="usersUpdateMailFolders">Command `az mail user update-folder`</a>
...
#### <a name="users.mailFoldersDeleteUserConfigurations">Command `az mail user-mail-folder delete`</a>
...
#### <a name="users.mailFoldersCreateUserConfigurations">Command `az mail user-mail-folder create-user-configuration`</a>
...
#### <a name="users.mailFolders.messagesDeleteMentions">Command `az mail user-mail-folder-message delete`</a>
...
#### <a name="users.mailFolders.messagesListMentions">Command `az mail user-mail-folder-message list-mention`</a>
...
#### <a name="users.mailFolders.messagesGetMentions">Command `az mail user-mail-folder-message show-mention`</a>
...
#### <a name="users.mailFolders.messagesUpdateMentions">Command `az mail user-mail-folder-message update-mention`</a>
...
#### <a name="users.messagesDeleteMentions">Command `az mail user-message delete`</a>
...
#### <a name="users.messagesCreateMentions">Command `az mail user-message create-mention`</a>
...
#### <a name="users.messagesListMentions">Command `az mail user-message list-mention`</a>
...
#### <a name="users.messagesGetMentions">Command `az mail user-message show-mention`</a>
...
#### <a name="users.messagesUpdateMentions">Command `az mail user-message update-mention`</a>
