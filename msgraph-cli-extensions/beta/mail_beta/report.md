...
#### <a name="users.mailFolders.messagesDeleteMentions">Command `az mail user-mail-folder-message delete-mention`</a>
...
#### <a name="users.messagesDeleteMentions">Command `az mail user-message delete-mention`</a>
