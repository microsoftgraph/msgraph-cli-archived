...
class UsersMailFoldersOperations:
    ...
    async def get_messages_content(
        self,
        user_id: str,
        mail_folder_id: str,
        message_id: str,
    ...
    async def set_messages_content(
        self,
        user_id: str,
        mail_folder_id: str,
        message_id: str,
    ...
    def list_user_configurations(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~mail.models.CollectionOfUserConfiguration]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_user_configurations(
        self,
        user_id: str,
        mail_folder_id: str,
        body: "models.MicrosoftGraphUserConfiguration",
        **kwargs
