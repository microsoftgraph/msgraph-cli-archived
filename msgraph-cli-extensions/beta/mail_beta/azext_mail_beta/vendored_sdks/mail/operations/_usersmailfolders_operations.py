...
class usersmailfoldersOperations(object):
    ...
    def get_messages_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_messages_content.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/$value'}  # type: ignore
    ...
    set_messages_content.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/$value'}  # type: ignore
    ...
    def list_user_configurations(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_user_configurations.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                    'mailFolder-id': self._serialize.url("mail_folder_id", mail_folder_id, 'str'),
                }
    ...
    list_user_configurations.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/userConfigurations'}  # type: ignore

    def create_user_configurations(
        self,
        user_id,  # type: str
        mail_folder_id,  # type: str
        body,  # type: "models.microsoftgraphuserconfiguration"
        **kwargs  # type: Any
    ):
        ...
        :type mail_folder_id: str
        :param body: New navigation property.
        :type body: ~mail.models.microsoftgraphuserconfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.create_user_configurations.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'mailFolder-id': self._serialize.url("mail_folder_id", mail_folder_id, 'str'),
        }
        ...
        return deserialized
    create_user_configurations.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/userConfigurations'}  # type: ignore
    ...
    def get_user_configurations(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_user_configurations.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'mailFolder-id': self._serialize.url("mail_folder_id", mail_folder_id, 'str'),
        ...
        return deserialized
    get_user_configurations.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/userConfigurations/{userConfiguration-id}'}  # type: ignore
    ...
    def update_user_configurations(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.update_user_configurations.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'mailFolder-id': self._serialize.url("mail_folder_id", mail_folder_id, 'str'),
            'userConfiguration-id': self._serialize.url("user_configuration_id", user_configuration_id, 'str'),
    ...
    update_user_configurations.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/userConfigurations/{userConfiguration-id}'}  # type: ignore
    ...
    def delete_user_configurations(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_user_configurations.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'mailFolder-id': self._serialize.url("mail_folder_id", mail_folder_id, 'str'),
            'userConfiguration-id': self._serialize.url("user_configuration_id", user_configuration_id, 'str'),
    ...
    delete_user_configurations.metadata = {'url': '/users/{user-id}/mailFolders/{mailFolder-id}/userConfigurations/{userConfiguration-id}'}  # type: ignore
