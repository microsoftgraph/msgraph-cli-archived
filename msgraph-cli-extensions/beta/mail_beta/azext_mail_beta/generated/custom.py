...
def mail_user_mail_folder_create_message_rule(client,
    ...
    body['exceptions']['is_approval_request'] = is_approval_request
    body['exceptions']['is_automatic_forward'] = is_automatic_forward
    body['exceptions']['is_automatic_reply'] = is_automatic_reply
    body['exceptions']['is_encrypted'] = is_encrypted
    body['exceptions']['is_meeting_request'] = is_meeting_request
    body['exceptions']['is_meeting_response'] = is_meeting_response
    body['exceptions']['is_non_delivery_report'] = is_non_delivery_report
    body['exceptions']['is_permission_controlled'] = is_permission_controlled
    body['exceptions']['is_read_receipt'] = is_read_receipt
    body['exceptions']['is_signed'] = is_signed
    body['exceptions']['is_voicemail'] = is_voicemail
