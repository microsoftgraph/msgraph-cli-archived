...
mail_beta_usersinferenceclassification = CliCommandType(
    operations_tmpl='azext_mail_beta.vendored_sdks.mail.operations._usersinferenceclassification_operations#usersinferenceclassificationOperations.{}',
    client_factory=cf_usersinferenceclassification,
)


mail_beta_usersmailfolder = CliCommandType(
    operations_tmpl=(
        'azext_mail_beta.vendored_sdks.mail.operations._usersmailfolders_operations#usersmailfoldersOperations.{}'
    ),
    client_factory=cf_usersmailfolder,
)


mail_beta_usersmailfoldersmessage = CliCommandType(
    operations_tmpl='azext_mail_beta.vendored_sdks.mail.operations._usersmailfoldersmessages_operations#usersmailfoldersmessagesOperations.{}',
    client_factory=cf_usersmailfoldersmessage,
)


mail_beta_usersmessage = CliCommandType(
    operations_tmpl=(
        'azext_mail_beta.vendored_sdks.mail.operations._usersmessages_operations#usersmessagesOperations.{}'
    ),
...
def load_command_table(self, _):
    ...
    with self.command_group(
        ...
        mail_beta_usersinferenceclassification,
        client_factory=cf_usersinferenceclassification,
    ) as g:
    ...
    with self.command_group('mail usersmailfolder', mail_beta_usersmailfolder, client_factory=cf_usersmailfolder) as g:
        ...
        g.custom_command('create-user-configuration', 'mail_usersmailfolder_create_user_configuration')
        ...
        g.custom_command('delete-user-configuration', 'mail_usersmailfolder_delete_user_configuration')
        ...
        g.custom_command('list-user-configuration', 'mail_usersmailfolder_list_user_configuration')
        g.custom_command('set-message-content', 'mail_usersmailfolder_set_message_content')
        ...
        g.custom_command('show-message-content', 'mail_usersmailfolder_show_message_content')
        ...
        g.custom_command('show-user-configuration', 'mail_usersmailfolder_show_user_configuration')
        ...
        g.custom_command('update-user-configuration', 'mail_usersmailfolder_update_user_configuration')

    with self.command_group(
        'mail usersmailfoldersmessage', mail_beta_usersmailfoldersmessage, client_factory=cf_usersmailfoldersmessage
    ) as g:
        ...
        g.custom_command('create-mention', 'mail_usersmailfoldersmessage_create_mention')
        g.custom_command(
        ...
        g.custom_command('delete-mention', 'mail_usersmailfoldersmessage_delete_mention')
        g.custom_command(
        ...
        g.custom_command('list-mention', 'mail_usersmailfoldersmessage_list_mention')
        g.custom_command(
        ...
        g.custom_command('show-mention', 'mail_usersmailfoldersmessage_show_mention')
        g.custom_command(
        ...
        g.custom_command('update-mention', 'mail_usersmailfoldersmessage_update_mention')
        g.custom_command(
    ...
    with self.command_group('mail usersmessage', mail_beta_usersmessage, client_factory=cf_usersmessage) as g:
        ...
        g.custom_command('create-mention', 'mail_usersmessage_create_mention')
        g.custom_command(
        ...
        g.custom_command('delete-mention', 'mail_usersmessage_delete_mention')
        g.custom_command(
        ...
        g.custom_command('list-mention', 'mail_usersmessage_list_mention')
        ...
        g.custom_command('show-mention', 'mail_usersmessage_show_mention')
        ...
        g.custom_command('update-mention', 'mail_usersmessage_update_mention')
        g.custom_command(
