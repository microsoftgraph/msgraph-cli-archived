...
class SearchOperations(object):
    ...
    def query(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Kd2XrlSearchMicrosoftGraphQueryPostRequestbodyContentApplicationJsonSchema(requests=requests)
        ...
        body_content = self._serialize.body(_body, 'Paths1Kd2XrlSearchMicrosoftGraphQueryPostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    query.metadata = {'url': '/search/microsoft.graph.query'}  # type: ignore
