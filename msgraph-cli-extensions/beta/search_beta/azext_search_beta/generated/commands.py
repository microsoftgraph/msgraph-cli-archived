...
def load_command_table(self, _):
    ...
    with self.command_group('search external-external', search_beta_external_external) as g:
    ...
    with self.command_group('search external', search_beta_external) as g:
    ...
    with self.command_group('search search-entity', search_beta_search_search_entity) as g:
    ...
    with self.command_group('search search', search_beta_search) as g:
