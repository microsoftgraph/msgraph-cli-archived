...
class UserOperations(object):
    ...
    def update_analytic(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphUserAnalytics(id=id, settings=settings, activity_statistics=activity_statistics)
    ...
    def update_profile(
        ...
        interests=None,  # type: Optional[List["models.MicrosoftGraphPersonInterest"]]
        ...
        skills=None,  # type: Optional[List["models.MicrosoftGraphSkillProficiency"]]
