...
class TeamInstalledAppOperations(object):
    """TeamInstalledAppOperations operations.
    ...
    def get_team_app(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_team_app.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsApp'}  # type: ignore

    def get_ref_team_app(
        self,
        team_id,  # type: str
        teams_app_installation_id,  # type: str
        **kwargs  # type: Any
        ...
        return deserialized
    get_ref_team_app.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsApp/$ref'}  # type: ignore

    def set_ref_team_app(
        self,
        team_id,  # type: str
        teams_app_installation_id,  # type: str
    ...
    set_ref_team_app.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsApp/$ref'}  # type: ignore

    def delete_ref_team_app(
        self,
        team_id,  # type: str
        teams_app_installation_id,  # type: str
    ...
    delete_ref_team_app.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsApp/$ref'}  # type: ignore
    ...
    def get_team_app_definition(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_team_app_definition.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsAppDefinition'}  # type: ignore

    def get_ref_team_app_definition(
        self,
        team_id,  # type: str
        teams_app_installation_id,  # type: str
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_ref_team_app_definition.metadata['url']  # type: ignore
        path_format_arguments = {
            'team-id': self._serialize.url("team_id", team_id, 'str'),
            'teamsAppInstallation-id': self._serialize.url("teams_app_installation_id", teams_app_installation_id, 'str'),
        }
        ...
        return deserialized
    get_ref_team_app_definition.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsAppDefinition/$ref'}  # type: ignore

    def set_ref_team_app_definition(
        self,
        team_id,  # type: str
        teams_app_installation_id,  # type: str
        body,  # type: Dict[str, object]
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.set_ref_team_app_definition.metadata['url']  # type: ignore
        path_format_arguments = {
            'team-id': self._serialize.url("team_id", team_id, 'str'),
            'teamsAppInstallation-id': self._serialize.url("teams_app_installation_id", teams_app_installation_id, 'str'),
        }
    ...
    set_ref_team_app_definition.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsAppDefinition/$ref'}  # type: ignore

    def delete_ref_team_app_definition(
        self,
        team_id,  # type: str
        teams_app_installation_id,  # type: str
        if_match=None,  # type: Optional[str]
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_ref_team_app_definition.metadata['url']  # type: ignore
        path_format_arguments = {
            'team-id': self._serialize.url("team_id", team_id, 'str'),
            'teamsAppInstallation-id': self._serialize.url("teams_app_installation_id", teams_app_installation_id, 'str'),
        }
    ...
    delete_ref_team_app_definition.metadata = {'url': '/teams/{team-id}/installedApps/{teamsAppInstallation-id}/teamsAppDefinition/$ref'}  # type: ignore
