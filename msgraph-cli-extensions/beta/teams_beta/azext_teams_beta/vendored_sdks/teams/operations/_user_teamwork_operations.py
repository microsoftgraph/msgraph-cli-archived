...
class UserTeamworkOperations(object):
    ...
    def list_installed_app(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfUserScopeTeamsAppInstallation"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~teams.models.CollectionOfUserScopeTeamsAppInstallation]
    ...
    def create_installed_app(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MicrosoftGraphUserScopeTeamsAppInstallation"
        ...
        body = models.MicrosoftGraphUserScopeTeamsAppInstallation(id=id, id_teams_app_definition_id=microsoft_graph_entity_id, azure_ad_app_id=azure_ad_app_id, description=description, display_name_teams_app_definition_display_name=display_name, last_modified_date_time=last_modified_date_time, publishing_state=publishing_state, shortdescription=shortdescription, teams_app_id=teams_app_id, version=version, application=application, device=device, user=user, id_teams_app_id=id1, display_name_teams_app_display_name=microsoft_graph_teams_app_display_name, distribution_method=distribution_method, external_id=external_id, app_definitions=app_definitions, id_chat_id=id2, created_date_time=created_date_time, last_updated_date_time=last_updated_date_time, topic=topic, installed_apps=installed_apps, members=members, messages=messages, tabs=tabs)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphUserScopeTeamsAppInstallation')
    ...
    def get_installed_app(
        self,
        user_id,  # type: str
        user_scope_teams_app_installation_id,  # type: str
