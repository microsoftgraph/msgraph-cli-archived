...
class ChatOperations(object):
    ...
    def send_activity_notification(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1BjzoobChatsChatIdMicrosoftGraphSendactivitynotificationPostRequestbodyContentApplicationJsonSchema(topic=topic, activity_type=activity_type, chain_id=chain_id, preview_text=preview_text, template_parameters=template_parameters, recipient=recipient)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
