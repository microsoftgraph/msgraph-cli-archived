...
class ChatsMessagesRepliesOperations(object):
    """ChatsMessagesRepliesOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/chats/{chat-id}/messages/{chatMessage-id}/replies/microsoft.graph.delta()'}  # type: ignore
