...
class UserOperations(object):
    ...
    def create_chat(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphChat(id=id, created_date_time=created_date_time, last_updated_date_time=last_updated_date_time, topic=topic, installed_apps=installed_apps, members=members, messages=messages, tabs=tabs)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphChat')
    ...
    def update_teamwork(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphUserTeamwork(id=id, installed_apps=installed_apps)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'MicrosoftGraphUserTeamwork')
        body_content_kwargs['content'] = body_content
        request = self._client.patch(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
