...
class UsersOperations(object):
    ...
    def list_chats(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_chats.metadata['url']  # type: ignore
    ...
    list_chats.metadata = {'url': '/users/{user-id}/chats'}  # type: ignore

    def create_chats(
        self,
        user_id,  # type: str
        body,  # type: "models.MicrosoftGraphChat"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~teams.models.MicrosoftGraphChat
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.create_chats.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_chats.metadata = {'url': '/users/{user-id}/chats'}  # type: ignore
    ...
    def get_chats(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_chats.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_chats.metadata = {'url': '/users/{user-id}/chats/{chat-id}'}  # type: ignore
    ...
    def update_chats(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.update_chats.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'chat-id': self._serialize.url("chat_id", chat_id, 'str'),
        }
    ...
    update_chats.metadata = {'url': '/users/{user-id}/chats/{chat-id}'}  # type: ignore
    ...
    def delete_chats(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_chats.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'chat-id': self._serialize.url("chat_id", chat_id, 'str'),
        }
    ...
    delete_chats.metadata = {'url': '/users/{user-id}/chats/{chat-id}'}  # type: ignore
    ...
    def update_teamwork(
        self,
        user_id,  # type: str
        body,  # type: "models.MicrosoftGraphUserTeamwork"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type user_id: str
        :param body: New navigation property values.
        :type body: ~teams.models.MicrosoftGraphUserTeamwork
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
