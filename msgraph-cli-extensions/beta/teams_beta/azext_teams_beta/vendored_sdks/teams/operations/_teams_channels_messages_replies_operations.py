...
class TeamsChannelsMessagesRepliesOperations(object):
    """TeamsChannelsMessagesRepliesOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/microsoft.graph.delta()'}  # type: ignore
