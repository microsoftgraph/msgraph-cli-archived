...
class TeamOperations(object):
    ...
    def create_channel(
        ...
        is_favorite_by_default=None,  # type: Optional[bool]
        membership_type=None,  # type: Optional[Union[str, "models.MicrosoftGraphChannelMembershipType"]]
        moderation_settings=None,  # type: Optional["models.MicrosoftGraphChannelModerationSettings"]
    ...
    def list_installed_app(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfTeamsAppInstallation0"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~teams.models.CollectionOfTeamsAppInstallation0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_member(
        self,
        team_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum211"]]]
    ...
    def archive(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsBezc4TeamsTeamIdMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema(should_set_spo_site_read_only_for_members=should_set_spo_site_read_only_for_members)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def clone(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Izic0UTeamsTeamIdMicrosoftGraphClonePostRequestbodyContentApplicationJsonSchema(display_name=display_name, description=description, mail_nickname=mail_nickname, classification=classification, visibility=visibility, parts_to_clone=parts_to_clone)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def send_activity_notification(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Bflym4TeamsTeamIdMicrosoftGraphSendactivitynotificationPostRequestbodyContentApplicationJsonSchema(topic=topic, activity_type=activity_type, chain_id=chain_id, preview_text=preview_text, template_parameters=template_parameters, recipient=recipient)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths1Bflym4TeamsTeamIdMicrosoftGraphSendactivitynotificationPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def list_owner(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~teams.models.CollectionOfUser]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_ref_owner(
        self,
        team_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum221"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfLinksOfUser"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~teams.models.CollectionOfLinksOfUser]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update_photo(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphProfilePhoto(id=id, height=height, width=width)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
