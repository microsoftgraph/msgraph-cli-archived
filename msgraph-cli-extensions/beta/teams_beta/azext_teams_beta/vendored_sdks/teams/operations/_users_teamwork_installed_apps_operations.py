...
class UsersTeamworkInstalledAppsOperations(object):
    """UsersTeamworkInstalledAppsOperations operations.
    ...
    def get_chat(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum307"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum308"]]]
        **kwargs  # type: Any
    ):
