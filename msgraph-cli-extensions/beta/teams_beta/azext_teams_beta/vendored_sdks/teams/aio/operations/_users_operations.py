...
class usersOperations:
    ...
    async def create_chats(
        self,
        user_id: str,
        body: "models.microsoftgraphchat",
        **kwargs
    ...
    async def update_teamwork(
        self,
        user_id: str,
        body: "models.microsoftgraphuserteamwork",
        **kwargs
    ) -> None:
