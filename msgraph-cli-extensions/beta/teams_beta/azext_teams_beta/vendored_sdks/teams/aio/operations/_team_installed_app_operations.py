...
class TeamInstalledAppOperations:
    """TeamInstalledAppOperations async operations.
    ...
    async def get_ref_team_app_definition(
        self,
        team_id: str,
        teams_app_installation_id: str,
        **kwargs
    ...
    async def set_ref_team_app_definition(
        self,
        team_id: str,
        teams_app_installation_id: str,
        body: Dict[str, object],
    ...
    async def delete_ref_team_app_definition(
        self,
        team_id: str,
        teams_app_installation_id: str,
        if_match: Optional[str] = None,
