...
class UserOperations:
    ...
    def list_chat(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfChat0"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~teams.models.CollectionOfChat0]
