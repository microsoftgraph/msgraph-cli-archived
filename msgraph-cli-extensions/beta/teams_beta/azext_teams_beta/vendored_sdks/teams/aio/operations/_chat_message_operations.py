...
class ChatMessageOperations:
    """ChatMessageOperations async operations.
    ...
    delete_hosted_content.metadata = {'url': '/chats/{chat-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}'}  # type: ignore
    ...
    async def get_hosted_content_content(
        ...
        **kwargs
        ...
        return deserialized
    get_hosted_content_content.metadata = {'url': '/chats/{chat-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}/$value'}  # type: ignore
    ...
    set_hosted_content_content.metadata = {'url': '/chats/{chat-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}/$value'}  # type: ignore
    ...
    async def create_reply(
        ...
        microsoft_graph_chat_message_chat_id: Optional[str] = None,
    ...
    delete_reply.metadata = {'url': '/chats/{chat-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}'}  # type: ignore
