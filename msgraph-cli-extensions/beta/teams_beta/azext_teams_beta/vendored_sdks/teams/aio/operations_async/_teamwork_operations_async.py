...
class TeamworkOperations:
    ...
    async def create_workforce_integration(
        ...
        eligibility_filtering_enabled_entities: Optional[Union[str, "models.MicrosoftGraphEligibilityFilteringEnabledEntities"]] = None,
        ...
        supports: Optional[Union[str, "models.MicrosoftGraphWorkforceIntegrationSupportedEntities"]] = None,
