...
def load_command_table(self, _):
    ...
    with self.command_group('teams', teams_beta_app_catalog, client_factory=cf_app_catalog) as g:
    ...
    with self.command_group('teams', teams_beta_app_catalog_team_app, client_factory=cf_app_catalog_team_app) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_chat_chat, client_factory=cf_chat_chat) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_chat, client_factory=cf_chat) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        ...
        g.custom_command('send-activity-notification', 'teams_send_activity_notification')
    ...
    with self.command_group('teams', teams_beta_chat_installed_app, client_factory=cf_chat_installed_app) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_chat_member, client_factory=cf_chat_member) as g:
    ...
    with self.command_group('teams', teams_beta_chat_message, client_factory=cf_chat_message) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_chat_message_reply, client_factory=cf_chat_message_reply) as g:
        g.custom_command('delta', 'teams_delta')
    ...
    with self.command_group('teams', teams_beta_chat_tab, client_factory=cf_chat_tab) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('get-ref-team-app', 'teams_get_ref_team_app')
        g.custom_command('get-team-app', 'teams_get_team_app')
        g.custom_command('set-ref-team-app', 'teams_set_ref_team_app')
    ...
    with self.command_group('teams', teams_beta_group, client_factory=cf_group) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_team_team, client_factory=cf_team_team) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_team, client_factory=cf_team) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('all-message', 'teams_all_message')
    ...
    with self.command_group('teams', teams_beta_team_channel, client_factory=cf_team_channel) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('all-message', 'teams_all_message')
        g.custom_command('complete-migration', 'teams_complete_migration')
        g.custom_command('create-member', 'teams_create_member')
    ...
    with self.command_group('teams', teams_beta_team_channel_member, client_factory=cf_team_channel_member) as g:
        g.custom_command('add', 'teams_add')
    ...
    with self.command_group('teams', teams_beta_team_channel_message, client_factory=cf_team_channel_message) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('create-hosted-content', 'teams_create_hosted_content')
        g.custom_command('create-reply', 'teams_create_reply')
        g.custom_command('delta', 'teams_delta')
    ...
    with self.command_group('teams', teams_beta_team_channel_message_reply,
    ...
    with self.command_group('teams', teams_beta_team_channel_tab, client_factory=cf_team_channel_tab) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('get-ref-team-app', 'teams_get_ref_team_app')
        g.custom_command('get-team-app', 'teams_get_team_app')
        g.custom_command('set-ref-team-app', 'teams_set_ref_team_app')
    ...
    with self.command_group('teams', teams_beta_team_installed_app, client_factory=cf_team_installed_app) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('get-ref-team-app', 'teams_get_ref_team_app')
        g.custom_command('get-ref-team-app-definition', 'teams_get_ref_team_app_definition')
        g.custom_command('get-team-app', 'teams_get_team_app')
    ...
    with self.command_group('teams', teams_beta_team_member, client_factory=cf_team_member) as g:
        g.custom_command('add', 'teams_add')
    ...
    with self.command_group('teams', teams_beta_team_primary_channel, client_factory=cf_team_primary_channel) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('complete-migration', 'teams_complete_migration')
        g.custom_command('create-member', 'teams_create_member')
        g.custom_command('create-message', 'teams_create_message')
    ...
    with self.command_group('teams', teams_beta_team_primary_channel_member,
    ...
    with self.command_group('teams', teams_beta_team_primary_channel_message,
    ...
    with self.command_group('teams', teams_beta_team_primary_channel_message_reply,
    ...
    with self.command_group('teams', teams_beta_team_primary_channel_tab,
    ...
    with self.command_group('teams', teams_beta_team_schedule, client_factory=cf_team_schedule) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_team_schedule_time_card,
    ...
    with self.command_group('teams', teams_beta_teamwork_teamwork, client_factory=cf_teamwork_teamwork) as g:
    ...
    with self.command_group('teams', teams_beta_teamwork, client_factory=cf_teamwork) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
    ...
    with self.command_group('teams', teams_beta_user, client_factory=cf_user) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('create-chat', 'teams_create_chat')
    ...
    with self.command_group('teams', teams_beta_user_teamwork, client_factory=cf_user_teamwork) as g:
        g.custom_command('delete', 'teams_delete', confirmation=True)
        g.custom_command('create-installed-app', 'teams_create_installed_app')
        g.custom_command('get-installed-app', 'teams_get_installed_app')
        g.custom_command('list-installed-app', 'teams_list_installed_app')
    ...
    with self.command_group('teams', teams_beta_user_teamwork_installed_app,
