...
class UserContactOperations:
    """UserContactOperations async operations.
    ...
    delete_extension.metadata = {'url': '/users/{user-id}/contacts/{contact-id}/extensions/{extension-id}'}  # type: ignore
    ...
    delete_multi_value_extended_property.metadata = {'url': '/users/{user-id}/contacts/{contact-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    delete_single_value_extended_property.metadata = {'url': '/users/{user-id}/contacts/{contact-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
