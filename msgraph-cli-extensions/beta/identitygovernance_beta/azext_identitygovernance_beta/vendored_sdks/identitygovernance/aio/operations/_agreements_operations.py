...
class agreementsOperations:
    ...
    def list_acceptances(
        ...
        **kwargs
    ) -> AsyncIterable["models.collectionofagreementacceptance"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_governance.models.collectionofagreementacceptance]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_acceptances.metadata['url']  # type: ignore
    ...
    list_acceptances.metadata = {'url': '/agreements/{agreement-id}/acceptances'}  # type: ignore

    async def create_acceptances(
        self,
        agreement_id: str,
        body: "models.microsoftgraphagreementacceptance",
        **kwargs
        ...
        :type body: ~identity_governance.models.microsoftgraphagreementacceptance
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.create_acceptances.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_acceptances.metadata = {'url': '/agreements/{agreement-id}/acceptances'}  # type: ignore
    ...
    async def get_acceptances(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_acceptances.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
        ...
        return deserialized
    get_acceptances.metadata = {'url': '/agreements/{agreement-id}/acceptances/{agreementAcceptance-id}'}  # type: ignore

    async def update_acceptances(
        self,
        agreement_id: str,
        agreement_acceptance_id: str,
        body: "models.microsoftgraphagreementacceptance",
        **kwargs
        ...
        # Construct URL
        url = self.update_acceptances.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
            'agreementAcceptance-id': self._serialize.url("agreement_acceptance_id", agreement_acceptance_id, 'str'),
        }
    ...
    update_acceptances.metadata = {'url': '/agreements/{agreement-id}/acceptances/{agreementAcceptance-id}'}  # type: ignore

    async def delete_acceptances(
        self,
        agreement_id: str,
        agreement_acceptance_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_acceptances.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
            'agreementAcceptance-id': self._serialize.url("agreement_acceptance_id", agreement_acceptance_id, 'str'),
        }
    ...
    delete_acceptances.metadata = {'url': '/agreements/{agreement-id}/acceptances/{agreementAcceptance-id}'}  # type: ignore
    ...
    async def get_file(
        ...
        **kwargs
    ) -> "models.microsoftgraphagreementfile":
    ...
    async def update_file(
        self,
        agreement_id: str,
        body: "models.microsoftgraphagreementfile",
        **kwargs
    ) -> None:
        ...
        :type agreement_id: str
        :param body: New navigation property values.
        :type body: ~identity_governance.models.microsoftgraphagreementfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_files(
        ...
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.collectionofagreementfilelocalization0"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_governance.models.collectionofagreementfilelocalization0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_files.metadata['url']  # type: ignore
                path_format_arguments = {
                    'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_files.metadata = {'url': '/agreements/{agreement-id}/files'}  # type: ignore
    ...
    async def create_files(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.create_files.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_files.metadata = {'url': '/agreements/{agreement-id}/files'}  # type: ignore
    ...
    async def get_files(
        ...
        **kwargs
        ...
        return deserialized
    get_files.metadata = {'url': '/agreements/{agreement-id}/files/{agreementFileLocalization-id}'}  # type: ignore
    ...
    async def update_files(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_files.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
            'agreementFileLocalization-id': self._serialize.url("agreement_file_localization_id", agreement_file_localization_id, 'str'),
        }
    ...
    update_files.metadata = {'url': '/agreements/{agreement-id}/files/{agreementFileLocalization-id}'}  # type: ignore
    ...
    async def delete_files(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_files.metadata['url']  # type: ignore
        path_format_arguments = {
            'agreement-id': self._serialize.url("agreement_id", agreement_id, 'str'),
            'agreementFileLocalization-id': self._serialize.url("agreement_file_localization_id", agreement_file_localization_id, 'str'),
        }
    ...
    delete_files.metadata = {'url': '/agreements/{agreement-id}/files/{agreementFileLocalization-id}'}  # type: ignore
