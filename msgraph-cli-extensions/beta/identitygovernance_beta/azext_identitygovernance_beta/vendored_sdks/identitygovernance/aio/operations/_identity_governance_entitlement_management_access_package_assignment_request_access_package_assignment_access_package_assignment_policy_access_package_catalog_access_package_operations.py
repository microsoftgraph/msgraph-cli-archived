...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageOperations async operations.
    ...
    def list_access_package_assignment_policy(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfAccessPackageAssignmentPolicy2"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_governance.models.CollectionOfAccessPackageAssignmentPolicy2]
    ...
    async def get_access_package_catalog(
        ...
        access_package_assignment_request_id: str,
        access_package_id: str,
        select: Optional[List[Union[str, "models.Enum356"]]] = None,
        expand: Optional[List[Union[str, "models.Enum357"]]] = None,
        **kwargs
    ...
    def list_access_package_resource_role_scope(
        ...
        access_package_assignment_request_id: str,
        access_package_id: str,
        orderby: Optional[List[Union[str, "models.Enum358"]]] = None,
        select: Optional[List[Union[str, "models.Enum359"]]] = None,
        expand: Optional[List[Union[str, "models.Enum360"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfAccessPackageResourceRoleScope1"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_governance.models.CollectionOfAccessPackageResourceRoleScope1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_access_package_resource_role_scope(
        ...
        expand: Optional[List[Union[str, "models.Enum362"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphAccessPackageResourceRoleScope":
        """Get accessPackageResourceRoleScopes from identityGovernance.
