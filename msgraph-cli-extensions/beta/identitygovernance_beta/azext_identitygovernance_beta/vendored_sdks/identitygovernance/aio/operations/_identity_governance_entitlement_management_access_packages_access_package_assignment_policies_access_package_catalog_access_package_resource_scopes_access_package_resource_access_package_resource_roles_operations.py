...
class IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackageResourceScopesAccessPackageResourceAccessPackageResourceRolesOperations:
    """IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackageResourceScopesAccessPackageResourceAccessPackageResourceRolesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1284"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1285"]]] = None,
        **kwargs
