...
class IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopesAccessPackageResourceScopeOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopesAccessPackageResourceScopeOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1187"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1188"]]] = None,
        **kwargs
