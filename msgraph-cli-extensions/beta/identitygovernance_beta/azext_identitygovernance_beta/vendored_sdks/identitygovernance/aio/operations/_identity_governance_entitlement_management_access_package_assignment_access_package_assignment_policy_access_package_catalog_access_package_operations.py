...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageOperations async operations.
    ...
    def list_access_package_assignment_policy(
        ...
        orderby: Optional[List[Union[str, "models.Enum931"]]] = None,
        select: Optional[List[Union[str, "models.Enum932"]]] = None,
        expand: Optional[List[Union[str, "models.Enum933"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfAccessPackageAssignmentPolicy6"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_governance.models.CollectionOfAccessPackageAssignmentPolicy6]
    ...
    async def get_access_package_assignment_policy(
        ...
        select: Optional[List[Union[str, "models.Enum934"]]] = None,
        expand: Optional[List[Union[str, "models.Enum935"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphAccessPackageAssignmentPolicy":
        """Get accessPackageAssignmentPolicies from identityGovernance.
    ...
    async def get_access_package_catalog(
        ...
        access_package_assignment_id: str,
        access_package_id: str,
        select: Optional[List[Union[str, "models.Enum936"]]] = None,
        expand: Optional[List[Union[str, "models.Enum937"]]] = None,
        **kwargs
    ...
    def list_access_package_resource_role_scope(
        ...
        access_package_assignment_id: str,
        access_package_id: str,
        orderby: Optional[List[Union[str, "models.Enum938"]]] = None,
        select: Optional[List[Union[str, "models.Enum939"]]] = None,
        expand: Optional[List[Union[str, "models.Enum940"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfAccessPackageResourceRoleScope5"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_governance.models.CollectionOfAccessPackageResourceRoleScope5]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_access_package_resource_role_scope(
        ...
        select: Optional[List[Union[str, "models.Enum941"]]] = None,
        expand: Optional[List[Union[str, "models.Enum942"]]] = None,
        **kwargs
    ) -> "models.MicrosoftGraphAccessPackageResourceRoleScope":
        """Get accessPackageResourceRoleScopes from identityGovernance.
