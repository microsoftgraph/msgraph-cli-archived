...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRolesAccessPackageAssignmentsAccessPackageAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackageResourceRolesOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRolesAccessPackageAssignmentsAccessPackageAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackageResourceRolesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum480"]]] = None,
        expand: Optional[List[Union[str, "models.Enum481"]]] = None,
        **kwargs
