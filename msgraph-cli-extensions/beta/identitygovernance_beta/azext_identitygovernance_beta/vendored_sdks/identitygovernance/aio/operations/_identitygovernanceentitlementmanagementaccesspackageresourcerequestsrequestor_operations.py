...
class identitygovernanceentitlementmanagementaccesspackageresourcerequestsrequestorOperations:
    """identitygovernanceentitlementmanagementaccesspackageresourcerequestsrequestorOperations async operations.
    ...
    async def get_connected_organization(
        ...
        select: Optional[List[Union[str, "models.Enum1162"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1163"]]] = None,
        **kwargs
