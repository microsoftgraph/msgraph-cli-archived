...
class identitygovernanceentitlementmanagementaccesspackagecatalogsaccesspackageresourcescopesOperations:
    """identitygovernanceentitlementmanagementaccesspackagecatalogsaccesspackageresourcescopesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1086"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1087"]]] = None,
        **kwargs
