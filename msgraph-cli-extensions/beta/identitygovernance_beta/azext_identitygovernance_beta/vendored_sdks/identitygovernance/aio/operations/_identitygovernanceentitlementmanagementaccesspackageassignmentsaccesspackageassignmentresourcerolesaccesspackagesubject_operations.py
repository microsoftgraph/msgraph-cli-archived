...
class identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageassignmentresourcerolesaccesspackagesubjectOperations:
    """identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageassignmentresourcerolesaccesspackagesubjectOperations async operations.
    ...
    async def get_connected_organization(
        ...
        select: Optional[List[Union[str, "models.Enum1032"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1033"]]] = None,
        **kwargs
