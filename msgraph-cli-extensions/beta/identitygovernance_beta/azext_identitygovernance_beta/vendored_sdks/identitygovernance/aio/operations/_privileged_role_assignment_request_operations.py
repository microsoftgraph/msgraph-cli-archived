...
class PrivilegedRoleAssignmentRequestOperations:
    """PrivilegedRoleAssignmentRequestOperations async operations.
    ...
    async def get_role_info(
        self,
        privileged_role_assignment_request_id: str,
        select: Optional[List[Union[str, "models.Enum1396"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1397"]]] = None,
        **kwargs
    ...
    async def my(
        self,
        **kwargs
    ) -> List["models.MicrosoftGraphPrivilegedRoleAssignmentRequest"]:
        """Invoke function my.
