...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRolesAccessPackageAssignmentsAccessPackageAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackageResourceScopesOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRolesAccessPackageAssignmentsAccessPackageAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackageResourceScopesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum518"]]] = None,
        expand: Optional[List[Union[str, "models.Enum519"]]] = None,
        **kwargs
