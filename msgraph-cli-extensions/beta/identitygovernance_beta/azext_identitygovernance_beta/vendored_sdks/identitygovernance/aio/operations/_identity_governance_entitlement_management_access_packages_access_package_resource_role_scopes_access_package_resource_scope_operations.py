...
class IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageResourceRoleScopesAccessPackageResourceScopeOperations:
    """IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageResourceRoleScopesAccessPackageResourceScopeOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1321"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1322"]]] = None,
        **kwargs
