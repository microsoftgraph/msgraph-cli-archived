...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentsAccessPackageAccessPackageResourceRoleScopesAccessPackageResourceScopeAccessPackageResourceAccessPackageResourceRolesOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentsAccessPackageAccessPackageResourceRoleScopesAccessPackageResourceScopeAccessPackageResourceAccessPackageResourceRolesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum856"]]] = None,
        expand: Optional[List[Union[str, "models.Enum857"]]] = None,
        **kwargs
