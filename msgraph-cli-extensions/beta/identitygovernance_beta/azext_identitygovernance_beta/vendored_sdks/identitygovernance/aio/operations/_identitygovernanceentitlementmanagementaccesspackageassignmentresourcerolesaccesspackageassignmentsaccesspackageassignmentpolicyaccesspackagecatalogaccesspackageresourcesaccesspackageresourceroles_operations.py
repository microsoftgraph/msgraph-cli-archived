...
class identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageassignmentpolicyaccesspackagecatalogaccesspackageresourcesaccesspackageresourcerolesOperations:
    """identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageassignmentpolicyaccesspackagecatalogaccesspackageresourcesaccesspackageresourcerolesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum611"]]] = None,
        expand: Optional[List[Union[str, "models.Enum612"]]] = None,
        **kwargs
