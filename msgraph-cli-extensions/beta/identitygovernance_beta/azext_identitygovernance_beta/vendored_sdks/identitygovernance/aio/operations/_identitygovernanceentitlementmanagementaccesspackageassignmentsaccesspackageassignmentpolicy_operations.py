...
class identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageassignmentpolicyOperations:
    """identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageassignmentpolicyOperations async operations.
    ...
    async def get_access_package_catalog(
        self,
        access_package_assignment_id: str,
        select: Optional[List[Union[str, "models.Enum867"]]] = None,
        expand: Optional[List[Union[str, "models.Enum868"]]] = None,
        **kwargs
