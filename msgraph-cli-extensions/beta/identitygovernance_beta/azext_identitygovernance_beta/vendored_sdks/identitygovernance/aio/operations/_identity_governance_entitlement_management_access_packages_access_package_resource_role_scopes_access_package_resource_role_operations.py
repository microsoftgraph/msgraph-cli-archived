...
class IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageResourceRoleScopesAccessPackageResourceRoleOperations:
    """IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageResourceRoleScopesAccessPackageResourceRoleOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1305"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1306"]]] = None,
        **kwargs
