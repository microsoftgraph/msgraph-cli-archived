...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRolesAccessPackageAssignmentsTargetOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRolesAccessPackageAssignmentsTargetOperations async operations.
    ...
    async def get_connected_organization(
        ...
        select: Optional[List[Union[str, "models.Enum708"]]] = None,
        expand: Optional[List[Union[str, "models.Enum709"]]] = None,
        **kwargs
