...
class identitygovernanceentitlementmanagementaccesspackagecatalogsaccesspackageresourcesaccesspackageresourcescopesOperations:
    """identitygovernanceentitlementmanagementaccesspackagecatalogsaccesspackageresourcesaccesspackageresourcescopesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1079"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1080"]]] = None,
        **kwargs
