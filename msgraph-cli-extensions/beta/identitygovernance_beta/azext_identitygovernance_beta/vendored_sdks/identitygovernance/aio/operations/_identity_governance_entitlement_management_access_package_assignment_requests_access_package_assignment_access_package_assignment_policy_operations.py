...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestsAccessPackageAssignmentAccessPackageAssignmentPolicyOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestsAccessPackageAssignmentAccessPackageAssignmentPolicyOperations async operations.
    ...
    async def get_access_package_catalog(
        self,
        access_package_assignment_request_id: str,
        select: Optional[List[Union[str, "models.Enum287"]]] = None,
        expand: Optional[List[Union[str, "models.Enum288"]]] = None,
        **kwargs
