...
class IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopesAccessPackageResourceRoleOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopesAccessPackageResourceRoleOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1171"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1172"]]] = None,
        **kwargs
