...
class identitygovernanceentitlementmanagementaccesspackageassignmentrequestsaccesspackageassignmentaccesspackageassignmentpolicyaccesspackagecatalogaccesspackagesaccesspackageresourcerolescopesaccesspackageresourceroleOperations:
    """identitygovernanceentitlementmanagementaccesspackageassignmentrequestsaccesspackageassignmentaccesspackageassignmentpolicyaccesspackagecatalogaccesspackagesaccesspackageresourcerolescopesaccesspackageresourceroleOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum365"]]] = None,
        expand: Optional[List[Union[str, "models.Enum366"]]] = None,
        **kwargs
