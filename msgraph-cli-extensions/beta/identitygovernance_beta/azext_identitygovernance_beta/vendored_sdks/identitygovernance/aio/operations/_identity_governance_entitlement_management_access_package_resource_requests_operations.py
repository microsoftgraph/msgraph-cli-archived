...
class IdentityGovernanceEntitlementManagementAccessPackageResourceRequestsOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageResourceRequestsOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1158"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1159"]]] = None,
        **kwargs
    ...
    async def get_ref_access_package_resource(
        self,
        access_package_resource_request_id: str,
        **kwargs
    ) -> str:
    ...
    async def set_ref_access_package_resource(
        self,
        access_package_resource_request_id: str,
    ...
    async def delete_ref_access_package_resource(
        self,
        access_package_resource_request_id: str,
    ...
    async def get_requestor(
        self,
        access_package_resource_request_id: str,
        select: Optional[List[Union[str, "models.Enum1160"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1161"]]] = None,
        **kwargs
