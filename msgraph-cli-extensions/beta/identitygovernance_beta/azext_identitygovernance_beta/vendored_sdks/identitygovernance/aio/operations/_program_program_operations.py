...
class ProgramProgramOperations:
    """ProgramProgramOperations async operations.
    ...
    async def create_program(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphProgram(id=id, description=description, display_name=display_name, controls=controls)
