...
class privilegedroleassignmentrequestsprivilegedroleassignmentrequestOperations:
    """privilegedroleassignmentrequestsprivilegedroleassignmentrequestOperations async operations.
    ...
    async def create_privileged_role_assignment_request(
        self,
        body: "models.microsoftgraphprivilegedroleassignmentrequest",
        **kwargs
