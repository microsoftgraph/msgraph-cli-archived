...
class IdentityGovernanceEntitlementManagementAccessPackageResourcesAccessPackageResourceScopesOperations:
    """IdentityGovernanceEntitlementManagementAccessPackageResourcesAccessPackageResourceScopesOperations async operations.
    ...
    async def get_access_package_resource(
        ...
        select: Optional[List[Union[str, "models.Enum1218"]]] = None,
        expand: Optional[List[Union[str, "models.Enum1219"]]] = None,
        **kwargs
