...
class privilegedrolesOperations(object):
    """privilegedrolesOperations operations.
    ...
    list_assignments.metadata = {'url': '/privilegedRoles/{privilegedRole-id}/assignments'}  # type: ignore

    def list_ref_assignments(
        self,
        privileged_role_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_assignments.metadata['url']  # type: ignore
                path_format_arguments = {
                    'privilegedRole-id': self._serialize.url("privileged_role_id", privileged_role_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_assignments.metadata = {'url': '/privilegedRoles/{privilegedRole-id}/assignments/$ref'}  # type: ignore

    def create_ref_assignments(
        self,
        privileged_role_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_ref_assignments.metadata['url']  # type: ignore
        path_format_arguments = {
            'privilegedRole-id': self._serialize.url("privileged_role_id", privileged_role_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_assignments.metadata = {'url': '/privilegedRoles/{privilegedRole-id}/assignments/$ref'}  # type: ignore

    def self_activate(
        self,
        privileged_role_id,  # type: str
        body,  # type: "models.pathsfneytmprivilegedrolesprivilegedroleidmicrosoftgraphselfactivatepostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~identity_governance.models.pathsfneytmprivilegedrolesprivilegedroleidmicrosoftgraphselfactivatepostrequestbodycontentapplicationjsonschema
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_settings(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_settings.metadata = {'url': '/privilegedRoles/{privilegedRole-id}/settings'}  # type: ignore

    def update_settings(
        self,
        privileged_role_id,  # type: str
        body,  # type: "models.microsoftgraphprivilegedrolesettings"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type body: ~identity_governance.models.microsoftgraphprivilegedrolesettings
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    update_settings.metadata = {'url': '/privilegedRoles/{privilegedRole-id}/settings'}  # type: ignore
    ...
    delete_settings.metadata = {'url': '/privilegedRoles/{privilegedRole-id}/settings'}  # type: ignore
    ...
    def update_summary(
        self,
        privileged_role_id,  # type: str
        body,  # type: "models.microsoftgraphprivilegedrolesummary"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type privileged_role_id: str
        :param body: New navigation property values.
        :type body: ~identity_governance.models.microsoftgraphprivilegedrolesummary
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
