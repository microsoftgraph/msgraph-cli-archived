...
class identitygovernanceentitlementmanagementaccesspackageassignmentrequestsaccesspackageassignmentaccesspackageaccesspackageassignmentpoliciesaccesspackagecatalogaccesspackagesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackageassignmentrequestsaccesspackageassignmentaccesspackageaccesspackageassignmentpoliciesaccesspackagecatalogaccesspackagesOperations operations.
    ...
    def search(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    search.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequest-id}/accessPackageAssignment/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackages/microsoft.graph.Search()'}  # type: ignore
