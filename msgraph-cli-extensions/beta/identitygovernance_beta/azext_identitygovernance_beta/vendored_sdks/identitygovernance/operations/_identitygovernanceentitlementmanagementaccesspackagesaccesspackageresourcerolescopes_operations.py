...
class identitygovernanceentitlementmanagementaccesspackagesaccesspackageresourcerolescopesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackagesaccesspackageresourcerolescopesOperations operations.
    ...
    def get_access_package_resource_role(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1303"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1304"]]]
        **kwargs  # type: Any
    ):
    ...
    def get_access_package_resource_scope(
        ...
        access_package_id,  # type: str
        access_package_resource_role_scope_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum1319"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1320"]]]
        **kwargs  # type: Any
    ):
