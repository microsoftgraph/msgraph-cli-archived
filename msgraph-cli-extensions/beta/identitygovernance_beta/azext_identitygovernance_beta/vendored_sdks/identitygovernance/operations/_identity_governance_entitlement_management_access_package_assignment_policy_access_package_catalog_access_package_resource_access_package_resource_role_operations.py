...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceAccessPackageResourceRoleOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceAccessPackageResourceRoleOperations operations.
    ...
    def get_access_package_resource(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~identity_governance.models.Enum85]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum86]
        ...
        return deserialized
    get_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackageResources/{accessPackageResource-id}/accessPackageResourceRoles/{accessPackageResourceRole-id}/accessPackageResource'}  # type: ignore
    ...
    update_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackageResources/{accessPackageResource-id}/accessPackageResourceRoles/{accessPackageResourceRole-id}/accessPackageResource'}  # type: ignore
    ...
    delete_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackageResources/{accessPackageResource-id}/accessPackageResourceRoles/{accessPackageResourceRole-id}/accessPackageResource'}  # type: ignore
