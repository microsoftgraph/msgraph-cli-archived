...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceScopeOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceScopeOperations operations.
    ...
    def get_access_package_resource(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum518"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum519"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum518]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum519]
        ...
        return deserialized
    get_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole-id}/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackageResourceScopes/{accessPackageResourceScope-id}/accessPackageResource'}  # type: ignore
