...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceAccessPackageResourceScopeOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceAccessPackageResourceScopeOperations operations.
    ...
    def get_access_package_resource(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum618"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum619"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum618]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum619]
        ...
        return deserialized
    get_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole-id}/accessPackageAssignments/{accessPackageAssignment-id}/accessPackageAssignmentPolicy/accessPackageCatalog/accessPackageResources/{accessPackageResource-id}/accessPackageResourceScopes/{accessPackageResourceScope-id}/accessPackageResource'}  # type: ignore
