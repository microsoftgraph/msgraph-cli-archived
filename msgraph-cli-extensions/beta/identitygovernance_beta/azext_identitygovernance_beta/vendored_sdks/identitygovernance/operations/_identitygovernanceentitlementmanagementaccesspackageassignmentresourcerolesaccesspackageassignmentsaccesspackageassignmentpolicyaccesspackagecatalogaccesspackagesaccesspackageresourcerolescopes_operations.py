...
class identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageassignmentpolicyaccesspackagecatalogaccesspackagesaccesspackageresourcerolescopesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageassignmentpolicyaccesspackagecatalogaccesspackagesaccesspackageresourcerolescopesOperations operations.
    ...
    def get_access_package_resource_role(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum656"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum657"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum656]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum657]
    ...
    def get_access_package_resource_scope(
        ...
        **kwargs  # type: Any
        ...
        :type access_package_resource_role_scope_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_governance.models.Enum672]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum673]
        :keyword callable cls: A custom type or function that will be passed the direct response
