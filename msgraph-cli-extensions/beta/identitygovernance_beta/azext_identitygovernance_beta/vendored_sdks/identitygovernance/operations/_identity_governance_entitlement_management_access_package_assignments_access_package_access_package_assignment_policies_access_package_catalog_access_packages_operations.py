...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentsAccessPackageAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackagesOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentsAccessPackageAccessPackageAssignmentPoliciesAccessPackageCatalogAccessPackagesOperations operations.
    ...
    def search(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    search.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackages/microsoft.graph.Search()'}  # type: ignore
