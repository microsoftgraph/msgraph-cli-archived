...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyOperations operations.
    ...
    def get_access_package(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum758"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum759"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum758]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum759]
        ...
        return deserialized
    get_access_package.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackage'}  # type: ignore
    ...
    def get_ref_access_package(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_ref_access_package.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackage/$ref'}  # type: ignore
    ...
    set_ref_access_package.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackage/$ref'}  # type: ignore
    ...
    delete_ref_access_package.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackage/$ref'}  # type: ignore

    def get_access_package_catalog(
        self,
        access_package_assignment_id,  # type: str
        access_package_assignment_policy_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum760"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum761"]]]
        **kwargs  # type: Any
    ):
        ...
        :type access_package_assignment_policy_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_governance.models.Enum760]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum761]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_access_package_catalog.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog'}  # type: ignore
    ...
    update_access_package_catalog.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog'}  # type: ignore
    ...
    delete_access_package_catalog.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog'}  # type: ignore
