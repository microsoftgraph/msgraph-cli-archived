...
class identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageaccesspackageresourcerolescopesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageaccesspackageresourcerolescopesOperations operations.
    ...
    def get_access_package_resource_role(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~identity_governance.models.Enum831]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum832]
        ...
        return deserialized
    get_access_package_resource_role.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceRole'}  # type: ignore
    ...
    update_access_package_resource_role.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceRole'}  # type: ignore
    ...
    delete_access_package_resource_role.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceRole'}  # type: ignore
    ...
    def get_access_package_resource_scope(
        ...
        **kwargs  # type: Any
        ...
        :type access_package_resource_role_scope_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_governance.models.Enum847]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum848]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_access_package_resource_scope.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceScope'}  # type: ignore
    ...
    update_access_package_resource_scope.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceScope'}  # type: ignore
    ...
    delete_access_package_resource_scope.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceScope'}  # type: ignore
