...
class identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageaccesspackageassignmentpoliciesaccesspackagecatalogaccesspackageresourcescopesaccesspackageresourceaccesspackageresourcerolesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageaccesspackageassignmentpoliciesaccesspackagecatalogaccesspackageresourcescopesaccesspackageresourceaccesspackageresourcerolesOperations operations.
    ...
    def get_access_package_resource(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum525"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum526"]]]
        **kwargs  # type: Any
    ):
