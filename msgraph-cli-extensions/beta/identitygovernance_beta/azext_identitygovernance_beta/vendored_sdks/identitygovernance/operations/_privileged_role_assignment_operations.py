...
class PrivilegedRoleAssignmentOperations(object):
    """PrivilegedRoleAssignmentOperations operations.
    ...
    def make_permanent(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Ao8IriPrivilegedroleassignmentsPrivilegedroleassignmentIdMicrosoftGraphMakepermanentPostRequestbodyContentApplicationJsonSchema(reason=reason, ticket_number=ticket_number, ticket_system=ticket_system)
