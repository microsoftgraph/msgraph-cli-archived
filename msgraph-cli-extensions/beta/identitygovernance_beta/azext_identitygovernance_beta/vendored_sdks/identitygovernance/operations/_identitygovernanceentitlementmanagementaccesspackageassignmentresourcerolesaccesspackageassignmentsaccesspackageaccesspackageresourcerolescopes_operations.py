...
class identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageaccesspackageresourcerolescopesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackageassignmentresourcerolesaccesspackageassignmentsaccesspackageaccesspackageresourcerolescopesOperations operations.
    ...
    def get_access_package_resource_role(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum544"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum545"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum544]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum545]
    ...
    def get_access_package_resource_scope(
        ...
        **kwargs  # type: Any
        ...
        :type access_package_resource_role_scope_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_governance.models.Enum560]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum561]
        :keyword callable cls: A custom type or function that will be passed the direct response
