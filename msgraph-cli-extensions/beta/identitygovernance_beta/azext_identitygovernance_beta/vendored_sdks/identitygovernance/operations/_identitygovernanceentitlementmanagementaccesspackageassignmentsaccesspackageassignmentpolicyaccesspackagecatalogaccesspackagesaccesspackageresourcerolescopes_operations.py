...
class identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageassignmentpolicyaccesspackagecatalogaccesspackagesaccesspackageresourcerolescopesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackageassignmentsaccesspackageassignmentpolicyaccesspackagecatalogaccesspackagesaccesspackageresourcerolescopesOperations operations.
    ...
    def get_access_package_resource_role(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum943"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum944"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum943]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum944]
    ...
    def get_access_package_resource_scope(
        ...
        **kwargs  # type: Any
        ...
        :type access_package_resource_role_scope_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_governance.models.Enum959]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum960]
        :keyword callable cls: A custom type or function that will be passed the direct response
