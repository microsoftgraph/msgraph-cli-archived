...
class IdentityGovernanceEntitlementManagementAccessPackageCatalogAccessPackageAccessPackageResourceRoleScopeAccessPackageResourceRoleOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageCatalogAccessPackageAccessPackageResourceRoleScopeAccessPackageResourceRoleOperations operations.
    ...
    def get_access_package_resource(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1123"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1124"]]]
        **kwargs  # type: Any
    ):
