...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceScopeOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceScopeOperations operations.
    ...
    def get_access_package_resource(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~identity_governance.models.Enum225]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum226]
        ...
        return deserialized
    get_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequest-id}/accessPackageAssignment/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackageResourceScopes/{accessPackageResourceScope-id}/accessPackageResource'}  # type: ignore
