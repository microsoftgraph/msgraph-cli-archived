...
class ProgramControlProgramControlOperations(object):
    ...
    def list_program_control(
        self,
        orderby=None,  # type: Optional[List[Union[str, "models.Enum1416"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum1417"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1418"]]]
        **kwargs  # type: Any
    ):
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_governance.models.CollectionOfProgramControl]
    ...
    def create_program_control(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphProgramControl(id=id, control_id=control_id, control_type_id=control_type_id, created_date_time=created_date_time, display_name=display_name, owner=owner, program_id=program_id, resource=resource, status=status, program=program)
    ...
    def get_program_control(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1419"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1420"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphProgramControl"
