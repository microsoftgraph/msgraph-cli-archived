...
class identitygovernanceentitlementmanagementaccesspackagesaccesspackageassignmentpoliciesOperations(object):
    """identitygovernanceentitlementmanagementaccesspackagesaccesspackageassignmentpoliciesOperations operations.
    ...
    def get_access_package(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1230"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1231"]]]
        **kwargs  # type: Any
    ):
    ...
    def get_access_package_catalog(
        ...
        access_package_id,  # type: str
        access_package_assignment_policy_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum1232"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1233"]]]
        **kwargs  # type: Any
    ):
