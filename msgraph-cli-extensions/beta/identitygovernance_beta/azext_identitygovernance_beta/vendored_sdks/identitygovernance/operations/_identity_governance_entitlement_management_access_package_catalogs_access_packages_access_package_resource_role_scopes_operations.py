...
class IdentityGovernanceEntitlementManagementAccessPackageCatalogsAccessPackagesAccessPackageResourceRoleScopesOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageCatalogsAccessPackagesAccessPackageResourceRoleScopesOperations operations.
    ...
    def get_access_package_resource_role(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum1121"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1122"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum1121]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum1122]
        ...
        return deserialized
    get_access_package_resource_role.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog-id}/accessPackages/{accessPackage-id}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceRole'}  # type: ignore
    ...
    update_access_package_resource_role.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog-id}/accessPackages/{accessPackage-id}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceRole'}  # type: ignore
    ...
    delete_access_package_resource_role.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog-id}/accessPackages/{accessPackage-id}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceRole'}  # type: ignore
    ...
    def get_access_package_resource_scope(
        ...
        access_package_id,  # type: str
        access_package_resource_role_scope_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum1137"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum1138"]]]
        **kwargs  # type: Any
    ):
        ...
        :type access_package_resource_role_scope_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_governance.models.Enum1137]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum1138]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_access_package_resource_scope.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog-id}/accessPackages/{accessPackage-id}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceScope'}  # type: ignore
    ...
    update_access_package_resource_scope.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog-id}/accessPackages/{accessPackage-id}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceScope'}  # type: ignore
    ...
    delete_access_package_resource_scope.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog-id}/accessPackages/{accessPackage-id}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope-id}/accessPackageResourceScope'}  # type: ignore
