...
class IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceAccessPackageResourceScopeOperations(object):
    """IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogAccessPackageResourceAccessPackageResourceScopeOperations operations.
    ...
    def get_access_package_resource(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum511"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum512"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~identity_governance.models.Enum511]
        :param expand: Expand related entities.
        :type expand: list[str or ~identity_governance.models.Enum512]
        ...
        return deserialized
    get_access_package_resource.metadata = {'url': '/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole-id}/accessPackageAssignments/{accessPackageAssignment-id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}/accessPackageCatalog/accessPackageResources/{accessPackageResource-id}/accessPackageResourceScopes/{accessPackageResourceScope-id}/accessPackageResource'}  # type: ignore
