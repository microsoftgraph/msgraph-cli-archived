...
def load_command_table(self, _):
    ...
    with self.command_group('crossdeviceexperiences', crossdeviceexperiences_beta_user, client_factory=cf_user) as g:
        ...
        g.custom_command('create-device', 'crossdeviceexperiences_create_device')
        g.custom_command('get-activity', 'crossdeviceexperiences_get_activity')
        g.custom_command('get-device', 'crossdeviceexperiences_get_device')
        g.custom_command('list-activity', 'crossdeviceexperiences_list_activity')
        g.custom_command('list-device', 'crossdeviceexperiences_list_device')
        g.custom_command('update-activity', 'crossdeviceexperiences_update_activity')
        g.custom_command('update-device', 'crossdeviceexperiences_update_device')
    ...
    with self.command_group('crossdeviceexperiences', crossdeviceexperiences_beta_user_activity,
    ...
    with self.command_group('crossdeviceexperiences', crossdeviceexperiences_beta_user_activity_history_item,
