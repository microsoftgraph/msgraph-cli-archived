...
class financialscompaniessalesquotescustomerOperations(object):
    """financialscompaniessalesquotescustomerOperations operations.
    ...
    def list_picture(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.collectionofpicture18"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~financials.models.collectionofpicture18]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_picture(
        ...
        sales_quote_id,  # type: str
        picture_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum318"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.microsoftgraphpicture"
