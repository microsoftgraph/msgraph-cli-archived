...
class FinancialCompanySaleCreditMemoOperations(object):
    """FinancialCompanySaleCreditMemoOperations operations.
    ...
    def get_currency(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~financials.models.Enum189]
        ...
        return deserialized
    get_currency.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/currency'}  # type: ignore
    ...
    update_currency.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/currency'}  # type: ignore
    ...
    delete_currency.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/currency'}  # type: ignore
    ...
    def get_customer(
        ...
        **kwargs  # type: Any
        ...
        :type sales_credit_memo_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum190]
        :param expand: Expand related entities.
        :type expand: list[str or ~financials.models.Enum191]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_customer.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/customer'}  # type: ignore
    ...
    update_customer.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/customer'}  # type: ignore
    ...
    delete_customer.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/customer'}  # type: ignore
    ...
    def get_payment_term(
        ...
        **kwargs  # type: Any
        ...
        :type sales_credit_memo_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum199]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_payment_term.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/paymentTerm'}  # type: ignore
    ...
    update_payment_term.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/paymentTerm'}  # type: ignore
    ...
    delete_payment_term.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/paymentTerm'}  # type: ignore
    ...
    def list_sale_credit_memo_line(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfSalesCreditMemoLine0"]
        ...
        :type orderby: list[str or ~financials.models.Enum200]
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum201]
        :param expand: Expand related entities.
        :type expand: list[str or ~financials.models.Enum202]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSalesCreditMemoLine0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~financials.models.CollectionOfSalesCreditMemoLine0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfSalesCreditMemoLine0"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfSalesCreditMemoLine0', pipeline_response)
    ...
    list_sale_credit_memo_line.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/salesCreditMemoLines'}  # type: ignore
    ...
    def create_sale_credit_memo_line(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_sale_credit_memo_line.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/salesCreditMemoLines'}  # type: ignore
    ...
    def get_sale_credit_memo_line(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum203]
        :param expand: Expand related entities.
        :type expand: list[str or ~financials.models.Enum204]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSalesCreditMemoLine, or the result of cls(response)
        :rtype: ~financials.models.MicrosoftGraphSalesCreditMemoLine
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_sale_credit_memo_line.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/salesCreditMemoLines/{salesCreditMemoLine-id}'}  # type: ignore
    ...
    update_sale_credit_memo_line.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/salesCreditMemoLines/{salesCreditMemoLine-id}'}  # type: ignore
    ...
    delete_sale_credit_memo_line.metadata = {'url': '/financials/companies/{company-id}/salesCreditMemos/{salesCreditMemo-id}/salesCreditMemoLines/{salesCreditMemoLine-id}'}  # type: ignore
