...
class FinancialsCompaniesSalesQuotesSalesQuoteLinesOperations(object):
    """FinancialsCompaniesSalesQuotesSalesQuoteLinesOperations operations.
    ...
    def get_account(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~financials.models.Enum326]
        ...
        return deserialized
    get_account.metadata = {'url': '/financials/companies/{company-id}/salesQuotes/{salesQuote-id}/salesQuoteLines/{salesQuoteLine-id}/account'}  # type: ignore
    ...
    update_account.metadata = {'url': '/financials/companies/{company-id}/salesQuotes/{salesQuote-id}/salesQuoteLines/{salesQuoteLine-id}/account'}  # type: ignore
    ...
    delete_account.metadata = {'url': '/financials/companies/{company-id}/salesQuotes/{salesQuote-id}/salesQuoteLines/{salesQuoteLine-id}/account'}  # type: ignore
    ...
    def get_item(
        ...
        **kwargs  # type: Any
        ...
        :type sales_quote_line_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum327]
        :param expand: Expand related entities.
        :type expand: list[str or ~financials.models.Enum328]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_item.metadata = {'url': '/financials/companies/{company-id}/salesQuotes/{salesQuote-id}/salesQuoteLines/{salesQuoteLine-id}/item'}  # type: ignore
    ...
    update_item.metadata = {'url': '/financials/companies/{company-id}/salesQuotes/{salesQuote-id}/salesQuoteLines/{salesQuoteLine-id}/item'}  # type: ignore
    ...
    delete_item.metadata = {'url': '/financials/companies/{company-id}/salesQuotes/{salesQuote-id}/salesQuoteLines/{salesQuoteLine-id}/item'}  # type: ignore
