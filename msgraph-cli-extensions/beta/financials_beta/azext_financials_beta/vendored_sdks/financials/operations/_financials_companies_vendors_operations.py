...
class FinancialsCompaniesVendorsOperations(object):
    """FinancialsCompaniesVendorsOperations operations.
    ...
    def get_currency(
        ...
        company_id,  # type: str
        vendor_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum351"]]]
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~financials.models.Enum351]
        ...
        return deserialized
    get_currency.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/currency'}  # type: ignore
    ...
    update_currency.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/currency'}  # type: ignore
    ...
    delete_currency.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/currency'}  # type: ignore
    ...
    def get_payment_method(
        ...
        **kwargs  # type: Any
        ...
        :type vendor_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum352]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_payment_method.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/paymentMethod'}  # type: ignore
    ...
    update_payment_method.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/paymentMethod'}  # type: ignore
    ...
    delete_payment_method.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/paymentMethod'}  # type: ignore

    def get_payment_term(
        self,
        company_id,  # type: str
        vendor_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum353"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        ...
        :type vendor_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum353]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_payment_term.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/paymentTerm'}  # type: ignore
    ...
    update_payment_term.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/paymentTerm'}  # type: ignore
    ...
    delete_payment_term.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/paymentTerm'}  # type: ignore

    def list_picture(
        self,
        company_id,  # type: str
        vendor_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum354"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum355"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfPicture20"]
        ...
        :type orderby: list[str or ~financials.models.Enum354]
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum355]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPicture20 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~financials.models.CollectionOfPicture20]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfPicture20"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfPicture20', pipeline_response)
    ...
    list_picture.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture'}  # type: ignore
    ...
    def create_picture(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_picture.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture'}  # type: ignore
    ...
    def get_picture(
        ...
        **kwargs  # type: Any
        ...
        :type picture_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum356]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPicture, or the result of cls(response)
        ...
        return deserialized
    get_picture.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture/{picture-id}'}  # type: ignore
    ...
    update_picture.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture/{picture-id}'}  # type: ignore
    ...
    delete_picture.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture/{picture-id}'}  # type: ignore
    ...
    def get_picture_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_picture_content.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture/{picture-id}/content'}  # type: ignore
    ...
    set_picture_content.metadata = {'url': '/financials/companies/{company-id}/vendors/{vendor-id}/picture/{picture-id}/content'}  # type: ignore
