...
class FinancialsCompaniesCustomersOperations(object):
    """FinancialsCompaniesCustomersOperations operations.
    ...
    def get_currency(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~financials.models.Enum63]
        ...
        return deserialized
    get_currency.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/currency'}  # type: ignore
    ...
    update_currency.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/currency'}  # type: ignore
    ...
    delete_currency.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/currency'}  # type: ignore
    ...
    def get_payment_method(
        ...
        **kwargs  # type: Any
        ...
        :type customer_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum64]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_payment_method.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/paymentMethod'}  # type: ignore
    ...
    update_payment_method.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/paymentMethod'}  # type: ignore
    ...
    delete_payment_method.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/paymentMethod'}  # type: ignore
    ...
    def get_payment_term(
        ...
        **kwargs  # type: Any
        ...
        :type customer_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum65]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_payment_term.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/paymentTerm'}  # type: ignore
    ...
    update_payment_term.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/paymentTerm'}  # type: ignore
    ...
    delete_payment_term.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/paymentTerm'}  # type: ignore
    ...
    def list_picture(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfPicture1"]
        ...
        :type orderby: list[str or ~financials.models.Enum66]
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum67]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPicture1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~financials.models.CollectionOfPicture1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfPicture1"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfPicture1', pipeline_response)
    ...
    list_picture.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture'}  # type: ignore
    ...
    def create_picture(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_picture.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture'}  # type: ignore
    ...
    def get_picture(
        ...
        **kwargs  # type: Any
        ...
        :type picture_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum68]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPicture, or the result of cls(response)
        ...
        return deserialized
    get_picture.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture/{picture-id}'}  # type: ignore
    ...
    update_picture.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture/{picture-id}'}  # type: ignore
    ...
    delete_picture.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture/{picture-id}'}  # type: ignore
    ...
    def get_picture_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_picture_content.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture/{picture-id}/content'}  # type: ignore
    ...
    set_picture_content.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/picture/{picture-id}/content'}  # type: ignore
    ...
    def get_shipment_method(
        ...
        **kwargs  # type: Any
        ...
        :type customer_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum69]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_shipment_method.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/shipmentMethod'}  # type: ignore
    ...
    update_shipment_method.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/shipmentMethod'}  # type: ignore
    ...
    delete_shipment_method.metadata = {'url': '/financials/companies/{company-id}/customers/{customer-id}/shipmentMethod'}  # type: ignore
