...
class financialscompaniesjournallinesOperations(object):
    """financialscompaniesjournallinesOperations operations.
    ...
    def get_account(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~financials.models.Enum112]
        ...
        return deserialized
    get_account.metadata = {'url': '/financials/companies/{company-id}/journalLines/{journalLine-id}/account'}  # type: ignore
    ...
    update_account.metadata = {'url': '/financials/companies/{company-id}/journalLines/{journalLine-id}/account'}  # type: ignore
    ...
    delete_account.metadata = {'url': '/financials/companies/{company-id}/journalLines/{journalLine-id}/account'}  # type: ignore
