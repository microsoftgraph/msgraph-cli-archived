...
class FinancialsCompaniesSalesQuoteLinesItemOperations(object):
    """FinancialsCompaniesSalesQuoteLinesItemOperations operations.
    ...
    def get_item_category(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~financials.models.Enum301]
        ...
        return deserialized
    get_item_category.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/itemCategory'}  # type: ignore
    ...
    update_item_category.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/itemCategory'}  # type: ignore
    ...
    delete_item_category.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/itemCategory'}  # type: ignore
    ...
    def list_picture(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfPicture17"]
        ...
        :type orderby: list[str or ~financials.models.Enum302]
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum303]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPicture17 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~financials.models.CollectionOfPicture17]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfPicture17"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfPicture17', pipeline_response)
    ...
    list_picture.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture'}  # type: ignore
    ...
    def create_picture(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_picture.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture'}  # type: ignore
    ...
    def get_picture(
        ...
        **kwargs  # type: Any
        ...
        :type picture_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum304]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPicture, or the result of cls(response)
        ...
        return deserialized
    get_picture.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture/{picture-id}'}  # type: ignore
    ...
    update_picture.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture/{picture-id}'}  # type: ignore
    ...
    delete_picture.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture/{picture-id}'}  # type: ignore
    ...
    def get_picture_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_picture_content.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture/{picture-id}/content'}  # type: ignore
    ...
    set_picture_content.metadata = {'url': '/financials/companies/{company-id}/salesQuoteLines/{salesQuoteLine-id}/item/picture/{picture-id}/content'}  # type: ignore
