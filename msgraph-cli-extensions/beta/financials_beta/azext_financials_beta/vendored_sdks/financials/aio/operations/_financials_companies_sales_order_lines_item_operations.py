...
class FinancialsCompaniesSalesOrderLinesItemOperations:
    """FinancialsCompaniesSalesOrderLinesItemOperations async operations.
    ...
    def list_picture(
        ...
        company_id: str,
        sales_order_line_id: str,
        orderby: Optional[List[Union[str, "models.Enum262"]]] = None,
        select: Optional[List[Union[str, "models.Enum263"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPicture14"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~financials.models.CollectionOfPicture14]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
