...
class financialscompaniesvendorsOperations:
    """financialscompaniesvendorsOperations async operations.
    ...
    async def get_currency(
        ...
        company_id: str,
        vendor_id: str,
        select: Optional[List[Union[str, "models.Enum351"]]] = None,
    ...
    async def get_payment_term(
        ...
        company_id: str,
        vendor_id: str,
        select: Optional[List[Union[str, "models.Enum353"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ...
    def list_picture(
        ...
        company_id: str,
        vendor_id: str,
        orderby: Optional[List[Union[str, "models.Enum354"]]] = None,
        select: Optional[List[Union[str, "models.Enum355"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.collectionofpicture20"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~financials.models.collectionofpicture20]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
