...
class financialscompaniespurchaseinvoicespurchaseinvoicelinesitemOperations:
    """financialscompaniespurchaseinvoicespurchaseinvoicelinesitemOperations async operations.
    ...
    async def get_item_category(
        ...
        **kwargs
        ...
        :type select: list[str or ~financials.models.Enum160]
        ...
        return deserialized
    get_item_category.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/itemCategory'}  # type: ignore
    ...
    update_item_category.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/itemCategory'}  # type: ignore
    ...
    delete_item_category.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/itemCategory'}  # type: ignore
    ...
    def list_picture(
        ...
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.collectionofpicture6"]:
        ...
        :type orderby: list[str or ~financials.models.Enum161]
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum162]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofpicture6 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~financials.models.collectionofpicture6]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.collectionofpicture6"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionofpicture6', pipeline_response)
    ...
    list_picture.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture'}  # type: ignore
    ...
    async def create_picture(
        ...
        **kwargs
        ...
        return deserialized
    create_picture.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture'}  # type: ignore
    ...
    async def get_picture(
        ...
        **kwargs
        ...
        :type picture_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~financials.models.Enum163]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphpicture, or the result of cls(response)
        ...
        return deserialized
    get_picture.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture/{picture-id}'}  # type: ignore
    ...
    update_picture.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture/{picture-id}'}  # type: ignore
    ...
    delete_picture.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture/{picture-id}'}  # type: ignore
    ...
    async def get_picture_content(
        ...
        **kwargs
        ...
        return deserialized
    get_picture_content.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture/{picture-id}/content'}  # type: ignore
    ...
    set_picture_content.metadata = {'url': '/financials/companies/{company-id}/purchaseInvoices/{purchaseInvoice-id}/purchaseInvoiceLines/{purchaseInvoiceLine-id}/item/picture/{picture-id}/content'}  # type: ignore
