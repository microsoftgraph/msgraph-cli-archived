...
class financialscompaniessalesquotelinesitemOperations:
    """financialscompaniessalesquotelinesitemOperations async operations.
    ...
    def list_picture(
        ...
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.collectionofpicture17"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~financials.models.collectionofpicture17]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
