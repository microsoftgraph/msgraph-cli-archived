...
class FinancialsCompaniesSalesCreditMemosCustomerOperations:
    """FinancialsCompaniesSalesCreditMemosCustomerOperations async operations.
    ...
    def list_picture(
        ...
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPicture9"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~financials.models.CollectionOfPicture9]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
