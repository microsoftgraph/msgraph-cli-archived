...
class SitesPagesOperations(object):
    """SitesPagesOperations operations.
    ...
    publish.metadata = {'url': '/sites/{site-id}/pages/{sitePage-id}/microsoft.graph.publish'}  # type: ignore
