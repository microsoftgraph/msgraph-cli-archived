...
class SiteOnenotePageParentSectionPageOperations(object):
    """SiteOnenotePageParentSectionPageOperations operations.
    ...
    def copy_to_section(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsGk640QSitesSiteIdOnenotePagesOnenotepageIdParentsectionPagesOnenotepageId1MicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, site_collection_id=site_collection_id, site_id=string_site_id)
        ...
        body_content = self._serialize.body(_body, 'PathsGk640QSitesSiteIdOnenotePagesOnenotepageIdParentsectionPagesOnenotepageId1MicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema')
    ...
    def onenote_patch_content(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsV7Bq3TSitesSiteIdOnenotePagesOnenotepageIdParentsectionPagesOnenotepageId1MicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema(commands=commands)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PathsV7Bq3TSitesSiteIdOnenotePagesOnenotepageIdParentsectionPagesOnenotepageId1MicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
