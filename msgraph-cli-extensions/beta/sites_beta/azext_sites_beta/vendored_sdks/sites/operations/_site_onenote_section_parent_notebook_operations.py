...
class SiteOnenoteSectionParentNotebookOperations(object):
    ...
    def copy_notebook(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Gp723RSitesSiteIdOnenoteSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema(group_id=group_id, rename_as=rename_as, notebook_folder=notebook_folder, site_collection_id=site_collection_id, site_id=string_site_id)
        ...
        body_content = self._serialize.body(_body, 'Paths1Gp723RSitesSiteIdOnenoteSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    copy_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/microsoft.graph.copyNotebook'}  # type: ignore
