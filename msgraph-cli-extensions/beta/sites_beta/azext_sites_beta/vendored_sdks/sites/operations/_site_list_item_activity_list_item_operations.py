...
class SiteListItemActivityListItemOperations(object):
    """SiteListItemActivityListItemOperations operations.
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsV1SzefSitesSiteIdListsListIdItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        ...
        body_content = self._serialize.body(_body, 'PathsV1SzefSitesSiteIdListsListIdItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
    ...
    def get_activity_by_interval(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activity_by_interval.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
