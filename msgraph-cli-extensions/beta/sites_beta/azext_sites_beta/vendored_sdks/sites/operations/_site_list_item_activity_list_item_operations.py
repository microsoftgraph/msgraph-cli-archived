...
class SiteListItemActivityListItemOperations(object):
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsV1SzefSitesSiteIdListsListIdItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
