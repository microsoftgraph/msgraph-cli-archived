...
class SiteListItemActivityOperations(object):
    """SiteListItemActivityOperations operations.
    ...
    def get_drive_item(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~sites.models.Enum200]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum201]
        ...
        return deserialized
    get_drive_item.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/driveItem'}  # type: ignore
    ...
    update_drive_item.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/driveItem'}  # type: ignore
    ...
    delete_drive_item.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/driveItem'}  # type: ignore
    ...
    def get_drive_item_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_drive_item_content.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/driveItem/content'}  # type: ignore
    ...
    set_drive_item_content.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/driveItem/content'}  # type: ignore
    ...
    def get_list_item(
        ...
        **kwargs  # type: Any
        ...
        :type item_activity_old_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum202]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum203]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_list_item.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem'}  # type: ignore
    ...
    update_list_item.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem'}  # type: ignore
    ...
    delete_list_item.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem'}  # type: ignore
