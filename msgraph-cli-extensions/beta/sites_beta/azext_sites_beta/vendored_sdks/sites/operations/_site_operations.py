...
class SiteOperations(object):
    ...
    def create_page(
        ...
        page_layout_type=None,  # type: Optional[str]
        publishing_state=None,  # type: Optional["models.MicrosoftGraphPublicationFacet"]
        title=None,  # type: Optional[str]
        web_parts=None,  # type: Optional[List["models.MicrosoftGraphWebPart"]]
        **kwargs  # type: Any
    ):
