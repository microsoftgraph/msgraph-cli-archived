...
class SiteListItemOperations(object):
    """SiteListItemOperations operations.
    ...
    def list_activity(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~sites.models.Enum195]
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum196]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum197]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfItemActivityOld1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~sites.models.CollectionOfItemActivityOld1]
    ...
    list_activity.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities'}  # type: ignore
    ...
    def create_activity(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_activity.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities'}  # type: ignore
    ...
    def get_activity(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum198]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum199]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphItemActivityOld, or the result of cls(response)
        :rtype: ~sites.models.MicrosoftGraphItemActivityOld
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_activity.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    update_activity.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    delete_activity.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    def get_analytic(
        ...
        **kwargs  # type: Any
        ...
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum204]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum205]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_analytic.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/analytics'}  # type: ignore
    ...
    def get_ref_analytic(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_ref_analytic.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    set_ref_analytic.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    delete_ref_analytic.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    def get_drive_item(
        ...
        **kwargs  # type: Any
        ...
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum206]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum207]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_drive_item_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_drive_item_content.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem/content'}  # type: ignore
    ...
    set_drive_item_content.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem/content'}  # type: ignore
    ...
    def get_field(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_field.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields'}  # type: ignore
    ...
    update_field.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields'}  # type: ignore
    ...
    delete_field.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields'}  # type: ignore
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1HqqvqwSitesSiteIdListsListIdItemsListitemIdMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths1HqqvqwSitesSiteIdListsListIdItemsListitemIdMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_link.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/microsoft.graph.createLink'}  # type: ignore
    ...
    def get_activity_by_interval(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activity_by_interval.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    def list_version(
        ...
        **kwargs  # type: Any
        ...
        :type list_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~sites.models.Enum208]
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum209]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum210]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfListItemVersion0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~sites.models.CollectionOfListItemVersion0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_version.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions'}  # type: ignore
    ...
    def create_version(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_version.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions'}  # type: ignore
    ...
    def get_version(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~sites.models.Enum211]
        :param expand: Expand related entities.
        :type expand: list[str or ~sites.models.Enum212]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphListItemVersion, or the result of cls(response)
        :rtype: ~sites.models.MicrosoftGraphListItemVersion
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_version.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
    ...
    update_version.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
    ...
    delete_version.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
