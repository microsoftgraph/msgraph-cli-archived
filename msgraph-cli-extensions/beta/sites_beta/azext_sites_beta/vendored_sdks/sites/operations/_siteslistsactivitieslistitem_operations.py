...
class siteslistsactivitieslistitemOperations(object):
    """siteslistsactivitieslistitemOperations operations.
    ...
    def create_link(
        ...
        list_id,  # type: str
        item_activity_old_id,  # type: str
        body,  # type: "models.paths10gfm4psitessiteidlistslistidactivitiesitemactivityoldidlistitemmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
