...
class UsersOperations(object):
    ...
    def list_followed_sites(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_followed_sites.metadata['url']  # type: ignore
    ...
    list_followed_sites.metadata = {'url': '/users/{user-id}/followedSites'}  # type: ignore

    def list_ref_followed_sites(
        self,
        user_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~sites.models.Enum232]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_followed_sites.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_followed_sites.metadata = {'url': '/users/{user-id}/followedSites/$ref'}  # type: ignore

    def create_ref_followed_sites(
        self,
        user_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_ref_followed_sites.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_followed_sites.metadata = {'url': '/users/{user-id}/followedSites/$ref'}  # type: ignore
