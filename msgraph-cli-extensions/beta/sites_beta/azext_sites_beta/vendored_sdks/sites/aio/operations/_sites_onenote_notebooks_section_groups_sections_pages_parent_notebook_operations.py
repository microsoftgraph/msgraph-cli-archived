...
class SitesOnenoteNotebooksSectionGroupsSectionsPagesParentNotebookOperations:
    """SitesOnenoteNotebooksSectionGroupsSectionsPagesParentNotebookOperations async operations.
    ...
    async def copy_notebook(
        ...
        onenote_page_id: str,
        body: "models.Paths1D4W4JmSitesSiteIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
