...
class sitesonenotenotebooksOperations:
    ...
    async def copy_notebook(
        ...
        site_id: str,
        notebook_id: str,
        body: "models.pathss3y1mrsitessiteidonenotenotebooksnotebookidmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema",
        **kwargs
        ...
        :type body: ~sites.models.pathss3y1mrsitessiteidonenotenotebooksnotebookidmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema
    ...
    async def get_notebook_from_web_url(
        self,
        site_id: str,
        body: "models.pathsukf43dsitessiteidonenotenotebooksmicrosoftgraphgetnotebookfromweburlpostrequestbodycontentapplicationjsonschema",
        **kwargs
        ...
        :type site_id: str
        :param body: Action parameters.
        :type body: ~sites.models.pathsukf43dsitessiteidonenotenotebooksmicrosoftgraphgetnotebookfromweburlpostrequestbodycontentapplicationjsonschema
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_recent_notebooks(
        ...
        **kwargs
        ...
        return deserialized
    get_recent_notebooks.metadata = {'url': '/sites/{site-id}/onenote/notebooks/microsoft.graph.getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks})'}  # type: ignore
