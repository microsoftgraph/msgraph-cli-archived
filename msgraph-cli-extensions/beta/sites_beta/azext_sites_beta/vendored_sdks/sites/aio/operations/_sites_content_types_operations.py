...
class SitesContentTypesOperations:
    """SitesContentTypesOperations async operations.
    ...
    list_column_links.metadata = {'url': '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks'}  # type: ignore
    ...
    async def create_column_links(
        ...
        **kwargs
        ...
        return deserialized
    create_column_links.metadata = {'url': '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks'}  # type: ignore
    ...
    async def get_column_links(
        ...
        **kwargs
        ...
        return deserialized
    get_column_links.metadata = {'url': '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks/{columnLink-id}'}  # type: ignore
    ...
    update_column_links.metadata = {'url': '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks/{columnLink-id}'}  # type: ignore
    ...
    delete_column_links.metadata = {'url': '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks/{columnLink-id}'}  # type: ignore
