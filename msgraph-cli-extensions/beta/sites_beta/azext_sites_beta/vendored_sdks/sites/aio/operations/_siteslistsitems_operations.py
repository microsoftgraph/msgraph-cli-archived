...
class siteslistsitemsOperations:
    """siteslistsitemsOperations async operations.
    ...
    list_activities.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities'}  # type: ignore
    ...
    async def create_activities(
        ...
        **kwargs
        ...
        return deserialized
    create_activities.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities'}  # type: ignore
    ...
    async def get_activities(
        ...
        **kwargs
        ...
        return deserialized
    get_activities.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    update_activities.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    delete_activities.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    async def create_link(
        ...
        list_id: str,
        list_item_id: str,
        body: "models.paths1hqqvqwsitessiteidlistslistiditemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema",
        **kwargs
        ...
        :type body: ~sites.models.paths1hqqvqwsitessiteidlistslistiditemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_activities_by_interval(
        ...
        **kwargs
        ...
        return deserialized
    get_activities_by_interval.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
