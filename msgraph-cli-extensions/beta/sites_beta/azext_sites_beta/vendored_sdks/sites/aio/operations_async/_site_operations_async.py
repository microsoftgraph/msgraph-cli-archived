...
class SiteOperations:
    ...
    async def get_activity_by_interval(
        ...
        **kwargs
        ...
        return deserialized
    get_activity_by_interval.metadata = {'url': '/sites/{site-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    list_page.metadata = {'url': '/sites/{site-id}/pages'}  # type: ignore
    ...
    async def create_page(
        ...
        publishing_state: Optional["models.MicrosoftGraphPublicationFacet"] = None,
        title: Optional[str] = None,
        web_parts: Optional[List["models.MicrosoftGraphWebPart"]] = None,
        **kwargs
        ...
        :type publishing_state: ~sites.models.MicrosoftGraphPublicationFacet
        :param title:
        :type title: str
        :param web_parts:
        :type web_parts: list[~sites.models.MicrosoftGraphWebPart]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _body = models.MicrosoftGraphSitePage(id=id, created_date_time=created_date_time, description=description, e_tag=e_tag, last_modified_date_time=last_modified_date_time, name=name, web_url=web_url, created_by_user=created_by_user, last_modified_by_user=last_modified_by_user, drive_id=drive_id, drive_type=drive_type, id_parent_reference_id=microsoft_graph_item_reference_id, name_parent_reference_name=microsoft_graph_item_reference_name, path=path, share_id=share_id, sharepoint_ids=sharepoint_ids, site_id=microsoft_graph_item_reference_site_id, application_last_modified_by_application=application, device_last_modified_by_device=device, user_last_modified_by_user=user, application_created_by_application=microsoft_graph_identity_application, device_created_by_device=microsoft_graph_identity_device, user_created_by_user=microsoft_graph_identity_user, content_type=content_type_parameter, page_layout_type=page_layout_type, publishing_state=publishing_state, title=title, web_parts=web_parts)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphSitePage')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_page.metadata = {'url': '/sites/{site-id}/pages'}  # type: ignore
    ...
    async def get_page(
        ...
        **kwargs
        ...
        return deserialized
    get_page.metadata = {'url': '/sites/{site-id}/pages/{sitePage-id}'}  # type: ignore
    ...
    update_page.metadata = {'url': '/sites/{site-id}/pages/{sitePage-id}'}  # type: ignore
    ...
    delete_page.metadata = {'url': '/sites/{site-id}/pages/{sitePage-id}'}  # type: ignore
