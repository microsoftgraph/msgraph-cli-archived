    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'level':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter publishing_state. All possible keys are: '
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'last-recorded-date-time':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter times. All possible keys are: '
                               'last-recorded-date-time, observed-date-time, recorded-date-time'.format(k))
        return d
...
class AddDelete(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.delete = action
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'name':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter delete. All possible keys are: name, '
                               'object-type'.format(k))
        return d


class AddMove(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.move = action
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'from':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter move. All possible keys are: from, to'.
                format(k))
        return d


class AddRename(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.rename = action
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'new-name':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter rename. All possible keys are: new-name, '
                               'old-name'.format(k))
        return d


class AddVersion(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.version = action
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'new-version':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter version. All possible keys are: '
                               'new-version'.format(k))
        return d
...
class AddSitesListsActivitiesSubscriptions(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddSitesListsActivitiesSubscriptions, self).__call__(parser, namespace, action, option_string)
