...
class UsersOperations:
    ...
    async def invalidate_all_refresh_tokens(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.invalidate_all_refresh_tokens.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    invalidate_all_refresh_tokens.metadata = {'url': '/users/{user-id}/microsoft.graph.invalidateAllRefreshTokens'}  # type: ignore
    ...
    async def unblock_managed_apps(
        self,
        user_id: str,
        **kwargs
    ) -> None:
        ...
        # Construct URL
        url = self.unblock_managed_apps.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    unblock_managed_apps.metadata = {'url': '/users/{user-id}/microsoft.graph.unblockManagedApps'}  # type: ignore

    async def wipe_and_block_managed_apps(
        self,
        user_id: str,
        **kwargs
    ) -> None:
        ...
        # Construct URL
        url = self.wipe_and_block_managed_apps.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    wipe_and_block_managed_apps.metadata = {'url': '/users/{user-id}/microsoft.graph.wipeAndBlockManagedApps'}  # type: ignore

    async def wipe_managed_app_registration_by_device_tag(
        self,
        user_id: str,
        body: "models.Paths1X1038LUsersUserIdMicrosoftGraphWipemanagedappregistrationbydevicetagPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
        ...
        :type user_id: str
        :param body: Action parameters.
        :type body: ~users_actions.models.Paths1X1038LUsersUserIdMicrosoftGraphWipemanagedappregistrationbydevicetagPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_user_owned_objects(
        self,
        body: "models.PathsSidp1OUsersMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> "models.MicrosoftGraphDirectoryObject":
        ...
        :param body: Action parameters.
        :type body: ~users_actions.models.PathsSidp1OUsersMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphDirectoryObject, or the result of cls(response)
        :rtype: ~users_actions.models.MicrosoftGraphDirectoryObject
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_user_owned_objects.metadata = {'url': '/users/microsoft.graph.getUserOwnedObjects'}  # type: ignore
