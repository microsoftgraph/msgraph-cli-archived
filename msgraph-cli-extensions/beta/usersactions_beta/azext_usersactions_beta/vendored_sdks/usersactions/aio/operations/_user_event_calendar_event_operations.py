...
class UserEventCalendarEventOperations:
    ...
    async def accept(
        ...
        **kwargs
        ...
        body = models.Paths151E8WwUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
    ...
    async def cancel(
        ...
        **kwargs
        ...
        body = models.PathsDtrrxkUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema(comment=comment)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def decline(
        ...
        **kwargs
        ...
        body = models.PathsWzrwtkUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def forward(
        ...
        **kwargs
        ...
        body = models.Paths5So465UsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema(to_recipients=to_recipients, comment=comment)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def snooze_reminder(
        ...
        **kwargs
        ...
        body = models.Paths1K5RhlbUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema(new_reminder_time=new_reminder_time)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def tentatively_accept(
        ...
        **kwargs
        ...
        body = models.Paths1FlenwhUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
