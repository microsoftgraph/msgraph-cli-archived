...
class UserEventCalendarCalendarViewOperations:
    ...
    async def accept(
        ...
        **kwargs
        ...
        body = models.Paths1K9N0S0UsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
    ...
    async def cancel(
        ...
        **kwargs
        ...
        body = models.Paths6Mj0FbUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema(comment=comment)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def decline(
        ...
        **kwargs
        ...
        body = models.PathsJugtduUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def forward(
        ...
        **kwargs
        ...
        body = models.PathsSjerakUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema(to_recipients=to_recipients, comment=comment)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def snooze_reminder(
        ...
        **kwargs
        ...
        body = models.Paths1Xl24CxUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema(new_reminder_time=new_reminder_time)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def tentatively_accept(
        ...
        **kwargs
        ...
        body = models.Paths16SnmwtUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
