...
class UsersCalendarGroupsCalendarsEventsInstancesOperations:
    ...
    async def cancel(
        ...
        event_id: str,
        event_id1: str,
        body: "models.Paths1V3Kf7YUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def forward(
        ...
        event_id: str,
        event_id1: str,
        body: "models.Paths162WyqaUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
