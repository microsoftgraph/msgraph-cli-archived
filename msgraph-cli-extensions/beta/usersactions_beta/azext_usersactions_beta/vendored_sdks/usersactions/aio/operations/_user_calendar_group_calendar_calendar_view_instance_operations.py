...
class UserCalendarGroupCalendarCalendarViewInstanceOperations:
    ...
    async def accept(
        ...
        **kwargs
        ...
        body = models.Paths1Uvas2QUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
    ...
    async def cancel(
        ...
        **kwargs
        ...
        body = models.Paths1Uufmg9UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema(comment=comment)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths1Uufmg9UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def decline(
        ...
        **kwargs
        ...
        body = models.Paths1OgajooUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def forward(
        ...
        **kwargs
        ...
        body = models.Paths17Svq07UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema(to_recipients=to_recipients, comment=comment)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths17Svq07UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def snooze_reminder(
        ...
        **kwargs
        ...
        body = models.Paths10Vg7JzUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema(new_reminder_time=new_reminder_time)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def tentatively_accept(
        ...
        **kwargs
        ...
        body = models.Paths11Yp7UfUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema(comment=comment, send_response=send_response)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
