...
class UsersOnenoteNotebooksSectionGroupsSectionsPagesOperations:
    ...
    async def copy_to_section(
        ...
        onenote_page_id: str,
        body: "models.PathsGdge0LUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ...
    async def onenote_patch_content(
        ...
        onenote_section_id: str,
        onenote_page_id: str,
        body: "models.Paths1G3UapzUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
