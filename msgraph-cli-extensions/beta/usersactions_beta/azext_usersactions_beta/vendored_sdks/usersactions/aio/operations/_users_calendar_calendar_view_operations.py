...
class UsersCalendarCalendarViewOperations:
    ...
    async def cancel(
        ...
        user_id: str,
        event_id: str,
        body: "models.PathsBvmpnqUsersUserIdCalendarCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def forward(
        ...
        user_id: str,
        event_id: str,
        body: "models.PathsVlbv61UsersUserIdCalendarCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
