...
class UsersOutlookTaskFoldersTasksOperations:
    """UsersOutlookTaskFoldersTasksOperations async operations.
    ...
    async def complete(
        ...
        **kwargs
        ...
        return deserialized
    complete.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}/microsoft.graph.complete'}  # type: ignore
