...
class UsersEventsOperations:
    ...
    async def cancel(
        ...
        user_id: str,
        event_id: str,
        body: "models.Paths1F7X6GlUsersUserIdEventsEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def forward(
        ...
        user_id: str,
        event_id: str,
        body: "models.PathsPg3HzyUsersUserIdEventsEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
