...
class UsersEventsCalendarCalendarViewOperations:
    """UsersEventsCalendarCalendarViewOperations async operations.
    ...
    async def accept(
        ...
        event_id: str,
        event_id1: str,
        body: "models.Paths1K9N0S0UsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def cancel(
        ...
        event_id: str,
        event_id1: str,
        body: "models.Paths6Mj0FbUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
        ...
        :type event_id1: str
        :param body: Action parameters.
        :type body: ~users_actions.models.Paths6Mj0FbUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths6Mj0FbUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def decline(
        ...
        event_id: str,
        event_id1: str,
        body: "models.PathsJugtduUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def forward(
        ...
        event_id: str,
        event_id1: str,
        body: "models.PathsSjerakUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
        ...
        :type event_id1: str
        :param body: Action parameters.
        :type body: ~users_actions.models.PathsSjerakUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'PathsSjerakUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def snooze_reminder(
        ...
        event_id: str,
        event_id1: str,
        body: "models.Paths1Xl24CxUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def tentatively_accept(
        ...
        event_id: str,
        event_id1: str,
        body: "models.Paths16SnmwtUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
