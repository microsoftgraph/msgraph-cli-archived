...
class UsersCalendarGroupsCalendarsCalendarViewOperations:
    ...
    async def cancel(
        ...
        calendar_id: str,
        event_id: str,
        body: "models.Paths19J295OUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
    ...
    async def forward(
        ...
        calendar_id: str,
        event_id: str,
        body: "models.Paths15XjrtpUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema",
        **kwargs
    ) -> None:
