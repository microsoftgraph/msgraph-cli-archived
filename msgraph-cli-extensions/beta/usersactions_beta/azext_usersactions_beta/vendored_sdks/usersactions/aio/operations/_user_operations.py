...
class UserOperations:
    ...
    async def assign_license(
        self,
        user_id: str,
        add_licenses: Optional[List["models.MicrosoftGraphAssignedLicense"]] = None,
        ...
        **kwargs
        ...
        body = models.PathsBfhtneUsersUserIdMicrosoftGraphAssignlicensePostRequestbodyContentApplicationJsonSchema(add_licenses=add_licenses, remove_licenses=remove_licenses)
    ...
    async def change_password(
        ...
        **kwargs
        ...
        body = models.Paths3Mx0JpUsersUserIdMicrosoftGraphChangepasswordPostRequestbodyContentApplicationJsonSchema(current_password=current_password, new_password=new_password)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def check_member_group(
        ...
        **kwargs
        ...
        body = models.PathsDyyrb2UsersUserIdMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema(group_ids=group_ids)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def check_member_object(
        ...
        **kwargs
        ...
        body = models.PathsJ9Yxi4UsersUserIdMicrosoftGraphCheckmemberobjectsPostRequestbodyContentApplicationJsonSchema(ids=ids)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def export_personal_data(
        ...
        **kwargs
        ...
        body = models.Paths1Xhdcw6UsersUserIdMicrosoftGraphExportpersonaldataPostRequestbodyContentApplicationJsonSchema(storage_location=storage_location)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def find_meeting_time(
        self,
        user_id: str,
        attendees: Optional[List["models.MicrosoftGraphAttendeeBase"]] = None,
        ...
        activity_domain: Optional[Union[str, "models.MicrosoftGraphActivityDomain"]] = None,
        time_slots: Optional[List["models.MicrosoftGraphTimeSlot"]] = None,
        is_required: Optional[bool] = None,
        locations: Optional[List["models.MicrosoftGraphLocationConstraintItem"]] = None,
    ...
    async def get_mail_tip(
        self,
        user_id: str,
        email_addresses: Optional[List[str]] = None,
        mail_tips_options: Optional[Union[str, "models.MicrosoftGraphMailTipsType"]] = None,
        **kwargs
        ...
        body = models.PathsPp15VbUsersUserIdMicrosoftGraphGetmailtipsPostRequestbodyContentApplicationJsonSchema(email_addresses=email_addresses, mail_tips_options=mail_tips_options)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def get_member_group(
        ...
        **kwargs
        ...
        body = models.Paths18H5WxmUsersUserIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema(security_enabled_only=security_enabled_only)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def get_member_object(
        ...
        **kwargs
        ...
        body = models.Paths5Y1AzfUsersUserIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema(security_enabled_only=security_enabled_only)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def invalidate_all_refresh_token(
        self,
        user_id: str,
        **kwargs
    ) -> Optional[bool]:
        ...
        # Construct URL
        url = self.invalidate_all_refresh_token.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    invalidate_all_refresh_token.metadata = {'url': '/users/{user-id}/microsoft.graph.invalidateAllRefreshTokens'}  # type: ignore

    async def remove_all_device_from_management(
        self,
        user_id: str,
        **kwargs
    ) -> None:
    ...
    async def revoke_sign_in_session(
        self,
        user_id: str,
        **kwargs
    ) -> Optional[bool]:
    ...
    async def send_mail(
        ...
        mentions_preview: Optional["models.MicrosoftGraphMentionsPreview"] = None,
        ...
        **kwargs
        ...
        :type mentions_preview: ~users_actions.models.MicrosoftGraphMentionsPreview
        ...
        :param mentions:
        :type mentions: list[~users_actions.models.MicrosoftGraphMention]
    ...
    async def translate_exchange_id(
        self,
        user_id: str,
        input_ids: Optional[List[str]] = None,
        target_id_type: Optional[Union[str, "models.MicrosoftGraphExchangeIdFormat"]] = None,
        source_id_type: Optional[Union[str, "models.MicrosoftGraphExchangeIdFormat"]] = None,
        **kwargs
        ...
        body = models.PathsHqegrcUsersUserIdMicrosoftGraphTranslateexchangeidsPostRequestbodyContentApplicationJsonSchema(input_ids=input_ids, target_id_type=target_id_type, source_id_type=source_id_type)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def unblock_managed_app(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.unblock_managed_app.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    unblock_managed_app.metadata = {'url': '/users/{user-id}/microsoft.graph.unblockManagedApps'}  # type: ignore

    async def wipe_and_block_managed_app(
        self,
        user_id: str,
        **kwargs
    ) -> None:
        ...
        # Construct URL
        url = self.wipe_and_block_managed_app.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    wipe_and_block_managed_app.metadata = {'url': '/users/{user-id}/microsoft.graph.wipeAndBlockManagedApps'}  # type: ignore

    async def wipe_managed_app_registration_by_device_tag(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        body = models.Paths1X1038LUsersUserIdMicrosoftGraphWipemanagedappregistrationbydevicetagPostRequestbodyContentApplicationJsonSchema(device_tag=device_tag)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths1X1038LUsersUserIdMicrosoftGraphWipemanagedappregistrationbydevicetagPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    wipe_managed_app_registration_by_device_tag.metadata = {'url': '/users/{user-id}/microsoft.graph.wipeManagedAppRegistrationByDeviceTag'}  # type: ignore
    ...
    async def wipe_managed_app_registration_by_device_tag(
        ...
        **kwargs
        ...
        body = models.PathsVloam1UsersUserIdMicrosoftGraphWipemanagedappregistrationsbydevicetagPostRequestbodyContentApplicationJsonSchema(device_tag=device_tag)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        body = models.PathsBjm3ZyUsersMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema(ids=ids, types=types)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def get_user_owned_object(
        ...
        **kwargs
        ...
        body = models.PathsSidp1OUsersMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema(user_id=user_id, type=type)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'PathsSidp1OUsersMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    get_user_owned_object.metadata = {'url': '/users/microsoft.graph.getUserOwnedObjects'}  # type: ignore
    ...
    async def validate_property(
        ...
        **kwargs
        ...
        body = models.Paths1Tz6Rb9UsersMicrosoftGraphValidatepropertiesPostRequestbodyContentApplicationJsonSchema(entity_type=entity_type, display_name=display_name, mail_nickname=mail_nickname, on_behalf_of_user_id=on_behalf_of_user_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
