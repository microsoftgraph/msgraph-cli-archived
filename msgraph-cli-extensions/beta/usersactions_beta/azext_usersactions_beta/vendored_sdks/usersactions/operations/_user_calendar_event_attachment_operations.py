...
class UserCalendarEventAttachmentOperations(object):
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1X2Td9VUsersUserIdCalendarsCalendarIdEventsEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
