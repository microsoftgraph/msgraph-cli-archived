...
class UserOnenotePageParentSectionParentNotebookSectionOperations(object):
    """UserOnenotePageParentSectionParentNotebookSectionOperations operations.
    ...
    def copy_to_notebook(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1G0Hk3PUsersUserIdOnenotePagesOnenotepageIdParentsectionParentnotebookSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, rename_as=rename_as, site_collection_id=site_collection_id, site_id=site_id)
        ...
        body_content = self._serialize.body(_body, 'Paths1G0Hk3PUsersUserIdOnenotePagesOnenotepageIdParentsectionParentnotebookSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema')
    ...
    def copy_to_section_group(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths128Fvv9UsersUserIdOnenotePagesOnenotepageIdParentsectionParentnotebookSectionsOnenotesectionIdMicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, rename_as=rename_as, site_collection_id=site_collection_id, site_id=site_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths128Fvv9UsersUserIdOnenotePagesOnenotepageIdParentsectionParentnotebookSectionsOnenotesectionIdMicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
