...
class UserOutlookTaskFolderTaskAttachmentOperations(object):
    """UserOutlookTaskFolderTaskAttachmentOperations operations.
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths93Ov0OUsersUserIdOutlookTaskfoldersOutlooktaskfolderIdTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
        ...
        body_content = self._serialize.body(_body, 'Paths93Ov0OUsersUserIdOutlookTaskfoldersOutlooktaskfolderIdTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema')
