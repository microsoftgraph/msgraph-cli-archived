...
class UserCalendarEventCalendarOperations(object):
    """UserCalendarEventCalendarOperations operations.
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsT5E3J9UsersUserIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(_body, 'PathsT5E3J9UsersUserIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    get_schedule.metadata = {'url': '/users/{user-id}/calendars/{calendar-id}/events/{event-id}/calendar/microsoft.graph.getSchedule'}  # type: ignore
