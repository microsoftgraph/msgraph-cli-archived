...
class UserOnenoteSectionGroupParentNotebookSectionPageParentSectionOperations(object):
    """UserOnenoteSectionGroupParentNotebookSectionPageParentSectionOperations operations.
    ...
    def copy_to_notebook(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Ejrdf9UsersUserIdOnenoteSectiongroupsSectiongroupIdParentnotebookSectionsOnenotesectionIdPagesOnenotepageIdParentsectionMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, rename_as=rename_as, site_collection_id=site_collection_id, site_id=site_id)
        ...
        body_content = self._serialize.body(_body, 'Paths1Ejrdf9UsersUserIdOnenoteSectiongroupsSectiongroupIdParentnotebookSectionsOnenotesectionIdPagesOnenotepageIdParentsectionMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema')
    ...
    def copy_to_section_group(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths156Ew11UsersUserIdOnenoteSectiongroupsSectiongroupIdParentnotebookSectionsOnenotesectionIdPagesOnenotepageIdParentsectionMicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, rename_as=rename_as, site_collection_id=site_collection_id, site_id=site_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths156Ew11UsersUserIdOnenoteSectiongroupsSectiongroupIdParentnotebookSectionsOnenotesectionIdPagesOnenotepageIdParentsectionMicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
