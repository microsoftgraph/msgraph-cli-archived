...
class UserOnenoteNotebookSectionGroupSectionParentNotebookOperations(object):
    """UserOnenoteNotebookSectionGroupSectionParentNotebookOperations operations.
    ...
    def copy_notebook(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1H9IwvtUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema(group_id=group_id, rename_as=rename_as, notebook_folder=notebook_folder, site_collection_id=site_collection_id, site_id=site_id)
        ...
        body_content = self._serialize.body(_body, 'Paths1H9IwvtUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema')
