...
class UsersOperations(object):
    ...
    def wipe_managed_app_registration_by_device_tag(
        self,
        user_id,  # type: str
        body,  # type: "models.Paths1X1038LUsersUserIdMicrosoftGraphWipemanagedappregistrationbydevicetagPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def get_user_owned_objects(
        self,
        body,  # type: "models.PathsSidp1OUsersMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphDirectoryObject"
