...
class UserOutlookTaskAttachmentOperations(object):
    """UserOutlookTaskAttachmentOperations operations.
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Urds13UsersUserIdOutlookTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
        ...
        body_content = self._serialize.body(_body, 'Paths1Urds13UsersUserIdOutlookTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema')
