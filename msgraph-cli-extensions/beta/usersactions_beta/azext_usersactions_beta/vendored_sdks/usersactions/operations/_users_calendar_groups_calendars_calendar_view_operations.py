...
class UsersCalendarGroupsCalendarsCalendarViewOperations(object):
    ...
    def cancel(
        ...
        calendar_id,  # type: str
        event_id,  # type: str
        body,  # type: "models.Paths19J295OUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type event_id: str
        :param body: Action parameters.
        :type body: ~users_actions.models.Paths19J295OUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths19J295OUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def forward(
        ...
        calendar_id,  # type: str
        event_id,  # type: str
        body,  # type: "models.Paths15XjrtpUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type event_id: str
        :param body: Action parameters.
        :type body: ~users_actions.models.Paths15XjrtpUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths15XjrtpUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
