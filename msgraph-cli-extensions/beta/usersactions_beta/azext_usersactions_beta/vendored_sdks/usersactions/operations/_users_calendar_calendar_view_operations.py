...
class UsersCalendarCalendarViewOperations(object):
    ...
    def cancel(
        ...
        user_id,  # type: str
        event_id,  # type: str
        body,  # type: "models.PathsBvmpnqUsersUserIdCalendarCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type event_id: str
        :param body: Action parameters.
        :type body: ~users_actions.models.PathsBvmpnqUsersUserIdCalendarCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'PathsBvmpnqUsersUserIdCalendarCalendarviewEventIdMicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    cancel.metadata = {'url': '/users/{user-id}/calendar/calendarView/{event-id}/microsoft.graph.cancel'}  # type: ignore
    ...
    def forward(
        ...
        user_id,  # type: str
        event_id,  # type: str
        body,  # type: "models.PathsVlbv61UsersUserIdCalendarCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type event_id: str
        :param body: Action parameters.
        :type body: ~users_actions.models.PathsVlbv61UsersUserIdCalendarCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'PathsVlbv61UsersUserIdCalendarCalendarviewEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    forward.metadata = {'url': '/users/{user-id}/calendar/calendarView/{event-id}/microsoft.graph.forward'}  # type: ignore
