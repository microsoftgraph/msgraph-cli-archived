...
class UsersOutlookTasksAttachmentsOperations(object):
    """UsersOutlookTasksAttachmentsOperations operations.
    ...
    def create_upload_session(
        ...
        body,  # type: "models.Paths1Urds13UsersUserIdOutlookTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
