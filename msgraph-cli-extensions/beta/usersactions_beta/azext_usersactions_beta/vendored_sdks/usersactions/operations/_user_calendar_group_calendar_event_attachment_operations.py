...
class UserCalendarGroupCalendarEventAttachmentOperations(object):
    """UserCalendarGroupCalendarEventAttachmentOperations operations.
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths15UmoapUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
