...
class UserOperations(object):
    ...
    def invalidate_all_refresh_token(
        self,
        user_id,  # type: str
        **kwargs  # type: Any
    ):
    ...
    def send_mail(
        ...
        mentions_preview=None,  # type: Optional["models.MicrosoftGraphMentionsPreview"]
    ...
    def wipe_and_block_managed_app(
        self,
        user_id,  # type: str
        **kwargs  # type: Any
    ):
