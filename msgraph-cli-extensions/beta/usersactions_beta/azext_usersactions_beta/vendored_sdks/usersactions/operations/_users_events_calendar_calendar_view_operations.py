...
class UsersEventsCalendarCalendarViewOperations(object):
    ...
    def cancel(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths6Mj0FbUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def forward(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.PathsSjerakUsersUserIdEventsEventIdCalendarCalendarviewEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
