...
class UsersCalendarGroupsCalendarsCalendarViewInstancesOperations(object):
    ...
    def cancel(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths1Uufmg9UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def forward(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths17Svq07UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
