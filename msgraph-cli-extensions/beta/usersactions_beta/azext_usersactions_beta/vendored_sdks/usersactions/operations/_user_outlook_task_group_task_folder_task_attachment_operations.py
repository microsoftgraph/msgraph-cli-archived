...
class UserOutlookTaskGroupTaskFolderTaskAttachmentOperations(object):
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1E6Bxs8UsersUserIdOutlookTaskgroupsOutlooktaskgroupIdTaskfoldersOutlooktaskfolderIdTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
