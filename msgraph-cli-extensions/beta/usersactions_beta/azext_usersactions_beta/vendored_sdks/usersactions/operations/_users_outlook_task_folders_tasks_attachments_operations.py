...
class UsersOutlookTaskFoldersTasksAttachmentsOperations(object):
    """UsersOutlookTaskFoldersTasksAttachmentsOperations operations.
    ...
    def create_upload_session(
        ...
        body,  # type: "models.Paths93Ov0OUsersUserIdOutlookTaskfoldersOutlooktaskfolderIdTasksOutlooktaskIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
