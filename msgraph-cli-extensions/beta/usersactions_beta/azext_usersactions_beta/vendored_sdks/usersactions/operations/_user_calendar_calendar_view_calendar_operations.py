...
class UserCalendarCalendarViewCalendarOperations(object):
    """UserCalendarCalendarViewCalendarOperations operations.
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1Ybn8BcUsersUserIdCalendarsCalendarIdCalendarviewEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(_body, 'Paths1Ybn8BcUsersUserIdCalendarsCalendarIdCalendarviewEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
