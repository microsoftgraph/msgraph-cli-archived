...
class UsersManagedDevicesLogCollectionRequestsOperations(object):
    """UsersManagedDevicesLogCollectionRequestsOperations operations.
    ...
    def create_download_url(
        ...
        device_log_collection_response_id,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
