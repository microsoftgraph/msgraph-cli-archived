...
class UserMailFolderMessageAttachmentOperations(object):
    """UserMailFolderMessageAttachmentOperations operations.
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1C7XgoqUsersUserIdMailfoldersMailfolderIdMessagesMessageIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
        ...
        body_content = self._serialize.body(_body, 'Paths1C7XgoqUsersUserIdMailfoldersMailfolderIdMessagesMessageIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema')
