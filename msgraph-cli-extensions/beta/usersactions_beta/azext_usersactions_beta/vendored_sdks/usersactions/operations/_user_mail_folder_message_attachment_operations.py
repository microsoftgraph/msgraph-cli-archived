...
class UserMailFolderMessageAttachmentOperations(object):
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1C7XgoqUsersUserIdMailfoldersMailfolderIdMessagesMessageIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
