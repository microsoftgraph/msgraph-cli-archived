...
class UsersCalendarGroupsCalendarsEventsInstancesOperations(object):
    """UsersCalendarGroupsCalendarsEventsInstancesOperations operations.
    ...
    def accept(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths1X68UvwUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def cancel(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths1V3Kf7YUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type event_id1: str
        :param body: Action parameters.
        :type body: ~users_actions.models.Paths1V3Kf7YUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths1V3Kf7YUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphCancelPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def decline(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths18Ls1VzUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def forward(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths162WyqaUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type event_id1: str
        :param body: Action parameters.
        :type body: ~users_actions.models.Paths162WyqaUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'Paths162WyqaUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def snooze_reminder(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths16Pob1QUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def tentatively_accept(
        ...
        event_id,  # type: str
        event_id1,  # type: str
        body,  # type: "models.Paths1Ou2UdrUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
