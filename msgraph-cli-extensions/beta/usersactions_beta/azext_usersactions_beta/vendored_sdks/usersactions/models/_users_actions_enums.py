...
class MicrosoftGraphAdministratorConfiguredDeviceComplianceState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

    BASED_ON_DEVICE_COMPLIANCE_POLICY = "basedOnDeviceCompliancePolicy"
...
class MicrosoftGraphConfigurationManagerActionType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

    REFRESH_MACHINE_POLICY = "refreshMachinePolicy"
    REFRESH_USER_POLICY = "refreshUserPolicy"
    WAKE_UP_CLIENT = "wakeUpClient"
...
class MicrosoftGraphManagedDeviceRemoteAction(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    WIPE = "wipe"
    CUSTOM_TEXT_NOTIFICATION = "customTextNotification"
