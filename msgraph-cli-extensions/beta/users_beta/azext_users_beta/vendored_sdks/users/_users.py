...
class Users(object):
    ...
    :vartype user_outlook_task_folder: users.operations.UserOutlookTaskFolderOperations
    :ivar user_outlook_task_folder_task: UserOutlookTaskFolderTaskOperations operations
    :vartype user_outlook_task_folder_task: users.operations.UserOutlookTaskFolderTaskOperations
    :ivar user_outlook_task_group: UserOutlookTaskGroupOperations operations
    :vartype user_outlook_task_group: users.operations.UserOutlookTaskGroupOperations
    :ivar user_outlook_task_group_task_folder: UserOutlookTaskGroupTaskFolderOperations operations
    :vartype user_outlook_task_group_task_folder: users.operations.UserOutlookTaskGroupTaskFolderOperations
    :ivar user_outlook_task_group_task_folder_task: UserOutlookTaskGroupTaskFolderTaskOperations operations
    :vartype user_outlook_task_group_task_folder_task: users.operations.UserOutlookTaskGroupTaskFolderTaskOperations
    :ivar user_outlook_task: UserOutlookTaskOperations operations
    :vartype user_outlook_task: users.operations.UserOutlookTaskOperations
