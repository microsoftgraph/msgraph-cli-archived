...
class UserOutlookTaskOperations:
    """UserOutlookTaskOperations async operations.
    ...
    def list_attachment(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~users.models.Enum206]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum207]
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users.models.CollectionOfAttachment1]
    ...
    async def get_attachment(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum208]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
    ...
    delete_attachment.metadata = {'url': '/users/{user-id}/outlook/tasks/{outlookTask-id}/attachments/{attachment-id}'}  # type: ignore
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs
        ...
        :type outlook_task_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum209]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum210]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfMultiValueLegacyExtendedProperty3 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users.models.CollectionOfMultiValueLegacyExtendedProperty3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_multi_value_extended_property(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum211]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    delete_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/tasks/{outlookTask-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_single_value_extended_property(
        ...
        **kwargs
        ...
        :type outlook_task_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum212]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum213]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty3 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users.models.CollectionOfSingleValueLegacyExtendedProperty3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_single_value_extended_property(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum214]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
    ...
    delete_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/tasks/{outlookTask-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
