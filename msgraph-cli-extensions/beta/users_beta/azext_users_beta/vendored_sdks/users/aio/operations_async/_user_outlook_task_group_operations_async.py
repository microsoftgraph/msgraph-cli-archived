...
class UserOutlookTaskGroupOperations:
    """UserOutlookTaskGroupOperations async operations.
    ...
    def list_task_folder(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfOutlookTaskFolder0"]:
        ...
        :type orderby: list[str or ~users.models.Enum176]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum177]
        :param expand: Expand related entities.
        :type expand: list[str or ~users.models.Enum178]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOutlookTaskFolder0 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~users.models.CollectionOfOutlookTaskFolder0]
    ...
    async def get_task_folder(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum179]
        :param expand: Expand related entities.
        :type expand: list[str or ~users.models.Enum180]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOutlookTaskFolder, or the result of cls(response)
        :rtype: ~users.models.MicrosoftGraphOutlookTaskFolder
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_task_folder.metadata = {'url': '/users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}'}  # type: ignore
