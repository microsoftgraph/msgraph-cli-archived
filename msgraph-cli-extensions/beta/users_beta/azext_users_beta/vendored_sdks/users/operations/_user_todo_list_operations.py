...
class UserTodoListOperations(object):
    ...
    def list_extension(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~users.models.Enum239]
    ...
    def list_task(
        ...
        **kwargs  # type: Any
        ...
        :type todo_task_list_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum240]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum241]
        :param expand: Expand related entities.
        :type expand: list[str or ~users.models.Enum242]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_task(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum243]
        :param expand: Expand related entities.
        :type expand: list[str or ~users.models.Enum244]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphTodoTask, or the result of cls(response)
        :rtype: ~users.models.MicrosoftGraphTodoTask
        :raises: ~azure.core.exceptions.HttpResponseError
