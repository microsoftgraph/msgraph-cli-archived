...
class UserOutlookTaskFolderOperations(object):
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~users.models.Enum151]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum152]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~users.models.CollectionOfMultiValueLegacyExtendedProperty]
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum153]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    delete_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum154]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum155]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users.models.CollectionOfSingleValueLegacyExtendedProperty]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum156]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
    ...
    delete_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_task(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum157]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum158]
        :param expand: Expand related entities.
        :type expand: list[str or ~users.models.Enum159]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfOutlookTask or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users.models.CollectionOfOutlookTask]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_task(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum160]
        :param expand: Expand related entities.
        :type expand: list[str or ~users.models.Enum161]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphOutlookTask, or the result of cls(response)
        :rtype: ~users.models.MicrosoftGraphOutlookTask
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    delete_task.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}'}  # type: ignore
