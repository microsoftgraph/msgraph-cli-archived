...
class UserOutlookTaskFolderTaskOperations(object):
    """UserOutlookTaskFolderTaskOperations operations.
    ...
    def list_attachment(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~users.models.Enum162]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum163]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~users.models.CollectionOfAttachment]
    ...
    def get_attachment(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum164]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphAttachment, or the result of cls(response)
    ...
    delete_attachment.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}/attachments/{attachment-id}'}  # type: ignore
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum165]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum166]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfMultiValueLegacyExtendedProperty0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users.models.CollectionOfMultiValueLegacyExtendedProperty0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum167]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    delete_multi_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}'}  # type: ignore
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type outlook_task_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~users.models.Enum168]
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum169]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~users.models.CollectionOfSingleValueLegacyExtendedProperty0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~users.models.Enum170]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
    ...
    delete_single_value_extended_property.metadata = {'url': '/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}'}  # type: ignore
