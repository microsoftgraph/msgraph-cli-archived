...
def load_arguments(self, _):
    ...
    with self.argument_context('files drive create-activity') as c:
        ...
        c.argument('actor_user_display_name', type=str, help='The identity\'s display name. Note that this may not '
                   'always be available or up to date. For example, if a user changes their display name, the API may '
                   'show the new value in a future response, but the items associated with the user won\'t show up as '
                   'having changed when using delta.')
        c.argument('actor_user_id', type=str, help='Unique identifier for the identity.')
        c.argument('actor_device_display_name', type=str, help='The identity\'s display name. Note that this may not '
                   'always be available or up to date. For example, if a user changes their display name, the API may '
                   'show the new value in a future response, but the items associated with the user won\'t show up as '
                   'having changed when using delta.')
        c.argument('actor_device_id', type=str, help='Unique identifier for the identity.')
        c.argument('actor_application_display_name', type=str, help='The identity\'s display name. Note that this may '
                   'not always be available or up to date. For example, if a user changes their display name, the API '
                   'may show the new value in a future response, but the items associated with the user won\'t show up '
                   'as having changed when using delta.')
        c.argument('actor_application_id', type=str, help='Unique identifier for the identity.')
        ...
        c.argument('action_mention', action=AddActionMention, nargs='*', help='mentionAction')
        ...
        c.argument('action_restore', type=validate_file_or_dict, help='restoreAction Expected value: '
                   'json-string/@json-file.')
        c.argument('action_share', action=AddActionShare, nargs='*', help='shareAction')
    ...
    with self.argument_context('files share-shared-drive-item create-shared-drive-item') as c:
        ...
        c.argument('permission_link_configurator_url', type=str, help='')
    ...
    with self.argument_context('files share update-permission') as c:
        ...
        c.argument('link_configurator_url', type=str, help='')
