...
class SharesListActivitiesListItemOperations(object):
    """SharesListActivitiesListItemOperations operations.
    ...
    list_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/activities'}  # type: ignore
    ...
    def create_activities(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/activities'}  # type: ignore
    ...
    def get_activities(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    update_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    delete_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    def get_analytics(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/analytics'}  # type: ignore
    ...
    def get_ref_analytics(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_ref_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    set_ref_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    delete_ref_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    def get_fields(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_fields.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    update_fields.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    delete_fields.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore

    def create_link(
        self,
        shared_drive_item_id,  # type: str
        item_activity_old_id,  # type: str
        body,  # type: "models.PathsIl1AdwSharesShareddriveitemIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~files.models.PathsIl1AdwSharesShareddriveitemIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'PathsIl1AdwSharesShareddriveitemIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def get_activities_by_interval(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activities_by_interval.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    list_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/versions'}  # type: ignore
    ...
    def create_versions(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/versions'}  # type: ignore
    ...
    def get_versions(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
    ...
    update_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
    ...
    delete_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
