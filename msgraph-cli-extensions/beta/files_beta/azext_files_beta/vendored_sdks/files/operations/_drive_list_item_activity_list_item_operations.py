...
class DriveListItemActivityListItemOperations(object):
    """DriveListItemActivityListItemOperations operations.
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths15G389UDrivesDriveIdListItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
