...
class shareslistitemsOperations(object):
    """shareslistitemsOperations operations.
    ...
    def list_activities(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.collectionofitemactivityold6"]
        ...
        :type orderby: list[str or ~files.models.Enum295]
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum296]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum297]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofitemactivityold6 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~files.models.collectionofitemactivityold6]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.collectionofitemactivityold6"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionofitemactivityold6', pipeline_response)
    ...
    list_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities'}  # type: ignore
    ...
    def create_activities(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities'}  # type: ignore
    ...
    def get_activities(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum298]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum299]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphitemactivityold, or the result of cls(response)
        :rtype: ~files.models.microsoftgraphitemactivityold
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    update_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    delete_activities.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    def get_analytics(
        ...
        **kwargs  # type: Any
        ...
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum304]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum305]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/analytics'}  # type: ignore
    ...
    def get_ref_analytics(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_ref_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    set_ref_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    delete_ref_analytics.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    def get_drive_item(
        ...
        **kwargs  # type: Any
        ...
        :type list_item_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum306]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum307]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_drive_item_content(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_drive_item_content.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content'}  # type: ignore
    ...
    set_drive_item_content.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content'}  # type: ignore
    ...
    def get_fields(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_fields.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields'}  # type: ignore
    ...
    update_fields.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields'}  # type: ignore
    ...
    delete_fields.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields'}  # type: ignore

    def create_link(
        self,
        shared_drive_item_id,  # type: str
        list_item_id,  # type: str
        body,  # type: "models.pathsw7qa13sharesshareddriveitemidlistitemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~files.models.pathsw7qa13sharesshareddriveitemidlistitemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'pathsw7qa13sharesshareddriveitemidlistitemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    create_link.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/microsoft.graph.createLink'}  # type: ignore
    ...
    def get_activities_by_interval(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activities_by_interval.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    def list_versions(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.collectionoflistitemversion3"]
        ...
        :type list_item_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~files.models.Enum308]
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum309]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum310]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionoflistitemversion3 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~files.models.collectionoflistitemversion3]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.collectionoflistitemversion3"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionoflistitemversion3', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions'}  # type: ignore
    ...
    def create_versions(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions'}  # type: ignore
    ...
    def get_versions(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum311]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum312]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphlistitemversion, or the result of cls(response)
        :rtype: ~files.models.microsoftgraphlistitemversion
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
    ...
    update_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
    ...
    delete_versions.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
