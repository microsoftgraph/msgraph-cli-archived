...
class ShareListOperations(object):
    ...
    def list_activity(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~files.models.CollectionOfItemActivityOld4]
    ...
    delete_activity.metadata = {'url': '/shares/{sharedDriveItem-id}/list/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    delete_column.metadata = {'url': '/shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}'}  # type: ignore
    ...
    def list_content_type(
        ...
        expand=None,  # type: Optional[List[Union[str, "models.Enum282"]]]
        **kwargs  # type: Any
    ):
    ...
    delete_content_type.metadata = {'url': '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}'}  # type: ignore

    def get_drive(
        self,
        shared_drive_item_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum288"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum289"]]]
        **kwargs  # type: Any
    ):
    ...
    def update_drive(
        ...
        microsoft_graph_list_activities=None,  # type: Optional[List["models.MicrosoftGraphItemActivityOld"]]
        ...
        **kwargs  # type: Any
        ...
        :param microsoft_graph_list_activities:
        :type microsoft_graph_list_activities: list[~files.models.MicrosoftGraphItemActivityOld]
    ...
    delete_item.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}'}  # type: ignore
    ...
    delete_subscription.metadata = {'url': '/shares/{sharedDriveItem-id}/list/subscriptions/{subscription-id}'}  # type: ignore
