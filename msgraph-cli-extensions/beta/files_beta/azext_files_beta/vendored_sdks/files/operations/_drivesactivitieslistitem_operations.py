...
class drivesactivitieslistitemOperations(object):
    """drivesactivitieslistitemOperations operations.
    ...
    def create_link(
        ...
        drive_id,  # type: str
        item_activity_old_id,  # type: str
        body,  # type: "models.paths85vk2odrivesdriveidactivitiesitemactivityoldidlistitemmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
