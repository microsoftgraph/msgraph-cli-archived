...
class SharesListItemsActivitiesListItemOperations(object):
    """SharesListItemsActivitiesListItemOperations operations.
    ...
    def create_link(
        ...
        body,  # type: "models.PathsL44184SharesShareddriveitemIdListItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~files.models.PathsL44184SharesShareddriveitemIdListItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema
        ...
        body_content = self._serialize.body(body, 'PathsL44184SharesShareddriveitemIdListItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    create_link.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem/microsoft.graph.createLink'}  # type: ignore
    ...
    def get_activities_by_interval(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activities_by_interval.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
