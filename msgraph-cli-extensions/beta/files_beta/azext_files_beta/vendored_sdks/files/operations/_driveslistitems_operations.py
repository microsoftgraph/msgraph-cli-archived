...
class driveslistitemsOperations(object):
    """driveslistitemsOperations operations.
    ...
    def create_link(
        ...
        drive_id,  # type: str
        list_item_id,  # type: str
        body,  # type: "models.pathsvput3udrivesdriveidlistitemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
