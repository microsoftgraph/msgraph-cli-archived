...
class SharesListItemActivitiesListItemOperations(object):
    """SharesListItemActivitiesListItemOperations operations.
    ...
    def create_link(
        ...
        body,  # type: "models.Paths17RhsxkSharesShareddriveitemIdListitemActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~files.models.Paths17RhsxkSharesShareddriveitemIdListitemActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema
    ...
    def get_activities_by_interval(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_activities_by_interval.metadata = {'url': '/shares/{sharedDriveItem-id}/listItem/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
