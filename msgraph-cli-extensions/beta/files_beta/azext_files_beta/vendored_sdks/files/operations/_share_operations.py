...
class ShareOperations(object):
    ...
    def update_permission(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphPermission(id=id, expiration_date_time=expiration_date_time, granted_to_identities=granted_to_identities, has_password=has_password, roles=roles, share_id=share_id, application_link_application=application, configurator_url=configurator_url, prevents_download=prevents_download, scope=scope, type=type, web_html=web_html, web_url=web_url, email=email, invited_by=invited_by, redeemed_by=redeemed_by, sign_in_required=sign_in_required, drive_id=drive_id, drive_type=drive_type, id_inherited_from_id=microsoft_graph_item_reference_id, name=name, path=path, share_id_inherited_from_share_id=microsoft_graph_item_reference_share_id, sharepoint_ids=sharepoint_ids, site_id=site_id, application_granted_to_application=microsoft_graph_identity_application, device=device, user=user)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
