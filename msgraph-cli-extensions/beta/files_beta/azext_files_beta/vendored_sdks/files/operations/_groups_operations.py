...
class GroupsOperations(object):
    ...
    list_drives.metadata = {'url': '/groups/{group-id}/drives'}  # type: ignore
    ...
    def create_drives(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_drives.metadata = {'url': '/groups/{group-id}/drives'}  # type: ignore
    ...
    def get_drives(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_drives.metadata = {'url': '/groups/{group-id}/drives/{drive-id}'}  # type: ignore
    ...
    update_drives.metadata = {'url': '/groups/{group-id}/drives/{drive-id}'}  # type: ignore
    ...
    delete_drives.metadata = {'url': '/groups/{group-id}/drives/{drive-id}'}  # type: ignore
