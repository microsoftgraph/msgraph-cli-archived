...
class ShareListItemActivityListItemOperations(object):
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths17RhsxkSharesShareddriveitemIdListitemActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        ...
        body_content = self._serialize.body(_body, 'Paths17RhsxkSharesShareddriveitemIdListitemActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
        ...
        return deserialized
    create_link.metadata = {'url': '/shares/{sharedDriveItem-id}/listItem/activities/{itemActivityOLD-id}/listItem/microsoft.graph.createLink'}  # type: ignore
...
ize('[MicrosoftGraphItemActivityStat]', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    get_activity_by_interval.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
