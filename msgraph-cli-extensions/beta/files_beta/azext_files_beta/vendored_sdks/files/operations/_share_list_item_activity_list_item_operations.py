...
class ShareListItemActivityListItemOperations(object):
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths17RhsxkSharesShareddriveitemIdListitemActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        ...
        body_content = self._serialize.body(body, 'Paths17RhsxkSharesShareddriveitemIdListitemActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
