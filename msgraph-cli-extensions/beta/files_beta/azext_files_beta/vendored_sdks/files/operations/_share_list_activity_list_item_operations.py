...
class ShareListActivityListItemOperations(object):
    ...
    def create_link(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsIl1AdwSharesShareddriveitemIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
