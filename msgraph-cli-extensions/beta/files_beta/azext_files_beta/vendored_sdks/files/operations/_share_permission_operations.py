...
class SharePermissionOperations(object):
    """SharePermissionOperations operations.
    ...
    def grant(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Mcxy93SharesShareddriveitemIdPermissionMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema(roles=roles, recipients=recipients)
    ...
    def revoke_grant(
        self,
        shared_drive_item_id,  # type: str
        grantees=None,  # type: Optional[List["models.MicrosoftGraphDriveRecipient"]]
        **kwargs  # type: Any
    ):
        ...
        body = models.Paths50Xy75SharesShareddriveitemIdPermissionMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema(grantees=grantees)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
