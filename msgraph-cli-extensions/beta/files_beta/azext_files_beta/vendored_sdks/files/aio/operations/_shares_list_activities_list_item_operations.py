...
class SharesListActivitiesListItemOperations:
    """SharesListActivitiesListItemOperations async operations.
    ...
    async def create_link(
        ...
        shared_drive_item_id: str,
        item_activity_old_id: str,
        body: "models.PathsIl1AdwSharesShareddriveitemIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema",
        **kwargs
