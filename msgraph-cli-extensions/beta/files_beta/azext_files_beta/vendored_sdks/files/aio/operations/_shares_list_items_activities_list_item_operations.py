...
class SharesListItemsActivitiesListItemOperations:
    """SharesListItemsActivitiesListItemOperations async operations.
    ...
    async def create_link(
        ...
        body: "models.PathsL44184SharesShareddriveitemIdListItemsListitemIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema",
        **kwargs
