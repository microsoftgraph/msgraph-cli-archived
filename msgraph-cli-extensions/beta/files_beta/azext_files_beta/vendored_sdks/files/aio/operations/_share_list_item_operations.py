...
class ShareListItemOperations:
    ...
    async def create_link(
        ...
        **kwargs
        ...
        body = models.PathsWclibkSharesShareddriveitemIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
