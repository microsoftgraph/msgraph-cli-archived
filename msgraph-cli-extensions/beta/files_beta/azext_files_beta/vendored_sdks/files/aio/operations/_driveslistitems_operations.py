...
class driveslistitemsOperations:
    """driveslistitemsOperations async operations.
    ...
    def list_activities(
        ...
        **kwargs
    ) -> AsyncIterable["models.collectionofitemactivityold3"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files.models.collectionofitemactivityold3]
    ...
    list_activities.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/activities'}  # type: ignore
    ...
    async def create_activities(
        ...
        **kwargs
        ...
        return deserialized
    create_activities.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/activities'}  # type: ignore
    ...
    async def get_activities(
        ...
        expand: Optional[List[Union[str, "models.Enum209"]]] = None,
        **kwargs
    ) -> "models.microsoftgraphitemactivityold":
        """Get activities from drives.
        ...
        return deserialized
    get_activities.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    update_activities.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    delete_activities.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}'}  # type: ignore
    ...
    async def get_analytics(
        ...
        **kwargs
        ...
        return deserialized
    get_analytics.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/analytics'}  # type: ignore
    ...
    async def get_ref_analytics(
        ...
        **kwargs
        ...
        return deserialized
    get_ref_analytics.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    set_ref_analytics.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    delete_ref_analytics.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/analytics/$ref'}  # type: ignore
    ...
    async def get_fields(
        ...
        **kwargs
        ...
        return deserialized
    get_fields.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/fields'}  # type: ignore
    ...
    update_fields.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/fields'}  # type: ignore
    ...
    delete_fields.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/fields'}  # type: ignore

    async def create_link(
        self,
        drive_id: str,
        list_item_id: str,
        body: "models.pathsvput3udrivesdriveidlistitemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema",
        **kwargs
        ...
        :type body: ~files.models.pathsvput3udrivesdriveidlistitemslistitemidmicrosoftgraphcreatelinkpostrequestbodycontentapplicationjsonschema
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_activities_by_interval(
        ...
        **kwargs
        ...
        return deserialized
    get_activities_by_interval.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    def list_versions(
        ...
        **kwargs
    ) -> AsyncIterable["models.collectionoflistitemversion1"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files.models.collectionoflistitemversion1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_versions.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions'}  # type: ignore
    ...
    async def create_versions(
        ...
        **kwargs
        ...
        return deserialized
    create_versions.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions'}  # type: ignore
    ...
    async def get_versions(
        ...
        **kwargs
        ...
        return deserialized
    get_versions.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
    ...
    update_versions.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
    ...
    delete_versions.metadata = {'url': '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}'}  # type: ignore
