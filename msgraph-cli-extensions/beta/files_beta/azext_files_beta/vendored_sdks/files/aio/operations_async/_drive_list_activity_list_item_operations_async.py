...
class DriveListActivityListItemOperations:
    """DriveListActivityListItemOperations async operations.
    ...
    def list_activity(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfItemActivityOld2"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files.models.CollectionOfItemActivityOld2]
    ...
    list_activity.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/activities'}  # type: ignore
    ...
    async def create_activity(
        ...
        **kwargs
        ...
        return deserialized
    create_activity.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/activities'}  # type: ignore
    ...
    async def get_activity(
        ...
        **kwargs
        ...
        return deserialized
    get_activity.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    update_activity.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    delete_activity.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    async def get_analytic(
        ...
        **kwargs
        ...
        return deserialized
    get_analytic.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/analytics'}  # type: ignore
    ...
    async def get_ref_analytic(
        ...
        **kwargs
        ...
        return deserialized
    get_ref_analytic.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    set_ref_analytic.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    delete_ref_analytic.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    async def get_field(
        ...
        **kwargs
        ...
        return deserialized
    get_field.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    update_field.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    delete_field.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    async def create_link(
        ...
        **kwargs
        ...
        _body = models.Paths1Qap20EDrivesDriveIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths1Qap20EDrivesDriveIdListActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def get_activity_by_interval(
        ...
        **kwargs
        ...
        return deserialized
    get_activity_by_interval.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    def list_version(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files.models.CollectionOfListItemVersion0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_version.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/versions'}  # type: ignore
    ...
    async def create_version(
        ...
        **kwargs
        ...
        return deserialized
    create_version.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/versions'}  # type: ignore
    ...
    async def get_version(
        ...
        **kwargs
        ...
        return deserialized
    get_version.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
    ...
    update_version.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
    ...
    delete_version.metadata = {'url': '/drives/{drive-id}/list/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
