...
class DriveActivityListItemOperations:
    """DriveActivityListItemOperations async operations.
    ...
    def list_activity(
        ...
        **kwargs
        ...
        :type orderby: list[str or ~files.models.Enum133]
        :param select: Select properties to be returned.
        :type select: list[str or ~files.models.Enum134]
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Get9ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfItemActivityOld0 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files.models.CollectionOfItemActivityOld0]
    ...
    list_activity.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/activities'}  # type: ignore
    ...
    async def create_activity(
        ...
        **kwargs
        ...
        return deserialized
    create_activity.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/activities'}  # type: ignore
    ...
    async def get_activity(
        ...
        **kwargs
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Get4ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphItemActivityOld, or the result of cls(response)
        :rtype: ~files.models.MicrosoftGraphItemActivityOld
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_activity.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    update_activity.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    delete_activity.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/activities/{itemActivityOLD-id1}'}  # type: ignore
    ...
    async def get_analytic(
        ...
        **kwargs
        ...
        return deserialized
    get_analytic.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/analytics'}  # type: ignore
    ...
    async def get_ref_analytic(
        ...
        **kwargs
        ...
        return deserialized
    get_ref_analytic.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    set_ref_analytic.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    delete_ref_analytic.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/analytics/$ref'}  # type: ignore
    ...
    async def get_drive_item(
        ...
        **kwargs
        ...
        return deserialized
    get_drive_item.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/driveItem'}  # type: ignore
    ...
    update_drive_item.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/driveItem'}  # type: ignore
    ...
    delete_drive_item.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/driveItem'}  # type: ignore
    ...
    async def get_drive_item_content(
        ...
        **kwargs
        ...
        return deserialized
    get_drive_item_content.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/driveItem/content'}  # type: ignore
    ...
    set_drive_item_content.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/driveItem/content'}  # type: ignore
    ...
    async def get_field(
        ...
        **kwargs
        ...
        return deserialized
    get_field.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    update_field.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    delete_field.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/fields'}  # type: ignore
    ...
    async def create_link(
        ...
        **kwargs
        ...
        _body = models.Paths85Vk2ODrivesDriveIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema(type=type, scope=scope, expiration_date_time=expiration_date_time, password=password, recipients=recipients)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'Paths85Vk2ODrivesDriveIdActivitiesItemactivityoldIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_link.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/microsoft.graph.createLink'}  # type: ignore
    ...
    async def get_activity_by_interval(
        ...
        **kwargs
        ...
        return deserialized
    get_activity_by_interval.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore
    ...
    def list_version(
        ...
        **kwargs
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~files.models.Enum144]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_version.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/versions'}  # type: ignore
    ...
    async def create_version(
        ...
        **kwargs
        ...
        return deserialized
    create_version.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/versions'}  # type: ignore
    ...
    async def get_version(
        ...
        **kwargs
        ...
        return deserialized
    get_version.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
    ...
    update_version.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
    ...
    delete_version.metadata = {'url': '/drives/{drive-id}/activities/{itemActivityOLD-id}/listItem/versions/{listItemVersion-id}'}  # type: ignore
