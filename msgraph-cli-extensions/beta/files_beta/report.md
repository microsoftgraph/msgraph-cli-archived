...
### files create-activity

create-activity a files.
...
|Name (az)|Swagger name|
|---------|------------|
|files|shares.listItem.activities.listItem|
...
### files get-activity-by-interval

get-activity-by-interval a files.
...
### files get-bundle-content

get-bundle-content a files.
...
|Name (az)|Swagger name|
|---------|------------|
|files|shares.listItem.activities|
...
### files set-bundle-content

set-bundle-content a files.
...
### files update-activity

update-activity a files.
