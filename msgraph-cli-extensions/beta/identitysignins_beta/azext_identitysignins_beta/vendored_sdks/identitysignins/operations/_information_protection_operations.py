...
class InformationProtectionOperations(object):
    ...
    def create_data_loss_prevention_policy(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphDataLossPreventionPolicy(id=id, name=name)
    ...
    def update_policy(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphInformationProtectionPolicy(id=id, labels=labels)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def update_sensitivity_policy_setting(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphSensitivityPolicySettings(id=id, applicable_to=applicable_to, downgrade_sensitivity_requires_justification=downgrade_sensitivity_requires_justification, help_web_url=help_web_url, is_mandatory=is_mandatory)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
