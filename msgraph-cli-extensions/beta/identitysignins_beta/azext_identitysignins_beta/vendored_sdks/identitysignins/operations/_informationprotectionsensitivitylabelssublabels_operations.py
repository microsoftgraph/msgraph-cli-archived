...
class informationprotectionsensitivitylabelssublabelsOperations(object):
    """informationprotectionsensitivitylabelssublabelsOperations operations.
    ...
    def evaluate(
        ...
        body,  # type: "models.pathsk62xddinformationprotectionsensitivitylabelssensitivitylabelidsublabelsmicrosoftgraphevaluatepostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
