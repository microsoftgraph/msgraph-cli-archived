...
class InformationProtectionSensitivityLabelSublabelOperations(object):
    """InformationProtectionSensitivityLabelSublabelOperations operations.
    ...
    def evaluate(
        ...
        **kwargs  # type: Any
        ...
        _body = models.PathsK62XddInformationprotectionSensitivitylabelsSensitivitylabelIdSublabelsMicrosoftGraphEvaluatePostRequestbodyContentApplicationJsonSchema(discovered_sensitive_types=discovered_sensitive_types, current_label=current_label)
        ...
        body_content = self._serialize.body(_body, 'PathsK62XddInformationprotectionSensitivitylabelsSensitivitylabelIdSublabelsMicrosoftGraphEvaluatePostRequestbodyContentApplicationJsonSchema')
