...
class TrustFrameworkKeySetOperations(object):
    ...
    def generate_key(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1IaopbhTrustframeworkKeysetsTrustframeworkkeysetIdMicrosoftGraphGeneratekeyPostRequestbodyContentApplicationJsonSchema(use=use, kty=kty, nbf=nbf, exp=exp)
    ...
    def upload_certificate(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths19SkfwzTrustframeworkKeysetsTrustframeworkkeysetIdMicrosoftGraphUploadcertificatePostRequestbodyContentApplicationJsonSchema(key=key)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def upload_pkcs12(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths11Ap814TrustframeworkKeysetsTrustframeworkkeysetIdMicrosoftGraphUploadpkcs12PostRequestbodyContentApplicationJsonSchema(key=key, password=password)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def upload_secret(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsDmvqaiTrustframeworkKeysetsTrustframeworkkeysetIdMicrosoftGraphUploadsecretPostRequestbodyContentApplicationJsonSchema(use=use, k=k, nbf=nbf, exp=exp)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
