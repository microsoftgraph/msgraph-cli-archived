...
class Oauth2PermissionGrantOAuth2PermissionGrantOperations(object):
    ...
    def create_o_auth2_permission_grant(
        ...
        **kwargs  # type: Any
        ...
        _body = models.MicrosoftGraphOAuth2PermissionGrant(id=id, client_id=client_id, consent_type=consent_type, expiry_time=expiry_time, principal_id=principal_id, resource_id=resource_id, scope=scope, start_time=start_time)
