...
class RiskDetectionRiskDetectionOperations(object):
    ...
    def list_risk_detection(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~identity_sign_ins.models.CollectionOfRiskDetection]
    ...
    def create_risk_detection(
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphRiskDetection')
