...
class RiskDetectionsRiskDetectionOperations(object):
    """RiskDetectionsRiskDetectionOperations operations.
    ...
    def create_risk_detection(
        self,
        body,  # type: "models.MicrosoftGraphRiskDetection"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~identity_sign_ins.models.MicrosoftGraphRiskDetection
        :keyword callable cls: A custom type or function that will be passed the direct response
