...
class Oauth2PermissionGrantsOAuth2PermissionGrantOperations(object):
    """Oauth2PermissionGrantsOAuth2PermissionGrantOperations operations.
    ...
    def create_o_auth2_permission_grant(
        self,
        body,  # type: "models.MicrosoftGraphOAuth2PermissionGrant"
        **kwargs  # type: Any
    ):
