...
class InformationProtectionPolicyLabelOperations:
    ...
    async def evaluate_classification_result(
        ...
        **kwargs
        ...
        body = models.PathsLeqqhcInformationprotectionPolicyLabelsMicrosoftGraphEvaluateclassificationresultsPostRequestbodyContentApplicationJsonSchema(classification_results=classification_results, format=format, identifier=identifier, metadata=metadata, state=state)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def evaluate_removal(
        ...
        **kwargs
        ...
        body = models.PathsZ22GcjInformationprotectionPolicyLabelsMicrosoftGraphEvaluateremovalPostRequestbodyContentApplicationJsonSchema(downgrade_justification=downgrade_justification, format=format, identifier=identifier, metadata=metadata, state=state)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def extract_label(
        ...
        **kwargs
        ...
        body = models.PathsBj48EsInformationprotectionPolicyLabelsMicrosoftGraphExtractlabelPostRequestbodyContentApplicationJsonSchema(format=format, identifier=identifier, metadata=metadata, state=state)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
