...
class IdentityOperations:
    ...
    async def get_conditional_access(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_conditional_access.metadata['url']  # type: ignore
        ...
        return deserialized
    get_conditional_access.metadata = {'url': '/identity/conditionalAccess'}  # type: ignore
    ...
    async def update_conditional_access(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_conditional_access.metadata['url']  # type: ignore
    ...
    update_conditional_access.metadata = {'url': '/identity/conditionalAccess'}  # type: ignore

    async def delete_conditional_access(
        self,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_conditional_access.metadata['url']  # type: ignore
    ...
    def list_user_flows(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfIdentityUserFlow"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.CollectionOfIdentityUserFlow]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_user_flows(
        self,
        body: "models.MicrosoftGraphIdentityUserFlow",
        **kwargs
    ) -> "models.MicrosoftGraphIdentityUserFlow":
