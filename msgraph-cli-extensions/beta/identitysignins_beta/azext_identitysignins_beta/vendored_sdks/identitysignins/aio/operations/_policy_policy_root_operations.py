...
class PolicyPolicyRootOperations:
    ...
    async def update_policy_root(
        self,
        b2_c_authentication_methods_policy: Optional["models.MicrosoftGraphB2CAuthenticationMethodsPolicy"] = None,
        activity_based_timeout_policies: Optional[List["models.MicrosoftGraphActivityBasedTimeoutPolicy"]] = None,
        authorization_policy: Optional[List["models.MicrosoftGraphAuthorizationPolicy"]] = None,
        ...
        private_link_resource_policies: Optional[List["models.MicrosoftGraphPrivateLinkResource"]] = None,
