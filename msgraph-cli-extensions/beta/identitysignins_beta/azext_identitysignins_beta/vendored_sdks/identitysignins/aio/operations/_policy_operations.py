...
class PolicyOperations:
    ...
    async def create_activity_based_timeout_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphActivityBasedTimeoutPolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, definition=definition, is_organization_default=is_organization_default, applies_to=applies_to)
    ...
    async def update_admin_consent_request_policy(
        ...
        reviewers: Optional[List["models.MicrosoftGraphAccessReviewScope"]] = None,
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphAdminConsentRequestPolicy(id=id, is_enabled=is_enabled, notify_reviewers=notify_reviewers, reminders_enabled=reminders_enabled, request_duration_in_days=request_duration_in_days, reviewers=reviewers, version=version)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def get_authentication_flow_policy(
        self,
    ...
    async def update_authentication_flow_policy(
        self,
        id: Optional[str] = None,
        description: Optional[str] = None,
        display_name: Optional[str] = None,
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphAuthenticationFlowsPolicy(id=id, description=description, display_name=display_name, is_enabled=is_enabled)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def delete_authentication_flow_policy(
        self,
        if_match: Optional[str] = None,
        **kwargs
    ) -> None:
    ...
    async def create_authorization_policy(
        ...
        allow_invites_from: Optional[Union[str, "models.MicrosoftGraphAllowInvitesFrom"]] = None,
        block_msol_power_shell: Optional[bool] = None,
        default_user_role_permissions: Optional["models.MicrosoftGraphDefaultUserRolePermissions"] = None,
        enabled_preview_features: Optional[List[str]] = None,
        guest_user_role_id: Optional[str] = None,
    ...
    async def get_b2_c_authentication_method_policy(
        self,
    ...
    async def update_b2_c_authentication_method_policy(
        self,
        id: Optional[str] = None,
    ...
    async def delete_b2_c_authentication_method_policy(
        self,
        if_match: Optional[str] = None,
        **kwargs
    ) -> None:
    ...
    async def create_claim_mapping_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphClaimsMappingPolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, definition=definition, is_organization_default=is_organization_default, applies_to=applies_to)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def create_conditional_access_policy(
        ...
        client_applications: Optional["models.MicrosoftGraphConditionalAccessClientApplications"] = None,
        client_app_types: Optional[List[Union[str, "models.MicrosoftGraphConditionalAccessClientApp"]]] = None,
        devices: Optional["models.MicrosoftGraphConditionalAccessDevices"] = None,
        device_states: Optional["models.MicrosoftGraphConditionalAccessDeviceStates"] = None,
        ...
        user_risk_levels: Optional[List[Union[str, "models.MicrosoftGraphRiskLevel"]]] = None,
    ...
    async def update_device_registration_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphDeviceRegistrationPolicy(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def create_home_realm_discovery_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphHomeRealmDiscoveryPolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, definition=definition, is_organization_default=is_organization_default, applies_to=applies_to)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def update_identity_security_default_enforcement_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphIdentitySecurityDefaultsEnforcementPolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, is_enabled=is_enabled)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def create_permission_grant_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphPermissionGrantPolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, excludes=excludes, includes=includes)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def create_private_link_resource_policy(
        self,
        id: Optional[str] = None,
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphPrivateLinkResource(id=id, allowed_tenant_ids=allowed_tenant_ids, arm_resource_id=arm_resource_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def get_private_link_resource_policy(
        self,
    ...
    async def update_private_link_resource_policy(
        self,
        private_link_resource_id: str,
        id: Optional[str] = None,
        allowed_tenant_ids: Optional[List[str]] = None,
    ...
    async def delete_private_link_resource_policy(
        self,
        private_link_resource_id: str,
        if_match: Optional[str] = None,
        **kwargs
    ...
    async def create_token_issuance_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphTokenIssuancePolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, definition=definition, is_organization_default=is_organization_default, applies_to=applies_to)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def create_token_lifetime_policy(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphTokenLifetimePolicy(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, definition=definition, is_organization_default=is_organization_default, applies_to=applies_to)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
