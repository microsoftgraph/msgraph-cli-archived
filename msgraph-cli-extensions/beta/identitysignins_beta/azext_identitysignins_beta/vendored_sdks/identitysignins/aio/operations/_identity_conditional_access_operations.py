...
class IdentityConditionalAccessOperations:
    """IdentityConditionalAccessOperations async operations.
    ...
    def list_named_locations(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.CollectionOfNamedLocation]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_named_locations.metadata['url']  # type: ignore
    ...
    list_named_locations.metadata = {'url': '/identity/conditionalAccess/namedLocations'}  # type: ignore

    async def create_named_locations(
        self,
        body: "models.MicrosoftGraphNamedLocation",
        **kwargs
    ) -> "models.MicrosoftGraphNamedLocation":
        """Create new navigation property to namedLocations for identity.

        Create new navigation property to namedLocations for identity.

        :param body: New navigation property.
        :type body: ~identity_sign_ins.models.MicrosoftGraphNamedLocation
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.create_named_locations.metadata['url']  # type: ignore
        ...
        return deserialized
    create_named_locations.metadata = {'url': '/identity/conditionalAccess/namedLocations'}  # type: ignore

    async def get_named_locations(
        self,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_named_locations.metadata['url']  # type: ignore
        ...
        return deserialized
    get_named_locations.metadata = {'url': '/identity/conditionalAccess/namedLocations/{namedLocation-id}'}  # type: ignore

    async def update_named_locations(
        self,
        named_location_id: str,
        body: "models.MicrosoftGraphNamedLocation",
        **kwargs
        ...
        # Construct URL
        url = self.update_named_locations.metadata['url']  # type: ignore
        path_format_arguments = {
            'namedLocation-id': self._serialize.url("named_location_id", named_location_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    update_named_locations.metadata = {'url': '/identity/conditionalAccess/namedLocations/{namedLocation-id}'}  # type: ignore

    async def delete_named_locations(
        self,
        named_location_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_named_locations.metadata['url']  # type: ignore
        path_format_arguments = {
            'namedLocation-id': self._serialize.url("named_location_id", named_location_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    delete_named_locations.metadata = {'url': '/identity/conditionalAccess/namedLocations/{namedLocation-id}'}  # type: ignore
    ...
    def list_policies(
        ...
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfConditionalAccessPolicy"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.CollectionOfConditionalAccessPolicy]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_policies.metadata = {'url': '/identity/conditionalAccess/policies'}  # type: ignore
    ...
    async def create_policies(
        ...
        **kwargs
        ...
        return deserialized
    create_policies.metadata = {'url': '/identity/conditionalAccess/policies'}  # type: ignore
    ...
    async def get_policies(
        ...
        **kwargs
        ...
        return deserialized
    get_policies.metadata = {'url': '/identity/conditionalAccess/policies/{conditionalAccessPolicy-id}'}  # type: ignore
    ...
    update_policies.metadata = {'url': '/identity/conditionalAccess/policies/{conditionalAccessPolicy-id}'}  # type: ignore
    ...
    delete_policies.metadata = {'url': '/identity/conditionalAccess/policies/{conditionalAccessPolicy-id}'}  # type: ignore
