...
class informationprotectionpolicyOperations:
    """informationprotectionpolicyOperations async operations.
    ...
    def list_labels(
        ...
        **kwargs
    ) -> AsyncIterable["models.collectionofinformationprotectionlabel"]:
        """Get labels from informationProtection.

        Get labels from informationProtection.

        :param orderby: Order items by property values.
        :type orderby: list[str or ~identity_sign_ins.models.Enum49]
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_sign_ins.models.Enum50]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofinformationprotectionlabel or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.collectionofinformationprotectionlabel]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionofinformationprotectionlabel', pipeline_response)
    ...
    async def create_labels(
        ...
        **kwargs
        ...
        deserialized = self._deserialize('microsoftgraphinformationprotectionlabel', pipeline_response)
    ...
    async def get_labels(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_sign_ins.models.Enum51]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphinformationprotectionlabel, or the result of cls(response)
