...
class IdentitySignIns(object):
    ...
    :vartype identity_providers: identity_sign_ins.aio.operations.IdentityProvidersOperations
    ...
    :vartype information_protection_data_loss_prevention_policies: identity_sign_ins.aio.operations.InformationProtectionDataLossPreventionPoliciesOperations
    ...
    :vartype information_protection_policy_labels: identity_sign_ins.aio.operations.InformationProtectionPolicyLabelsOperations
    :ivar information_protection_sensitivity_labels: InformationProtectionSensitivityLabelsOperations operations
    :vartype information_protection_sensitivity_labels: identity_sign_ins.aio.operations.InformationProtectionSensitivityLabelsOperations
    ...
    :vartype information_protection_sensitivity_labels_sublabels: identity_sign_ins.aio.operations.InformationProtectionSensitivityLabelsSublabelsOperations
    ...
    :vartype risk_detections_risk_detection: identity_sign_ins.aio.operations.RiskDetectionsRiskDetectionOperations
    :ivar risky_users_risky_user: RiskyUsersRiskyUserOperations operations
    :vartype risky_users_risky_user: identity_sign_ins.aio.operations.RiskyUsersRiskyUserOperations
    :ivar risky_users: RiskyUsersOperations operations
    :vartype risky_users: identity_sign_ins.aio.operations.RiskyUsersOperations
    ...
    :vartype trust_framework_key_sets: identity_sign_ins.aio.operations.TrustFrameworkKeySetsOperations
    ...
    :vartype users_authentication: identity_sign_ins.aio.operations.UsersAuthenticationOperations
