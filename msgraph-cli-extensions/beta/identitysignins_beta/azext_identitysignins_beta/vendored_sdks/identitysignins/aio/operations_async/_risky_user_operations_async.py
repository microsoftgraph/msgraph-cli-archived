...
class RiskyUserOperations:
    ...
    def list_history(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.CollectionOfRiskyUserHistoryItem]
