...
class PolicyPermissionGrantPolicyOperations:
    """PolicyPermissionGrantPolicyOperations async operations.
    ...
    def list_exclude(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.CollectionOfPermissionGrantConditionSet]
    ...
    async def create_exclude(
        ...
        permission_type: Optional[Union[str, "models.MicrosoftGraphPermissionType"]] = None,
    ...
    def list_include(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_sign_ins.models.CollectionOfPermissionGrantConditionSet0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
