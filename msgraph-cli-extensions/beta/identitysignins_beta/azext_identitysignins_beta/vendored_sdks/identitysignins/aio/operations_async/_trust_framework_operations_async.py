...
class TrustFrameworkOperations:
    ...
    async def create_key_set(
        self,
        id: Optional[str] = None,
        keys: Optional[List["models.MicrosoftGraphTrustFrameworkKey"]] = None,
        **kwargs
