...
class UserAuthenticationOperations:
    """UserAuthenticationOperations async operations.
    ...
    def list_email_method(
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_email_method.metadata['url']  # type: ignore
    ...
    list_email_method.metadata = {'url': '/users/{user-id}/authentication/emailMethods'}  # type: ignore

    async def create_email_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphEmailAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_email_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphEmailAuthenticationMethod')
        ...
        return deserialized
    create_email_method.metadata = {'url': '/users/{user-id}/authentication/emailMethods'}  # type: ignore

    async def get_email_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_email_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_email_method.metadata = {'url': '/users/{user-id}/authentication/emailMethods/{emailAuthenticationMethod-id}'}  # type: ignore

    async def update_email_method(
        self,
        user_id: str,
        email_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_email_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'emailAuthenticationMethod-id': self._serialize.url("email_authentication_method_id", email_authentication_method_id, 'str'),
        }
    ...
    update_email_method.metadata = {'url': '/users/{user-id}/authentication/emailMethods/{emailAuthenticationMethod-id}'}  # type: ignore

    async def delete_email_method(
        self,
        user_id: str,
        email_authentication_method_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_email_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'emailAuthenticationMethod-id': self._serialize.url("email_authentication_method_id", email_authentication_method_id, 'str'),
        }
    ...
    delete_email_method.metadata = {'url': '/users/{user-id}/authentication/emailMethods/{emailAuthenticationMethod-id}'}  # type: ignore

    def list_fido2_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_fido2_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_fido2_method.metadata = {'url': '/users/{user-id}/authentication/fido2Methods'}  # type: ignore

    async def create_fido2_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphFido2AuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_fido2_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphFido2AuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_fido2_method.metadata = {'url': '/users/{user-id}/authentication/fido2Methods'}  # type: ignore

    async def get_fido2_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_fido2_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_fido2_method.metadata = {'url': '/users/{user-id}/authentication/fido2Methods/{fido2AuthenticationMethod-id}'}  # type: ignore

    async def update_fido2_method(
        self,
        user_id: str,
        fido2_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_fido2_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'fido2AuthenticationMethod-id': self._serialize.url("fido2_authentication_method_id", fido2_authentication_method_id, 'str'),
        }
    ...
    update_fido2_method.metadata = {'url': '/users/{user-id}/authentication/fido2Methods/{fido2AuthenticationMethod-id}'}  # type: ignore

    async def delete_fido2_method(
        self,
        user_id: str,
        fido2_authentication_method_id: str,
        if_match: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.delete_fido2_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'fido2AuthenticationMethod-id': self._serialize.url("fido2_authentication_method_id", fido2_authentication_method_id, 'str'),
        }
    ...
    delete_fido2_method.metadata = {'url': '/users/{user-id}/authentication/fido2Methods/{fido2AuthenticationMethod-id}'}  # type: ignore
    ...
    def list_method(
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_method.metadata = {'url': '/users/{user-id}/authentication/methods'}  # type: ignore
    ...
    async def create_method(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_method.metadata = {'url': '/users/{user-id}/authentication/methods'}  # type: ignore
    ...
    async def get_method(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_method.metadata = {'url': '/users/{user-id}/authentication/methods/{authenticationMethod-id}'}  # type: ignore
    ...
    async def update_method(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'authenticationMethod-id': self._serialize.url("authentication_method_id", authentication_method_id, 'str'),
        }
    ...
    update_method.metadata = {'url': '/users/{user-id}/authentication/methods/{authenticationMethod-id}'}  # type: ignore
    ...
    async def delete_method(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'authenticationMethod-id': self._serialize.url("authentication_method_id", authentication_method_id, 'str'),
        }
    ...
    delete_method.metadata = {'url': '/users/{user-id}/authentication/methods/{authenticationMethod-id}'}  # type: ignore

    def list_microsoft_authenticator_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_microsoft_authenticator_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/microsoftAuthenticatorMethods'}  # type: ignore

    async def create_microsoft_authenticator_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphMicrosoftAuthenticatorAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphMicrosoftAuthenticatorAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/microsoftAuthenticatorMethods'}  # type: ignore

    async def get_microsoft_authenticator_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod-id}'}  # type: ignore

    async def update_microsoft_authenticator_method(
        self,
        user_id: str,
        microsoft_authenticator_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'microsoftAuthenticatorAuthenticationMethod-id': self._serialize.url("microsoft_authenticator_authentication_method_id", microsoft_authenticator_authentication_method_id, 'str'),
        }
    ...
    update_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod-id}'}  # type: ignore
    ...
    async def delete_microsoft_authenticator_method(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'microsoftAuthenticatorAuthenticationMethod-id': self._serialize.url("microsoft_authenticator_authentication_method_id", microsoft_authenticator_authentication_method_id, 'str'),
        }
    ...
    delete_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod-id}'}  # type: ignore

    def list_oath_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_oath_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_oath_method.metadata = {'url': '/users/{user-id}/authentication/oathMethods'}  # type: ignore

    async def create_oath_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphSoftwareOathAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_oath_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphSoftwareOathAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_oath_method.metadata = {'url': '/users/{user-id}/authentication/oathMethods'}  # type: ignore

    async def get_oath_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_oath_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_oath_method.metadata = {'url': '/users/{user-id}/authentication/oathMethods/{softwareOathAuthenticationMethod-id}'}  # type: ignore

    async def update_oath_method(
        self,
        user_id: str,
        software_oath_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_oath_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'softwareOathAuthenticationMethod-id': self._serialize.url("software_oath_authentication_method_id", software_oath_authentication_method_id, 'str'),
        }
    ...
    update_oath_method.metadata = {'url': '/users/{user-id}/authentication/oathMethods/{softwareOathAuthenticationMethod-id}'}  # type: ignore

    async def delete_oath_method(
        self,
        user_id: str,
        software_oath_authentication_method_id: str,
        if_match: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.delete_oath_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'softwareOathAuthenticationMethod-id': self._serialize.url("software_oath_authentication_method_id", software_oath_authentication_method_id, 'str'),
        }
    ...
    delete_oath_method.metadata = {'url': '/users/{user-id}/authentication/oathMethods/{softwareOathAuthenticationMethod-id}'}  # type: ignore
    ...
    list_operation.metadata = {'url': '/users/{user-id}/authentication/operations'}  # type: ignore
    ...
    async def create_operation(
        ...
        status: Optional[Union[str, "models.MicrosoftGraphLongRunningOperationStatus"]] = None,
        ...
        **kwargs
        ...
        :param status:
        :type status: str or ~identity_sign_ins.models.MicrosoftGraphLongRunningOperationStatus
        :param status_detail:
        ...
        _body = models.MicrosoftGraphLongRunningOperation(id=id, created_date_time=created_date_time, last_action_date_time=last_action_date_time, resource_location=resource_location, status=status, status_detail=status_detail)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphLongRunningOperation')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_operation.metadata = {'url': '/users/{user-id}/authentication/operations'}  # type: ignore
    ...
    async def get_operation(
        ...
        **kwargs
        ...
        return deserialized
    get_operation.metadata = {'url': '/users/{user-id}/authentication/operations/{longRunningOperation-id}'}  # type: ignore
    ...
    update_operation.metadata = {'url': '/users/{user-id}/authentication/operations/{longRunningOperation-id}'}  # type: ignore
    ...
    delete_operation.metadata = {'url': '/users/{user-id}/authentication/operations/{longRunningOperation-id}'}  # type: ignore

    def list_passwordless_microsoft_authenticator_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_passwordless_microsoft_authenticator_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_passwordless_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/passwordlessMicrosoftAuthenticatorMethods'}  # type: ignore

    async def create_passwordless_microsoft_authenticator_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphPasswordlessMicrosoftAuthenticatorAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_passwordless_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphPasswordlessMicrosoftAuthenticatorAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_passwordless_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/passwordlessMicrosoftAuthenticatorMethods'}  # type: ignore

    async def get_passwordless_microsoft_authenticator_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_passwordless_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_passwordless_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod-id}'}  # type: ignore

    async def update_passwordless_microsoft_authenticator_method(
        self,
        user_id: str,
        passwordless_microsoft_authenticator_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_passwordless_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'passwordlessMicrosoftAuthenticatorAuthenticationMethod-id': self._serialize.url("passwordless_microsoft_authenticator_authentication_method_id", passwordless_microsoft_authenticator_authentication_method_id, 'str'),
        }
    ...
    update_passwordless_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod-id}'}  # type: ignore

    async def delete_passwordless_microsoft_authenticator_method(
        self,
        user_id: str,
        passwordless_microsoft_authenticator_authentication_method_id: str,
        if_match: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.delete_passwordless_microsoft_authenticator_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'passwordlessMicrosoftAuthenticatorAuthenticationMethod-id': self._serialize.url("passwordless_microsoft_authenticator_authentication_method_id", passwordless_microsoft_authenticator_authentication_method_id, 'str'),
        }
    ...
    delete_passwordless_microsoft_authenticator_method.metadata = {'url': '/users/{user-id}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod-id}'}  # type: ignore

    def list_password_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_password_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_password_method.metadata = {'url': '/users/{user-id}/authentication/passwordMethods'}  # type: ignore

    async def create_password_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphPasswordAuthenticationMethod(id=id, creation_date_time=creation_date_time, password=password)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_password_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphPasswordAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_password_method.metadata = {'url': '/users/{user-id}/authentication/passwordMethods'}  # type: ignore

    async def get_password_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_password_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_password_method.metadata = {'url': '/users/{user-id}/authentication/passwordMethods/{passwordAuthenticationMethod-id}'}  # type: ignore

    async def update_password_method(
        self,
        user_id: str,
        password_authentication_method_id: str,
        id: Optional[str] = None,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_password_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'passwordAuthenticationMethod-id': self._serialize.url("password_authentication_method_id", password_authentication_method_id, 'str'),
        }
    ...
    update_password_method.metadata = {'url': '/users/{user-id}/authentication/passwordMethods/{passwordAuthenticationMethod-id}'}  # type: ignore

    async def delete_password_method(
        self,
        user_id: str,
        password_authentication_method_id: str,
        if_match: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.delete_password_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'passwordAuthenticationMethod-id': self._serialize.url("password_authentication_method_id", password_authentication_method_id, 'str'),
        }
    ...
    delete_password_method.metadata = {'url': '/users/{user-id}/authentication/passwordMethods/{passwordAuthenticationMethod-id}'}  # type: ignore

    def list_phone_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_phone_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_phone_method.metadata = {'url': '/users/{user-id}/authentication/phoneMethods'}  # type: ignore

    async def create_phone_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        phone_number: Optional[str] = None,
        phone_type: Optional[Union[str, "models.MicrosoftGraphAuthenticationPhoneType"]] = None,
        sms_sign_in_state: Optional[Union[str, "models.MicrosoftGraphAuthenticationMethodSignInState"]] = None,
        **kwargs
        ...
        :param phone_type:
        :type phone_type: str or ~identity_sign_ins.models.MicrosoftGraphAuthenticationPhoneType
        :param sms_sign_in_state:
        :type sms_sign_in_state: str or ~identity_sign_ins.models.MicrosoftGraphAuthenticationMethodSignInState
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _body = models.MicrosoftGraphPhoneAuthenticationMethod(id=id, phone_number=phone_number, phone_type=phone_type, sms_sign_in_state=sms_sign_in_state)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_phone_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphPhoneAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_phone_method.metadata = {'url': '/users/{user-id}/authentication/phoneMethods'}  # type: ignore

    async def get_phone_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_phone_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_phone_method.metadata = {'url': '/users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}'}  # type: ignore

    async def update_phone_method(
        self,
        user_id: str,
        phone_authentication_method_id: str,
        id: Optional[str] = None,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.update_phone_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'phoneAuthenticationMethod-id': self._serialize.url("phone_authentication_method_id", phone_authentication_method_id, 'str'),
        }
    ...
    update_phone_method.metadata = {'url': '/users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}'}  # type: ignore
    ...
    async def delete_phone_method(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.delete_phone_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'phoneAuthenticationMethod-id': self._serialize.url("phone_authentication_method_id", phone_authentication_method_id, 'str'),
        }
    ...
    delete_phone_method.metadata = {'url': '/users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}'}  # type: ignore

    def list_security_question_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_security_question_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_security_question_method.metadata = {'url': '/users/{user-id}/authentication/securityQuestionMethods'}  # type: ignore

    async def create_security_question_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphSecurityQuestionAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_security_question_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphSecurityQuestionAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_security_question_method.metadata = {'url': '/users/{user-id}/authentication/securityQuestionMethods'}  # type: ignore

    async def get_security_question_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_security_question_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_security_question_method.metadata = {'url': '/users/{user-id}/authentication/securityQuestionMethods/{securityQuestionAuthenticationMethod-id}'}  # type: ignore

    async def update_security_question_method(
        self,
        user_id: str,
        security_question_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_security_question_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'securityQuestionAuthenticationMethod-id': self._serialize.url("security_question_authentication_method_id", security_question_authentication_method_id, 'str'),
        }
    ...
    update_security_question_method.metadata = {'url': '/users/{user-id}/authentication/securityQuestionMethods/{securityQuestionAuthenticationMethod-id}'}  # type: ignore

    async def delete_security_question_method(
        self,
        user_id: str,
        security_question_authentication_method_id: str,
        if_match: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.delete_security_question_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'securityQuestionAuthenticationMethod-id': self._serialize.url("security_question_authentication_method_id", security_question_authentication_method_id, 'str'),
        }
    ...
    delete_security_question_method.metadata = {'url': '/users/{user-id}/authentication/securityQuestionMethods/{securityQuestionAuthenticationMethod-id}'}  # type: ignore

    def list_temporary_access_pass_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_temporary_access_pass_method.metadata['url']  # type: ignore
                path_format_arguments = {
                    'user-id': self._serialize.url("user_id", user_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_temporary_access_pass_method.metadata = {'url': '/users/{user-id}/authentication/temporaryAccessPassMethods'}  # type: ignore

    async def create_temporary_access_pass_method(
        self,
        user_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphTemporaryAccessPassAuthenticationMethod(id=id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.create_temporary_access_pass_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphTemporaryAccessPassAuthenticationMethod')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        return deserialized
    create_temporary_access_pass_method.metadata = {'url': '/users/{user-id}/authentication/temporaryAccessPassMethods'}  # type: ignore

    async def get_temporary_access_pass_method(
        self,
        user_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_temporary_access_pass_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
        ...
        return deserialized
    get_temporary_access_pass_method.metadata = {'url': '/users/{user-id}/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethod-id}'}  # type: ignore

    async def update_temporary_access_pass_method(
        self,
        user_id: str,
        temporary_access_pass_authentication_method_id: str,
        id: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.update_temporary_access_pass_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'temporaryAccessPassAuthenticationMethod-id': self._serialize.url("temporary_access_pass_authentication_method_id", temporary_access_pass_authentication_method_id, 'str'),
        }
    ...
    update_temporary_access_pass_method.metadata = {'url': '/users/{user-id}/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethod-id}'}  # type: ignore

    async def delete_temporary_access_pass_method(
        self,
        user_id: str,
        temporary_access_pass_authentication_method_id: str,
        if_match: Optional[str] = None,
        **kwargs
        ...
        # Construct URL
        url = self.delete_temporary_access_pass_method.metadata['url']  # type: ignore
        path_format_arguments = {
            'user-id': self._serialize.url("user_id", user_id, 'str'),
            'temporaryAccessPassAuthenticationMethod-id': self._serialize.url("temporary_access_pass_authentication_method_id", temporary_access_pass_authentication_method_id, 'str'),
        }
    ...
    delete_temporary_access_pass_method.metadata = {'url': '/users/{user-id}/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethod-id}'}  # type: ignore
