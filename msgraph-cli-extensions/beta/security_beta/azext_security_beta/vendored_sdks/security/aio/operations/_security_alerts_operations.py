...
class SecurityAlertsOperations:
    """SecurityAlertsOperations async operations.
    ...
    async def update_alerts(
        self,
        body: "models.Paths1PgxztnSecurityAlertsMicrosoftGraphUpdatealertsPostRequestbodyContentApplicationJsonSchema",
        **kwargs
