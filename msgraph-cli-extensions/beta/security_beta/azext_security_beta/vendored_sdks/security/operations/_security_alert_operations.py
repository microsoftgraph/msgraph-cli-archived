...
class SecurityAlertOperations(object):
    ...
    def update_alert(
        ...
        **kwargs  # type: Any
        ...
        _body = models.Paths1PgxztnSecurityAlertsMicrosoftGraphUpdatealertsPostRequestbodyContentApplicationJsonSchema(value=value)
        ...
        body_content = self._serialize.body(_body, 'Paths1PgxztnSecurityAlertsMicrosoftGraphUpdatealertsPostRequestbodyContentApplicationJsonSchema')
