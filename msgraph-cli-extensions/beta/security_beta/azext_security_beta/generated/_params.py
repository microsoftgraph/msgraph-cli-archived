...
def load_arguments(self, _):
    ...
    with self.argument_context('security security-security gety') as c:
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security-security updatey') as c:
    ...
    with self.argument_context('security security create-alert') as c:
        ...
        c.argument('file_states', action=AddFileStates, nargs='*', help='Security-related stateful information '
                   'generated by the provider about the file(s) related to this alert.')
        ...
        c.argument('vulnerability_states', action=AddSecuritySecurityCreateAlertVulnerabilityStates, nargs='*', help=''
    ...
    with self.argument_context('security security createy-action') as c:
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
    ...
    with self.argument_context('security security get-cloud-app-security-profile') as c:
        c.argument('cloud_app_security_profile_id', type=str, help='key: id of cloudAppSecurityProfile')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-domain-security-profile') as c:
        c.argument('domain_security_profile_id', type=str, help='key: id of domainSecurityProfile')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-file-security-profile') as c:
        c.argument('file_security_profile_id', type=str, help='key: id of fileSecurityProfile')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-host-security-profile') as c:
        c.argument('host_security_profile_id', type=str, help='key: id of hostSecurityProfile')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-ip-security-profile') as c:
        c.argument('ip_security_profile_id', type=str, help='key: id of ipSecurityProfile')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-provider-tenant-setting') as c:
        c.argument('provider_tenant_setting_id', type=str, help='key: id of providerTenantSetting')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-secure-score') as c:
        c.argument('secure_score_id', type=str, help='key: id of secureScore')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('security security get-secure-score-control-profile') as c:
        c.argument('secure_score_control_profile_id', type=str, help='key: id of secureScoreControlProfile')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('security security gety-action') as c:
        c.argument('security_action_id', type=str, help='key: id of securityAction')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('security security listy-action') as c:
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('security security updatey-action') as c:
        c.argument('security_action_id', type=str, help='key: id of securityAction')
        c.argument('id_', options_list=['--id'], type=str, help='Read-only.')
        c.argument('action_reason', type=str, help='')
        c.argument('app_id', type=str, help='')
