...
|---------|------------|--------|
|az security security-security|Security.security|[commands](#CommandsInSecurity.security)|
...
|az security security-security-action|Security.securityActions|[commands](#CommandsInSecurity.securityActions)|
...
### <a name="CommandsInSecurity.security">Commands in `az security security-security` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az security security-security show-security](#Security.securityGetSecurity)|GetSecurity|[Parameters](#ParametersSecurity.securityGetSecurity)|Not Found|
|[az security security-security update-security](#Security.securityUpdateSecurity)|UpdateSecurity|[Parameters](#ParametersSecurity.securityUpdateSecurity)|Not Found|

### <a name="CommandsInSecurity.securityActions">Commands in `az security security-security-action` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az security security-security-action cancel-security-action](#Security.securityActionscancelSecurityAction)|cancelSecurityAction|[Parameters](#ParametersSecurity.securityActionscancelSecurityAction)|Not Found|
...
### group `az security security-security`
#### <a name="Security.securityGetSecurity">Command `az security security-security show-security`</a>
...
#### <a name="Security.securityUpdateSecurity">Command `az security security-security update-security`</a>
...
### group `az security security-security-action`
#### <a name="Security.securityActionscancelSecurityAction">Command `az security security-security-action cancel-security-action`</a>
