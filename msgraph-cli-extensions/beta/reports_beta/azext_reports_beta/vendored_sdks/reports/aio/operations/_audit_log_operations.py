...
class AuditLogOperations:
    ...
    async def create_directory_audit(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphDirectoryAudit(id=id, activity_date_time=activity_date_time, activity_display_name=activity_display_name, additional_details=additional_details, category=category, correlation_id=correlation_id, logged_by_service=logged_by_service, operation_type=operation_type, result=result, result_reason=result_reason, target_resources=target_resources, app=app, user=user)
    ...
    def list_directory_provisioning(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~reports.models.CollectionOfProvisioningObjectSummary]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_directory_provisioning(
        ...
        service_principal: Optional["models.MicrosoftGraphProvisioningServicePrincipal"] = None,
        tenant_id: Optional[str] = None,
        details: Optional[Dict[str, object]] = None,
        display_name: Optional[str] = None,
        microsoft_graph_provisioning_system_details_id: Optional[str] = None,
        microsoft_graph_details_info_details: Optional[Dict[str, object]] = None,
    ...
    async def delete_directory_provisioning(
        self,
        provisioning_object_summary_id: str,
        if_match: Optional[str] = None,
        **kwargs
    ...
    def list_provisioning(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~reports.models.CollectionOfProvisioningObjectSummary0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
