...
class AuditLogsOperations:
    """AuditLogsOperations async operations.
    ...
    async def create_directory_audits(
        self,
        body: "models.MicrosoftGraphDirectoryAudit",
        **kwargs
    ...
    async def update_directory_audits(
        self,
        directory_audit_id: str,
        body: "models.MicrosoftGraphDirectoryAudit",
        **kwargs
    ...
    async def delete_directory_audits(
        self,
        directory_audit_id: str,
    ...
    async def create_directory_provisioning(
        self,
        body: "models.MicrosoftGraphProvisioningObjectSummary",
        **kwargs
    ...
    async def create_restricted_sign_ins(
        self,
        body: "models.MicrosoftGraphRestrictedSignIn",
        **kwargs
    ...
    async def get_restricted_sign_ins(
        self,
    ...
    async def update_restricted_sign_ins(
        self,
        restricted_sign_in_id: str,
        body: "models.MicrosoftGraphRestrictedSignIn",
        **kwargs
    ...
    async def delete_restricted_sign_ins(
        self,
        restricted_sign_in_id: str,
        if_match: Optional[str] = None,
        **kwargs
