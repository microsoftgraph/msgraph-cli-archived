...
class reportsreportrootOperations:
    """reportsreportrootOperations async operations.
    ...
    async def get_report_root(
        ...
        **kwargs
        ...
        :type select: list[str or ~reports.models.Enum32]
        :param expand: Expand related entities.
        :type expand: list[str or ~reports.models.Enum33]
        ...
        return deserialized
    get_report_root.metadata = {'url': '/reports'}  # type: ignore

    async def update_report_root(
        self,
        ...
        **kwargs
        ...
        :type body: ~reports.models.microsoftgraphreportroot
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    update_report_root.metadata = {'url': '/reports'}  # type: ignore
