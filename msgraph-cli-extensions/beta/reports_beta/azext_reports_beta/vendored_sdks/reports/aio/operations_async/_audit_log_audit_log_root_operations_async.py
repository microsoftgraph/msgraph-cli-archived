...
class AuditLogAuditLogRootOperations:
    ...
    async def update_audit_log_root(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphAuditLogRoot(id=id, directory_audits=directory_audits, directory_provisioning=directory_provisioning, provisioning=provisioning, restricted_sign_ins=restricted_sign_ins, sign_ins=sign_ins)
