...
class auditlogsauditlogrootOperations(object):
    """auditlogsauditlogrootOperations operations.
    ...
    def update_audit_log_root(
        self,
        body,  # type: "models.microsoftgraphauditlogroot"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        """Update auditLogs.
        ...
        :type body: ~reports.models.microsoftgraphauditlogroot
        :keyword callable cls: A custom type or function that will be passed the direct response
