...
class AuditLogAuditLogRootOperations(object):
    ...
    def get_audit_log_root(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~reports.models.MicrosoftGraphAuditLogRoot
    ...
    def update_audit_log_root(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphAuditLogRoot(id=id, directory_audits=directory_audits, directory_provisioning=directory_provisioning, provisioning=provisioning, restricted_sign_ins=restricted_sign_ins, sign_ins=sign_ins)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphAuditLogRoot')
