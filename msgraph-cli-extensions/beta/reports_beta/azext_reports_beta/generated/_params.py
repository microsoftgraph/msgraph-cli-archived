...
def load_arguments(self, _):
    ...
    with self.argument_context('reports create-directory-provisioning') as c:
        c.argument('body', type=validate_file_or_dict, help='New navigation property Expected value: '
                   'json-string/@json-file.')

    with self.argument_context('reports create-provisioning') as c:
        c.argument('body', type=validate_file_or_dict, help='New navigation property Expected value: '
                   'json-string/@json-file.')
    ...
    with self.argument_context('reports get-directory-provisioning') as c:
        c.argument('provisioning_object_summary_id', type=str, help='key: id of provisioningObjectSummary')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('reports get-provisioning') as c:
        c.argument('provisioning_object_summary_id', type=str, help='key: id of provisioningObjectSummary')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('reports list-directory-provisioning') as c:
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')

    with self.argument_context('reports list-provisioning') as c:
        c.argument('orderby', nargs='*', help='Order items by property values')
        c.argument('select', nargs='*', help='Select properties to be returned')
        c.argument('expand', nargs='*', help='Expand related entities')
    ...
    with self.argument_context('reports update-directory-provisioning') as c:
        c.argument('provisioning_object_summary_id', type=str, help='key: id of provisioningObjectSummary')
        c.argument('body', type=validate_file_or_dict, help='New navigation property values Expected value: '
                   'json-string/@json-file.')

    with self.argument_context('reports update-provisioning') as c:
        c.argument('provisioning_object_summary_id', type=str, help='key: id of provisioningObjectSummary')
        c.argument('body', type=validate_file_or_dict, help='New navigation property values Expected value: '
                   'json-string/@json-file.')
    ...
    with self.argument_context('reports get-m365-app-platform-user-count') as c:
        c.argument('period', type=str, help='')

    with self.argument_context('reports get-m365-app-user-count') as c:
        c.argument('period', type=str, help='')

    with self.argument_context('reports get-m365-app-user-detail-c8-df') as c:
        c.argument('period', type=str, help='')

    with self.argument_context('reports get-m365-app-user-detail2-b20') as c:
        c.argument('date', help='')
