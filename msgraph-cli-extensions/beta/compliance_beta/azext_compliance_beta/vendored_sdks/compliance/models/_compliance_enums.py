...
class Enum132(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    ID = "id"
    ID_DESC = "id desc"
    ACKNOWLEDGED_DATE_TIME = "acknowledgedDateTime"
    ACKNOWLEDGED_DATE_TIME_DESC = "acknowledgedDateTime desc"
    APPLY_HOLD_TO_SOURCES = "applyHoldToSources"
    APPLY_HOLD_TO_SOURCES_DESC = "applyHoldToSources desc"
    CREATED_DATE_TIME = "createdDateTime"
...
class Enum133(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    RELEASED_DATE_TIME = "releasedDateTime"
    STATUS = "status"
    LAST_INDEX_OPERATION = "lastIndexOperation"
    SITE_SOURCES = "siteSources"
    UNIFIED_GROUP_SOURCES = "unifiedGroupSources"
...
class Enum145(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    INCLUDED_SOURCES_DESC = "includedSources desc"
...
class MicrosoftGraphCaseAction(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    INDEX = "index"
    SEARCH = "search"
    ADD_DATA_TO_REVIEW_SET = "addDataToReviewSet"

class MicrosoftGraphCaseOperationStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class MicrosoftGraphCaseStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class MicrosoftGraphCustodianStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class MicrosoftGraphSourceType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
