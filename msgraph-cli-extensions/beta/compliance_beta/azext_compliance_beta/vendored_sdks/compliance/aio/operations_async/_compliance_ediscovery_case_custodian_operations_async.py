...
class ComplianceEdiscoveryCaseCustodianOperations:
    """ComplianceEdiscoveryCaseCustodianOperations async operations.
    ...
    async def create_site_source(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphSiteSource(id=id, created_date_time=created_date_time, display_name=display_name, application=application, device=device, user=user, site=site)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphSiteSource')
        body_content_kwargs['content'] = body_content
    ...
    async def create_unified_group_source(
        self,
        ediscovery_case_id: str,
        custodian_id: str,
        id: Optional[str] = None,
        ...
        device: Optional["models.MicrosoftGraphIdentity"] = None,
        user: Optional["models.MicrosoftGraphIdentity"] = None,
        included_sources: Optional[Union[str, "models.MicrosoftGraphSourceType"]] = None,
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphUnifiedGroupSource(id=id, created_date_time=created_date_time, display_name=display_name, application=application, device=device, user=user, included_sources=included_sources, group=group)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphUnifiedGroupSource')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def get_unified_group_source(
        self,
        ediscovery_case_id: str,
        custodian_id: str,
    ...
    async def update_unified_group_source(
        self,
        ediscovery_case_id: str,
        custodian_id: str,
        unified_group_source_id: str,
    ...
    async def delete_unified_group_source(
        self,
        ediscovery_case_id: str,
        custodian_id: str,
        unified_group_source_id: str,
    ...
    async def create_user_source(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphUserSource(id=id, created_date_time=created_date_time, display_name=display_name, application=application, device=device, user=user, email=email, included_sources=included_sources)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'MicrosoftGraphUserSource')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
