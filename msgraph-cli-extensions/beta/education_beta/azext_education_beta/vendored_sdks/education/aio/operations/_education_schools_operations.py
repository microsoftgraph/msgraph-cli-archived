...
class EducationSchoolsOperations:
    """EducationSchoolsOperations async operations.
    ...
    async def get_ref_administrative_unit(
        self,
        education_school_id: str,
        **kwargs
    ) -> str:
    ...
    async def set_ref_administrative_unit(
        self,
        education_school_id: str,
    ...
    async def delete_ref_administrative_unit(
        self,
        education_school_id: str,
    ...
    def list_ref_classes(
        self,
        education_school_id: str,
        orderby: Optional[List[Union[str, "models.Enum232"]]] = None,
        **kwargs
    ) -> AsyncIterable["models.CollectionOfLinksOfEducationClass1"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~education.models.CollectionOfLinksOfEducationClass1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
