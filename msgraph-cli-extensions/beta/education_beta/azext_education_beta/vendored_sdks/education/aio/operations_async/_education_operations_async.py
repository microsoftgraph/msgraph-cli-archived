...
class EducationOperations:
    ...
    async def create_class(
        ...
        **kwargs
        ...
        _body = models.MicrosoftGraphEducationClass(id=id, class_code=class_code, course=course, description=description, display_name=display_name, external_id=external_id, external_name=external_name, external_source=external_source, external_source_detail=external_source_detail, grade=grade, mail_nickname=mail_nickname, term=term, assignment_categories=assignment_categories, assignments=assignments, group=group, members=members, schools=schools, teachers=teachers, display_name_created_by_user_display_name=microsoft_graph_identity_display_name, id_created_by_user_id=microsoft_graph_identity_id, display_name_created_by_device_display_name=display_name1, id_created_by_device_id=id1, display_name_created_by_application_display_name=display_name2, id_created_by_application_id=id2)
