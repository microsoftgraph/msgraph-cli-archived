...
class educationclassesteachersOperations(object):
    """educationclassesteachersOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/classes/{educationClass-id}/teachers/microsoft.graph.delta()'}  # type: ignore
