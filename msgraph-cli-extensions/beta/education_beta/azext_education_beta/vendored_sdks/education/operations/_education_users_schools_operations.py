...
class EducationUsersSchoolsOperations(object):
    """EducationUsersSchoolsOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/users/{educationUser-id}/schools/microsoft.graph.delta()'}  # type: ignore
