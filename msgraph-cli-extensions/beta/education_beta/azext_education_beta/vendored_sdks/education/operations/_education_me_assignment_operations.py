...
class EducationMeAssignmentOperations(object):
    """EducationMeAssignmentOperations operations.
    ...
    delete_category.metadata = {'url': '/education/me/assignments/{educationAssignment-id}/categories/{educationCategory-id}'}  # type: ignore
    ...
    delete_resource.metadata = {'url': '/education/me/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}'}  # type: ignore
    ...
    delete_submission.metadata = {'url': '/education/me/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}'}  # type: ignore
