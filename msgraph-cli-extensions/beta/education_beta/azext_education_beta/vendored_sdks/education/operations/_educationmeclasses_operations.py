...
class educationmeclassesOperations(object):
    """educationmeclassesOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/me/classes/microsoft.graph.delta()'}  # type: ignore
