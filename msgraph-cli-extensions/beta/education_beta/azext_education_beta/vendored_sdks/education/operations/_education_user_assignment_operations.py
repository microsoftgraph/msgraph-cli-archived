...
class EducationUserAssignmentOperations(object):
    """EducationUserAssignmentOperations operations.
    ...
    def list_category(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEducationCategory2"]
        ...
        :type orderby: list[str or ~education.models.Enum256]
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum257]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEducationCategory2 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~education.models.CollectionOfEducationCategory2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEducationCategory2"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEducationCategory2', pipeline_response)
    ...
    list_category.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories'}  # type: ignore
    ...
    def create_category(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_category.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories'}  # type: ignore
    ...
    def get_category(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum258"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MicrosoftGraphEducationCategory"
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum258]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEducationCategory, or the result of cls(response)
        ...
        return deserialized
    get_category.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories/{educationCategory-id}'}  # type: ignore
    ...
    update_category.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories/{educationCategory-id}'}  # type: ignore
    ...
    delete_category.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories/{educationCategory-id}'}  # type: ignore

    def get_resource_folder_url(
        self,
        education_user_id,  # type: str
        education_assignment_id,  # type: str
        **kwargs  # type: Any
        ...
        return deserialized
    get_resource_folder_url.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/microsoft.graph.getResourcesFolderUrl()'}  # type: ignore
    ...
    def publish(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    publish.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/microsoft.graph.publish'}  # type: ignore

    def list_resource(
        self,
        education_user_id,  # type: str
        education_assignment_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum259"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum260"]]]
        expand=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.CollectionOfEducationAssignmentResource1"]
        ...
        :type education_assignment_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~education.models.Enum259]
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum260]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEducationAssignmentResource1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~education.models.CollectionOfEducationAssignmentResource1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEducationAssignmentResource1"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEducationAssignmentResource1', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_resource.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/resources'}  # type: ignore
    ...
    def create_resource(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphEducationAssignmentResource(id=id, distribute_for_student_work=distribute_for_student_work, created_by=created_by, created_date_time=created_date_time, display_name=display_name, last_modified_by=last_modified_by, last_modified_date_time=last_modified_date_time)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        return deserialized
    create_resource.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/resources'}  # type: ignore
    ...
    def get_resource(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum261]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEducationAssignmentResource, or the result of cls(response)
        ...
        return deserialized
    get_resource.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}'}  # type: ignore
    ...
    update_resource.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}'}  # type: ignore
    ...
    delete_resource.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}'}  # type: ignore
    ...
    def get_rubric(
        ...
        **kwargs  # type: Any
        ...
        :type education_assignment_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum262]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        return deserialized
    get_rubric.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/rubric'}  # type: ignore
    ...
    update_rubric.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/rubric'}  # type: ignore
    ...
    delete_rubric.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/rubric'}  # type: ignore
    ...
    def list_submission(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfEducationSubmission1"]
        ...
        :type education_assignment_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~education.models.Enum263]
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum264]
        :param expand: Expand related entities.
        :type expand: list[str or ~education.models.Enum265]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfEducationSubmission1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~education.models.CollectionOfEducationSubmission1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfEducationSubmission1"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfEducationSubmission1', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_submission.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions'}  # type: ignore
    ...
    def create_submission(
        ...
        released_date_time=None,  # type: Optional[datetime.datetime]
        resources_folder_url=None,  # type: Optional[str]
        returned_date_time=None,  # type: Optional[datetime.datetime]
        status=None,  # type: Optional[Union[str, "models.MicrosoftGraphEducationSubmissionStatus"]]
        submitted_date_time=None,  # type: Optional[datetime.datetime]
        unsubmitted_date_time=None,  # type: Optional[datetime.datetime]
        outcomes=None,  # type: Optional[List["models.MicrosoftGraphEducationOutcome"]]
        resources=None,  # type: Optional[List["models.MicrosoftGraphEducationSubmissionResource"]]
        submitted_resources=None,  # type: Optional[List["models.MicrosoftGraphEducationSubmissionResource"]]
        application=None,  # type: Optional["models.MicrosoftGraphIdentity"]
        device=None,  # type: Optional["models.MicrosoftGraphIdentity"]
        user=None,  # type: Optional["models.MicrosoftGraphIdentity"]
        microsoft_graph_identity_application=None,  # type: Optional["models.MicrosoftGraphIdentity"]
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphEducationSubmission(id=id, recipient=recipient, released_date_time=released_date_time, resources_folder_url=resources_folder_url, returned_date_time=returned_date_time, status=status, submitted_date_time=submitted_date_time, unsubmitted_date_time=unsubmitted_date_time, outcomes=outcomes, resources=resources, submitted_resources=submitted_resources, application_unsubmitted_by_application=application, device_unsubmitted_by_device=device, user_unsubmitted_by_user=user, application_submitted_by_application=microsoft_graph_identity_application, device_submitted_by_device=microsoft_graph_identity_device, user_submitted_by_user=microsoft_graph_identity_user, application_returned_by_application=application1, device_returned_by_device=device1, user_returned_by_user=user1, application_released_by_application=application2, device_released_by_device=device2, user_released_by_user=user2)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        return deserialized
    create_submission.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions'}  # type: ignore
    ...
    def get_submission(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum266]
        :param expand: Expand related entities.
        :type expand: list[str or ~education.models.Enum267]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEducationSubmission, or the result of cls(response)
        :rtype: ~education.models.MicrosoftGraphEducationSubmission
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_submission.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}'}  # type: ignore
    ...
    update_submission.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}'}  # type: ignore
    ...
    delete_submission.metadata = {'url': '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}'}  # type: ignore
