...
class EducationSchoolsClassesOperations(object):
    """EducationSchoolsClassesOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/schools/{educationSchool-id}/classes/microsoft.graph.delta()'}  # type: ignore
