...
class EducationEducationRootOperations(object):
    """EducationEducationRootOperations operations.
    ...
    def get_education_root(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MicrosoftGraphEducationRoot"
        """Get education.

        Get education.

        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Get0ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~education.models.Get1ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphEducationRoot, or the result of cls(response)
        :rtype: ~education.models.MicrosoftGraphEducationRoot
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MicrosoftGraphEducationRoot"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        accept = "application/json"

        # Construct URL
        url = self.get_education_root.metadata['url']  # type: ignore
        ...
        deserialized = self._deserialize('MicrosoftGraphEducationRoot', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    get_education_root.metadata = {'url': '/education'}  # type: ignore
    ...
    def update_education_root(
        ...
        **kwargs  # type: Any
        ...
        _body = models.MicrosoftGraphEducationRoot(id=id, synchronization_profiles=synchronization_profiles, classes=classes, me=me, schools=schools, users=users)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.update_education_root.metadata['url']  # type: ignore
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphEducationRoot')
    ...
    update_education_root.metadata = {'url': '/education'}  # type: ignore
