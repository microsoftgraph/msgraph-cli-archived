...
class EducationMeTaughtClassesOperations(object):
    """EducationMeTaughtClassesOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/me/taughtClasses/microsoft.graph.delta()'}  # type: ignore
