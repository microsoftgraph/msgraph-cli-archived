...
class EducationClassesMembersOperations(object):
    """EducationClassesMembersOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/classes/{educationClass-id}/members/microsoft.graph.delta()'}  # type: ignore
