...
class EducationClassesSchoolsOperations(object):
    """EducationClassesSchoolsOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/classes/{educationClass-id}/schools/microsoft.graph.delta()'}  # type: ignore
