...
class EducationUsersTaughtClassesOperations(object):
    """EducationUsersTaughtClassesOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/users/{educationUser-id}/taughtClasses/microsoft.graph.delta()'}  # type: ignore
