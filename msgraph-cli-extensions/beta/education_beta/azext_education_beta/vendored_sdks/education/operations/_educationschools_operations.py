...
class educationschoolsOperations(object):
    """educationschoolsOperations operations.
    ...
    def get_administrative_unit(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~education.models.Enum227]
        :param expand: Expand related entities.
        :type expand: list[str or ~education.models.Enum228]
    ...
    def get_ref_administrative_unit(
        self,
        education_school_id,  # type: str
        **kwargs  # type: Any
    ):
        ...
        # Construct URL
        url = self.get_ref_administrative_unit.metadata['url']  # type: ignore
        path_format_arguments = {
            'educationSchool-id': self._serialize.url("education_school_id", education_school_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    get_ref_administrative_unit.metadata = {'url': '/education/schools/{educationSchool-id}/administrativeUnit/$ref'}  # type: ignore

    def set_ref_administrative_unit(
        self,
        education_school_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.set_ref_administrative_unit.metadata['url']  # type: ignore
        path_format_arguments = {
            'educationSchool-id': self._serialize.url("education_school_id", education_school_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    set_ref_administrative_unit.metadata = {'url': '/education/schools/{educationSchool-id}/administrativeUnit/$ref'}  # type: ignore

    def delete_ref_administrative_unit(
        self,
        education_school_id,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_ref_administrative_unit.metadata['url']  # type: ignore
        path_format_arguments = {
            'educationSchool-id': self._serialize.url("education_school_id", education_school_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    delete_ref_administrative_unit.metadata = {'url': '/education/schools/{educationSchool-id}/administrativeUnit/$ref'}  # type: ignore

    def list_classes(
        self,
        education_school_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum229"]]]
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~education.models.Enum229]
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum230]
        :param expand: Expand related entities.
        :type expand: list[str or ~education.models.Enum231]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_classes.metadata = {'url': '/education/schools/{educationSchool-id}/classes'}  # type: ignore

    def list_ref_classes(
        self,
        education_school_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum232"]]]
        **kwargs  # type: Any
    ):
        ...
        :type education_school_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~education.models.Enum232]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_ref_classes.metadata = {'url': '/education/schools/{educationSchool-id}/classes/$ref'}  # type: ignore
    ...
    def create_ref_classes(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_ref_classes.metadata = {'url': '/education/schools/{educationSchool-id}/classes/$ref'}  # type: ignore
    ...
    def list_users(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.collectionofeducationuser1"]
        ...
        :type education_school_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~education.models.Enum233]
        :param select: Select properties to be returned.
        :type select: list[str or ~education.models.Enum234]
        :param expand: Expand related entities.
        :type expand: list[str or ~education.models.Enum235]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofeducationuser1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~education.models.collectionofeducationuser1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_users.metadata = {'url': '/education/schools/{educationSchool-id}/users'}  # type: ignore
    ...
    def list_ref_users(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.collectionoflinksofeducationuser1"]
        ...
        :type education_school_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~education.models.Enum236]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionoflinksofeducationuser1 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~education.models.collectionoflinksofeducationuser1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_ref_users.metadata['url']  # type: ignore
                path_format_arguments = {
                    'educationSchool-id': self._serialize.url("education_school_id", education_school_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_ref_users.metadata = {'url': '/education/schools/{educationSchool-id}/users/$ref'}  # type: ignore

    def create_ref_users(
        self,
        education_school_id,  # type: str
        body,  # type: Dict[str, object]
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.create_ref_users.metadata['url']  # type: ignore
        path_format_arguments = {
            'educationSchool-id': self._serialize.url("education_school_id", education_school_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_ref_users.metadata = {'url': '/education/schools/{educationSchool-id}/users/$ref'}  # type: ignore

    def delta(
        self,
        **kwargs  # type: Any
    ):
        # type: (...) -> List["models.microsoftgrapheducationschool"]
