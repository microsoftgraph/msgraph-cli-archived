...
class EducationMeSchoolsOperations(object):
    """EducationMeSchoolsOperations operations.
    ...
    def delta(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    delta.metadata = {'url': '/education/me/schools/microsoft.graph.delta()'}  # type: ignore
