...
class UsersOnenoteSectionGroupsSectionsPagesOperations(object):
    ...
    def preview(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    preview.metadata = {'url': '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/microsoft.graph.preview()'}  # type: ignore
