...
class UserOnenoteNotebookOperations:
    ...
    async def get_recent_notebook(
        ...
        **kwargs
        ...
        :rtype: list[~users_functions.models.MicrosoftGraphRecentNotebook]
        ...
        return deserialized
    get_recent_notebook.metadata = {'url': '/users/{user-id}/onenote/notebooks/microsoft.graph.getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks})'}  # type: ignore
