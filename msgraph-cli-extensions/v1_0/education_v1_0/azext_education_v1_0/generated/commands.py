...
def load_command_table(self, _):
    ...
    education_v1_0_education_education_root = CliCommandType(
        operations_tmpl='azext_education_v1_0.vendored_sdks.education.operations._education_education_root_operations#EducationEducationRootOperations.{}',
        client_factory=cf_education_education_root,
    )
    with self.command_group('education education-root', education_v1_0_education_education_root) as g:
    ...
    with self.command_group('education education', education_v1_0_education) as g:
    ...
    with self.command_group('education education-class', education_v1_0_education_class) as g:
    ...
    education_v1_0_education_me = CliCommandType(
        operations_tmpl=(
            'azext_education_v1_0.vendored_sdks.education.operations._education_me_operations#EducationMeOperations.{}'
        ),
        client_factory=cf_education_me,
    )
    with self.command_group('education education-me', education_v1_0_education_me) as g:
    ...
    with self.command_group('education education-school', education_v1_0_education_school) as g:
    ...
    with self.command_group('education education-user', education_v1_0_education_user) as g:
