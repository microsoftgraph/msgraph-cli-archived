...
def load_arguments(self, _):
    ...
    with self.argument_context('calendar group create-event') as c:
        ...
        c.argument('single_value_extended_properties', action=AddCalendarGroupCreateViewSingleValueExtendedProperties,
                   ...
                   'Read-only. Nullable.')
        c.argument('pattern', action=AddPattern, nargs='+', help='recurrencePattern', arg_group='Recurrence')
        c.argument('range', action=AddRange, nargs='+', help='recurrenceRange', arg_group='Recurrence')
        c.argument('email_address', action=AddOwner, nargs='+', help='emailAddress', arg_group='Organizer')
        c.argument('conference_id', type=str, help='The ID of the conference.', arg_group='Online Meeting')
        c.argument('join_url', type=str, help='The external link that launches the online meeting. This is a URL that '
                   'clients will launch into a browser and will redirect the user to join the meeting.',
                   arg_group='Online Meeting')
        c.argument('phones', action=AddPhones, nargs='+', help='All of the phone numbers associated with this '
                   'conference.', arg_group='Online Meeting')
        c.argument('quick_dial', type=str, help='The pre-formatted quickdial for this call.', arg_group='Online '
                   'Meeting')
        c.argument('toll_free_numbers', nargs='+', help='The toll free numbers that can be used to join the '
                   'conference.', arg_group='Online Meeting')
        c.argument('toll_number', type=str, help='The toll number that can be used to join the conference.',
                   arg_group='Online Meeting')
        c.argument('address', action=AddAddress, nargs='+', help='physicalAddress', arg_group='Location')
        c.argument('coordinates', action=AddCoordinates, nargs='+', help='outlookGeoCoordinates',
                   arg_group='Location')
        c.argument('display_name', type=str, help='The name associated with the location.', arg_group='Location')
        ...
        c.argument('location_type', arg_type=get_enum_type(['default', 'conferenceRoom', 'homeAddress',
                   ...
                   help='', arg_group='Location')
        c.argument('location_uri', type=str, help='Optional URI representing the location.', arg_group='Location')
        c.argument('unique_id', type=str, help='For internal use only.', arg_group='Location')
        c.argument('unique_id_type', arg_type=get_enum_type(['unknown', 'locationStore', 'directory', 'private',
                                                             'bing']), help='', arg_group='Location')
    ...
    with self.argument_context('calendar group-calendar show-calendar-permission') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar group-calendar show-calendar-view') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('start_date_time', type=str, help='The start date and time of the time range, represented in ISO '
                   '8601 format. For example, 2019-11-08T19:00:00-08:00')
    ...
    with self.argument_context('calendar group-calendar show-event') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar group-calendar show-multi-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar show-single-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view show-attachment') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('attachment_id', type=str, help='key: id of attachment')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view show-calendar') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar group-calendar-view show-extension') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('extension_id', type=str, help='key: id of extension')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view show-instance') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view show-multi-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-calendar-view show-single-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-calendar-event show-attachment') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('attachment_id', type=str, help='key: id of attachment')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-event show-calendar') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar group-calendar-event show-extension') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('extension_id', type=str, help='key: id of extension')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-event show-instance') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-event show-multi-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-calendar-event show-single-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-calendar-view-calendar show-calendar-permission') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view-calendar show-calendar-view') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view-calendar show-event') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-calendar-view-calendar show-multi-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-calendar-view-calendar show-single-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-event show-attachment') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('attachment_id', type=str, help='key: id of attachment')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-event show-calendar') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar group-event show-extension') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('extension_id', type=str, help='key: id of extension')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-event show-instance') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-event show-multi-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-event show-single-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-event-calendar show-calendar-permission') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-event-calendar show-calendar-view') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-event-calendar show-event') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar group-event-calendar show-multi-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar group-event-calendar show-single-value-extended-property') as c:
        c.argument('group_id', type=str, help='key: id of group')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar place-place create-place') as c:
        ...
        c.argument('geo_coordinates', action=AddCoordinates, nargs='+', help='outlookGeoCoordinates')
    ...
    with self.argument_context('calendar place-place show-place') as c:
        c.argument('place_id', type=str, help='key: id of place')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')
    ...
    with self.argument_context('calendar user-calendar show-calendar-permission') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar user-calendar show-calendar-view') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('start_date_time', type=str, help='The start date and time of the time range, represented in ISO '
                   '8601 format. For example, 2019-11-08T19:00:00-08:00')
    ...
    with self.argument_context('calendar user-calendar show-event') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar user-calendar show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view show-attachment') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('attachment_id', type=str, help='key: id of attachment')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view show-calendar') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar user-calendar-view show-extension') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('extension_id', type=str, help='key: id of extension')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view show-instance') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-calendar-view show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-calendar-event show-attachment') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('attachment_id', type=str, help='key: id of attachment')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-event show-calendar') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar user-calendar-event show-extension') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('extension_id', type=str, help='key: id of extension')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-event show-instance') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-event show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-calendar-event show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-calendar-group show-calendar') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-group-calendar show-calendar-permission') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
    ...
    with self.argument_context('calendar user-calendar-group-calendar show-calendar-view') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar show-event') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
    ...
    with self.argument_context('calendar user-calendar-group-calendar show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
    ...
    with self.argument_context('calendar user-calendar-group-calendar-view show-attachment') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-view show-calendar') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-view show-extension') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-view show-instance') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-view show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-view show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-event show-attachment') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-event show-calendar') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-event show-extension') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-event show-instance') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-event show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-group-calendar-event show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('calendar_group_id', type=str, help='key: id of calendarGroup')
        c.argument('calendar_id', type=str, help='key: id of calendar')
        c.argument('event_id', type=str, help='key: id of event')
    ...
    with self.argument_context('calendar user-calendar-view-calendar show-calendar-permission') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view-calendar show-calendar-view') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view-calendar show-event') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-calendar-view-calendar show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-calendar-view-calendar show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-event show-attachment') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('attachment_id', type=str, help='key: id of attachment')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-event show-calendar') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
        c.argument('expand', nargs='+', help='Expand related entities')

    with self.argument_context('calendar user-event show-extension') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('extension_id', type=str, help='key: id of extension')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-event show-instance') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-event show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-event show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-event-calendar show-calendar-permission') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('calendar_permission_id', type=str, help='key: id of calendarPermission')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-event-calendar show-calendar-view') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-event-calendar show-event') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('event_id1', type=str, help='key: id of event')
        c.argument('select', nargs='+', help='Select properties to be returned')
    ...
    with self.argument_context('calendar user-event-calendar show-multi-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('multi_value_legacy_extended_property_id', type=str, help='key: id of '
                   'multiValueLegacyExtendedProperty')
    ...
    with self.argument_context('calendar user-event-calendar show-single-value-extended-property') as c:
        c.argument('user_id', type=str, help='key: id of user')
        c.argument('event_id', type=str, help='key: id of event')
        c.argument('single_value_legacy_extended_property_id', type=str, help='key: id of '
                   'singleValueLegacyExtendedProperty')
