...
class userseventsOperations:
    ...
    def list_attachments(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum379"]]] = None,
    ...
    async def get_attachments(
        ...
        event_id: str,
        attachment_id: str,
        select: Optional[List[Union[str, "models.Enum381"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ) -> "models.microsoftgraphattachment":
        """Get attachments from users.
    ...
    async def get_calendar(
        ...
        expand: Optional[List[Union[str, "models.Enum383"]]] = None,
        **kwargs
    ...
    def list_extensions(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum403"]]] = None,
    ...
    def list_instances(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum404"]]] = None,
    ...
    async def get_instances(
        ...
        event_id: str,
        event_id1: str,
        select: Optional[List[Union[str, "models.Enum407"]]] = None,
        expand: Optional[List[Union[str, "models.Enum408"]]] = None,
        **kwargs
    ) -> "models.microsoftgraphevent":
        """Get instances from users.
    ...
    def list_multi_value_extended_properties(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum409"]]] = None,
        select: Optional[List[Union[str, "models.Enum410"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
    ...
    def list_single_value_extended_properties(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum412"]]] = None,
        select: Optional[List[Union[str, "models.Enum413"]]] = None,
        expand: Optional[List[str]] = None,
        **kwargs
