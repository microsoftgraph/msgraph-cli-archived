...
class UsersCalendarCalendarViewOperations:
    ...
    def list_attachments(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum167"]]] = None,
    ...
    def list_instances(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfEvent12"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~calendar.models.CollectionOfEvent12]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_multi_value_extended_properties(
        ...
        user_id: str,
        event_id: str,
        orderby: Optional[List[Union[str, "models.Enum178"]]] = None,
