...
class directoryroletemplatesdirectoryroletemplateOperations(object):
    """directoryroletemplatesdirectoryroletemplateOperations operations.
    ...
    def create_directory_role_template(
        self,
        body,  # type: "models.microsoftgraphdirectoryroletemplate"
        **kwargs  # type: Any
    ):
