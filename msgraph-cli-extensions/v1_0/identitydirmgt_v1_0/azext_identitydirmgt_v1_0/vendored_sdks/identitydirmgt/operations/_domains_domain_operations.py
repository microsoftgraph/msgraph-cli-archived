...
class DomainsDomainOperations(object):
    """DomainsDomainOperations operations.
    ...
    def create_domain(
        self,
        body,  # type: "models.MicrosoftGraphDomain"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~identity_directory_management.models.MicrosoftGraphDomain
        :keyword callable cls: A custom type or function that will be passed the direct response
