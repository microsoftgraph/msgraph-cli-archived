...
class DirectoryOperations:
    ...
    async def create_administrative_unit(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphAdministrativeUnit(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, visibility=visibility, members=members, scoped_role_members=scoped_role_members, extensions=extensions)
