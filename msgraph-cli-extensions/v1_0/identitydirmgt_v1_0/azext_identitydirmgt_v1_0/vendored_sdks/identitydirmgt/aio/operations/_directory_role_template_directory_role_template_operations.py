...
class DirectoryRoleTemplateDirectoryRoleTemplateOperations:
    """DirectoryRoleTemplateDirectoryRoleTemplateOperations async operations.
    ...
    def list_directory_role_template(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfDirectoryRoleTemplate"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfDirectoryRoleTemplate]
    ...
    async def create_directory_role_template(
        self,
        ...
        **kwargs
    ) -> "models.MicrosoftGraphDirectoryRoleTemplate":
        ...
        body = models.MicrosoftGraphDirectoryRoleTemplate(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphDirectoryRoleTemplate')
    ...
    async def get_directory_role_template(
        self,
    ...
    async def update_directory_role_template(
        self,
        directory_role_template_id: str,
        id: Optional[str] = None,
        deleted_date_time: Optional[datetime.datetime] = None,
    ...
    async def delete_directory_role_template(
        self,
        directory_role_template_id: str,
