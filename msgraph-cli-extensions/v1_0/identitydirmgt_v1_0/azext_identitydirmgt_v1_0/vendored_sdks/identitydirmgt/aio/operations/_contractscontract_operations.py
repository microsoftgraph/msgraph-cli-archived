...
class contractscontractOperations:
    """contractscontractOperations async operations.
    ...
    async def create_contract(
        self,
        body: "models.microsoftgraphcontract",
        **kwargs
        ...
        :type body: ~identity_directory_management.models.microsoftgraphcontract
        :keyword callable cls: A custom type or function that will be passed the direct response
