...
class directoryroletemplatesdirectoryroletemplateOperations:
    """directoryroletemplatesdirectoryroletemplateOperations async operations.
    ...
    async def create_directory_role_template(
        self,
        body: "models.microsoftgraphdirectoryroletemplate",
        **kwargs
        ...
        :type body: ~identity_directory_management.models.microsoftgraphdirectoryroletemplate
        :keyword callable cls: A custom type or function that will be passed the direct response
