...
class DirectoryRoleDirectoryRoleOperations:
    ...
    async def create_directory_role(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphDirectoryRole(id=id, deleted_date_time=deleted_date_time, description=description, display_name=display_name, role_template_id=role_template_id, members=members, scoped_members=scoped_members)
