...
class ContractContractOperations:
    """ContractContractOperations async operations.
    ...
    def list_contract(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfContract"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~identity_directory_management.models.CollectionOfContract]
    ...
    async def create_contract(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphContract(id=id, deleted_date_time=deleted_date_time, contract_type=contract_type, customer_id=customer_id, default_domain_name=default_domain_name, display_name=display_name)
        ...
        body_content = self._serialize.body(body, 'MicrosoftGraphContract')
    ...
    async def get_contract(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~identity_directory_management.models.Enum18]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContract, or the result of cls(response)
