...
from ._configuration_async import CrossDeviceExperiencesConfiguration
...
class CrossDeviceExperiences(object):
    ...
    :vartype user: cross_device_experiences.aio.operations_async.UserOperations
    :ivar user_activity: UserActivityOperations operations
    :vartype user_activity: cross_device_experiences.aio.operations_async.UserActivityOperations
    :ivar user_activity_history_item: UserActivityHistoryItemOperations operations
    :vartype user_activity_history_item: cross_device_experiences.aio.operations_async.UserActivityHistoryItemOperations
