...
class UsersOnenoteNotebooksSectionGroupsSectionsParentNotebookOperations:
    """UsersOnenoteNotebooksSectionGroupsSectionsParentNotebookOperations async operations.
    ...
    async def copy_notebook(
        ...
        body: "models.Paths1H9IwvtUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema",
        **kwargs
