...
class usersonenotenotebookssectiongroupssectionspagesparentnotebookOperations:
    """usersonenotenotebookssectiongroupssectionspagesparentnotebookOperations async operations.
    ...
    async def copy_notebook(
        ...
        onenote_page_id: str,
        body: "models.pathsfm3zd0usersuseridonenotenotebooksnotebookidsectiongroupssectiongroupidsectionsonenotesectionidpagesonenotepageidparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema",
        **kwargs
