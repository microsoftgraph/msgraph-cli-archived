...
class UserManagedDeviceOperations:
    ...
    async def wipe(
        ...
        **kwargs
        ...
        _body = models.Paths14R8Rr7UsersUserIdManageddevicesManageddeviceIdMicrosoftGraphWipePostRequestbodyContentApplicationJsonSchema(keep_enrollment_data=keep_enrollment_data, keep_user_data=keep_user_data, mac_os_unlock_code=mac_os_unlock_code)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
