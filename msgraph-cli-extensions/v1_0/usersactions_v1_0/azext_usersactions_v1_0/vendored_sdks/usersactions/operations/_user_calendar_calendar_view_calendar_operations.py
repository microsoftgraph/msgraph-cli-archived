...
class UserCalendarCalendarViewCalendarOperations(object):
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Ybn8BcUsersUserIdCalendarsCalendarIdCalendarviewEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
