...
class UserOnenoteNotebookSectionGroupSectionPageOperations(object):
    ...
    def copy_to_section(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsGdge0LUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, site_collection_id=site_collection_id, site_id=site_id)
    ...
    def onenote_patch_content(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1G3UapzUsersUserIdOnenoteNotebooksNotebookIdSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema(commands=commands)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
