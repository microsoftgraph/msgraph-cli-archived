...
class UserMailFolderChildFolderOperations(object):
    ...
    def copy(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1E02JcUsersUserIdMailfoldersMailfolderIdChildfoldersMailfolderId1MicrosoftGraphCopyPostRequestbodyContentApplicationJsonSchema(destination_id=destination_id)
    ...
    def move(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Ekxa5VUsersUserIdMailfoldersMailfolderIdChildfoldersMailfolderId1MicrosoftGraphMovePostRequestbodyContentApplicationJsonSchema(destination_id=destination_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
