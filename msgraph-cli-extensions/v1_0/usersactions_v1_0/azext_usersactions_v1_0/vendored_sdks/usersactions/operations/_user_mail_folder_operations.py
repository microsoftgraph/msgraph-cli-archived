...
class UserMailFolderOperations(object):
    ...
    def copy(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsSdgf1MUsersUserIdMailfoldersMailfolderIdMicrosoftGraphCopyPostRequestbodyContentApplicationJsonSchema(destination_id=destination_id)
    ...
    def move(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths1Adv2SrUsersUserIdMailfoldersMailfolderIdMicrosoftGraphMovePostRequestbodyContentApplicationJsonSchema(destination_id=destination_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
