...
class UserEventCalendarOperations(object):
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths11Iq6NwUsersUserIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(body, 'Paths11Iq6NwUsersUserIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
