...
class UsersOnlineMeetingsOperations(object):
    """UsersOnlineMeetingsOperations operations.
    ...
    def create_or_get(
        self,
        user_id,  # type: str
        body,  # type: "models.Paths1H47062UsersUserIdOnlinemeetingsMicrosoftGraphCreateorgetPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~users_actions.models.Paths1H47062UsersUserIdOnlinemeetingsMicrosoftGraphCreateorgetPostRequestbodyContentApplicationJsonSchema
