...
class UsersOnenoteNotebooksSectionsParentSectionGroupParentNotebookOperations(object):
    """UsersOnenoteNotebooksSectionsParentSectionGroupParentNotebookOperations operations.
    ...
    def copy_notebook(
        ...
        body,  # type: "models.PathsH9F1UhUsersUserIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdParentsectiongroupParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
