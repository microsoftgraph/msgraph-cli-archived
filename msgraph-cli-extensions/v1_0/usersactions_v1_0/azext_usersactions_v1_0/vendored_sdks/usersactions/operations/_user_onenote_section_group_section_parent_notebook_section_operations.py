...
class UserOnenoteSectionGroupSectionParentNotebookSectionOperations(object):
    ...
    def copy_to_notebook(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsI6Vxt9UsersUserIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdParentnotebookSectionsOnenotesectionId1MicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, rename_as=rename_as, site_collection_id=site_collection_id, site_id=site_id)
    ...
    def copy_to_section_group(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsDoh0LaUsersUserIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdParentnotebookSectionsOnenotesectionId1MicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema(id=id, group_id=group_id, rename_as=rename_as, site_collection_id=site_collection_id, site_id=site_id)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
