...
class UserOnenoteNotebookSectionParentNotebookOperations(object):
    ...
    def copy_notebook(
        ...
        **kwargs  # type: Any
        ...
        body = models.Paths119LdlmUsersUserIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdParentnotebookMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema(group_id=group_id, rename_as=rename_as, notebook_folder=notebook_folder, site_collection_id=site_collection_id, site_id=site_id)
