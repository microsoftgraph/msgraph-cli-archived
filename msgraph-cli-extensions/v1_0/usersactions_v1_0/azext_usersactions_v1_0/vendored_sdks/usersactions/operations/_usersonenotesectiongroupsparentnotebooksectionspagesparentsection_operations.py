...
class usersonenotesectiongroupsparentnotebooksectionspagesparentsectionOperations(object):
    """usersonenotesectiongroupsparentnotebooksectionspagesparentsectionOperations operations.
    ...
    def copy_to_notebook(
        ...
        body,  # type: "models.paths1ejrdf9usersuseridonenotesectiongroupssectiongroupidparentnotebooksectionsonenotesectionidpagesonenotepageidparentsectionmicrosoftgraphcopytonotebookpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
    ...
    def copy_to_section_group(
        ...
        onenote_section_id,  # type: str
        onenote_page_id,  # type: str
        body,  # type: "models.paths156ew11usersuseridonenotesectiongroupssectiongroupidparentnotebooksectionsonenotesectionidpagesonenotepageidparentsectionmicrosoftgraphcopytosectiongrouppostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.microsoftgraphonenoteoperation"
