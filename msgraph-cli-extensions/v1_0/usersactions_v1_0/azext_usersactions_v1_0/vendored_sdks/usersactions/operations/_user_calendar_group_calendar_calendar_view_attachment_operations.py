...
class UserCalendarGroupCalendarCalendarViewAttachmentOperations(object):
    ...
    def create_upload_session(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsYbtkdsUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdCalendarviewEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema(attachment_item=attachment_item)
