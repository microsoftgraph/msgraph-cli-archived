...
class UserCalendarOperations(object):
    ...
    def get_schedule(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsQue4OrUsersUserIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema(schedules=schedules, end_time=end_time, start_time=start_time, availability_view_interval=availability_view_interval)
        ...
        body_content = self._serialize.body(body, 'PathsQue4OrUsersUserIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema')
