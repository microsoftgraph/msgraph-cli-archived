...
class userseventscalendarOperations(object):
    ...
    def get_schedule(
        ...
        user_id,  # type: str
        event_id,  # type: str
        body,  # type: "models.paths11iq6nwusersuserideventseventidcalendarmicrosoftgraphgetschedulepostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~users_actions.models.paths11iq6nwusersuserideventseventidcalendarmicrosoftgraphgetschedulepostrequestbodycontentapplicationjsonschema
