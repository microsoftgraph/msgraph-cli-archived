...
#### <a name="sites.lists.itemsgetActivitiesByInterval-53ee">Command `az sites site-list-item show-activity`</a>
...
#### <a name="sites.lists.itemsgetActivitiesByInterval-96b0">Command `az sites site-list-item show-activity`</a>
