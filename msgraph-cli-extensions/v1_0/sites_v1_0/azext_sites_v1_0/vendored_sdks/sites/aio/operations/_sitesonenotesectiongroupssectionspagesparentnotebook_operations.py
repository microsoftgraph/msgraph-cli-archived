...
class sitesonenotesectiongroupssectionspagesparentnotebookOperations:
    ...
    async def copy_notebook(
        ...
        onenote_page_id: str,
        body: "models.pathsh3vfs3sitessiteidonenotesectiongroupssectiongroupidsectionsonenotesectionidpagesonenotepageidparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema",
        **kwargs
