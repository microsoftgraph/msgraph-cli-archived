...
class sitesonenotenotebookssectionspagesparentnotebookOperations(object):
    """sitesonenotenotebookssectionspagesparentnotebookOperations operations.
    ...
    def copy_notebook(
        ...
        body,  # type: "models.paths11s117psitessiteidonenotenotebooksnotebookidsectionsonenotesectionidpagesonenotepageidparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~sites.models.paths11s117psitessiteidonenotenotebooksnotebookidsectionsonenotesectionidpagesonenotepageidparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema
        ...
        body_content = self._serialize.body(body, 'paths11s117psitessiteidonenotenotebooksnotebookidsectionsonenotesectionidpagesonenotepageidparentnotebookmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema')
        ...
        return deserialized
    copy_notebook.metadata = {'url': '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook/microsoft.graph.copyNotebook'}  # type: ignore
