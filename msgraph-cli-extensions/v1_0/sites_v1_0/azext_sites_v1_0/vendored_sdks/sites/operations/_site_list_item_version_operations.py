...
class SiteListItemVersionOperations(object):
    """SiteListItemVersionOperations operations.
    ...
    def get_field(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_field.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}/fields'}  # type: ignore
    ...
    update_field.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}/fields'}  # type: ignore
    ...
    delete_field.metadata = {'url': '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}/fields'}  # type: ignore
