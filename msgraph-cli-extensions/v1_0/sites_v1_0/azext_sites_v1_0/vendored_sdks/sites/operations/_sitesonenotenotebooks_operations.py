...
class sitesonenotenotebooksOperations(object):
    ...
    def copy_notebook(
        ...
        body,  # type: "models.pathss3y1mrsitessiteidonenotenotebooksnotebookidmicrosoftgraphcopynotebookpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
    ...
    def get_notebook_from_web_url(
        self,
        site_id,  # type: str
        body,  # type: "models.pathsukf43dsitessiteidonenotenotebooksmicrosoftgraphgetnotebookfromweburlpostrequestbodycontentapplicationjsonschema"
        **kwargs  # type: Any
    ):
