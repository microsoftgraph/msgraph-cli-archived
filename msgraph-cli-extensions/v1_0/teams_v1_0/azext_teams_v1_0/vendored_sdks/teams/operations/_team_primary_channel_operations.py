...
class TeamPrimaryChannelOperations(object):
    ...
    def get_file_folder(
        ...
        **kwargs  # type: Any
        ...
        :type expand: list[str or ~teams.models.Enum115]
    ...
    def list_member(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfConversationMember1"]
        ...
        :type orderby: list[str or ~teams.models.Enum116]
        :param select: Select properties to be returned.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~teams.models.CollectionOfConversationMember1]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_member(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~teams.models.Enum118]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphConversationMember, or the result of cls(response)
    ...
    def list_message(
        ...
        **kwargs  # type: Any
        ...
        :param expand: Expand related entities.
        :type expand: list[str or ~teams.models.Enum121]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_tab(
        ...
        **kwargs  # type: Any
        ...
        :type team_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~teams.models.Enum130]
        :param select: Select properties to be returned.
        :type select: list[str or ~teams.models.Enum131]
        :param expand: Expand related entities.
        :type expand: list[str or ~teams.models.Enum132]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_tab(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~teams.models.Enum133]
        :param expand: Expand related entities.
        :type expand: list[str or ~teams.models.Enum134]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphTeamsTab, or the result of cls(response)
        :rtype: ~teams.models.MicrosoftGraphTeamsTab
        :raises: ~azure.core.exceptions.HttpResponseError
