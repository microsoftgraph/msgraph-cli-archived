...
class TeamOperations(object):
    ...
    def create_channel(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphChannel(id=id, description=description, display_name=display_name, email=email, membership_type=membership_type, web_url=web_url, files_folder=files_folder, members=members, messages=messages, tabs=tabs)
    ...
    def create_installed_app(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphTeamsAppInstallation(id=id, teams_app_definition=teams_app_definition, id_teams_app_id=microsoft_graph_entity_id, display_name=display_name, distribution_method=distribution_method, external_id=external_id, app_definitions=app_definitions)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
