...
def load_command_table(self, _):
    ...
    with self.command_group('mail user', mail_v1_0_user) as g:
    ...
    with self.command_group('mail user-inference-classification', mail_v1_0_user_inference_classification) as g:
    ...
    with self.command_group('mail user-mail-folder', mail_v1_0_user_mail_folder) as g:
    ...
    with self.command_group('mail user-mail-folder-message', mail_v1_0_user_mail_folder_message) as g:
    ...
    with self.command_group('mail user-message', mail_v1_0_user_message) as g:
