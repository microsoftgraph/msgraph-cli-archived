...
def load_command_table(self, _):
    ...
    mail_v1_0_user_inference_classification = CliCommandType(
        operations_tmpl='azext_mail_v1_0.vendored_sdks.mail.operations._user_inference_classification_operations#UserIn'
        'ferenceClassificationOperations.{}',
        client_factory=cf_user_inference_classification)
    with self.command_group('mail user-inference-classification', mail_v1_0_user_inference_classification,
    ...
    mail_v1_0_user_mail_folder = CliCommandType(
        operations_tmpl='azext_mail_v1_0.vendored_sdks.mail.operations._user_mail_folder_operations#UserMailFolderOpera'
        'tions.{}',
        client_factory=cf_user_mail_folder)
    with self.command_group('mail user-mail-folder', mail_v1_0_user_mail_folder, client_factory=cf_user_mail_folder,
    ...
    mail_v1_0_user_mail_folder_message = CliCommandType(
        operations_tmpl='azext_mail_v1_0.vendored_sdks.mail.operations._user_mail_folder_message_operations#UserMailFol'
        'derMessageOperations.{}',
        client_factory=cf_user_mail_folder_message)
    with self.command_group('mail user-mail-folder-message', mail_v1_0_user_mail_folder_message,
    ...
    with self.command_group('mail user-message', mail_v1_0_user_message, client_factory=cf_user_message,
                            is_experimental=True) as g:
