...
class InformationProtectionThreatAssessmentRequestsOperations(object):
    """InformationProtectionThreatAssessmentRequestsOperations operations.
    ...
    def create_results(
        self,
        threat_assessment_request_id,  # type: str
        body,  # type: "models.MicrosoftGraphThreatAssessmentResult"
        **kwargs  # type: Any
    ):
