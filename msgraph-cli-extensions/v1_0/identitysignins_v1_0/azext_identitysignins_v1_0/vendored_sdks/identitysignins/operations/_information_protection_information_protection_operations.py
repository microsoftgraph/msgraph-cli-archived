...
class InformationProtectionInformationProtectionOperations(object):
    """InformationProtectionInformationProtectionOperations operations.
    ...
    def update_information_protection(
        ...
        **kwargs  # type: Any
        ...
        _body = models.MicrosoftGraphInformationProtection(id=id, threat_assessment_requests=threat_assessment_requests)
