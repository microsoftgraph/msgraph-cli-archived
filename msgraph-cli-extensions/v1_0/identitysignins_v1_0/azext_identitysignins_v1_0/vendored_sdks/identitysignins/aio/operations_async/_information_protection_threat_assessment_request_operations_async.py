...
class InformationProtectionThreatAssessmentRequestOperations:
    """InformationProtectionThreatAssessmentRequestOperations async operations.
    ...
    async def create_result(
        ...
        result_type: Optional[Union[str, "models.MicrosoftGraphThreatAssessmentResultType"]] = None,
        **kwargs
        ...
        _body = models.MicrosoftGraphThreatAssessmentResult(id=id, created_date_time=created_date_time, message=message, result_type=result_type)
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphThreatAssessmentResult')
