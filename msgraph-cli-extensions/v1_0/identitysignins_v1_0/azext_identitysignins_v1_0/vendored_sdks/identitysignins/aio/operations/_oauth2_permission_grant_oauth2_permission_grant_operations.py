...
class Oauth2PermissionGrantOAuth2PermissionGrantOperations:
    ...
    async def create_o_auth2_permission_grant(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphOAuth2PermissionGrant(id=id, client_id=client_id, consent_type=consent_type, principal_id=principal_id, resource_id=resource_id, scope=scope)
