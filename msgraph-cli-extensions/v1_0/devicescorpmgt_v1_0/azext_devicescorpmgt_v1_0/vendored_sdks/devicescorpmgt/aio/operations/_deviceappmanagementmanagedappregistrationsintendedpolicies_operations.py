...
class deviceappmanagementmanagedappregistrationsintendedpoliciesOperations:
    """deviceappmanagementmanagedappregistrationsintendedpoliciesOperations async operations.
    ...
    async def target_apps(
        ...
        body: "models.paths1mv9gnvdeviceappmanagementmanagedappregistrationsmanagedappregistrationidintendedpoliciesmanagedapppolicyidmicrosoftgraphtargetappspostrequestbodycontentapplicationjsonschema",
        **kwargs
    ) -> None:
