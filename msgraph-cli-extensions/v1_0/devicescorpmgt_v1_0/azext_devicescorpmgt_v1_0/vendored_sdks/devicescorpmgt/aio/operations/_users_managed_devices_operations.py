...
class UsersManagedDevicesOperations:
    ...
    async def update_device_category(
        ...
        user_id: str,
        managed_device_id: str,
        body: "models.MicrosoftGraphDeviceCategory",
        **kwargs
    ) -> None:
    ...
    async def create_device_compliance_policy_states(
        self,
        user_id: str,
        managed_device_id: str,
        body: "models.MicrosoftGraphDeviceCompliancePolicyState",
        **kwargs
    ...
    async def update_device_compliance_policy_states(
        self,
        user_id: str,
        managed_device_id: str,
        device_compliance_policy_state_id: str,
    ...
    async def delete_device_compliance_policy_states(
        self,
        user_id: str,
        managed_device_id: str,
        device_compliance_policy_state_id: str,
    ...
    async def create_device_configuration_states(
        self,
        user_id: str,
        managed_device_id: str,
        body: "models.MicrosoftGraphDeviceConfigurationState",
        **kwargs
    ...
    async def update_device_configuration_states(
        self,
        user_id: str,
        managed_device_id: str,
        device_configuration_state_id: str,
    ...
    async def delete_device_configuration_states(
        self,
        user_id: str,
        managed_device_id: str,
        device_configuration_state_id: str,
