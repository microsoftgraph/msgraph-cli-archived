...
class UserManagedDeviceOperations:
    ...
    async def update_device_category(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphDeviceCategory(id=id, description=description, display_name=display_name)
    ...
    async def create_device_compliance_policy_state(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphDeviceCompliancePolicyState(id=id, display_name=display_name, platform_type=platform_type, setting_count=setting_count, setting_states=setting_states, state=state, version=version)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def create_device_configuration_state(
        ...
        **kwargs
        ...
        body = models.MicrosoftGraphDeviceConfigurationState(id=id, display_name=display_name, platform_type=platform_type, setting_count=setting_count, setting_states=setting_states, state=state, version=version)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
