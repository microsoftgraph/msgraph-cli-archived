...
class DeviceAppManagementMobileAppConfigurationOperations(object):
    """DeviceAppManagementMobileAppConfigurationOperations operations.
    ...
    def create_device_statuses(
        ...
        device_model=None,  # type: Optional[str]
        last_reported_date_time=None,  # type: Optional[datetime.datetime]
        status=None,  # type: Optional[Union[str, "models.MicrosoftGraphComplianceStatus"]]
    ...
    def update_device_status_summary(
        ...
        managed_device_mobile_app_configuration_id,  # type: str
        id=None,  # type: Optional[str]
        configuration_version=None,  # type: Optional[int]
        error_count=None,  # type: Optional[int]
        failed_count=None,  # type: Optional[int]
        last_update_date_time=None,  # type: Optional[datetime.datetime]
        not_applicable_count=None,  # type: Optional[int]
        pending_count=None,  # type: Optional[int]
        success_count=None,  # type: Optional[int]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def create_user_statuses(
        ...
        managed_device_mobile_app_configuration_id,  # type: str
        id=None,  # type: Optional[str]
        devices_count=None,  # type: Optional[int]
        last_reported_date_time=None,  # type: Optional[datetime.datetime]
        status=None,  # type: Optional[Union[str, "models.MicrosoftGraphComplianceStatus"]]
