...
class deviceappmanagementvpptokensOperations(object):
    """deviceappmanagementvpptokensOperations operations.
    ...
    def sync_licenses(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.sync_licenses.metadata['url']  # type: ignore
        ...
        return deserialized
    sync_licenses.metadata = {'url': '/deviceAppManagement/vppTokens/{vppToken-id}/microsoft.graph.syncLicenses'}  # type: ignore
