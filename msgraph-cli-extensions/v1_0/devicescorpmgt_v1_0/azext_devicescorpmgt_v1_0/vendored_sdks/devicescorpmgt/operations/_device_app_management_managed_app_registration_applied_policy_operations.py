...
class DeviceAppManagementManagedAppRegistrationAppliedPolicyOperations(object):
    ...
    def target_app(
        ...
        **kwargs  # type: Any
        ...
        body = models.PathsVf2Dh9DeviceappmanagementManagedappregistrationsManagedappregistrationIdAppliedpoliciesManagedapppolicyIdMicrosoftGraphTargetappsPostRequestbodyContentApplicationJsonSchema(apps=apps)
