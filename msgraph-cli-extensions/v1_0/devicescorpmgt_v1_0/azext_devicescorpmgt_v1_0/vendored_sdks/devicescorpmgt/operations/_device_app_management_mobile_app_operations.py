...
class DeviceAppManagementMobileAppOperations(object):
    """DeviceAppManagementMobileAppOperations operations.
    ...
    def create_assignment(
        ...
        intent=None,  # type: Optional[Union[str, "models.MicrosoftGraphInstallIntent"]]
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphMobileAppAssignment(id=id, intent=intent, settings=settings, target=target)
    ...
    def assign(
        self,
        mobile_app_id,  # type: str
        mobile_app_assignments=None,  # type: Optional[List["models.MicrosoftGraphMobileAppAssignment"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        body = models.Paths12NzrcrDeviceappmanagementMobileappsMobileappIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema(mobile_app_assignments=mobile_app_assignments)
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
