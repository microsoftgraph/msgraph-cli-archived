...
def load_command_table(self, _):
    ...
    with self.command_group('devicescorpmgt device-app-management', devicescorpmgt_v1_0_device_app_management) as g:
    ...
    with self.command_group(
        'devicescorpmgt device-app-management-managed-e-book', devicescorpmgt_v1_0_device_app_management_managed_ebook
    ) as g:
    ...
    with self.command_group(
        'devicescorpmgt device-app-management-mobile-app', devicescorpmgt_v1_0_device_app_management_mobile_app
    ) as g:
    ...
    with self.command_group(
        'devicescorpmgt device-app-management-vpp-token', devicescorpmgt_v1_0_device_app_management_vpp_token
    ) as g:
    ...
    with self.command_group('devicescorpmgt user', devicescorpmgt_v1_0_user) as g:
    ...
    with self.command_group('devicescorpmgt user-managed-device', devicescorpmgt_v1_0_user_managed_device) as g:
