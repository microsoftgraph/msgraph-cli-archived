...
def load_command_table(self, _):
    ...
    with self.command_group('planner group-planner', planner_v1_0_group_planner, client_factory=cf_group_planner,
    ...
    with self.command_group('planner group-planner-plan', planner_v1_0_group_planner_plan,
    ...
    with self.command_group('planner group-planner-plan-bucket', planner_v1_0_group_planner_plan_bucket,
    ...
    with self.command_group('planner group-planner-plan-bucket-task', planner_v1_0_group_planner_plan_bucket_task,
    ...
    with self.command_group('planner group-planner-plan-task', planner_v1_0_group_planner_plan_task,
    ...
    with self.command_group('planner planner', planner_v1_0_planner, client_factory=cf_planner,
                            is_experimental=True) as g:
    ...
    with self.command_group('planner planner-bucket', planner_v1_0_planner_bucket, client_factory=cf_planner_bucket,
                            is_experimental=True) as g:
    ...
    with self.command_group('planner planner-bucket-task', planner_v1_0_planner_bucket_task,
    ...
    with self.command_group('planner planner-plan', planner_v1_0_planner_plan, client_factory=cf_planner_plan,
                            is_experimental=True) as g:
    ...
    with self.command_group('planner planner-plan-bucket', planner_v1_0_planner_plan_bucket,
    ...
    with self.command_group('planner planner-plan-bucket-task', planner_v1_0_planner_plan_bucket_task,
    ...
    with self.command_group('planner planner-plan-task', planner_v1_0_planner_plan_task,
    ...
    with self.command_group('planner planner-task', planner_v1_0_planner_task, client_factory=cf_planner_task,
                            is_experimental=True) as g:
    ...
    with self.command_group('planner user-planner', planner_v1_0_user_planner, client_factory=cf_user_planner,
                            is_experimental=True) as g:
    ...
    with self.command_group('planner user-planner-plan', planner_v1_0_user_planner_plan,
    ...
    with self.command_group('planner user-planner-plan-bucket', planner_v1_0_user_planner_plan_bucket,
    ...
    with self.command_group('planner user-planner-plan-bucket-task', planner_v1_0_user_planner_plan_bucket_task,
    ...
    with self.command_group('planner user-planner-plan-task', planner_v1_0_user_planner_plan_task,
    ...
    with self.command_group('planner user-planner-task', planner_v1_0_user_planner_task,
