...
class PlannerBucketOperations:
    """PlannerBucketOperations async operations.
    ...
    def list_task(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerTask1"]:
        ...
        :type orderby: list[str or ~planner.models.Enum39]
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum40]
        :param expand: Expand related entities.
        :type expand: list[str or ~planner.models.Enum41]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPlannerTask1 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerTask1]
    ...
    list_task.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks'}  # type: ignore
    ...
    async def create_task(
        ...
        **kwargs
        ...
        return deserialized
    create_task.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks'}  # type: ignore
    ...
    async def get_task(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum42]
        :param expand: Expand related entities.
        :type expand: list[str or ~planner.models.Enum43]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerTask, or the result of cls(response)
        :rtype: ~planner.models.MicrosoftGraphPlannerTask
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_task.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
    ...
    update_task.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
    ...
    delete_task.metadata = {'url': '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
