...
class UserPlannerPlanOperations:
    ...
    def list_bucket(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerBucket2"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerBucket2]
    ...
    delete_bucket.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}'}  # type: ignore
    ...
    delete_detail.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/details'}  # type: ignore
    ...
    def list_task(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerTask6"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerTask6]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    delete_task.metadata = {'url': '/users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}'}  # type: ignore
