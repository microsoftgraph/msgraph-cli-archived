...
class PlannerPlanBucketOperations:
    """PlannerPlanBucketOperations async operations.
    ...
    def list_task(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfPlannerTask2"]:
        ...
        :type orderby: list[str or ~planner.models.Enum58]
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum59]
        :param expand: Expand related entities.
        :type expand: list[str or ~planner.models.Enum60]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfPlannerTask2 or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~planner.models.CollectionOfPlannerTask2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CollectionOfPlannerTask2"]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('CollectionOfPlannerTask2', pipeline_response)
    ...
    list_task.metadata = {'url': '/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks'}  # type: ignore
    ...
    async def create_task(
        ...
        **kwargs
        ...
        return deserialized
    create_task.metadata = {'url': '/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks'}  # type: ignore
    ...
    async def get_task(
        ...
        **kwargs
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~planner.models.Enum61]
        :param expand: Expand related entities.
        :type expand: list[str or ~planner.models.Enum62]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphPlannerTask, or the result of cls(response)
        :rtype: ~planner.models.MicrosoftGraphPlannerTask
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_task.metadata = {'url': '/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
    ...
    update_task.metadata = {'url': '/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
    ...
    delete_task.metadata = {'url': '/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}'}  # type: ignore
