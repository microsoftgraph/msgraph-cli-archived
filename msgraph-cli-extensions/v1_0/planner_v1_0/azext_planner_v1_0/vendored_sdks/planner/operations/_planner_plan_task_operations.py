...
class PlannerPlanTaskOperations(object):
    """PlannerPlanTaskOperations operations.
    ...
    def get_detail(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_detail.metadata = {'url': '/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    update_detail.metadata = {'url': '/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details'}  # type: ignore
    ...
    delete_detail.metadata = {'url': '/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details'}  # type: ignore
