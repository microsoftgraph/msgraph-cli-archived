...
class UsersOutlookOperations(object):
    """UsersOutlookOperations operations.
    ...
    def create_master_categories(
        self,
        user_id,  # type: str
        body,  # type: "models.MicrosoftGraphOutlookCategory"
        **kwargs  # type: Any
    ):
