...
def load_arguments(self, _):
    ...
    with self.argument_context('users user create') as c:
        ...
        c.argument('device_management_troubleshooting_events', action=AddDeviceManagementTroubleshootingEvents, nargs=''
                   '*', help='The list of troubleshooting events for this user.')
        ...
        c.argument('insights_id', type=str, help='Read-only.')
        c.argument('insights_shared', type=validate_file_or_dict, help='Calculated relationship identifying documents '
                   'shared with or by the user. This includes URLs, file attachments, and reference attachments to '
                   'OneDrive for Business and SharePoint files found in Outlook messages and meetings. This also '
                   'includes URLs and reference attachments to Teams conversations. Ordered by recency of share. '
                   'Expected value: json-string/@json-file.')
        c.argument('insights_trending', type=validate_file_or_dict, help='Calculated relationship identifying '
                   'documents trending around a user. Trending documents are calculated based on activity of the '
                   'user\'s closest network of people and include files stored in OneDrive for Business and '
                   'SharePoint. Trending insights help the user to discover potentially useful content that the user '
                   'has access to, but has never viewed before. Expected value: json-string/@json-file.')
        c.argument('insights_used', type=validate_file_or_dict, help='Calculated relationship identifying the latest '
                   'documents viewed or modified by a user, including OneDrive for Business and SharePoint documents, '
                   'ranked by recency of use. Expected value: json-string/@json-file.')
        ...
        c.argument('mailbox_settings_language', action=AddMailboxSettingsLanguage, nargs='*', help='localeInfo')
