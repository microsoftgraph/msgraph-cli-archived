...
def load_command_table(self, _):
    ...
    with self.command_group('users user-user', users_v1_0_user_user, client_factory=cf_user_user) as g:
        ...
        g.custom_command('show-user', 'users_user_user_show_user')
    ...
    users_v1_0_user_outlook = CliCommandType(
        operations_tmpl='azext_users_v1_0.vendored_sdks.users.operations._users_outlook_operations#UsersOutlookOperatio'
        'ns.{}',
    ...
    users_v1_0_user_setting = CliCommandType(
        operations_tmpl='azext_users_v1_0.vendored_sdks.users.operations._users_settings_operations#UsersSettingsOperat'
        'ions.{}',
