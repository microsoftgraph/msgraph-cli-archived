...
|---------|------------|--------|
|az users user-user|users.user|[commands](#CommandsInusers.user)|
...
### <a name="CommandsInusers.user">Commands in `az users user-user` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az users user-user delete](#users.userDeleteUser)|DeleteUser|[Parameters](#Parametersusers.userDeleteUser)|Not Found|
|[az users user-user create-user](#users.userCreateUser)|CreateUser|[Parameters](#Parametersusers.userCreateUser)|Not Found|
|[az users user-user list-user](#users.userListUser)|ListUser|[Parameters](#Parametersusers.userListUser)|Not Found|
|[az users user-user show-user](#users.userGetUser)|GetUser|[Parameters](#Parametersusers.userGetUser)|Not Found|
|[az users user-user update-user](#users.userUpdateUser)|UpdateUser|[Parameters](#Parametersusers.userUpdateUser)|Not Found|
...
### group `az users user-user`
#### <a name="users.userDeleteUser">Command `az users user-user delete`</a>
...
#### <a name="users.userCreateUser">Command `az users user-user create-user`</a>
...
#### <a name="users.userListUser">Command `az users user-user list-user`</a>
...
#### <a name="users.userGetUser">Command `az users user-user show-user`</a>
...
#### <a name="users.userUpdateUser">Command `az users user-user update-user`</a>
