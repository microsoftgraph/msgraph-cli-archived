...
class sitesonenotesectionsparentnotebooksectiongroupsOperations(object):
    """sitesonenotesectionsparentnotebooksectiongroupsOperations operations.
    ...
    def get_parent_notebook(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum685"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum686"]]]
        **kwargs  # type: Any
    ):
        ...
        :type select: list[str or ~notes.models.Enum685]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum686]
    ...
    delete_parent_notebook.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentNotebook'}  # type: ignore
    ...
    def get_parent_section_group(
        ...
        onenote_section_id,  # type: str
        section_group_id,  # type: str
        select=None,  # type: Optional[List[Union[str, "models.Enum687"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum688"]]]
        **kwargs  # type: Any
    ):
        ...
        :type section_group_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum687]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum688]
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    delete_parent_section_group.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/parentSectionGroup'}  # type: ignore
    ...
    def list_section_groups(
        ...
        onenote_section_id,  # type: str
        section_group_id,  # type: str
        orderby=None,  # type: Optional[List[Union[str, "models.Enum689"]]]
        select=None,  # type: Optional[List[Union[str, "models.Enum690"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum691"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.collectionofsectiongroup38"]
        ...
        :type orderby: list[str or ~notes.models.Enum689]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum690]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum691]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofsectiongroup38 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.collectionofsectiongroup38]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.collectionofsectiongroup38"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionofsectiongroup38', pipeline_response)
    ...
    list_section_groups.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def create_section_groups(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_section_groups.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups'}  # type: ignore
    ...
    def get_section_groups(
        ...
        select=None,  # type: Optional[List[Union[str, "models.Enum692"]]]
        expand=None,  # type: Optional[List[Union[str, "models.Enum693"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.microsoftgraphsectiongroup"
        """Get sectionGroups from sites.
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum692]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum693]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphsectiongroup, or the result of cls(response)
        :rtype: ~notes.models.microsoftgraphsectiongroup
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_section_groups.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    update_section_groups.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    delete_section_groups.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sectionGroups/{sectionGroup-id1}'}  # type: ignore
    ...
    def list_sections(
        ...
        **kwargs  # type: Any
        ...
        :type section_group_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~notes.models.Enum694]
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum695]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum696]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either collectionofonenotesection37 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~notes.models.collectionofonenotesection37]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.collectionofonenotesection37"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('collectionofonenotesection37', pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
            return deserialized.odata_next_link or None, iter(list_of_elem)
    ...
    list_sections.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def create_sections(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_sections.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections'}  # type: ignore
    ...
    def get_sections(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~notes.models.Enum697]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Enum698]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: microsoftgraphonenotesection, or the result of cls(response)
        :rtype: ~notes.models.microsoftgraphonenotesection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    get_sections.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    update_sections.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
    ...
    delete_sections.metadata = {'url': '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id1}'}  # type: ignore
