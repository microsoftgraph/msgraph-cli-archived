...
class GroupOperations(object):
    ...
    def update_onenote(
        ...
        **kwargs  # type: Any
        ...
        body = models.MicrosoftGraphOnenote(id=id, notebooks=notebooks, operations=operations, pages=pages, resources=resources, section_groups=section_groups, sections=sections)
