...
class GroupOperations(object):
    ...
    def get_onenote(
        ...
        **kwargs  # type: Any
        ...
        :type select: list[str or ~notes.models.Get1ItemsItem]
        :param expand: Expand related entities.
        :type expand: list[str or ~notes.models.Get2ItemsItem]
    ...
    def update_onenote(
        ...
        **kwargs  # type: Any
        ...
        _body = models.MicrosoftGraphOnenote(id=id, notebooks=notebooks, operations=operations, pages=pages, resources=resources, section_groups=section_groups, sections=sections)
    ...
    delete_onenote.metadata = {'url': '/groups/{group-id}/onenote'}  # type: ignore
