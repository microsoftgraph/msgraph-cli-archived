...
class GroupsOnenotePagesParentNotebookSectionsOperations:
    """GroupsOnenotePagesParentNotebookSectionsOperations async operations.
    ...
    list_pages.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def create_pages(
        ...
        **kwargs
        ...
        return deserialized
    create_pages.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages'}  # type: ignore
    ...
    async def get_pages(
        ...
        **kwargs
        ...
        return deserialized
    get_pages.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    update_pages.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
    ...
    delete_pages.metadata = {'url': '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/pages/{onenotePage-id1}'}  # type: ignore
