...
class DeviceAppManagementDeviceAppManagementOperations:
    ...
    async def update_device_app_management(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(_body, 'MicrosoftGraphDeviceAppManagement')
