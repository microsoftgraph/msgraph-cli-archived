...
class ShareSharedDriveItemOperations:
    """ShareSharedDriveItemOperations async operations.
    ...
    def list_shared_drive_item(
        ...
        **kwargs
    ) -> AsyncIterable["models.CollectionOfSharedDriveItem"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~files.models.CollectionOfSharedDriveItem]
    ...
    async def create_shared_drive_item(
        self,
        ...
        site: Optional["models.MicrosoftGraphSite"] = None,
        microsoft_graph_entity_id: Optional[str] = None,
        expiration_date_time: Optional[datetime.datetime] = None,
        granted_to_identities: Optional[List["models.MicrosoftGraphIdentitySet"]] = None,
        has_password: Optional[bool] = None,
        roles: Optional[List[str]] = None,
        microsoft_graph_permission_share_id: Optional[str] = None,
        ...
        microsoft_graph_sharing_link_web_url: Optional[str] = None,
        email: Optional[str] = None,
        invited_by: Optional["models.MicrosoftGraphIdentitySet"] = None,
        ...
        drive_type1: Optional[str] = None,
        id11: Optional[str] = None,
        name2: Optional[str] = None,
        path1: Optional[str] = None,
        share_id1: Optional[str] = None,
        ...
        id16: Optional[str] = None,
        display_name13: Optional[str] = None,
        id17: Optional[str] = None,
        ...
        id18: Optional[str] = None,
        id19: Optional[str] = None,
        created_date_time1: Optional[datetime.datetime] = None,
        description1: Optional[str] = None,
        e_tag1: Optional[str] = None,
        last_modified_date_time1: Optional[datetime.datetime] = None,
        name3: Optional[str] = None,
        web_url1: Optional[str] = None,
        created_by_user1: Optional["models.MicrosoftGraphUser"] = None,
        last_modified_by_user1: Optional["models.MicrosoftGraphUser"] = None,
        drive_id2: Optional[str] = None,
        drive_type2: Optional[str] = None,
        id20: Optional[str] = None,
        name4: Optional[str] = None,
        path2: Optional[str] = None,
        share_id2: Optional[str] = None,
        sharepoint_ids3: Optional["models.MicrosoftGraphSharepointIds"] = None,
        site_id2: Optional[str] = None,
        display_name14: Optional[str] = None,
        id21: Optional[str] = None,
        display_name15: Optional[str] = None,
        id22: Optional[str] = None,
        display_name16: Optional[str] = None,
        id23: Optional[str] = None,
        display_name17: Optional[str] = None,
        id24: Optional[str] = None,
        display_name18: Optional[str] = None,
        id25: Optional[str] = None,
        display_name19: Optional[str] = None,
        id26: Optional[str] = None,
        microsoft_graph_list_display_name: Optional[str] = None,
        list: Optional["models.MicrosoftGraphListInfo"] = None,
        sharepoint_ids4: Optional["models.MicrosoftGraphSharepointIds"] = None,
        ...
        display_name20: Optional[str] = None,
        id27: Optional[str] = None,
        display_name21: Optional[str] = None,
        id28: Optional[str] = None,
        display_name22: Optional[str] = None,
        id29: Optional[str] = None,
        **kwargs
    ) -> "models.MicrosoftGraphSharedDriveItem":
        ...
        :type microsoft_graph_drive_item: ~files.models.MicrosoftGraphDriveItem
        ...
        :param id18: Read-only.
        :type id18: str
        :param id19: Read-only.
        :type id19: str
        :param created_date_time1: Date and time of item creation. Read-only.
        :type created_date_time1: ~datetime.datetime
        :param description1: Provides a user-visible description of the item. Optional.
        :type description1: str
        :param e_tag1: ETag for the item. Read-only.
        :type e_tag1: str
        :param last_modified_date_time1: Date and time the item was last modified. Read-only.
        :type last_modified_date_time1: ~datetime.datetime
        :param name3: The name of the item. Read-write.
        :type name3: str
        :param web_url1: URL that displays the resource in the browser. Read-only.
        :type web_url1: str
        :param created_by_user1: Represents an Azure Active Directory user object.
        :type created_by_user1: ~files.models.MicrosoftGraphUser
        :param last_modified_by_user1: Represents an Azure Active Directory user object.
        :type last_modified_by_user1: ~files.models.MicrosoftGraphUser
        :param drive_id2: Unique identifier of the drive instance that contains the item. Read-only.
        :type drive_id2: str
        :param drive_type2: Identifies the type of drive. See [drive][] resource for values.
        :type drive_type2: str
        :param id20: Unique identifier of the item in the drive. Read-only.
        :type id20: str
        :param name4: The name of the item being referenced. Read-only.
        :type name4: str
        :param path2: Path that can be used to navigate to the item. Read-only.
        :type path2: str
        :param share_id2: A unique identifier for a shared resource that can be accessed via the
         [Shares][] API.
        :type share_id2: str
        ...
        :param id21: Unique identifier for the identity.
        :type id21: str
        ...
        :param id22: Unique identifier for the identity.
        :type id22: str
        ...
        :param id23: Unique identifier for the identity.
        :type id23: str
        :param display_name17: The identity's display name. Note that this may not always be available
         or up to date. For example, if a user changes their display name, the API may show the new
         value in a future response, but the items associated with the user won't show up as having
         changed when using delta.
        :type display_name17: str
        :param id24: Unique identifier for the identity.
        :type id24: str
        :param display_name18: The identity's display name. Note that this may not always be available
         or up to date. For example, if a user changes their display name, the API may show the new
         value in a future response, but the items associated with the user won't show up as having
         changed when using delta.
        :type display_name18: str
        :param id25: Unique identifier for the identity.
        :type id25: str
        :param display_name19: The identity's display name. Note that this may not always be available
         or up to date. For example, if a user changes their display name, the API may show the new
         value in a future response, but the items associated with the user won't show up as having
         changed when using delta.
        :type display_name19: str
        :param id26: Unique identifier for the identity.
        :type id26: str
        ...
        :param sharepoint_ids4: sharepointIds.
        :type sharepoint_ids4: ~files.models.MicrosoftGraphSharepointIds
        ...
        :param display_name20: The identity's display name. Note that this may not always be available
         or up to date. For example, if a user changes their display name, the API may show the new
         value in a future response, but the items associated with the user won't show up as having
         changed when using delta.
        :type display_name20: str
        :param id27: Unique identifier for the identity.
        :type id27: str
        :param display_name21: The identity's display name. Note that this may not always be available
         or up to date. For example, if a user changes their display name, the API may show the new
         value in a future response, but the items associated with the user won't show up as having
         changed when using delta.
        :type display_name21: str
        :param id28: Unique identifier for the identity.
        :type id28: str
        :param display_name22: The identity's display name. Note that this may not always be available
         or up to date. For example, if a user changes their display name, the API may show the new
         value in a future response, but the items associated with the user won't show up as having
         changed when using delta.
        :type display_name22: str
        :param id29: Unique identifier for the identity.
        :type id29: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _body = models.MicrosoftGraphSharedDriveItem(id=id, created_date_time=created_date_time, description=description, e_tag=e_tag, last_modified_date_time=last_modified_date_time, name=name, web_url=web_url, created_by_user=created_by_user, last_modified_by_user=last_modified_by_user, drive_id=drive_id, drive_type=drive_type, id_parent_reference_id=microsoft_graph_item_reference_id, name_parent_reference_name=microsoft_graph_item_reference_name, path=path, share_id=share_id, sharepoint_ids=sharepoint_ids, site_id=site_id, display_name_last_modified_by_user_display_name=display_name, id_last_modified_by_user_id=microsoft_graph_identity_id, display_name_last_modified_by_device_display_name=microsoft_graph_identity_display_name, id_last_modified_by_device_id=id1, display_name_last_modified_by_application_display_name=display_name1, id_last_modified_by_application_id=id2, display_name_created_by_user_display_name=display_name2, id_created_by_user_id=id3, display_name_created_by_device_display_name=display_name3, id_created_by_device_id=id4, display_name_created_by_application_display_name=display_name4, id_created_by_application_id=id5, drive_item=drive_item, items=items, root=root, site=site, id_permission_id=microsoft_graph_entity_id, expiration_date_time=expiration_date_time, granted_to_identities=granted_to_identities, has_password=has_password, roles=roles, share_id_permission_share_id=microsoft_graph_permission_share_id, application=application, prevents_download=prevents_download, scope=scope, type=type, web_html=web_html, web_url_permission_link_web_url=microsoft_graph_sharing_link_web_url, email=email, invited_by=invited_by, redeemed_by=redeemed_by, sign_in_required=sign_in_required, drive_id_permission_inherited_from_drive_id=microsoft_graph_item_reference_drive_id, drive_type_permission_inherited_from_drive_type=microsoft_graph_item_reference_drive_type, id_permission_inherited_from_id=id6, name_permission_inherited_from_name=name1, path_permission_inherited_from_path=microsoft_graph_item_reference_path, share_id_permission_inherited_from_share_id=microsoft_graph_item_reference_share_id, sharepoint_ids_permission_inherited_from_sharepoint_ids=microsoft_graph_sharepoint_ids, site_id_permission_inherited_from_site_id=microsoft_graph_item_reference_site_id, display_name_permission_granted_to_user_display_name=display_name5, id_permission_granted_to_user_id=id7, display_name_permission_granted_to_device_display_name=display_name6, id_permission_granted_to_device_id=id8, display_name_permission_granted_to_application_display_name=display_name7, id_permission_granted_to_application_id=id9, id_list_item_id=id10, created_date_time_list_item_created_date_time=microsoft_graph_base_item_created_date_time_created_date_time, description_list_item_description=microsoft_graph_base_item_description, e_tag_list_item_e_tag=microsoft_graph_base_item_e_tag, last_modified_date_time_list_item_last_modified_date_time=microsoft_graph_base_item_last_modified_date_time_last_modified_date_time, name_list_item_name=microsoft_graph_base_item_name, web_url_list_item_web_url=microsoft_graph_base_item_web_url, created_by_user_list_item_created_by_user=microsoft_graph_user_created_by_user, last_modified_by_user_list_item_last_modified_by_user=microsoft_graph_user_last_modified_by_user, drive_id_list_item_parent_reference_drive_id=drive_id1, drive_type_list_item_parent_reference_drive_type=drive_type1, id_list_item_parent_reference_id=id11, name_list_item_parent_reference_name=name2, path_list_item_parent_reference_path=path1, share_id_list_item_parent_reference_share_id=share_id1, sharepoint_ids_list_item_parent_reference_sharepoint_ids=sharepoint_ids1, site_id_list_item_parent_reference_site_id=site_id1, display_name_list_item_last_modified_by_user_display_name=display_name8, id_list_item_last_modified_by_user_id=id12, display_name_list_item_last_modified_by_device_display_name=display_name9, id_list_item_last_modified_by_device_id=id13, display_name_list_item_last_modified_by_application_display_name=display_name10, id_list_item_last_modified_by_application_id=id14, display_name_list_item_created_by_user_display_name=display_name11, id_list_item_created_by_user_id=id15, display_name_list_item_created_by_device_display_name=display_name12, id_list_item_created_by_device_id=id16, display_name_list_item_created_by_application_display_name=display_name13, id_list_item_created_by_application_id=id17, content_type=content_type_parameter, sharepoint_ids_list_item_sharepoint_ids=sharepoint_ids2, analytics=analytics, drive_item_list_item_drive_item=microsoft_graph_drive_item, versions=versions, id_list_item_fields_id=id18, id_list_id=id19, created_date_time_list_created_date_time=created_date_time1, description_list_description=description1, e_tag_list_e_tag=e_tag1, last_modified_date_time_list_last_modified_date_time=last_modified_date_time1, name_list_name=name3, web_url_list_web_url=web_url1, created_by_user_list_created_by_user=created_by_user1, last_modified_by_user_list_last_modified_by_user=last_modified_by_user1, drive_id_list_parent_reference_drive_id=drive_id2, drive_type_list_parent_reference_drive_type=drive_type2, id_list_parent_reference_id=id20, name_list_parent_reference_name=name4, path_list_parent_reference_path=path2, share_id_list_parent_reference_share_id=share_id2, sharepoint_ids_list_parent_reference_sharepoint_ids=sharepoint_ids3, site_id_list_parent_reference_site_id=site_id2, display_name_list_last_modified_by_user_display_name=display_name14, id_list_last_modified_by_user_id=id21, display_name_list_last_modified_by_device_display_name=display_name15, id_list_last_modified_by_device_id=id22, display_name_list_last_modified_by_application_display_name=display_name16, id_list_last_modified_by_application_id=id23, display_name_list_created_by_user_display_name=display_name17, id_list_created_by_user_id=id24, display_name_list_created_by_device_display_name=display_name18, id_list_created_by_device_id=id25, display_name_list_created_by_application_display_name=display_name19, id_list_created_by_application_id=id26, display_name_list_display_name=microsoft_graph_list_display_name, list=list, sharepoint_ids_list_sharepoint_ids=sharepoint_ids4, system=system, columns=columns, content_types=content_types, drive=drive, items_list_items=microsoft_graph_list_items, subscriptions=subscriptions, display_name_owner_user_display_name=display_name20, id_owner_user_id=id27, display_name_owner_device_display_name=display_name21, id_owner_device_id=id28, display_name_owner_application_display_name=display_name22, id_owner_application_id=id29)
    ...
    async def get_shared_drive_item(
        self,
    ...
    async def update_shared_drive_item(
        self,
        shared_drive_item_id: str,
        id: Optional[str] = None,
        created_date_time: Optional[datetime.datetime] = None,
    ...
    async def delete_shared_drive_item(
        self,
        shared_drive_item_id: str,
