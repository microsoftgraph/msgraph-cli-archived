...
class shareslistitemsOperations:
    ...
    async def get_drive_item(
        ...
        expand: Optional[List[Union[str, "models.Enum155"]]] = None,
        **kwargs
    ...
    async def get_activities_by_interval96_b0(
        ...
        **kwargs
        ...
        return deserialized
    get_activities_by_interval96_b0.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/microsoft.graph.getActivitiesByInterval()'}  # type: ignore
    ...
    async def get_activities_by_interval53_ee(
        ...
        **kwargs
        ...
        return deserialized
    get_activities_by_interval53_ee.metadata = {'url': '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/microsoft.graph.getActivitiesByInterval(startDateTime=\'{startDateTime}\',endDateTime=\'{endDateTime}\',interval=\'{interval}\')'}  # type: ignore

    def list_versions(
        self,
        shared_drive_item_id: str,
        list_item_id: str,
        orderby: Optional[List[Union[str, "models.Enum156"]]] = None,
