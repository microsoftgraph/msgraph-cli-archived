...
class ShareSharedDriveItemOperations(object):
    ...
    def create_shared_drive_item(
        ...
        created_date_time1=None,  # type: Optional[datetime.datetime]
        description1=None,  # type: Optional[str]
        e_tag1=None,  # type: Optional[str]
        last_modified_date_time1=None,  # type: Optional[datetime.datetime]
        name3=None,  # type: Optional[str]
        web_url1=None,  # type: Optional[str]
        created_by_user1=None,  # type: Optional["models.MicrosoftGraphUser"]
        last_modified_by_user1=None,  # type: Optional["models.MicrosoftGraphUser"]
        drive_id2=None,  # type: Optional[str]
        drive_type2=None,  # type: Optional[str]
        id20=None,  # type: Optional[str]
        name4=None,  # type: Optional[str]
        path2=None,  # type: Optional[str]
        share_id2=None,  # type: Optional[str]
        sharepoint_ids3=None,  # type: Optional["models.MicrosoftGraphSharepointIds"]
        site_id2=None,  # type: Optional[str]
        display_name14=None,  # type: Optional[str]
        id21=None,  # type: Optional[str]
        display_name15=None,  # type: Optional[str]
        id22=None,  # type: Optional[str]
        display_name16=None,  # type: Optional[str]
        id23=None,  # type: Optional[str]
        display_name17=None,  # type: Optional[str]
        id24=None,  # type: Optional[str]
        display_name18=None,  # type: Optional[str]
        id25=None,  # type: Optional[str]
        display_name19=None,  # type: Optional[str]
        id26=None,  # type: Optional[str]
        microsoft_graph_list_display_name=None,  # type: Optional[str]
        list=None,  # type: Optional["models.MicrosoftGraphListInfo"]
        sharepoint_ids4=None,  # type: Optional["models.MicrosoftGraphSharepointIds"]
        ...
        display_name20=None,  # type: Optional[str]
        id27=None,  # type: Optional[str]
        display_name21=None,  # type: Optional[str]
        id28=None,  # type: Optional[str]
        display_name22=None,  # type: Optional[str]
        id29=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
