...
def load_command_table(self, _):
    ...
    with self.command_group('personalcontacts user', personalcontacts_v1_0_user) as g:
    ...
    with self.command_group('personalcontacts user-contact-folder', personalcontacts_v1_0_user_contact_folder) as g:
    ...
    with self.command_group(
        'personalcontacts user-contact-folder-contact', personalcontacts_v1_0_user_contact_folder_contact
    ) as g:
    ...
    with self.command_group('personalcontacts user-contact', personalcontacts_v1_0_user_contact) as g:
