...
class SubscriptionsSubscriptionOperations:
    """SubscriptionsSubscriptionOperations async operations.
    ...
    async def create_subscription(
        ...
        **kwargs
        ...
        :type body: ~change_notifications.models.MicrosoftGraphSubscription
        :keyword callable cls: A custom type or function that will be passed the direct response
