...
class UsersOperations(object):
    ...
    def list_app_role_assignments(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CollectionOfAppRoleAssignment2"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~applications.models.CollectionOfAppRoleAssignment2]
    ...
    list_app_role_assignments.metadata = {'url': '/users/{user-id}/appRoleAssignments'}  # type: ignore
    ...
    def create_app_role_assignments(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create_app_role_assignments.metadata = {'url': '/users/{user-id}/appRoleAssignments'}  # type: ignore
    ...
    def get_app_role_assignments(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_app_role_assignments.metadata = {'url': '/users/{user-id}/appRoleAssignments/{appRoleAssignment-id}'}  # type: ignore
    ...
    update_app_role_assignments.metadata = {'url': '/users/{user-id}/appRoleAssignments/{appRoleAssignment-id}'}  # type: ignore
    ...
    delete_app_role_assignments.metadata = {'url': '/users/{user-id}/appRoleAssignments/{appRoleAssignment-id}'}  # type: ignore
