...
def load_command_table(self, _):
    ...
    with self.command_group('applications', applications_v1_0_application_application,
    ...
    with self.command_group('applications', applications_v1_0_application, client_factory=cf_application) as g:
        g.custom_command('delete', 'applications_delete', confirmation=True)
    ...
    with self.command_group('applications', applications_v1_0_group, client_factory=cf_group) as g:
        g.custom_command('delete', 'applications_delete', confirmation=True)
    ...
    with self.command_group('applications', applications_v1_0_service_principal_service_principal,
    ...
    with self.command_group('applications', applications_v1_0_service_principal,
    ...
    with self.command_group('applications', applications_v1_0_user, client_factory=cf_user) as g:
        g.custom_command('delete', 'applications_delete', confirmation=True)
        g.custom_command('create-app-role-assignment', 'applications_create_app_role_assignment')
        g.custom_command('get-app-role-assignment', 'applications_get_app_role_assignment')
        g.custom_command('list-app-role-assignment', 'applications_list_app_role_assignment')
