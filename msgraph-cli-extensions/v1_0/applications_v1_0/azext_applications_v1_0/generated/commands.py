...
def load_command_table(self, _):
    ...
    applications_v1_0_application_application = CliCommandType(
        operations_tmpl='azext_applications_v1_0.vendored_sdks.applications.operations._applications_application_operat'
        'ions#ApplicationsApplicationOperations.{}',
    ...
    with self.command_group('applications application-application', applications_v1_0_application_application,
        ...
        g.custom_command('show-application', 'applications_application_application_show_application')
        g.custom_command('show-logo', 'applications_application_application_show_logo')
    ...
    applications_v1_0_application = CliCommandType(
        operations_tmpl='azext_applications_v1_0.vendored_sdks.applications.operations._applications_operations#Applica'
        'tionsOperations.{}',
        client_factory=cf_application)
    with self.command_group('applications application', applications_v1_0_application,
                            client_factory=cf_application) as g:
    ...
    applications_v1_0_group = CliCommandType(
        operations_tmpl='azext_applications_v1_0.vendored_sdks.applications.operations._groups_operations#GroupsOperati'
        'ons.{}',
    ...
    applications_v1_0_service_principal_service_principal = CliCommandType(
        operations_tmpl='azext_applications_v1_0.vendored_sdks.applications.operations._service_principals_service_prin'
        'cipal_operations#ServicePrincipalsServicePrincipalOperations.{}',
    ...
    with self.command_group('applications service-principal-service-principal',
        ...
        g.custom_command('list-service-principal', 'applications_service_principal_service_principal_list_service_princ'
                         'ipal')
        g.custom_command('show-service-principal', 'applications_service_principal_service_principal_show_service_princ'
                         'ipal')
    ...
    applications_v1_0_service_principal = CliCommandType(
        operations_tmpl='azext_applications_v1_0.vendored_sdks.applications.operations._service_principals_operations#S'
        'ervicePrincipalsOperations.{}',
    ...
    with self.command_group('applications service-principal', applications_v1_0_service_principal,
                            client_factory=cf_service_principal) as g:
    ...
    applications_v1_0_user = CliCommandType(
        operations_tmpl='azext_applications_v1_0.vendored_sdks.applications.operations._users_operations#UsersOperation'
        's.{}',
