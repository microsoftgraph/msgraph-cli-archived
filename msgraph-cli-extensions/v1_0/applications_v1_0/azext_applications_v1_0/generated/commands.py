...
def load_command_table(self, _):
    ...
    with self.command_group('applications application', applications_v1_0_application_application) as g:
    ...
    with self.command_group('applications application', applications_v1_0_application) as g:
        g.custom_command('delete', 'applications_application_delete', confirmation=True)
    ...
    with self.command_group('applications group', applications_v1_0_group) as g:
    ...
    with self.command_group(
        'applications service-principal-service-principal', applications_v1_0_service_principal_service_principal
    ) as g:
    ...
    with self.command_group('applications service-principal', applications_v1_0_service_principal) as g:
    ...
    with self.command_group('applications user', applications_v1_0_user) as g:
