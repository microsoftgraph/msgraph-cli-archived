...
|---------|------------|--------|
|az applications application-application|applications.application|[commands](#CommandsInapplications.application)|
...
### <a name="CommandsInapplications.application">Commands in `az applications application-application` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az applications application-application delete](#applications.applicationDeleteApplication)|DeleteApplication|[Parameters](#Parametersapplications.applicationDeleteApplication)|Not Found|
|[az applications application-application create-application](#applications.applicationCreateApplication)|CreateApplication|[Parameters](#Parametersapplications.applicationCreateApplication)|Not Found|
|[az applications application-application list-application](#applications.applicationListApplication)|ListApplication|[Parameters](#Parametersapplications.applicationListApplication)|Not Found|
|[az applications application-application set-logo](#applications.applicationSetLogo)|SetLogo|[Parameters](#Parametersapplications.applicationSetLogo)|Not Found|
|[az applications application-application show-application](#applications.applicationGetApplication)|GetApplication|[Parameters](#Parametersapplications.applicationGetApplication)|Not Found|
|[az applications application-application show-logo](#applications.applicationGetLogo)|GetLogo|[Parameters](#Parametersapplications.applicationGetLogo)|Not Found|
|[az applications application-application update-application](#applications.applicationUpdateApplication)|UpdateApplication|[Parameters](#Parametersapplications.applicationUpdateApplication)|Not Found|
...
### group `az applications application-application`
#### <a name="applications.applicationDeleteApplication">Command `az applications application-application delete`</a>
...
#### <a name="applications.applicationCreateApplication">Command `az applications application-application create-application`</a>
...
#### <a name="applications.applicationListApplication">Command `az applications application-application list-application`</a>
...
#### <a name="applications.applicationSetLogo">Command `az applications application-application set-logo`</a>
...
#### <a name="applications.applicationGetApplication">Command `az applications application-application show-application`</a>
...
#### <a name="applications.applicationGetLogo">Command `az applications application-application show-logo`</a>
...
#### <a name="applications.applicationUpdateApplication">Command `az applications application-application update-application`</a>
