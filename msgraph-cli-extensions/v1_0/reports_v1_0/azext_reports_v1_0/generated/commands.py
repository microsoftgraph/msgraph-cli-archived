...
def load_command_table(self, _):
    ...
    with self.command_group('reports audit-log-audit-log-root', reports_v1_0_audit_log_audit_log_root) as g:
    ...
    reports_v1_0_audit_log = CliCommandType(
        operations_tmpl=(
            'azext_reports_v1_0.vendored_sdks.reports.operations._audit_logs_operations#AuditLogsOperations.{}'
        ),
        client_factory=cf_audit_log,
    )
    with self.command_group('reports audit-log', reports_v1_0_audit_log) as g:
    ...
    with self.command_group('reports report-root', reports_v1_0_report_report_root) as g:
    ...
    with self.command_group('reports report', reports_v1_0_report) as g:
