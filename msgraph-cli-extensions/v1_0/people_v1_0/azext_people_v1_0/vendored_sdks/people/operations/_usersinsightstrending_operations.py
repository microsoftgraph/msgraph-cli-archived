...
class usersinsightstrendingOperations(object):
    """usersinsightstrendingOperations operations.
    ...
    def get_ref_resource(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get_ref_resource.metadata = {'url': '/users/{user-id}/insights/trending/{trending-id}/resource/$ref'}  # type: ignore
    ...
    set_ref_resource.metadata = {'url': '/users/{user-id}/insights/trending/{trending-id}/resource/$ref'}  # type: ignore
    ...
    delete_ref_resource.metadata = {'url': '/users/{user-id}/insights/trending/{trending-id}/resource/$ref'}  # type: ignore
