...
class UserContactFolderOperations(object):
    ...
    def list_child_folder(
        ...
        **kwargs  # type: Any
        ...
        :type orderby: list[str or ~Microsoft.Graph.PowerShell.models.Enum10]
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum11]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Get9ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfContactFolder0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~Microsoft.Graph.PowerShell.models.CollectionOfContactFolder0]
    ...
    def create_child_folder(
        ...
        **kwargs  # type: Any
        ...
        :type single_value_extended_properties: list[~Microsoft.Graph.PowerShell.models.MicrosoftGraphSingleValueLegacyExtendedProperty]
        :param multi_value_extended_properties: The collection of multi-value extended properties
         defined for the contactFolder. Read-only. Nullable.
        :type multi_value_extended_properties: list[~Microsoft.Graph.PowerShell.models.MicrosoftGraphMultiValueLegacyExtendedProperty]
        ...
        :rtype: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContactFolder
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_child_folder(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum13]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Get4ItemsItem]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContactFolder, or the result of cls(response)
        :rtype: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContactFolder
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_contact(
        ...
        **kwargs  # type: Any
        ...
        :type contact_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~Microsoft.Graph.PowerShell.models.Enum15]
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum16]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Enum17]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfContact or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~Microsoft.Graph.PowerShell.models.CollectionOfContact]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_contact(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContact
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContact, or the result of cls(response)
        :rtype: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContact
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_contact(
        ...
        **kwargs  # type: Any
        ...
        :type contact_id: str
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum18]
        :param expand: Expand related entities.
        :type expand: list[str or ~Microsoft.Graph.PowerShell.models.Enum19]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphContact, or the result of cls(response)
        :rtype: ~Microsoft.Graph.PowerShell.models.MicrosoftGraphContact
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type contact_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~Microsoft.Graph.PowerShell.models.Enum28]
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum29]
        :param expand: Expand related entities.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~Microsoft.Graph.PowerShell.models.CollectionOfMultiValueLegacyExtendedProperty0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_multi_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum30]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphMultiValueLegacyExtendedProperty, or the result of cls(response)
    ...
    def list_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :type contact_folder_id: str
        :param orderby: Order items by property values.
        :type orderby: list[str or ~Microsoft.Graph.PowerShell.models.Enum31]
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum32]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CollectionOfSingleValueLegacyExtendedProperty0 or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~Microsoft.Graph.PowerShell.models.CollectionOfSingleValueLegacyExtendedProperty0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_single_value_extended_property(
        ...
        **kwargs  # type: Any
        ...
        :param select: Select properties to be returned.
        :type select: list[str or ~Microsoft.Graph.PowerShell.models.Enum33]
        :param expand: Expand related entities.
        :type expand: list[str]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MicrosoftGraphSingleValueLegacyExtendedProperty, or the result of cls(response)
