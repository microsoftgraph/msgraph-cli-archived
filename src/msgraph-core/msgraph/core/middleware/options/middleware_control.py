from msgraph.core.constants import AUTH_MIDDLEWARE_OPTIONS
from msgraph.core.middleware.options.auth_middleware_options import AuthMiddlewareOptions
...
class MiddlewareControl:
    ...
    def set(self, middleware_option_name, middleware_option):
        self.middleware_options.update(
            {middleware_option_name: middleware_option})
